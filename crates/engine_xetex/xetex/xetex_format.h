/* tectonic_xetex_format engine header for version 31 */
...
#define TECTONIC_FORMAT_VERSION 31 /* = 0x1f */
...
#define INT_PAR__tracing_assigns 58 /* = 0x3a */
#define INT_PAR__tracing_groups 59 /* = 0x3b */
#define INT_PAR__tracing_ifs 60 /* = 0x3c */
#define INT_PAR__tracing_scan_tokens 61 /* = 0x3d */
#define INT_PAR__tracing_nesting 62 /* = 0x3e */
#define INT_PAR__pre_display_direction 63 /* = 0x3f */
#define INT_PAR__last_line_fit 64 /* = 0x40 */
#define INT_PAR__saving_vdiscards 65 /* = 0x41 */
#define INT_PAR__saving_hyph_codes 66 /* = 0x42 */
#define INT_PAR__suppress_fontnotfound_error 67 /* = 0x43 */
#define INT_PAR__xetex_linebreak_locale 68 /* = 0x44 */
#define INT_PAR__xetex_linebreak_penalty 69 /* = 0x45 */
#define INT_PAR__xetex_protrude_chars 70 /* = 0x46 */
#define INT_PAR__texxet 71 /* = 0x47 */
#define INT_PAR__xetex_dash_break 72 /* = 0x48 */
#define INT_PAR__xetex_upwards 73 /* = 0x49 */
#define INT_PAR__xetex_use_glyph_metrics 74 /* = 0x4a */
#define INT_PAR__xetex_inter_char_tokens 75 /* = 0x4b */
#define INT_PAR__xetex_input_normalization 76 /* = 0x4c */
#define INT_PAR__xetex_default_input_mode 77 /* = 0x4d */
#define INT_PAR__xetex_default_input_encoding 78 /* = 0x4e */
#define INT_PAR__xetex_tracing_fonts 79 /* = 0x4f */
#define INT_PAR__xetex_interword_space_shaping 80 /* = 0x50 */
#define INT_PAR__xetex_generate_actual_text 81 /* = 0x51 */
#define INT_PAR__xetex_hyphenatable_length 82 /* = 0x52 */
#define INT_PAR__synctex 83 /* = 0x53 */
#define INT_PAR__pdfoutput 84 /* = 0x54 */
#define INT_PARS 85 /* = 0x55 */
...
#define FROZEN_NULL_FONT 2243738 /* = 0x223c9a */
#define UNDEFINED_CONTROL_SEQUENCE 2252739 /* = 0x225fc3 */
#define GLUE_BASE 2252740 /* = 0x225fc4 */
#define SKIP_BASE 2252759 /* = 0x225fd7 */
#define MU_SKIP_BASE 2253015 /* = 0x2260d7 */
#define LOCAL_BASE 2253271 /* = 0x2261d7 */
#define TOKS_BASE 2253284 /* = 0x2261e4 */
#define ETEX_PEN_BASE 2253540 /* = 0x2262e4 */
#define BOX_BASE 2253544 /* = 0x2262e8 */
#define CUR_FONT_LOC 2253800 /* = 0x2263e8 */
#define MATH_FONT_BASE 2253801 /* = 0x2263e9 */
#define CAT_CODE_BASE 2254569 /* = 0x2266e9 */
#define LC_CODE_BASE 3368681 /* = 0x3366e9 */
#define UC_CODE_BASE 4482793 /* = 0x4466e9 */
#define SF_CODE_BASE 5596905 /* = 0x5566e9 */
#define MATH_CODE_BASE 6711017 /* = 0x6666e9 */
#define CHAR_SUB_CODE_BASE 7825129 /* = 0x7766e9 */
#define INT_BASE 8939241 /* = 0x8866e9 */
#define COUNT_BASE 8939326 /* = 0x88673e */
#define DEL_CODE_BASE 8939582 /* = 0x88683e */
#define DIMEN_BASE 10053694 /* = 0x99683e */
#define SCALED_BASE 10053717 /* = 0x996855 */
#define EQTB_SIZE 10053972 /* = 0x996954 */
#define EQTB_TOP 10653972 /* = 0xa29114 */
...
#define XETEX_FORMAT_PRIMITIVE_INITIALIZERS \
    ...
    { "Umathcode", XETEX_DEF_CODE, 6711018, xf_prim_init_none }, \
    { "XeTeXmathcode", XETEX_DEF_CODE, 6711018, xf_prim_init_none }, \
    { "Udelcodenum", XETEX_DEF_CODE, DEL_CODE_BASE, xf_prim_init_none }, \
    { "XeTeXdelcodenum", XETEX_DEF_CODE, DEL_CODE_BASE, xf_prim_init_none }, \
    { "Udelcode", XETEX_DEF_CODE, 8939583, xf_prim_init_none }, \
    { "XeTeXdelcode", XETEX_DEF_CODE, 8939583, xf_prim_init_none }, \
    { "textfont", DEF_FAMILY, 2253801, xf_prim_init_none }, \
    { "scriptfont", DEF_FAMILY, 2254057, xf_prim_init_none }, \
    { "scriptscriptfont", DEF_FAMILY, 2254313, xf_prim_init_none }, \
