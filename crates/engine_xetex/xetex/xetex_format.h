/* tectonic_xetex_format engine header for version 33 */
...
#define TECTONIC_FORMAT_VERSION 33 /* = 0x21 */
...
#define PRIM_SIZE 2100 /* = 0x834 */
#define PRIM_PRIME 1777 /* = 0x6f1 */
...
#define INT_PAR__tracing_stack_levels 55 /* = 0x37 */
#define INT_PAR__tracing_assigns 56 /* = 0x38 */
#define INT_PAR__tracing_groups 57 /* = 0x39 */
#define INT_PAR__tracing_ifs 58 /* = 0x3a */
#define INT_PAR__tracing_scan_tokens 59 /* = 0x3b */
#define INT_PAR__tracing_nesting 60 /* = 0x3c */
#define INT_PAR__pre_display_direction 61 /* = 0x3d */
#define INT_PAR__last_line_fit 62 /* = 0x3e */
#define INT_PAR__saving_vdiscards 63 /* = 0x3f */
#define INT_PAR__saving_hyph_codes 64 /* = 0x40 */
#define INT_PAR__suppress_fontnotfound_error 65 /* = 0x41 */
#define INT_PAR__xetex_linebreak_locale 66 /* = 0x42 */
#define INT_PAR__xetex_linebreak_penalty 67 /* = 0x43 */
#define INT_PAR__xetex_protrude_chars 68 /* = 0x44 */
#define INT_PAR__texxet 69 /* = 0x45 */
#define INT_PAR__xetex_dash_break 70 /* = 0x46 */
#define INT_PAR__xetex_upwards 71 /* = 0x47 */
#define INT_PAR__xetex_use_glyph_metrics 72 /* = 0x48 */
#define INT_PAR__xetex_inter_char_tokens 73 /* = 0x49 */
#define INT_PAR__xetex_input_normalization 74 /* = 0x4a */
#define INT_PAR__xetex_default_input_mode 75 /* = 0x4b */
#define INT_PAR__xetex_default_input_encoding 76 /* = 0x4c */
#define INT_PAR__xetex_tracing_fonts 77 /* = 0x4d */
#define INT_PAR__xetex_interword_space_shaping 78 /* = 0x4e */
#define INT_PAR__xetex_generate_actual_text 79 /* = 0x4f */
#define INT_PAR__xetex_hyphenatable_length 80 /* = 0x50 */
#define INT_PAR__synctex 81 /* = 0x51 */
#define INT_PAR__pdfoutput 82 /* = 0x52 */
...
#define PRIM_EQTB_BASE 2243238 /* = FROZEN_NULL_FONT */
#define FROZEN_NULL_FONT 2245338 /* = 0x2242da */
#define UNDEFINED_CONTROL_SEQUENCE 2254339 /* = 0x226603 */
#define GLUE_BASE 2254340 /* = 0x226604 */
#define SKIP_BASE 2254359 /* = 0x226617 */
#define MU_SKIP_BASE 2254615 /* = 0x226717 */
#define LOCAL_BASE 2254871 /* = 0x226817 */
#define TOKS_BASE 2254884 /* = 0x226824 */
#define ETEX_PEN_BASE 2255140 /* = 0x226924 */
#define BOX_BASE 2255144 /* = 0x226928 */
#define CUR_FONT_LOC 2255400 /* = 0x226a28 */
#define MATH_FONT_BASE 2255401 /* = 0x226a29 */
#define CAT_CODE_BASE 2256169 /* = 0x226d29 */
#define LC_CODE_BASE 3370281 /* = 0x336d29 */
#define UC_CODE_BASE 4484393 /* = 0x446d29 */
#define SF_CODE_BASE 5598505 /* = 0x556d29 */
#define MATH_CODE_BASE 6712617 /* = 0x666d29 */
#define INT_BASE 7826729 /* = 0x776d29 */
#define COUNT_BASE 7826812 /* = 0x776d7c */
#define DEL_CODE_BASE 7827068 /* = 0x776e7c */
#define DIMEN_BASE 8941180 /* = 0x886e7c */
#define SCALED_BASE 8941203 /* = 0x886e93 */
#define EQTB_SIZE 8941458 /* = 0x886f92 */
#define EQTB_TOP 9541458 /* = 0x919752 */
...
#define XETEX_FORMAT_PRIMITIVE_INITIALIZERS \
    ...
    { "Umathcode", XETEX_DEF_CODE, 6712618, xf_prim_init_none }, \
    { "XeTeXmathcode", XETEX_DEF_CODE, 6712618, xf_prim_init_none }, \
    { "Udelcodenum", XETEX_DEF_CODE, DEL_CODE_BASE, xf_prim_init_none }, \
    { "XeTeXdelcodenum", XETEX_DEF_CODE, DEL_CODE_BASE, xf_prim_init_none }, \
    { "Udelcode", XETEX_DEF_CODE, 7827069, xf_prim_init_none }, \
    { "XeTeXdelcode", XETEX_DEF_CODE, 7827069, xf_prim_init_none }, \
    { "textfont", DEF_FAMILY, 2255401, xf_prim_init_none }, \
    { "scriptfont", DEF_FAMILY, 2255657, xf_prim_init_none }, \
    { "scriptscriptfont", DEF_FAMILY, 2255913, xf_prim_init_none }, \
