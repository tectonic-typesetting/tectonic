...
extern scaled_t cur_active_width[7];
extern scaled_t background[7];
extern scaled_t break_width[7];
...
extern scaled_t disc_width;
extern int32_t easy_line;
extern int32_t last_special_line;
extern scaled_t first_width;
extern scaled_t second_width;
extern scaled_t first_indent;
extern scaled_t second_indent;
...
void movement(scaled_t w, eight_bits o);
...
int32_t reverse(int32_t this_box, int32_t t, scaled_t * cur_g, double * cur_glue);
void hlist_out(void);
void vlist_out(void);
