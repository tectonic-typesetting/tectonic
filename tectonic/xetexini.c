...
initialize_primitives(void)
{
    ...
    primitive(S(lineskip), 76 /*assign_glue*/, 2252240L /*glue_base 0*/);
    primitive(S(baselineskip), 76 /*assign_glue*/, 2252241L /*glue_base 1*/);
    primitive(S(parskip), 76 /*assign_glue*/, 2252242L /*glue_base 2*/);
    primitive(S(abovedisplayskip), 76 /*assign_glue*/, 2252243L /*glue_base 3*/);
    primitive(S(belowdisplayskip), 76 /*assign_glue*/, 2252244L /*glue_base 4*/);
    primitive(S(abovedisplayshortskip), 76 /*assign_glue*/, 2252245L /*glue_base 5*/);
    primitive(S(belowdisplayshortskip), 76 /*assign_glue*/, 2252246L /*glue_base 6*/);
    primitive(S(leftskip), 76 /*assign_glue*/, 2252247L /*glue_base 7*/);
    primitive(S(rightskip), 76 /*assign_glue*/, 2252248L /*glue_base 8*/);
    primitive(S(topskip), 76 /*assign_glue*/, 2252249L /*glue_base 9*/);
    primitive(S(splittopskip), 76 /*assign_glue*/, 2252250L /*glue_base 10*/);
    primitive(S(tabskip), 76 /*assign_glue*/, 2252251L /*glue_base 11*/);
    primitive(S(spaceskip), 76 /*assign_glue*/, 2252252L /*glue_base 12*/);
    primitive(S(xspaceskip), 76 /*assign_glue*/, 2252253L /*glue_base 13*/);
    primitive(S(parfillskip), 76 /*assign_glue*/, 2252254L /*glue_base 14*/);
    primitive(S(XeTeXlinebreakskip), 76 /*assign_glue*/, 2252255L /*glue_base 15*/);
    primitive(S(thinmuskip), 77 /*assign_mu_glue*/, 2252256L /*glue_base 16*/);
    primitive(S(medmuskip), 77 /*assign_mu_glue*/, 2252257L /*glue_base 17*/);
    primitive(S(thickmuskip), 77 /*assign_mu_glue*/, 2252258L /*glue_base 18*/);
    primitive(S(output), 73 /*assign_toks*/, 2252772L /*output_routine_loc*/);
    primitive(S(everypar), 73 /*assign_toks*/, 2252773L /*every_par_loc*/);
    primitive(S(everymath), 73 /*assign_toks*/, 2252774L /*every_math_loc*/);
    primitive(S(everydisplay), 73 /*assign_toks*/, 2252775L /*every_display_loc*/);
    primitive(S(everyhbox), 73 /*assign_toks*/, 2252776L /*every_hbox_loc*/);
    primitive(S(everyvbox), 73 /*assign_toks*/, 2252777L /*every_vbox_loc*/);
    primitive(S(everyjob), 73 /*assign_toks*/, 2252778L /*every_job_loc*/);
    primitive(S(everycr), 73 /*assign_toks*/, 2252779L /*every_cr_loc*/);
    primitive(S(errhelp), 73 /*assign_toks*/, 2252780L /*err_help_loc*/);
    primitive(S(pretolerance), 74 /*assign_int*/, 8938740L /*int_base 0*/);
    primitive(S(tolerance), 74 /*assign_int*/, 8938741L /*int_base 1*/);
    primitive(S(linepenalty), 74 /*assign_int*/, 8938742L /*int_base 2*/);
    primitive(S(hyphenpenalty), 74 /*assign_int*/, 8938743L /*int_base 3*/);
    primitive(S(exhyphenpenalty), 74 /*assign_int*/, 8938744L /*int_base 4*/);
    primitive(S(clubpenalty), 74 /*assign_int*/, 8938745L /*int_base 5*/);
    primitive(S(widowpenalty), 74 /*assign_int*/, 8938746L /*int_base 6*/);
    primitive(S(displaywidowpenalty), 74 /*assign_int*/, 8938747L /*int_base 7*/);
    primitive(S(brokenpenalty), 74 /*assign_int*/, 8938748L /*int_base 8*/);
    primitive(S(binoppenalty), 74 /*assign_int*/, 8938749L /*int_base 9*/);
    primitive(S(relpenalty), 74 /*assign_int*/, 8938750L /*int_base 10*/);
    primitive(S(predisplaypenalty), 74 /*assign_int*/, 8938751L /*int_base 11*/);
    primitive(S(postdisplaypenalty), 74 /*assign_int*/, 8938752L /*int_base 12*/);
    primitive(S(interlinepenalty), 74 /*assign_int*/, 8938753L /*int_base 13*/);
    primitive(S(doublehyphendemerits), 74 /*assign_int*/, 8938754L /*int_base 14*/);
    primitive(S(finalhyphendemerits), 74 /*assign_int*/, 8938755L /*int_base 15*/);
    primitive(S(adjdemerits), 74 /*assign_int*/, 8938756L /*int_base 16*/);
    primitive(S(mag), 74 /*assign_int*/, 8938757L /*int_base 17*/);
    primitive(S(delimiterfactor), 74 /*assign_int*/, 8938758L /*int_base 18*/);
    primitive(S(looseness), 74 /*assign_int*/, 8938759L /*int_base 19*/);
    primitive(S(time), 74 /*assign_int*/, 8938760L /*int_base 20*/);
    primitive(S(day), 74 /*assign_int*/, 8938761L /*int_base 21*/);
    primitive(S(month), 74 /*assign_int*/, 8938762L /*int_base 22*/);
    primitive(S(year), 74 /*assign_int*/, 8938763L /*int_base 23*/);
    primitive(S(showboxbreadth), 74 /*assign_int*/, 8938764L /*int_base 24*/);
    primitive(S(showboxdepth), 74 /*assign_int*/, 8938765L /*int_base 25*/);
    primitive(S(hbadness), 74 /*assign_int*/, 8938766L /*int_base 26*/);
    primitive(S(vbadness), 74 /*assign_int*/, 8938767L /*int_base 27*/);
    primitive(S(pausing), 74 /*assign_int*/, 8938768L /*int_base 28*/);
    primitive(S(tracingonline), 74 /*assign_int*/, 8938769L /*int_base 29*/);
    primitive(S(tracingmacros), 74 /*assign_int*/, 8938770L /*int_base 30*/);
    primitive(S(tracingstats), 74 /*assign_int*/, 8938771L /*int_base 31*/);
    primitive(S(tracingparagraphs), 74 /*assign_int*/, 8938772L /*int_base 32*/);
    primitive(S(tracingpages), 74 /*assign_int*/, 8938773L /*int_base 33*/);
    primitive(S(tracingoutput), 74 /*assign_int*/, 8938774L /*int_base 34*/);
    primitive(S(tracinglostchars), 74 /*assign_int*/, 8938775L /*int_base 35*/);
    primitive(S(tracingcommands), 74 /*assign_int*/, 8938776L /*int_base 36*/);
    primitive(S(tracingrestores), 74 /*assign_int*/, 8938777L /*int_base 37*/);
    primitive(S(uchyph), 74 /*assign_int*/, 8938778L /*int_base 38*/);
    primitive(S(outputpenalty), 74 /*assign_int*/, 8938779L /*int_base 39*/);
    primitive(S(maxdeadcycles), 74 /*assign_int*/, 8938780L /*int_base 40*/);
    primitive(S(hangafter), 74 /*assign_int*/, 8938781L /*int_base 41*/);
    primitive(S(floatingpenalty), 74 /*assign_int*/, 8938782L /*int_base 42*/);
    primitive(S(globaldefs), 74 /*assign_int*/, 8938783L /*int_base 43*/);
    primitive(S(fam), 74 /*assign_int*/, 8938784L /*int_base 44*/);
    primitive(S(escapechar), 74 /*assign_int*/, 8938785L /*int_base 45*/);
    primitive(S(defaulthyphenchar), 74 /*assign_int*/, 8938786L /*int_base 46*/);
    primitive(S(defaultskewchar), 74 /*assign_int*/, 8938787L /*int_base 47*/);
    primitive(S(endlinechar), 74 /*assign_int*/, 8938788L /*int_base 48*/);
    primitive(S(newlinechar), 74 /*assign_int*/, 8938789L /*int_base 49*/);
    primitive(S(language), 74 /*assign_int*/, 8938790L /*int_base 50*/);
    primitive(S(lefthyphenmin), 74 /*assign_int*/, 8938791L /*int_base 51*/);
    primitive(S(righthyphenmin), 74 /*assign_int*/, 8938792L /*int_base 52*/);
    primitive(S(holdinginserts), 74 /*assign_int*/, 8938793L /*int_base 53*/);
    primitive(S(errorcontextlines), 74 /*assign_int*/, 8938794L /*int_base 54*/);

    if (mltex_p) {
        mltex_enabled_p = true;
        primitive(S(charsubdefmax), 74 /*assign_int*/, 8938796L /*int_base 56*/);
        primitive(S(tracingcharsubdef), 74 /*assign_int*/, 8938797L /*int_base 57*/);
    }

    primitive(S(XeTeXlinebreakpenalty), 74 /*assign_int*/, 8938809L /*int_base 69*/);
    primitive(S(XeTeXprotrudechars), 74 /*assign_int*/, 8938810L /*int_base 70*/);
    primitive(S(parindent), 75 /*assign_dimen*/, 10053192L /*dimen_base 0*/);
    primitive(S(mathsurround), 75 /*assign_dimen*/, 10053193L /*dimen_base 1*/);
    primitive(S(lineskiplimit), 75 /*assign_dimen*/, 10053194L /*dimen_base 2*/);
    primitive(S(hsize), 75 /*assign_dimen*/, 10053195L /*dimen_base 3*/);
    primitive(S(vsize), 75 /*assign_dimen*/, 10053196L /*dimen_base 4*/);
    primitive(S(maxdepth), 75 /*assign_dimen*/, 10053197L /*dimen_base 5*/);
    primitive(S(splitmaxdepth), 75 /*assign_dimen*/, 10053198L /*dimen_base 6*/);
    primitive(S(boxmaxdepth), 75 /*assign_dimen*/, 10053199L /*dimen_base 7*/);
    primitive(S(hfuzz), 75 /*assign_dimen*/, 10053200L /*dimen_base 8*/);
    primitive(S(vfuzz), 75 /*assign_dimen*/, 10053201L /*dimen_base 9*/);
    primitive(S(delimitershortfall), 75 /*assign_dimen*/, 10053202L /*dimen_base 10*/);
    primitive(S(nulldelimiterspace), 75 /*assign_dimen*/, 10053203L /*dimen_base 11*/);
    primitive(S(scriptspace), 75 /*assign_dimen*/, 10053204L /*dimen_base 12*/);
    primitive(S(predisplaysize), 75 /*assign_dimen*/, 10053205L /*dimen_base 13*/);
    primitive(S(displaywidth), 75 /*assign_dimen*/, 10053206L /*dimen_base 14*/);
    primitive(S(displayindent), 75 /*assign_dimen*/, 10053207L /*dimen_base 15*/);
    primitive(S(overfullrule), 75 /*assign_dimen*/, 10053208L /*dimen_base 16*/);
    primitive(S(hangindent), 75 /*assign_dimen*/, 10053209L /*dimen_base 17*/);
    primitive(S(hoffset), 75 /*assign_dimen*/, 10053210L /*dimen_base 18*/);
    primitive(S(voffset), 75 /*assign_dimen*/, 10053211L /*dimen_base 19*/);
    ...
    primitive(S(fontdimen), 78 /*assign_font_dimen*/, 0);
    ...
    primitive(S(nullfont), 89 /*set_font*/, 0 /*font_base*/);
    ...
    primitive(S(catcode), 86 /*def_code*/, 2254068L /*cat_code_base*/);
    primitive(S(mathcode), 86 /*def_code*/, 6710516L /*math_code_base*/);
    primitive(S(XeTeXmathcodenum), 87 /*XeTeX_def_code*/, 6710516L /*math_code_base*/);
    primitive(S(Umathcodenum), 87 /*XeTeX_def_code*/, 6710516L /*math_code_base*/);
    ...
    primitive(S(lccode), 86 /*def_code*/, 3368180L /*lc_code_base*/);
    primitive(S(uccode), 86 /*def_code*/, 4482292L /*uc_code_base*/);
    primitive(S(sfcode), 86 /*def_code*/, 5596404L /*sf_code_base*/);
    primitive(S(XeTeXcharclass), 87 /*XeTeX_def_code*/, 5596404L /*sf_code_base*/);
    primitive(S(delcode), 86 /*def_code*/, 8939080L /*del_code_base*/);
    primitive(S(XeTeXdelcodenum), 87 /*XeTeX_def_code*/, 8939080L /*del_code_base*/);
    primitive(S(Udelcodenum), 87 /*XeTeX_def_code*/, 8939080L /*del_code_base*/);
    ...
    primitive(S(textfont), 88 /*def_family*/, 2253300L /*math_font_base*/);
    ...
    primitive(S(hyphenchar), 79 /*assign_font_int*/, 0);
    primitive(S(skewchar), 79 /*assign_font_int*/, 1);
    primitive(S(lpcode), 79 /*assign_font_int*/, 2);
    primitive(S(rpcode), 79 /*assign_font_int*/, 3);
    ...
    primitive(S(lowercase), 57 /*case_shift*/, 3368180L /*lc_code_base*/);
    primitive(S(uppercase), 57 /*case_shift*/, 4482292L /*uc_code_base*/);
    ...
    primitive(S(synctex), 74 /*assign_int*/, 8938823L /*int_base 83*/);
...
tt_run_engine(char *input_file_name)
{
	...
	primitive(S(XeTeXinterchartoks), 73 /*assign_toks*/, 2252782L /*XeTeX_inter_char_loc*/);
	...
	primitive(S(everyeof), 73 /*assign_toks*/, 2252781L /*every_eof_loc*/);
	primitive(S(tracingassigns), 74 /*assign_int*/, 8938798L /*int_base 58*/);
	primitive(S(tracinggroups), 74 /*assign_int*/, 8938799L /*int_base 59*/);
	primitive(S(tracingifs), 74 /*assign_int*/, 8938800L /*int_base 60*/);
	primitive(S(tracingscantokens), 74 /*assign_int*/, 8938801L /*int_base 61*/);
	primitive(S(tracingnesting), 74 /*assign_int*/, 8938802L /*int_base 62*/);
	primitive(S(predisplaydirection), 74 /*assign_int*/, 8938803L /*int_base 63*/);
	primitive(S(lastlinefit), 74 /*assign_int*/, 8938804L /*int_base 64*/);
	primitive(S(savingvdiscards), 74 /*assign_int*/, 8938805L /*int_base 65*/);
	primitive(S(savinghyphcodes), 74 /*assign_int*/, 8938806L /*int_base 66*/);
	...
	primitive(S(suppressfontnotfounderror), 74 /*assign_int*/, 8938807L /*int_base 67*/);
	primitive(S(TeXXeTstate), 74 /*assign_int*/, 8938811L /*eTeX_state_base 0*/);
	primitive(S(XeTeXupwardsmode), 74 /*assign_int*/, 8938813L /*eTeX_state_base 2*/);
	primitive(S(XeTeXuseglyphmetrics), 74 /*assign_int*/, 8938814L /*eTeX_state_base 3*/);
	primitive(S(XeTeXinterchartokenstate), 74 /*assign_int*/, 8938815L /*eTeX_state_base 4*/);
	primitive(S(XeTeXdashbreakstate), 74 /*assign_int*/, 8938812L /*eTeX_state_base 1*/);
	primitive(S(XeTeXinputnormalization), 74 /*assign_int*/, 8938816L /*eTeX_state_base 5*/);
	primitive(S(XeTeXtracingfonts), 74 /*assign_int*/, 8938819L /*eTeX_state_base 8*/);
	primitive(S(XeTeXinterwordspaceshaping), 74 /*assign_int*/, 8938820L /*eTeX_state_base 9*/);
	primitive(S(XeTeXgenerateactualtext), 74 /*assign_int*/, 8938821L /*eTeX_state_base 10*/);
	primitive(S(XeTeXhyphenatablelength), 74 /*assign_int*/, 8938822L /*eTeX_state_base 11*/);
