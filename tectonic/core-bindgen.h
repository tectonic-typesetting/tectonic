#ifndef tectonic_core_bindgen_h
#define tectonic_core_bindgen_h
...
extern int bibtex_simple_main(tt_bridge_api_t *api, const char *aux_file_name);

extern int dvipdfmx_simple_main(tt_bridge_api_t *api,
                                const char *dviname,
                                const char *pdfname,
                                bool enable_compression,
                                bool deterministic_tags);

extern int tex_simple_main(tt_bridge_api_t *api,
