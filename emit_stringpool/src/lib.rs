...
/*!
This crate is a build-time helper for Tectonic to emit a pre-filled "string
pool" data structure for the Tectonic C code.
*/
...
pub fn emit (listfile: &Path, outstem: &Path) -> Result<()> {
    ...
    writeln!(source, "/* Automatically generated by emit_stringpool. */")?;
    writeln!(header, "/* Automatically generated by emit_stringpool. */")?;
