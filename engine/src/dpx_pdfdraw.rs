...
extern "C" {
    ...
    #[no_mangle]
    fn pdf_sprint_length(buf: *mut libc::c_char, value: libc::c_double)
     -> libc::c_int;
    #[no_mangle]
    fn pdf_sprint_coord(buf: *mut libc::c_char, p: *const pdf_coord)
     -> libc::c_int;
    #[no_mangle]
    fn pdf_sprint_rect(buf: *mut libc::c_char, p: *const pdf_rect)
     -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn pdf_color_compare(color1: *const pdf_color, color2: *const pdf_color)
     -> libc::c_int;
    #[no_mangle]
    fn pdf_color_to_string(color: *const pdf_color, buffer: *mut libc::c_char,
                           mask: libc::c_char) -> libc::c_int;
    #[no_mangle]
...
pub struct pdf_gstate_ {
    ...
    pub linewidth: libc::c_double,
    pub linecap: libc::c_int,
    pub linejoin: libc::c_int,
    pub miterlimit: libc::c_double,
...
pub struct C2RustUnnamed_0 {
    pub opchr: libc::c_char,
    pub n_pts: libc::c_int,
    pub strkey: *const libc::c_char,
}
#[inline]
...
unsafe extern "C" fn inversematrix(mut W: *mut pdf_tmatrix,
                                   mut M: *const pdf_tmatrix) -> libc::c_int {
    let mut det: libc::c_double = 0.;
    det = (*M).a * (*M).d - (*M).b * (*M).c;
    if fabs(det) < 2.5e-16f64 {
        dpx_warning(b"Inverting matrix with zero determinant...\x00" as
...
unsafe extern "C" fn pdf_coord__equal(mut p1: *const pdf_coord,
                                      mut p2: *const pdf_coord)
 -> libc::c_int {
    if fabs((*p1).x - (*p2).x) < 1.0e-7f64 &&
           fabs((*p1).y - (*p2).y) < 1.0e-7f64 {
        return 1i32
    }
    return 0i32;
}
unsafe extern "C" fn pdf_coord__transform(mut p: *mut pdf_coord,
...
unsafe extern "C" fn pdf_coord__dtransform(mut p: *mut pdf_coord,
                                           mut M: *const pdf_tmatrix)
 -> libc::c_int {
    let mut x: libc::c_double = 0.;
    let mut y: libc::c_double = 0.;
...
unsafe extern "C" fn pdf_coord__idtransform(mut p: *mut pdf_coord,
                                            mut M: *const pdf_tmatrix)
 -> libc::c_int {
...
pub unsafe extern "C" fn pdf_invertmatrix(mut M: *mut pdf_tmatrix) {
    ...
    if !M.is_null() {
        ...
        __assert_fail(b"M\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 137i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 37],
                                                &[libc::c_char; 37]>(b"void pdf_invertmatrix(pdf_tmatrix *)\x00")).as_ptr());
    }
    det = (*M).a * (*M).d - (*M).b * (*M).c;
    if fabs(det) < 2.5e-16f64 {
        dpx_warning(b"Inverting matrix with zero determinant...\x00" as
...
static mut petypes: [C2RustUnnamed_0; 7] =
    [{
         let mut init =
             C2RustUnnamed_0{opchr: 'm' as i32 as libc::c_char,
                             n_pts: 1i32,
                             strkey:
                                 b"moveto\x00" as *const u8 as
                                     *const libc::c_char,};
         init
     },
     {
         let mut init =
             C2RustUnnamed_0{opchr: 'l' as i32 as libc::c_char,
                             n_pts: 1i32,
                             strkey:
                                 b"lineto\x00" as *const u8 as
                                     *const libc::c_char,};
         init
     },
     {
         let mut init =
             C2RustUnnamed_0{opchr: 'c' as i32 as libc::c_char,
                             n_pts: 3i32,
                             strkey:
                                 b"curveto\x00" as *const u8 as
                                     *const libc::c_char,};
         init
     },
     {
         let mut init =
             C2RustUnnamed_0{opchr: 'v' as i32 as libc::c_char,
                             n_pts: 2i32,
                             strkey:
                                 b"vcurveto\x00" as *const u8 as
                                     *const libc::c_char,};
         init
     },
     {
         let mut init =
             C2RustUnnamed_0{opchr: 'y' as i32 as libc::c_char,
                             n_pts: 2i32,
                             strkey:
                                 b"ycurveto\x00" as *const u8 as
                                     *const libc::c_char,};
         init
     },
     {
         let mut init =
             C2RustUnnamed_0{opchr: 'h' as i32 as libc::c_char,
                             n_pts: 0i32,
                             strkey:
                                 b"closepath\x00" as *const u8 as
                                     *const libc::c_char,};
         init
     },
     {
         let mut init =
             C2RustUnnamed_0{opchr: ' ' as i32 as libc::c_char,
                             n_pts: 0i32,
                             strkey: 0 as *const libc::c_char,};
         init
     }];
static mut fmt_buf: [libc::c_char; 1024] = [0; 1024];
    ...
    if !p.is_null() {
        ...
        __assert_fail(b"p\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 29],
                                                &[libc::c_char; 29]>(b"void init_a_path(pdf_path *)\x00")).as_ptr());
    }
...
unsafe extern "C" fn pdf_path__clearpath(mut p: *mut pdf_path) {
    if !p.is_null() {
        ...
        __assert_fail(b"p\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 37],
                                                &[libc::c_char; 37]>(b"void pdf_path__clearpath(pdf_path *)\x00")).as_ptr());
    }
    (*p).num_paths = 0i32 as libc::c_uint;
}
unsafe extern "C" fn pdf_path__growpath(mut p: *mut pdf_path,
                                        mut max_pe: libc::c_uint)
 -> libc::c_int {
    if max_pe < (*p).max_paths { return 0i32 }
    (*p).max_paths =
        if (*p).max_paths.wrapping_add(8i32 as libc::c_uint) > max_pe {
            (*p).max_paths.wrapping_add(8i32 as libc::c_uint)
        } else { max_pe };
    (*p).path =
        renew((*p).path as *mut libc::c_void,
              ((*p).max_paths as
                   libc::c_ulong).wrapping_mul(::std::mem::size_of::<pa_elem>()
                                                   as libc::c_ulong) as
                  uint32_t) as *mut pa_elem;
    return 0i32;
}
unsafe extern "C" fn clear_a_path(mut p: *mut pdf_path) {
    if !p.is_null() {
        ...
        __assert_fail(b"p\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 246i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 30],
                                                &[libc::c_char; 30]>(b"void clear_a_path(pdf_path *)\x00")).as_ptr());
    }
    (*p).path = mfree((*p).path as *mut libc::c_void) as *mut pa_elem;
    (*p).num_paths = 0i32 as libc::c_uint;
    (*p).max_paths = 0i32 as libc::c_uint;
}
unsafe extern "C" fn pdf_path__copypath(mut p1: *mut pdf_path,
...
/* start new subpath */
unsafe extern "C" fn pdf_path__moveto(mut pa: *mut pdf_path,
                                      mut cp: *mut pdf_coord,
                                      mut p0: *const pdf_coord)
 -> libc::c_int {
    let mut pe: *mut pa_elem = 0 as *mut pa_elem;
    pdf_path__growpath(pa,
                       (*pa).num_paths.wrapping_add(1i32 as libc::c_uint));
    if (*pa).num_paths > 0i32 as libc::c_uint {
        pe =
            &mut *(*pa).path.offset((*pa).num_paths.wrapping_sub(1i32 as
                                                                     libc::c_uint)
                                        as isize) as *mut pa_elem;
        if (*pe).type_0 == 0i32 {
            (*cp).x = (*p0).x;
            (*pe).p[0].x = (*cp).x;
            (*cp).y = (*p0).y;
 ...
 */
unsafe extern "C" fn pdf_path__next_pe(mut pa: *mut pdf_path,
                                       mut cp: *const pdf_coord)
 -> *mut pa_elem {
    let mut pe: *mut pa_elem = 0 as *mut pa_elem;
    pdf_path__growpath(pa,
                       (*pa).num_paths.wrapping_add(2i32 as libc::c_uint));
    if (*pa).num_paths == 0i32 as libc::c_uint {
...
unsafe extern "C" fn pdf_path__transform(mut pa: *mut pdf_path,
                                         mut M: *const pdf_tmatrix)
 -> libc::c_int {
    let mut pe: *mut pa_elem = 0 as *mut pa_elem;
    ...
    if !pa.is_null() && !M.is_null() {
        ...
        __assert_fail(b"pa && M\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 376i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 57],
                                                &[libc::c_char; 57]>(b"int pdf_path__transform(pdf_path *, const pdf_tmatrix *)\x00")).as_ptr());
    }
    i = 0i32 as libc::c_uint;
    while i < (*pa).num_paths {
        ...
        loop  {
            let fresh8 = n;
            n = n.wrapping_sub(1);
            if !(fresh8 > 0i32 as libc::c_uint) { break ; }
            pdf_coord__transform(&mut *(*pe).p.as_mut_ptr().offset(n as
                                                                       isize),
                                 M);
        }
        i = i.wrapping_add(1)
...
/* Path Construction */
unsafe extern "C" fn pdf_path__lineto(mut pa: *mut pdf_path,
                                      mut cp: *mut pdf_coord,
                                      mut p0: *const pdf_coord)
 -> libc::c_int {
    let mut pe: *mut pa_elem = 0 as *mut pa_elem;
...
unsafe extern "C" fn pdf_path__curveto(mut pa: *mut pdf_path,
                                       mut cp: *mut pdf_coord,
                                       mut p0: *const pdf_coord,
...
unsafe extern "C" fn pdf_path__elliptarc(mut pa: *mut pdf_path,
                                         mut cp: *mut pdf_coord,
                                         mut ca: *const pdf_coord,
                                         mut r_x: libc::c_double,
                                         mut r_y: libc::c_double,
                                         mut xar: libc::c_double,
                                         mut a_0: libc::c_double,
                                         mut a_1: libc::c_double,
                                         mut a_d: libc::c_int) -> libc::c_int 
 /* arc orientation        */
 {
    let mut b: libc::c_double = 0.; /* number of segments */
    let mut b_x: libc::c_double = 0.;
    let mut b_y: libc::c_double = 0.;
    let mut d_a: libc::c_double = 0.;
    ...
    let mut T: pdf_tmatrix =
        pdf_tmatrix{a: 0., b: 0., c: 0., d: 0., e: 0., f: 0.,};
    let mut n_c: libc::c_int = 0;
    let mut i: libc::c_int = 0;
    let mut error: libc::c_int = 0i32;
    if fabs(r_x) < 2.5e-16f64 || fabs(r_y) < 2.5e-16f64 { return -1i32 }
    if a_d < 0i32 {
        while a_1 > a_0 { a_1 -= 360.0f64 }
    } else { while a_1 < a_0 { a_0 -= 360.0f64 } }
    d_a = a_1 - a_0;
    n_c = 1i32;
    while fabs(d_a) > 90.0f64 * n_c as libc::c_double { n_c += 1 }
    d_a /= n_c as libc::c_double;
    if fabs(d_a) < 2.5e-16f64 { return -1i32 }
...
unsafe extern "C" fn pdf_path__closepath(mut pa: *mut pdf_path,
                                         mut cp: *mut pdf_coord)
 -> libc::c_int 
 /* no arg */
 {
    ...
    i =
        (*pa).num_paths.wrapping_sub(1i32 as libc::c_uint) as
            libc::c_int; /* No path or no start point(!) */
    while i >= 0i32 {
        pe = &mut *(*pa).path.offset(i as isize) as *mut pa_elem;
        if (*pe).type_0 == 0i32 { break ; }
        i -= 1
    }
    if pe.is_null() || i < 0i32 { return -1i32 }
    (*cp).x = (*pe).p[0].x;
    (*cp).y = (*pe).p[0].y;
    pdf_path__growpath(pa,
                       (*pa).num_paths.wrapping_add(1i32 as libc::c_uint));
 ...
 */
/* Just for quick test */
unsafe extern "C" fn pdf_path__isarect(mut pa: *mut pdf_path,
                                       mut f_ir: libc::c_int) -> libc::c_int 
 /* fill-rule is ignorable */
 {
    ...
    if (*pa).num_paths == 5i32 as libc::c_uint {
        ...
        if (*pe0).type_0 == 0i32 && (*pe1).type_0 == 1i32 &&
               (*pe2).type_0 == 1i32 && (*pe3).type_0 == 1i32 &&
               (*pe4).type_0 == 5i32 {
            if (*pe1).p[0].y - (*pe0).p[0].y == 0i32 as libc::c_double &&
                   (*pe2).p[0].x - (*pe1).p[0].x == 0i32 as libc::c_double &&
                   (*pe3).p[0].y - (*pe2).p[0].y == 0i32 as libc::c_double {
...
/* Path Painting */
/* F is obsoleted */
unsafe extern "C" fn INVERTIBLE_MATRIX(mut M: *const pdf_tmatrix)
 -> libc::c_int {
    if fabs((*M).a * (*M).d - (*M).b * (*M).c) < 2.5e-16f64 {
        dpx_warning(b"Transformation matrix not invertible.\x00" as *const u8
                        as *const libc::c_char);
        dpx_warning(b"--- M = [%g %g %g %g %g %g]\x00" as *const u8 as
                        *const libc::c_char, (*M).a, (*M).b, (*M).c, (*M).d,
                    (*M).e, (*M).f);
        return -1i32
    }
    return 0i32;
 ...
 */
unsafe extern "C" fn pdf_dev__rectshape(mut r: *const pdf_rect,
                                        mut M: *const pdf_tmatrix,
                                        mut opchr: libc::c_char)
 -> libc::c_int {
    let mut buf: *mut libc::c_char = fmt_buf.as_mut_ptr();
    ...
    if !r.is_null() &&
        ...
        __assert_fail(b"r && PT_OP_VALID(opchr)\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 667i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 68],
                                                &[libc::c_char; 68]>(b"int pdf_dev__rectshape(const pdf_rect *, const pdf_tmatrix *, char)\x00")).as_ptr());
    }
    isclip =
        if opchr as libc::c_int == 'W' as i32 ||
               opchr as libc::c_int == ' ' as i32 {
            1i32
        } else { 0i32 };
   ...
   */
    ...
    *buf.offset(fresh10 as isize) = ' ' as i32 as libc::c_char;
    if isclip == 0 {
        let fresh11 = len;
        len = len + 1;
        *buf.offset(fresh11 as isize) = 'q' as i32 as libc::c_char;
        if !M.is_null() {
            let fresh12 = len;
            len = len + 1;
            ...
            *buf.offset(fresh13 as isize) = ' ' as i32 as libc::c_char;
            let fresh14 = len;
            len = len + 1;
            *buf.offset(fresh14 as isize) = 'c' as i32 as libc::c_char;
            let fresh15 = len;
            len = len + 1;
            *buf.offset(fresh15 as isize) = 'm' as i32 as libc::c_char
        }
        let fresh16 = len;
        len = len + 1;
    ...
    let fresh17 = len;
    len = len + 1;
    *buf.offset(fresh17 as isize) = 'n' as i32 as libc::c_char;
    p.x = (*r).llx;
    p.y = (*r).lly;
    wd = (*r).urx - (*r).llx;
    ht = (*r).ury - (*r).lly;
    ...
    *buf.offset(fresh21 as isize) = ' ' as i32 as libc::c_char;
    let fresh22 = len;
    len = len + 1;
    *buf.offset(fresh22 as isize) = 'r' as i32 as libc::c_char;
    let fresh23 = len;
    len = len + 1;
    *buf.offset(fresh23 as isize) = 'e' as i32 as libc::c_char;
    if opchr as libc::c_int != ' ' as i32 {
        let fresh24 = len;
        len = len + 1;
        *buf.offset(fresh24 as isize) = ' ' as i32 as libc::c_char;
        let fresh25 = len;
        len = len + 1;
        *buf.offset(fresh25 as isize) = opchr;
        let fresh26 = len;
        len = len + 1;
        *buf.offset(fresh26 as isize) = ' ' as i32 as libc::c_char;
        let fresh27 = len;
        len = len + 1;
        *buf.offset(fresh27 as isize) =
            (if isclip != 0 { 'n' as i32 } else { 'Q' as i32 }) as
                libc::c_char
    }
...
/* FIXME */
unsafe extern "C" fn pdf_dev__flushpath(mut pa: *mut pdf_path,
                                        mut opchr: libc::c_char,
                                        mut rule: libc::c_int,
 ...
 -> libc::c_int {
    ...
    let mut b: *mut libc::c_char = fmt_buf.as_mut_ptr(); /* height... */
    let mut b_len: libc::c_int = 1024i32; /* op: re */
    let mut r: pdf_rect =
        pdf_rect{llx: 0., lly: 0., urx: 0., ury: 0.,}; /* op: m l c v y h */
    let mut pt: *mut pdf_coord = 0 as *mut pdf_coord; /* op: m l c v y h */
    let mut n_pts: libc::c_int =
        0; /* op: f F s S b B W f* F* s* S* b* B* W* */
    ...
    if !pa.is_null() &&
        ...
        __assert_fail(b"pa && PT_OP_VALID(opchr)\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 738i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 51],
                                                &[libc::c_char; 51]>(b"int pdf_dev__flushpath(pdf_path *, char, int, int)\x00")).as_ptr());
    }
    isclip = if opchr as libc::c_int == 'W' as i32 { 1i32 } else { 0i32 };
    ...
    if isrect != 0 {
        ...
        let fresh28 = len;
        len = len + 1;
        *b.offset(fresh28 as isize) = ' ' as i32 as libc::c_char;
        len += pdf_sprint_rect(b.offset(len as isize), &mut r);
        let fresh29 = len;
        len = len + 1;
        *b.offset(fresh29 as isize) = ' ' as i32 as libc::c_char;
        let fresh30 = len;
        len = len + 1;
        *b.offset(fresh30 as isize) = 'r' as i32 as libc::c_char;
        let fresh31 = len;
        len = len + 1;
        *b.offset(fresh31 as isize) = 'e' as i32 as libc::c_char;
        ...
        while i < n_seg {
            ...
            while j < n_pts {
                let fresh32 = len;
                len = len + 1;
                *b.offset(fresh32 as isize) = ' ' as i32 as libc::c_char;
            ...
            let fresh33 = len;
            len = len + 1;
            *b.offset(fresh33 as isize) = ' ' as i32 as libc::c_char;
            let fresh34 = len;
            len = len + 1;
    ...
    let fresh35 = len;
    len = len + 1;
    *b.offset(fresh35 as isize) = ' ' as i32 as libc::c_char;
    let fresh36 = len;
    len = len + 1;
    *b.offset(fresh36 as isize) = opchr;
    if rule == 1i32 {
        let fresh37 = len;
        len = len + 1;
        *b.offset(fresh37 as isize) = '*' as i32 as libc::c_char
    }
    if isclip != 0 {
        let fresh38 = len;
        len = len + 1;
        *b.offset(fresh38 as isize) = ' ' as i32 as libc::c_char;
        let fresh39 = len;
        len = len + 1;
        *b.offset(fresh39 as isize) = 'n' as i32 as libc::c_char
    }
    pdf_doc_add_page_content(b, len as libc::c_uint);
    return 0i32;
}
unsafe extern "C" fn m_stack_init(mut stack: *mut m_stack) {
    if !stack.is_null() {
        ...
        __assert_fail(b"stack\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 850i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 29],
                                                &[libc::c_char; 29]>(b"void m_stack_init(m_stack *)\x00")).as_ptr());
    }
    (*stack).size = 0i32;
    (*stack).top = 0 as *mut m_stack_elem;
    (*stack).bottom = 0 as *mut m_stack_elem;
}
unsafe extern "C" fn m_stack_push(mut stack: *mut m_stack,
    ...
    if !stack.is_null() {
        ...
        __assert_fail(b"stack\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 864i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 37],
                                                &[libc::c_char; 37]>(b"void m_stack_push(m_stack *, void *)\x00")).as_ptr());
    }
    elem =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<m_stack_elem>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut m_stack_elem;
    (*elem).prev = (*stack).top;
    (*elem).data = data;
    (*stack).top = elem;
    if (*stack).size == 0i32 { (*stack).bottom = elem }
    (*stack).size += 1;
}
unsafe extern "C" fn m_stack_pop(mut stack: *mut m_stack)
 -> *mut libc::c_void {
    let mut elem: *mut m_stack_elem = 0 as *mut m_stack_elem;
    ...
    if !stack.is_null() {
        ...
        __assert_fail(b"stack\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 885i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 29],
                                                &[libc::c_char; 29]>(b"void *m_stack_pop(m_stack *)\x00")).as_ptr());
    }
    if (*stack).size == 0i32 { return 0 as *mut libc::c_void }
    data = (*(*stack).top).data;
    elem = (*stack).top;
    (*stack).top = (*elem).prev;
    if (*stack).size == 1i32 { (*stack).bottom = 0 as *mut m_stack_elem }
    free(elem as *mut libc::c_void);
    (*stack).size -= 1;
    return data;
}
unsafe extern "C" fn m_stack_top(mut stack: *mut m_stack)
 -> *mut libc::c_void {
    let mut data: *mut libc::c_void = 0 as *mut libc::c_void;
    if !stack.is_null() {
    } else {
        __assert_fail(b"stack\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 907i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 29],
                                                &[libc::c_char; 29]>(b"void *m_stack_top(m_stack *)\x00")).as_ptr());
    }
    if (*stack).size == 0i32 { return 0 as *mut libc::c_void }
    data = (*(*stack).top).data;
    return data;
}
static mut gs_stack: m_stack =
    m_stack{size: 0,
...
unsafe extern "C" fn init_a_gstate(mut gs: *mut pdf_gstate) {
    ...
    (*gs).linedash.offset = 0i32 as libc::c_double;
    (*gs).linecap = 0i32;
    (*gs).linejoin = 0i32;
    (*gs).linewidth = 1.0f64;
    ...
    (*gs).pt_fixee.x = 0i32 as libc::c_double;
    (*gs).pt_fixee.y = 0i32 as libc::c_double;
}
unsafe extern "C" fn clear_a_gstate(mut gs: *mut pdf_gstate) {
    clear_a_path(&mut (*gs).path);
    memset(gs as *mut libc::c_void, 0i32,
           ::std::mem::size_of::<pdf_gstate>() as libc::c_ulong);
}
unsafe extern "C" fn copy_a_gstate(mut gs1: *mut pdf_gstate,
                                   mut gs2: *mut pdf_gstate) {
    let mut i: libc::c_int = 0;
    if !gs1.is_null() && !gs2.is_null() {
    } else {
        __assert_fail(b"gs1 && gs2\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 964i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 47],
                                                &[libc::c_char; 47]>(b"void copy_a_gstate(pdf_gstate *, pdf_gstate *)\x00")).as_ptr());
    }
    (*gs1).cp.x = (*gs2).cp.x;
    (*gs1).cp.y = (*gs2).cp.y;
   ...
   * copying whole path.
   */
    pdf_path__copypath(&mut (*gs1).path,
                       &mut (*gs2).path); /* Initial state */
    (*gs1).linedash.num_dash = (*gs2).linedash.num_dash;
    i = 0i32;
    while i < (*gs2).linedash.num_dash {
        (*gs1).linedash.pattern[i as usize] =
            (*gs2).linedash.pattern[i as usize];
        i += 1
    }
...
pub unsafe extern "C" fn pdf_dev_init_gstates() {
    ...
    gs =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<pdf_gstate>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut pdf_gstate;
    init_a_gstate(gs);
...
pub unsafe extern "C" fn pdf_dev_clear_gstates() {
    ...
    if gs_stack.size > 1i32 {
        /* at least 1 elem. */
        dpx_warning(b"GS stack depth is not zero at the end of the document.\x00"
                        as *const u8 as *const libc::c_char); /* op: q */
    }
    loop  {
...
pub unsafe extern "C" fn pdf_dev_gsave() -> libc::c_int {
    ...
    pdf_doc_add_page_content(b" q\x00" as *const u8 as *const libc::c_char,
                             2i32 as libc::c_uint);
    return 0i32;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_grestore() -> libc::c_int {
    ...
    if gs_stack.size <= 1i32 {
        ...
        dpx_warning(b"Too many grestores.\x00" as *const u8 as
                        *const libc::c_char); /* op: Q */
        return -1i32
    }
    gs = m_stack_pop(&mut gs_stack) as *mut pdf_gstate;
    clear_a_gstate(gs);
...
pub unsafe extern "C" fn pdf_dev_grestore_to(mut depth: libc::c_int) {
    ...
    if depth >= 0i32 {
        ...
        __assert_fail(b"depth >= 0\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 1113i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 30],
                                                &[libc::c_char; 30]>(b"void pdf_dev_grestore_to(int)\x00")).as_ptr());
    }
    if (*gss).size > depth + 1i32 {
        dpx_warning(b"Closing pending transformations at end of page/XObject.\x00"
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_currentpoint(mut p: *mut pdf_coord)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    ...
    if !p.is_null() {
        ...
        __assert_fail(b"p\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 1137i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 38],
                                                &[libc::c_char; 38]>(b"int pdf_dev_currentpoint(pdf_coord *)\x00")).as_ptr());
    }
    (*p).x = (*cpt).x;
    (*p).y = (*cpt).y;
    return 0i32;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_currentmatrix(mut M: *mut pdf_tmatrix)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    ...
    if !M.is_null() {
        ...
        __assert_fail(b"M\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 1151i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 41],
                                                &[libc::c_char; 41]>(b"int pdf_dev_currentmatrix(pdf_tmatrix *)\x00")).as_ptr());
    }
    (*M).a = (*CTM).a;
    (*M).b = (*CTM).b;
    (*M).c = (*CTM).c;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_set_color(mut color: *const pdf_color,
                                           mut mask: libc::c_char,
                                           mut force: libc::c_int) {
    let mut len: libc::c_int = 0;
    let mut gs: *mut pdf_gstate =
        m_stack_top(&mut gs_stack) as *mut pdf_gstate;
    let mut current: *mut pdf_color =
        if mask as libc::c_int != 0 {
            &mut (*gs).fillcolor
        } else { &mut (*gs).strokecolor };
    if pdf_color_is_valid(color) {
    } else {
        __assert_fail(b"pdf_color_is_valid(color)\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 1172i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"void pdf_dev_set_color(const pdf_color *, char, int)\x00")).as_ptr());
    }
    if !(pdf_dev_get_param(2i32) != 0 &&
             (force != 0 || pdf_color_compare(color, current) != 0)) {
    ...
    let fresh40 = len;
    len = len + 1;
    fmt_buf[fresh40 as usize] = ' ' as i32 as libc::c_char;
    match pdf_color_type(color) {
        -3 => {
            let fresh41 = len;
            len = len + 1;
            fmt_buf[fresh41 as usize] =
                ('R' as i32 | mask as libc::c_int) as libc::c_char;
            let fresh42 = len;
            len = len + 1;
            fmt_buf[fresh42 as usize] =
                ('G' as i32 | mask as libc::c_int) as libc::c_char
        }
        -4 => {
            let fresh43 = len;
            len = len + 1;
            fmt_buf[fresh43 as usize] =
                ('K' as i32 | mask as libc::c_int) as libc::c_char
        }
        -1 => {
            let fresh44 = len;
            len = len + 1;
            fmt_buf[fresh44 as usize] =
                ('G' as i32 | mask as libc::c_int) as libc::c_char
        }
        _ => { }
    }
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_concat(mut M: *const pdf_tmatrix)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    ...
    let mut W: pdf_tmatrix =
        {
            let mut init =
                pdf_tmatrix{a: 0i32 as libc::c_double,
    ...
    if !M.is_null() {
        ...
        __assert_fail(b"M\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 1215i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 40],
                                                &[libc::c_char; 40]>(b"int pdf_dev_concat(const pdf_tmatrix *)\x00")).as_ptr());
    }
   ...
   */
    if fabs((*M).a * (*M).d - (*M).b * (*M).c) < 2.5e-16f64 {
        dpx_warning(b"Transformation matrix not invertible.\x00" as *const u8
                        as *const libc::c_char); /* op: cm */
        dpx_warning(b"--- M = [%g %g %g %g %g %g]\x00" as *const u8 as
                        *const libc::c_char, (*M).a, (*M).b, (*M).c, (*M).d,
                    (*M).e, (*M).f);
        return -1i32
    }
    if fabs((*M).a - 1.0f64) > 2.5e-16f64 || fabs((*M).b) > 2.5e-16f64 ||
           fabs((*M).c) > 2.5e-16f64 || fabs((*M).d - 1.0f64) > 2.5e-16f64 ||
           fabs((*M).e) > 2.5e-16f64 || fabs((*M).f) > 2.5e-16f64 {
        let fresh45 = len;
        len = len + 1;
        *buf.offset(fresh45 as isize) = ' ' as i32 as libc::c_char;
        len += pdf_sprint_matrix(buf.offset(len as isize), M);
        let fresh46 = len;
        len = len + 1;
        *buf.offset(fresh46 as isize) = ' ' as i32 as libc::c_char;
        let fresh47 = len;
        len = len + 1;
        *buf.offset(fresh47 as isize) = 'c' as i32 as libc::c_char;
        let fresh48 = len;
        len = len + 1;
        *buf.offset(fresh48 as isize) = 'm' as i32 as libc::c_char;
        pdf_doc_add_page_content(buf, len as libc::c_uint);
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_setmiterlimit(mut mlimit: libc::c_double)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack; /* op: M */
    let mut gs: *mut pdf_gstate =
        m_stack_top(gss) as *mut pdf_gstate; /* op: J */
    let mut len: libc::c_int = 0i32; /* op: j */
    let mut buf: *mut libc::c_char = fmt_buf.as_mut_ptr(); /* op: w */
    if (*gs).miterlimit != mlimit {
        let fresh49 = len; /* op: */
        len = len + 1; /* op: */
        *buf.offset(fresh49 as isize) = ' ' as i32 as libc::c_char; /* op: */
        ...
        *buf.offset(fresh50 as isize) = ' ' as i32 as libc::c_char;
        let fresh51 = len;
        len = len + 1;
        *buf.offset(fresh51 as isize) = 'M' as i32 as libc::c_char;
        pdf_doc_add_page_content(buf, len as libc::c_uint);
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_setlinecap(mut capstyle: libc::c_int)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut len: libc::c_int = 0i32;
    ...
    if (*gs).linecap != capstyle {
        len =
            sprintf(buf, b" %d J\x00" as *const u8 as *const libc::c_char,
                    capstyle);
        pdf_doc_add_page_content(buf, len as libc::c_uint);
        (*gs).linecap = capstyle
    }
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_setlinejoin(mut joinstyle: libc::c_int)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut len: libc::c_int = 0i32;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_setlinewidth(mut width: libc::c_double)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut len: libc::c_int = 0i32;
    ...
    if (*gs).linewidth != width {
        let fresh52 = len;
        len = len + 1;
        *buf.offset(fresh52 as isize) = ' ' as i32 as libc::c_char;
        ...
        *buf.offset(fresh53 as isize) = ' ' as i32 as libc::c_char;
        let fresh54 = len;
        len = len + 1;
        *buf.offset(fresh54 as isize) = 'w' as i32 as libc::c_char;
        pdf_doc_add_page_content(buf, len as libc::c_uint);
        (*gs).linewidth = width
    }
    return 0i32;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_setdash(mut count: libc::c_int,
                                         mut pattern: *mut libc::c_double,
 ...
 -> libc::c_int {
    ...
    pdf_doc_add_page_content(buf, len as libc::c_uint);
    pdf_doc_add_page_content(b" d\x00" as *const u8 as *const libc::c_char,
                             2i32 as libc::c_uint);
    return 0i32;
}
/* ZSYUEDVEDEOF */
...
pub unsafe extern "C" fn pdf_dev_clip() -> libc::c_int {
    ...
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut cpa: *mut pdf_path = &mut (*gs).path;
    return pdf_dev__flushpath(cpa, 'W' as i32 as libc::c_char, 0i32, 0i32);
}
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_eoclip() -> libc::c_int {
    ...
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut cpa: *mut pdf_path = &mut (*gs).path;
    return pdf_dev__flushpath(cpa, 'W' as i32 as libc::c_char, 1i32, 0i32);
}
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_flushpath(mut p_op: libc::c_char,
...
pub unsafe extern "C" fn pdf_dev_newpath() -> libc::c_int {
    ...
    if (*p).num_paths > 0i32 as libc::c_uint { pdf_path__clearpath(p); }
    /* The following is required for "newpath" operator in mpost.c. */
    pdf_doc_add_page_content(b" n\x00" as *const u8 as *const libc::c_char,
                             2i32 as libc::c_uint); /* op: n */
    return 0i32;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_moveto(mut x: libc::c_double,
                                        mut y: libc::c_double)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_rmoveto(mut x: libc::c_double,
                                         mut y: libc::c_double)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_lineto(mut x: libc::c_double,
                                        mut y: libc::c_double)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_rlineto(mut x: libc::c_double,
                                         mut y: libc::c_double)
 -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_curveto(mut x0: libc::c_double,
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_vcurveto(mut x0: libc::c_double,
                                          mut y0: libc::c_double,
                                          mut x1: libc::c_double,
                                          mut y1: libc::c_double)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_ycurveto(mut x0: libc::c_double,
                                          mut y0: libc::c_double,
                                          mut x1: libc::c_double,
                                          mut y1: libc::c_double)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_rcurveto(mut x0: libc::c_double,
                                          mut y0: libc::c_double,
                                          mut x1: libc::c_double,
                                          mut y1: libc::c_double,
                                          mut x2: libc::c_double,
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_dtransform(mut p: *mut pdf_coord,
                                            mut M: *const pdf_tmatrix) {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut CTM: *mut pdf_tmatrix = &mut (*gs).matrix;
    if !p.is_null() {
        ...
        __assert_fail(b"p\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 1557i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 58],
                                                &[libc::c_char; 58]>(b"void pdf_dev_dtransform(pdf_coord *, const pdf_tmatrix *)\x00")).as_ptr());
    }
    pdf_coord__dtransform(p,
                          if !M.is_null() {
                              M
                          } else { CTM as *const pdf_tmatrix });
}
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_idtransform(mut p: *mut pdf_coord,
                                             mut M: *const pdf_tmatrix) {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut CTM: *mut pdf_tmatrix = &mut (*gs).matrix;
    if !p.is_null() {
        ...
        __assert_fail(b"p\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 1571i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 59],
                                                &[libc::c_char; 59]>(b"void pdf_dev_idtransform(pdf_coord *, const pdf_tmatrix *)\x00")).as_ptr());
    }
    pdf_coord__idtransform(p,
                           if !M.is_null() {
                               M
                           } else { CTM as *const pdf_tmatrix });
}
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_transform(mut p: *mut pdf_coord,
                                           mut M: *const pdf_tmatrix) {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut CTM: *mut pdf_tmatrix = &mut (*gs).matrix;
    if !p.is_null() {
        ...
        __assert_fail(b"p\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdraw.c\x00" as *const u8 as
                          *const libc::c_char, 1585i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 57],
                                                &[libc::c_char; 57]>(b"void pdf_dev_transform(pdf_coord *, const pdf_tmatrix *)\x00")).as_ptr());
    }
    pdf_coord__transform(p,
                         if !M.is_null() {
                             M
                         } else { CTM as *const pdf_tmatrix });
}
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_arc(mut c_x: libc::c_double,
                                     mut c_y: libc::c_double,
                                     mut r: libc::c_double,
                                     mut a_0: libc::c_double,
                                     mut a_1: libc::c_double) -> libc::c_int {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    let mut cpa: *mut pdf_path = &mut (*gs).path;
    let mut cpt: *mut pdf_coord = &mut (*gs).cp;
    ...
    c.x = c_x;
    c.y = c_y;
    return pdf_path__elliptarc(cpa, cpt, &mut c, r, r, 0.0f64, a_0, a_1,
                               1i32);
}
/* *negative* arc */
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_arcn(mut c_x: libc::c_double,
                                      mut c_y: libc::c_double,
                                      mut r: libc::c_double,
                                      mut a_0: libc::c_double,
                                      mut a_1: libc::c_double)
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_arcx(mut c_x: libc::c_double,
                                      mut c_y: libc::c_double,
                                      mut r_x: libc::c_double,
                                      mut r_y: libc::c_double,
                                      mut a_0: libc::c_double,
 ...
 -> libc::c_int {
    ...
    c.x = c_x;
    c.y = c_y;
    return pdf_path__elliptarc(cpa, cpt, &mut c, r_x, r_y, xar, a_0, a_1,
                               a_d);
}
/* Required by Tpic */
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_bspline(mut x0: libc::c_double,
                                         mut y0: libc::c_double,
                                         mut x1: libc::c_double,
                                         mut y1: libc::c_double,
                                         mut x2: libc::c_double,
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_rectfill(mut x: libc::c_double,
                                          mut y: libc::c_double,
                                          mut w: libc::c_double,
                                          mut h: libc::c_double)
 -> libc::c_int {
    ...
    r.urx = x + w;
    r.ury = y + h;
    return pdf_dev__rectshape(&mut r, 0 as *const pdf_tmatrix,
                              'f' as i32 as libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_rectclip(mut x: libc::c_double,
                                          mut y: libc::c_double,
                                          mut w: libc::c_double,
                                          mut h: libc::c_double)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_rectadd(mut x: libc::c_double,
                                         mut y: libc::c_double,
                                         mut w: libc::c_double,
                                         mut h: libc::c_double)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdf_dev_set_fixed_point(mut x: libc::c_double,
                                                 mut y: libc::c_double) {
    let mut gss: *mut m_stack = &mut gs_stack;
    let mut gs: *mut pdf_gstate = m_stack_top(gss) as *mut pdf_gstate;
    (*gs).pt_fixee.x = x;
