...
*/
    ...
    #[no_mangle]
    fn otl_parse_optstring(opt: *mut otl_opt, optstr: *const libc::c_char)
     -> libc::c_int;
    #[no_mangle]
    fn otl_match_optrule(opt: *mut otl_opt, tag: *const libc::c_char)
     -> libc::c_int;
    #[no_mangle]
...
unsafe extern "C" fn clt_read_record(mut rec: *mut clt_record,
                                     mut sfont: *mut sfnt) -> libc::c_int {
    let mut i: libc::c_int = 0;
    if !rec.is_null() && !sfont.is_null() {
    } else {
        __assert_fail(b"rec && sfont\x00" as *const u8 as *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 71i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 49],
                                                &[libc::c_char; 49]>(b"int clt_read_record(struct clt_record *, sfnt *)\x00")).as_ptr());
    }
    i = 0i32;
    while i < 4i32 {
        (*rec).tag[i as usize] =
            tt_get_signed_byte((*sfont).handle) as libc::c_char;
        i += 1
    }
...
unsafe extern "C" fn clt_read_range(mut rec: *mut clt_range,
                                    mut sfont: *mut sfnt) -> libc::c_int {
    if !rec.is_null() && !sfont.is_null() {
    } else {
        __assert_fail(b"rec && sfont\x00" as *const u8 as *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 85i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 47],
                                                &[libc::c_char; 47]>(b"int clt_read_range(struct clt_range *, sfnt *)\x00")).as_ptr());
    }
...
unsafe extern "C" fn clt_read_record_list(mut list: *mut clt_record_list,
                                          mut sfont: *mut sfnt)
 -> libc::c_int {
    ...
    if !list.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"list && sfont\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 117i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 59],
                                                &[libc::c_char; 59]>(b"int clt_read_record_list(struct clt_record_list *, sfnt *)\x00")).as_ptr());
    }
    ...
    if (*list).count as libc::c_int == 0i32 {
        ...
        (*list).record =
            new(((*list).count as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<clt_record>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut clt_record;
        i = 0i32;
        while i < (*list).count as libc::c_int {
            len +=
                clt_read_record(&mut *(*list).record.offset(i as isize),
                                sfont);
            i += 1
        }
    }
...
unsafe extern "C" fn clt_release_record_list(mut list: *mut clt_record_list) {
    if !list.is_null() {
        (*list).record =
            mfree((*list).record as *mut libc::c_void) as *mut clt_record;
        (*list).count = 0i32 as USHORT
    };
}
unsafe extern "C" fn clt_read_number_list(mut list: *mut clt_number_list,
                                          mut sfont: *mut sfnt)
 -> libc::c_int {
    let mut i: libc::c_int = 0;
    if !list.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"list && sfont\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 148i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 59],
                                                &[libc::c_char; 59]>(b"int clt_read_number_list(struct clt_number_list *, sfnt *)\x00")).as_ptr());
    }
    (*list).count = tt_get_unsigned_pair((*sfont).handle);
    if (*list).count as libc::c_int == 0i32 {
        ...
        (*list).value =
            new(((*list).count as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<USHORT>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut USHORT;
        i = 0i32;
        while i < (*list).count as libc::c_int {
            *(*list).value.offset(i as isize) =
...
unsafe extern "C" fn clt_release_number_list(mut list: *mut clt_number_list) {
    if !list.is_null() {
        (*list).value =
            mfree((*list).value as *mut libc::c_void) as *mut USHORT;
        (*list).count = 0i32 as USHORT
    };
}
unsafe extern "C" fn clt_read_script_table(mut tab: *mut clt_script_table,
                                           mut sfont: *mut sfnt)
 -> libc::c_int {
    let mut len: libc::c_int = 0;
    if !tab.is_null() && !sfont.is_null() {
    } else {
        __assert_fail(b"tab && sfont\x00" as *const u8 as *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 283i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 61],
                                                &[libc::c_char; 61]>(b"int clt_read_script_table(struct clt_script_table *, sfnt *)\x00")).as_ptr());
    }
...
unsafe extern "C" fn clt_release_script_table(mut tab:
                                                  *mut clt_script_table) {
    if !tab.is_null() { clt_release_record_list(&mut (*tab).LangSysRecord); };
}
unsafe extern "C" fn clt_read_langsys_table(mut tab: *mut clt_langsys_table,
                                            mut sfont: *mut sfnt)
 -> libc::c_int {
    let mut len: libc::c_int = 0;
    if !tab.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"tab && sfont\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 63],
                                                &[libc::c_char; 63]>(b"int clt_read_langsys_table(struct clt_langsys_table *, sfnt *)\x00")).as_ptr());
    }
...
unsafe extern "C" fn clt_release_langsys_table(mut tab:
                                                   *mut clt_langsys_table) {
    if !tab.is_null() { clt_release_number_list(&mut (*tab).FeatureIndex); };
}
unsafe extern "C" fn clt_read_feature_table(mut tab: *mut clt_feature_table,
                                            mut sfont: *mut sfnt)
 -> libc::c_int {
    let mut len: libc::c_int = 0;
    if !tab.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"tab && sfont\x00" as *const u8 as *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 344i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 63],
                                                &[libc::c_char; 63]>(b"int clt_read_feature_table(struct clt_feature_table *, sfnt *)\x00")).as_ptr());
    }
...
unsafe extern "C" fn clt_release_feature_table(mut tab:
                                                   *mut clt_feature_table) {
    if !tab.is_null() {
        clt_release_number_list(&mut (*tab).LookupListIndex);
    };
}
unsafe extern "C" fn clt_read_lookup_table(mut tab: *mut clt_lookup_table,
                                           mut sfont: *mut sfnt)
 -> libc::c_int {
    let mut len: libc::c_int = 0;
    if !tab.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"tab && sfont\x00" as *const u8 as *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 377i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 61],
                                                &[libc::c_char; 61]>(b"int clt_read_lookup_table(struct clt_lookup_table *, sfnt *)\x00")).as_ptr());
    }
...
unsafe extern "C" fn clt_release_lookup_table(mut tab:
                                                  *mut clt_lookup_table) {
    if !tab.is_null() { clt_release_number_list(&mut (*tab).SubTableList); };
}
unsafe extern "C" fn clt_read_coverage(mut cov: *mut clt_coverage,
                                       mut sfont: *mut sfnt) -> libc::c_int {
    let mut len: libc::c_int = 0;
    let mut i: libc::c_int = 0;
    if !cov.is_null() && !sfont.is_null() {
    } else {
        __assert_fail(b"cov && sfont\x00" as *const u8 as *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 399i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"int clt_read_coverage(struct clt_coverage *, sfnt *)\x00")).as_ptr());
    }
    ...
    match (*cov).format as libc::c_int {
        ...
        2 => {
            if (*cov).count as libc::c_int == 0i32 {
                ...
                (*cov).range =
                    new(((*cov).count as uint32_t as
                             libc::c_ulong).wrapping_mul(::std::mem::size_of::<clt_range>()
                                                             as libc::c_ulong)
                            as uint32_t) as *mut clt_range;
                i = 0i32;
                while i < (*cov).count as libc::c_int {
                    len +=
                        clt_read_range(&mut *(*cov).range.offset(i as isize),
                                       sfont);
                    i += 1
                }
            }
        ...
        _ => {
            _tt_abort(b"Unknown coverage format\x00" as *const u8 as
                          *const libc::c_char);
        }
    }
    return len;
...
unsafe extern "C" fn clt_release_coverage(mut cov: *mut clt_coverage) {
    if !cov.is_null() {
        match (*cov).format as libc::c_int {
            1 => {
                (*cov).list =
                    mfree((*cov).list as *mut libc::c_void) as *mut GlyphID
            }
            2 => {
                (*cov).range =
                    mfree((*cov).range as *mut libc::c_void) as *mut clt_range
            }
            _ => {
                _tt_abort(b"Unknown coverage format\x00" as *const u8 as
                              *const libc::c_char);
...
unsafe extern "C" fn clt_lookup_coverage(mut cov: *mut clt_coverage,
                                         mut gid: USHORT) -> libc::c_int {
    let mut i: libc::c_int = 0;
    if !cov.is_null() {
    } else {
        __assert_fail(b"cov\x00" as *const u8 as *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 460i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 55],
                                                &[libc::c_char; 55]>(b"int clt_lookup_coverage(struct clt_coverage *, USHORT)\x00")).as_ptr());
    }
    match (*cov).format as libc::c_int {
        1 => {
            i = 0i32;
            while i < (*cov).count as libc::c_int {
                if *(*cov).list.offset(i as isize) as libc::c_int >
                       gid as libc::c_int {
                    break ;
                }
                if *(*cov).list.offset(i as isize) as libc::c_int ==
        ...
        2 => {
            ...
            while i < (*cov).count as libc::c_int {
                ...
                if gid as libc::c_int <=
                       (*(*cov).range.offset(i as isize)).End as libc::c_int {
                    return (*(*cov).range.offset(i as
                                                     isize)).StartCoverageIndex
                               as libc::c_int + gid as libc::c_int -
                               (*(*cov).range.offset(i as isize)).Start as
                                   libc::c_int
                }
                i += 1
            }
...
unsafe extern "C" fn otl_gsub_read_single(mut subtab: *mut otl_gsub_subtab,
                                          mut sfont: *mut sfnt)
 -> libc::c_int {
    let mut len: libc::c_int = 0;
    ...
    if !subtab.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"subtab && sfont\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 496i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 59],
                                                &[libc::c_char; 59]>(b"int otl_gsub_read_single(struct otl_gsub_subtab *, sfnt *)\x00")).as_ptr());
    }
    offset =
        ttstub_input_seek((*sfont).handle, 0i32 as ssize_t, 1i32) as
            SFNT_ULONG;
    ...
    if (*subtab).SubstFormat as libc::c_int == 1i32 {
        ...
        data =
            new((1i32 as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub_single1>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut otl_gsub_single1;
        (*subtab).table.single1 = data;
        cov_offset = tt_get_unsigned_pair((*sfont).handle);
        (*data).DeltaGlyphID = tt_get_signed_pair((*sfont).handle);
        len += 4i32;
        ttstub_input_seek((*sfont).handle,
                          offset.wrapping_add(cov_offset as libc::c_uint) as
                              ssize_t, 0i32);
        ...
        data_0 =
            new((1i32 as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub_single2>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut otl_gsub_single2;
        ...
        if (*data_0).GlyphCount as libc::c_int == 0i32 {
            ...
            (*data_0).Substitute =
                new(((*data_0).GlyphCount as uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<GlyphID>()
                                                         as libc::c_ulong) as
                        uint32_t) as *mut GlyphID;
        ...
        _tt_abort(b"unexpected SubstFormat\x00" as *const u8 as
                      *const libc::c_char);
    }
    return len;
}
unsafe extern "C" fn otl_gsub_read_alternate(mut subtab: *mut otl_gsub_subtab,
                                             mut sfont: *mut sfnt)
 -> libc::c_int {
    let mut len: libc::c_int = 0;
    let mut i: USHORT = 0;
    ...
    let mut offset: SFNT_ULONG = 0;
    let mut cov_offset: Offset = 0;
    let mut altset_offsets: clt_number_list =
        clt_number_list{count: 0, value: 0 as *mut USHORT,};
    ...
    if !subtab.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"subtab && sfont\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 555i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 62],
                                                &[libc::c_char; 62]>(b"int otl_gsub_read_alternate(struct otl_gsub_subtab *, sfnt *)\x00")).as_ptr());
    }
    offset =
        ttstub_input_seek((*sfont).handle, 0i32 as ssize_t, 1i32) as
            SFNT_ULONG;
    ...
    (*subtab).SubstFormat = tt_get_unsigned_pair((*sfont).handle);
    if (*subtab).SubstFormat as libc::c_int != 1i32 {
        dpx_warning(b"Unknown GSUB SubstFormat for Alternate: %u\x00" as
    ...
    data =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub_alternate1>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut otl_gsub_alternate1;
    ...
    (*data).AlternateSet =
        new(((*data).AlternateSetCount as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub_altset>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut otl_gsub_altset;
    i = 0i32 as USHORT;
    while (i as libc::c_int) < (*data).AlternateSetCount as libc::c_int {
        ...
        altset =
            &mut *(*data).AlternateSet.offset(i as isize) as
                *mut otl_gsub_altset;
        altset_offset =
            offset.wrapping_add(*altset_offsets.value.offset(i as isize) as
                                    libc::c_uint);
        ...
        if (*altset).GlyphCount as libc::c_int == 0i32 {
            ...
            (*altset).Alternate =
                new(((*altset).GlyphCount as uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<GlyphID>()
                                                         as libc::c_ulong) as
                        uint32_t) as *mut GlyphID;
            j = 0i32 as USHORT;
            while (j as libc::c_int) < (*altset).GlyphCount as libc::c_int {
                *(*altset).Alternate.offset(j as isize) =
                    tt_get_unsigned_pair((*sfont).handle);
                len += 2i32;
                j = j.wrapping_add(1)
            }
...
unsafe extern "C" fn otl_gsub_read_ligature(mut subtab: *mut otl_gsub_subtab,
                                            mut sfont: *mut sfnt)
 -> libc::c_int {
    let mut len: libc::c_int = 0;
    let mut i: USHORT = 0;
    ...
    let mut offset: SFNT_ULONG = 0;
    let mut cov_offset: Offset = 0;
    let mut ligset_offsets: clt_number_list =
        clt_number_list{count: 0, value: 0 as *mut USHORT,};
    ...
    if !subtab.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"subtab && sfont\x00" as *const u8 as
                      ...
                      (*::std::mem::transmute::<&[u8; 61],
                                                &[libc::c_char; 61]>(b"int otl_gsub_read_ligature(struct otl_gsub_subtab *, sfnt *)\x00")).as_ptr());
    }
    offset =
        ttstub_input_seek((*sfont).handle, 0i32 as ssize_t, 1i32) as
            SFNT_ULONG;
    ...
    (*subtab).SubstFormat = tt_get_unsigned_pair((*sfont).handle);
    if (*subtab).SubstFormat as libc::c_int != 1i32 {
        dpx_warning(b"Unknown GSUB SubstFormat for Ligature: %u\x00" as
                        *const u8 as *const libc::c_char,
                    (*subtab).SubstFormat as libc::c_int);
        return -1i32
    }
    ...
    data =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub_ligature1>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut otl_gsub_ligature1;
    ...
    (*data).LigatureSet =
        new(((*data).LigSetCount as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub_ligset>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut otl_gsub_ligset;
    i = 0i32 as USHORT;
    while (i as libc::c_int) < (*data).LigSetCount as libc::c_int {
        let mut ligset_tab: clt_number_list =
            clt_number_list{count: 0, value: 0 as *mut USHORT,};
        let mut ligset: *mut otl_gsub_ligset = 0 as *mut otl_gsub_ligset;
        let mut ligset_offset: SFNT_ULONG = 0;
        let mut count: USHORT = 0;
        ligset =
            &mut *(*data).LigatureSet.offset(i as isize) as
                *mut otl_gsub_ligset;
        ligset_offset =
            offset.wrapping_add(*ligset_offsets.value.offset(i as isize) as
                                    libc::c_uint);
        ...
        if ligset_tab.count as libc::c_int == 0i32 {
            ...
            (*ligset).Ligature =
                new((ligset_tab.count as uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub_ligtab>()
                                                         as libc::c_ulong) as
                        uint32_t) as *mut otl_gsub_ligtab;
            j = 0i32 as USHORT;
            while (j as libc::c_int) < ligset_tab.count as libc::c_int {
                ttstub_input_seek((*sfont).handle,
                                  ligset_offset.wrapping_add(*ligset_tab.value.offset(j
                                                                                          as
                                                                                          isize)
                                                                 as
                                                                 libc::c_uint)
                ...
                (*(*ligset).Ligature.offset(j as isize)).CompCount =
                    tt_get_unsigned_pair((*sfont).handle);
                if (*(*ligset).Ligature.offset(j as isize)).CompCount as
                       libc::c_int == 0i32 {
                    let ref mut fresh0 =
                    ...
                    *fresh0 = 0 as *mut GlyphID;
                    ...
                    let ref mut fresh1 =
                        (*(*ligset).Ligature.offset(j as isize)).Component;
                    *fresh1 =
                        new((((*(*ligset).Ligature.offset(j as
                                                              isize)).CompCount
                                  as libc::c_int - 1i32) as uint32_t as
                                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<GlyphID>()
                                                                 as
                                                                 libc::c_ulong)
                    ...
                    while (count as libc::c_int) <
                              (*(*ligset).Ligature.offset(j as
                                                              isize)).CompCount
                                  as libc::c_int - 1i32 {
                        *(*(*ligset).Ligature.offset(j as
                                                         isize)).Component.offset(count
                                                                                      as
                                                                                      isize)
                            = tt_get_unsigned_pair((*sfont).handle);
                        count = count.wrapping_add(1)
...
unsafe extern "C" fn otl_gsub_release_single(mut subtab:
                                                 *mut otl_gsub_subtab) {
    if !subtab.is_null() {
        match (*subtab).SubstFormat as libc::c_int {
            1 => {
                let mut data: *mut otl_gsub_single1 =
                    0 as *mut otl_gsub_single1;
            ...
            2 => {
                let mut data_0: *mut otl_gsub_single2 =
                    0 as *mut otl_gsub_single2;
            ...
            _ => {
                _tt_abort(b"Unknown format for single substitution\x00" as
                              *const u8 as *const libc::c_char);
            }
        }
    };
}
unsafe extern "C" fn otl_gsub_release_ligature(mut subtab:
                                                   *mut otl_gsub_subtab) {
    if !subtab.is_null() {
        let mut data: *mut otl_gsub_ligature1 = 0 as *mut otl_gsub_ligature1;
        let mut i: USHORT = 0;
        ...
        if !data.is_null() && !(*data).LigatureSet.is_null() {
            i = 0i32 as USHORT;
            while (i as libc::c_int) < (*data).LigSetCount as libc::c_int {
                let mut ligset: *mut otl_gsub_ligset =
                    0 as *mut otl_gsub_ligset;
                ligset =
                    &mut *(*data).LigatureSet.offset(i as isize) as
                        *mut otl_gsub_ligset;
                j = 0i32 as USHORT;
                while (j as libc::c_int) <
                          (*ligset).LigatureCount as libc::c_int {
                    let ref mut fresh2 =
                        (*(*ligset).Ligature.offset(j as isize)).Component;
                    *fresh2 =
                        mfree((*(*ligset).Ligature.offset(j as
                                                              isize)).Component
                                  as *mut libc::c_void) as *mut GlyphID;
                    j = j.wrapping_add(1)
                }
                (*ligset).Ligature =
                    mfree((*ligset).Ligature as *mut libc::c_void) as
                        *mut otl_gsub_ligtab;
                i = i.wrapping_add(1)
            }
...
unsafe extern "C" fn otl_gsub_release_alternate(mut subtab:
                                                    *mut otl_gsub_subtab) {
    if !subtab.is_null() {
        let mut data: *mut otl_gsub_alternate1 =
            0 as *mut otl_gsub_alternate1;
        let mut i: USHORT = 0;
        data = (*subtab).table.alternate1;
        if !data.is_null() && !(*data).AlternateSet.is_null() {
            i = 0i32 as USHORT;
            while (i as libc::c_int) <
                      (*data).AlternateSetCount as libc::c_int {
                let mut altset: *mut otl_gsub_altset =
                    0 as *mut otl_gsub_altset;
                altset =
                    &mut *(*data).AlternateSet.offset(i as isize) as
                        *mut otl_gsub_altset;
                (*altset).Alternate =
                    mfree((*altset).Alternate as *mut libc::c_void) as
                        *mut GlyphID;
                i = i.wrapping_add(1)
            }
...
unsafe extern "C" fn otl_gsub_read_header(mut head: *mut otl_gsub_header,
                                          mut sfont: *mut sfnt)
 -> libc::c_int {
    if !head.is_null() && !sfont.is_null() {
    } else {
        __assert_fail(b"head && sfont\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 787i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 59],
                                                &[libc::c_char; 59]>(b"int otl_gsub_read_header(struct otl_gsub_header *, sfnt *)\x00")).as_ptr());
    }
...
unsafe extern "C" fn otl_gsub_read_feat(mut gsub: *mut otl_gsub_tab,
                                        mut sfont: *mut sfnt) -> libc::c_int {
    let mut feat_idx: libc::c_int = 0;
    let mut script_idx: libc::c_int = 0;
    let mut gsub_offset: SFNT_ULONG = 0;
    let mut offset: SFNT_ULONG = 0;
    let mut head: otl_gsub_header =
        otl_gsub_header{version: 0,
                        ScriptList: 0,
                        FeatureList: 0,
                        LookupList: 0,};
    ...
    let mut feature_list: clt_record_list =
        clt_record_list{count: 0, record: 0 as *mut clt_record,};
    let mut script_list: clt_record_list =
        clt_record_list{count: 0, record: 0 as *mut clt_record,};
    let mut lookup_list: clt_number_list =
        clt_number_list{count: 0, value: 0 as *mut USHORT,};
    ...
    if !gsub.is_null() && !sfont.is_null() {
        ...
        __assert_fail(b"gsub && sfont\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 830i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 54],
                                                &[libc::c_char; 54]>(b"int otl_gsub_read_feat(struct otl_gsub_tab *, sfnt *)\x00")).as_ptr());
    }
    gsub_offset =
        sfnt_find_table_pos(sfont,
                            b"GSUB\x00" as *const u8 as *const libc::c_char);
    if gsub_offset == 0i32 as libc::c_uint { return -1i32 }
    script = otl_new_opt();
    ...
    memset(feat_bits.as_mut_ptr() as *mut libc::c_void, 0i32,
    ...
    while script_idx < script_list.count as libc::c_int {
        if otl_match_optrule(script,
                             (*script_list.record.offset(script_idx as
                                                             isize)).tag.as_mut_ptr())
               != 0 {
            let mut script_tab: clt_script_table =
                clt_script_table{DefaultLangSys: 0,
                                 LangSysRecord:
                                     clt_record_list{count: 0,
                                                     record:
                                                         0 as
                                                             *mut clt_record,},};
            let mut langsys_idx: libc::c_int = 0;
            offset =
                gsub_offset.wrapping_add(head.ScriptList as
                                             libc::c_uint).wrapping_add((*script_list.record.offset(script_idx
                                                                                                        as
                                                                                                        isize)).offset
                                                                            as
                                                                            libc::c_uint);
            ...
            if otl_match_optrule(language,
                                 b"dflt\x00" as *const u8 as
                                     *const libc::c_char) != 0 &&
                   script_tab.DefaultLangSys as libc::c_int != 0i32 {
                let mut langsys_tab: clt_langsys_table =
                    clt_langsys_table{LookupOrder: 0,
                                      ReqFeatureIndex: 0,
                                      FeatureIndex:
                                          clt_number_list{count: 0,
                                                          value:
                                                              0 as
                                                                  *mut USHORT,},};
                if verbose > 0i32 {
                    dpx_message(b"otl_gsub>> OTL script-language enabled: %c%c%c%c.dflt\n\x00"
                ...
                ttstub_input_seek((*sfont).handle,
                                  offset.wrapping_add(script_tab.DefaultLangSys
                                                          as libc::c_uint) as
                                      ssize_t, 0i32);
                clt_read_langsys_table(&mut langsys_tab, sfont);
                if otl_match_optrule(feature,
                                     b"____\x00" as *const u8 as
                                         *const libc::c_char) != 0 &&
                       langsys_tab.ReqFeatureIndex as libc::c_int != 0xffffi32
                   {
                    feat_bits[(langsys_tab.ReqFeatureIndex as libc::c_int /
                                   8i32) as usize] =
                        (feat_bits[(langsys_tab.ReqFeatureIndex as libc::c_int
                                        / 8i32) as usize] as libc::c_int |
                             1i32 <<
                                 7i32 -
                                     langsys_tab.ReqFeatureIndex as
                                         libc::c_int % 8i32) as libc::c_uchar
                }
                feat_idx = 0i32;
                while feat_idx < langsys_tab.FeatureIndex.count as libc::c_int
                      {
                    feat_bits[(*langsys_tab.FeatureIndex.value.offset(feat_idx
                                                                          as
                                                                          isize)
                                   as libc::c_int / 8i32) as usize] =
                        (feat_bits[(*langsys_tab.FeatureIndex.value.offset(feat_idx
                                                                               as
                                                                               isize)
                                        as libc::c_int / 8i32) as usize] as
                             libc::c_int |
                             1i32 <<
                                 7i32 -
                                     *langsys_tab.FeatureIndex.value.offset(feat_idx
                                                                                as
                                                                                isize)
                                         as libc::c_int % 8i32) as
                            libc::c_uchar;
                    feat_idx += 1
                }
            ...
            while langsys_idx < script_tab.LangSysRecord.count as libc::c_int
                ...
                langsys_rec =
                    &mut *script_tab.LangSysRecord.record.offset(langsys_idx
                                                                     as isize)
                        as *mut clt_record;
                if otl_match_optrule(language,
                                     (*langsys_rec).tag.as_mut_ptr()) != 0 {
                                              ...
                                              clt_number_list{count: 0,
                                                              value:
                                                                  0 as
                                                                      *mut USHORT,},};
                    if verbose > 0i32 {
                        dpx_message(b"otl_gsub>> OTL script-language enabled: %c%c%c%c.%c%c%c%c\n\x00"
                                        as *const u8 as *const libc::c_char,
                                    (*script_list.record.offset(script_idx as
                                                                    isize)).tag[0]
                                        as libc::c_int,
                    ...
                    ttstub_input_seek((*sfont).handle,
                                      offset.wrapping_add((*langsys_rec).offset
                                                              as libc::c_uint)
                                          as ssize_t, 0i32);
                    ...
                    if otl_match_optrule(feature,
                                         b"____\x00" as *const u8 as
                                             *const libc::c_char) != 0 ||
                           langsys_tab_0.ReqFeatureIndex as libc::c_int !=
                               0xffffi32 {
                        feat_bits[(langsys_tab_0.ReqFeatureIndex as
                                       libc::c_int / 8i32) as usize] =
                            (feat_bits[(langsys_tab_0.ReqFeatureIndex as
                                            libc::c_int / 8i32) as usize] as
                                 libc::c_int |
                                 1i32 <<
                                     7i32 -
                                         langsys_tab_0.ReqFeatureIndex as
                                             libc::c_int % 8i32) as
                                libc::c_uchar
                    }
                    feat_idx = 0i32;
                    while feat_idx <
                              langsys_tab_0.FeatureIndex.count as libc::c_int
                          {
                        feat_bits[(*langsys_tab_0.FeatureIndex.value.offset(feat_idx
                                                                                as
                                                                                isize)
                                       as libc::c_int / 8i32) as usize] =
                            (feat_bits[(*langsys_tab_0.FeatureIndex.value.offset(feat_idx
                                 ...
                                 1i32 <<
                                     7i32 -
                                         *langsys_tab_0.FeatureIndex.value.offset(feat_idx
                                                                                      as
                                                                                      isize)
                                             as libc::c_int % 8i32) as
                                libc::c_uchar;
    ...
    if verbose > 0i32 {
        dpx_message(b"otl_gsub>> Reading OTL feature(s):\x00" as *const u8 as
                        *const libc::c_char);
    }
    feat_idx = 0i32;
    while feat_idx < feature_list.count as libc::c_int {
        if feat_bits[(feat_idx / 8i32) as usize] as libc::c_int &
               1i32 << 7i32 - feat_idx % 8i32 != 0 &&
               otl_match_optrule(feature,
                                 (*feature_list.record.offset(feat_idx as
                                                                  isize)).tag.as_mut_ptr())
                   != 0 {
            let mut feature_table: clt_feature_table =
                clt_feature_table{FeatureParams: 0,
                                  LookupListIndex:
                                      clt_number_list{count: 0,
                                                      value:
                                                          0 as
            ...
            let mut i: libc::c_int = 0;
            if verbose > 0i32 {
                dpx_message(b" %c%c%c%c\x00" as *const u8 as
                                *const libc::c_char,
                            (*feature_list.record.offset(feat_idx as
                                                             isize)).tag[0] as
                                libc::c_int,
            ...
            offset =
                gsub_offset.wrapping_add(head.FeatureList as
                                             libc::c_uint).wrapping_add((*feature_list.record.offset(feat_idx
                                                                                                         as
                                                                                                         isize)).offset
                                                                            as
                                                                            libc::c_uint);
            ...
            if feature_table.FeatureParams as libc::c_int != 0i32 {
                _tt_abort(b"unrecognized FeatureParams\x00" as *const u8 as
                              *const libc::c_char);
            }
            i = 0i32;
            while i < feature_table.LookupListIndex.count as libc::c_int {
                let mut lookup_table: clt_lookup_table =
                    clt_lookup_table{LookupType: 0,
                                     LookupFlag: 0,
                                     SubTableList:
                                         clt_number_list{count: 0,
                                                         value:
                ...
                ll_idx =
                    *feature_table.LookupListIndex.value.offset(i as isize) as
                        libc::c_int;
                if ll_idx >= lookup_list.count as libc::c_int {
                    _tt_abort(b"invalid Lookup index.\x00" as *const u8 as
                                  *const libc::c_char);
                }
                offset =
                    gsub_offset.wrapping_add(head.LookupList as
                                                 libc::c_uint).wrapping_add(*lookup_list.value.offset(ll_idx
                                                                                                          as
                                                                                                          isize)
                                                                                as
                                                                                libc::c_uint);
                ...
                if lookup_table.LookupType as libc::c_int != 1i32 &&
                    ...
                    if verbose > 0i32 {
                        dpx_warning(b"Skipping unsupported GSUB subtable: LookupType=%d\x00"
                                        as *const u8 as *const libc::c_char,
                                    lookup_table.LookupType as libc::c_int);
                    }
                } else {
                    subtab =
                        renew(subtab as *mut libc::c_void,
                              ((num_subtabs as libc::c_int +
                                    lookup_table.SubTableList.count as
                                        libc::c_int) as uint32_t as
                                   libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub_subtab>()
                                                                   as
                                                                   libc::c_ulong)
                                  as uint32_t) as *mut otl_gsub_subtab;
                    n_st = 0i32;
                    st_idx = 0i32;
                    while st_idx <
                        ...
                        offset =
                            gsub_offset.wrapping_add(head.LookupList as
                                                         libc::c_uint).wrapping_add(*lookup_list.value.offset(ll_idx
                                                                                                                  ...
                                                                                                                  isize)
                                                                                        as
                                                                                        libc::c_uint).wrapping_add(*lookup_table.SubTableList.value.offset(st_idx
                                                                                                                                                               as
                                                                                                                                                               isize)
                                                                                                                       as
                                                                                                                       libc::c_uint);
                        ttstub_input_seek((*sfont).handle, offset as ssize_t,
                                          0i32);
                        match lookup_table.LookupType as libc::c_int {
                            1 => {
                                r =
                                    otl_gsub_read_single(&mut *subtab.offset((num_subtabs
                                                                                  as
                                                                                  libc::c_int
                                                                                  +
                                                                                  n_st)
                                                         ...
                                                         sfont);
                                if r <= 0i32 {
                                    dpx_warning(b"Reading GSUB subtable (single) failed...\x00"
                                                    as *const u8 as
                                                    *const libc::c_char);
                                } else {
                                    if verbose > 0i32 {
                                        dpx_message(b"(single)\x00" as
                                                        *const u8 as
                                                        *const libc::c_char);
                                    }
                                    n_st += 1
                            ...
                            3 => {
                                r =
                                    otl_gsub_read_alternate(&mut *subtab.offset((num_subtabs
                                                                                     as
                                                                                     libc::c_int
                                                                                     +
                                                                                     n_st)
                                ...
                                if r <= 0i32 {
                                    ...
                                    if verbose > 0i32 {
                                        dpx_message(b"(alternate)\x00" as
                                                        *const u8 as
                                                        *const libc::c_char);
                                    }
                                    n_st += 1
                            ...
                            4 => {
                                r =
                                    otl_gsub_read_ligature(&mut *subtab.offset((num_subtabs
                                                                                    as
                                                                                    libc::c_int
                                                                                    +
                                                                                    n_st)
                                                           ...
                                                           sfont);
                                if r <= 0i32 {
                                    dpx_warning(b"Reading GSUB subtable (ligature) failed...\x00"
                                                    as *const u8 as
                                                    *const libc::c_char);
                                } else {
                                    if verbose > 0i32 {
                                        dpx_message(b"(ligature)\x00" as
                                                        *const u8 as
                                                        *const libc::c_char);
                                    }
                                    n_st += 1
                            ...
                            7 => {
                                ...
                                if !(SubstFormat as libc::c_int != 1i32) {
                                    ...
                                    ttstub_input_seek((*sfont).handle,
                                                      offset.wrapping_add(ExtensionOffset)
                                                          as ssize_t, 0i32);
                                    match ExtensionLookupType as libc::c_int {
                                        ...
                                        4 => {
                                            ...
                                            if r <= 0i32 {
                                                ...
                                                if verbose > 0i32 {
                                                    dpx_message(b"(ext:ligature)\x00"
                                                                    as
                                                                    *const u8
                                                                    as
                                                                    *const libc::c_char);
                    ...
                    num_subtabs =
                        (num_subtabs as libc::c_int + n_st) as USHORT;
    ...
    if verbose > 0i32 {
        ...
        dpx_message(b"otl_gsub>> %d subtable(s) read.\n\x00" as *const u8 as
                        *const libc::c_char, num_subtabs as libc::c_int);
    }
...
unsafe extern "C" fn otl_gsub_apply_single(mut subtab: *mut otl_gsub_subtab,
                                           mut gid: *mut USHORT)
 -> libc::c_int {
    let mut idx: libc::c_int = 0;
    if !subtab.is_null() && !gid.is_null() {
    } else {
        __assert_fail(b"subtab && gid\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 1145i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 62],
                                                &[libc::c_char; 62]>(b"int otl_gsub_apply_single(struct otl_gsub_subtab *, USHORT *)\x00")).as_ptr());
    }
    if (*subtab).SubstFormat as libc::c_int == 1i32 {
        let mut data: *mut otl_gsub_single1 = 0 as *mut otl_gsub_single1;
        data = (*subtab).table.single1;
        ...
        if idx >= 0i32 {
            *gid =
                (*gid as libc::c_int + (*data).DeltaGlyphID as libc::c_int) as
                    USHORT;
            return 0i32
        }
    } else if (*subtab).SubstFormat as libc::c_int == 2i32 {
...
unsafe extern "C" fn otl_gsub_apply_alternate(mut subtab:
                                                  *mut otl_gsub_subtab,
                                              mut alt_idx: USHORT,
                                              mut gid: *mut USHORT)
 -> libc::c_int {
    ...
    if !subtab.is_null() && !gid.is_null() {
        ...
        __assert_fail(b"subtab && gid\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 1177i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 73],
                                                &[libc::c_char; 73]>(b"int otl_gsub_apply_alternate(struct otl_gsub_subtab *, USHORT, USHORT *)\x00")).as_ptr());
    }
    if (*subtab).SubstFormat as libc::c_int == 1i32 {
        let mut data: *mut otl_gsub_alternate1 =
            0 as *mut otl_gsub_alternate1;
        ...
        if idx < 0i32 || idx >= (*data).AlternateSetCount as libc::c_int {
            ...
            let mut altset: *mut otl_gsub_altset = 0 as *mut otl_gsub_altset;
            altset =
                &mut *(*data).AlternateSet.offset(idx as isize) as
                    *mut otl_gsub_altset;
...
unsafe extern "C" fn glyph_seq_cmp(mut glyph_seq0: *mut GlyphID,
                                   mut n_glyphs0: USHORT,
                                   mut glyph_seq1: *mut GlyphID,
                                   mut n_glyphs1: USHORT) -> libc::c_int {
    let mut i: USHORT = 0;
...
unsafe extern "C" fn otl_gsub_apply_ligature(mut subtab: *mut otl_gsub_subtab,
 ...
 -> libc::c_int {
    ...
    if gid_in.is_null() || (num_gids as libc::c_int) < 1i32 { return -1i32 }
    if (*subtab).SubstFormat as libc::c_int == 1i32 {
        let mut data: *mut otl_gsub_ligature1 = 0 as *mut otl_gsub_ligature1;
        data = (*subtab).table.ligature1;
        ...
        if idx >= 0i32 && idx < (*data).LigSetCount as libc::c_int {
            ...
            let mut j: USHORT = 0;
            ligset =
                &mut *(*data).LigatureSet.offset(idx as isize) as
                    *mut otl_gsub_ligset;
            j = 0i32 as USHORT;
            while (j as libc::c_int) < (*ligset).LigatureCount as libc::c_int
                  {
                if glyph_seq_cmp(&mut *gid_in.offset(1),
                                 (num_gids as libc::c_int - 1i32) as USHORT,
                                 (*(*ligset).Ligature.offset(j as
                                                                 isize)).Component,
                                 ((*(*ligset).Ligature.offset(j as
                                                                  isize)).CompCount
                                      as libc::c_int - 1i32) as USHORT) == 0 {
                    *gid_out =
                        (*(*ligset).Ligature.offset(j as isize)).LigGlyph;
                    return 0i32
                }
...
pub unsafe extern "C" fn otl_gsub_new() -> *mut otl_gsub {
    ...
    gsub_list =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<otl_gsub>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut otl_gsub;
...
#[no_mangle]
pub unsafe extern "C" fn otl_gsub_add_feat(mut gsub_list: *mut otl_gsub,
 ...
 -> libc::c_int {
    ...
    if (*gsub_list).num_gsubs > 32i32 {
        _tt_abort(b"Too many GSUB features...\x00" as *const u8 as
                      *const libc::c_char);
    }
    i = 0i32;
    while i < (*gsub_list).num_gsubs {
        gsub =
            &mut *(*gsub_list).gsubs.as_mut_ptr().offset(i as isize) as
                *mut otl_gsub_tab;
    ...
    gsub =
        &mut *(*gsub_list).gsubs.as_mut_ptr().offset(i as isize) as
            *mut otl_gsub_tab;
    (*gsub).script =
        new((strlen(script).wrapping_add(1i32 as libc::c_ulong) as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
    strcpy((*gsub).script, script);
    (*gsub).language =
        new((strlen(language).wrapping_add(1i32 as libc::c_ulong) as uint32_t
                 as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
    ...
    (*gsub).feature =
        new((strlen(feature).wrapping_add(1i32 as libc::c_ulong) as uint32_t
                 as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
    ...
    if verbose > 0i32 {
        dpx_message(b"\n\x00" as *const u8 as *const libc::c_char);
        dpx_message(b"otl_gsub>> Reading \"%s.%s.%s\"...\n\x00" as *const u8
                        as *const libc::c_char, script, language, feature);
    }
...
unsafe extern "C" fn scan_otl_tag(mut otl_tags: *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    if !script.is_null() && !language.is_null() && !feature.is_null() {
        ...
        __assert_fail(b"script && language && feature\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-tt_gsub.c\x00" as *const u8 as
                          *const libc::c_char, 1357i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 69],
                                                &[libc::c_char; 69]>(b"int scan_otl_tag(const char *, const char *, char *, char *, char *)\x00")).as_ptr());
    }
    if otl_tags.is_null() || otl_tags >= endptr { return -1i32 }
    memset(script as *mut libc::c_void, ' ' as i32, 4i32 as libc::c_ulong);
    *script.offset(4) = 0i32 as libc::c_char;
    memset(language as *mut libc::c_void, ' ' as i32, 4i32 as libc::c_ulong);
    *language.offset(4) = 0i32 as libc::c_char;
    memset(feature as *mut libc::c_void, ' ' as i32, 4i32 as libc::c_ulong);
    *feature.offset(4) = 0i32 as libc::c_char;
    ...
    if !period.is_null() && period < endptr {
        ...
        if period < p.offset(5) {
            strncpy(script, p,
                    period.wrapping_offset_from(p) as libc::c_long as
                        libc::c_ulong);
        } else {
            dpx_warning(b"Invalid OTL script tag found: %s\x00" as *const u8
        ...
        if !period.is_null() && period < endptr {
            ...
            if period < p.offset(5) {
                ...
                dpx_warning(b"Invalid OTL lanuage tag found: %s\x00" as
                                *const u8 as *const libc::c_char, p);
                return -1i32
            }
            p = period.offset(1)
        }
    ...
    if p.offset(4) <= endptr {
        strncpy(feature, p,
                endptr.wrapping_offset_from(p) as libc::c_long as
                    libc::c_ulong);
        p = endptr
    } else {
        dpx_warning(b"No valid OTL feature tag specified.\x00" as *const u8 as
                        *const libc::c_char);
        return -1i32
    }
    return 0i32;
...
pub unsafe extern "C" fn otl_gsub_release(mut gsub_list: *mut otl_gsub) {
    ...
    while i < (*gsub_list).num_gsubs {
        ...
        while j < (*gsub).num_subtables {
            subtab =
                &mut *(*gsub).subtables.offset(j as isize) as
                    *mut otl_gsub_subtab;
            match (*subtab).LookupType as libc::c_int {
                1 => { otl_gsub_release_single(subtab); }
                3 => { otl_gsub_release_alternate(subtab); }
                4 => { otl_gsub_release_ligature(subtab); }
                _ => {
...
#[no_mangle]
pub unsafe extern "C" fn otl_gsub_apply(mut gsub_list: *mut otl_gsub,
                                        mut gid: *mut USHORT) -> libc::c_int {
    let mut retval: libc::c_int = -1i32;
    let mut gsub: *mut otl_gsub_tab = 0 as *mut otl_gsub_tab;
    let mut subtab: *mut otl_gsub_subtab = 0 as *mut otl_gsub_subtab;
    let mut i: libc::c_int = 0;
    let mut j: libc::c_int = 0;
    if gsub_list.is_null() || gid.is_null() { return retval }
    i = (*gsub_list).select;
    if i < 0i32 || i >= (*gsub_list).num_gsubs {
        _tt_abort(b"GSUB not selected...\x00" as *const u8 as
                      *const libc::c_char);
    }
    gsub =
        &mut *(*gsub_list).gsubs.as_mut_ptr().offset(i as isize) as
...
#[no_mangle]
pub unsafe extern "C" fn otl_gsub_apply_alt(mut gsub_list: *mut otl_gsub,
                                            mut alt_idx: USHORT,
                                            mut gid: *mut USHORT)
 -> libc::c_int {
    let mut retval: libc::c_int = -1i32;
...
#[no_mangle]
pub unsafe extern "C" fn otl_gsub_apply_lig(mut gsub_list: *mut otl_gsub,
                                            mut gid_in: *mut USHORT,
                                            mut num_gids: USHORT,
                                            mut gid_out: *mut USHORT)
 -> libc::c_int {
    ...
    let mut i: libc::c_int = 0;
    let mut j: libc::c_int = 0;
    if gsub_list.is_null() || gid_out.is_null() { return retval }
    i = (*gsub_list).select;
    if i < 0i32 || i >= (*gsub_list).num_gsubs {
        _tt_abort(b"GSUB not selected...\x00" as *const u8 as
                      *const libc::c_char);
    ...
    while retval < 0i32 && j < (*gsub).num_subtables {
        ...
        match (*subtab).LookupType as libc::c_int {
            4 => {
                retval =
                    otl_gsub_apply_ligature(subtab, gid_in, num_gids, gid_out)
            }
            _ => { }
        }
        j += 1
...
unsafe extern "C" fn gsub_find(mut gsub_list: *mut otl_gsub,
                               mut script: *const libc::c_char,
                               mut language: *const libc::c_char,
                               mut feature: *const libc::c_char)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otl_gsub_select(mut gsub_list: *mut otl_gsub,
                                         mut script: *const libc::c_char,
                                         mut language: *const libc::c_char,
                                         mut feature: *const libc::c_char)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otl_gsub_set_chain(mut gsub_list: *mut otl_gsub,
 ...
 -> libc::c_int {
    ...
    while p < endptr {
        ...
        if nextptr.is_null() { nextptr = endptr }
        if scan_otl_tag(p, nextptr, script.as_mut_ptr(),
                        language.as_mut_ptr(), feature.as_mut_ptr()) >= 0i32 {
            idx =
                gsub_find(gsub_list, script.as_mut_ptr(),
                          language.as_mut_ptr(), feature.as_mut_ptr());
            if idx >= 0i32 && idx <= (*gsub_list).num_gsubs {
                let mut entry: *mut gsub_entry = 0 as *mut gsub_entry;
                entry =
                    new((1i32 as uint32_t as
                             libc::c_ulong).wrapping_mul(::std::mem::size_of::<gsub_entry>()
                                                             as libc::c_ulong)
                            as uint32_t) as *mut gsub_entry;
                if (*gsub_list).first.is_null() { (*gsub_list).first = entry }
                if !prev.is_null() { (*prev).next = entry }
                (*entry).index = idx;
                prev = entry
            }
        }
    ...
    if !prev.is_null() { (*prev).next = 0 as *mut gsub_entry }
    return 0i32;
}
#[no_mangle]
pub unsafe extern "C" fn otl_gsub_add_feat_list(mut gsub_list: *mut otl_gsub,
                                                mut otl_tags:
                                                    *const libc::c_char,
                                                mut sfont: *mut sfnt)
 -> libc::c_int {
        ...
        if scan_otl_tag(p, nextptr, script.as_mut_ptr(),
            ...
            idx =
                gsub_find(gsub_list, script.as_mut_ptr(),
                          language.as_mut_ptr(), feature.as_mut_ptr());
            if idx < 0i32 {
                otl_gsub_add_feat(gsub_list, script.as_mut_ptr(),
                                  language.as_mut_ptr(), feature.as_mut_ptr(),
                                  sfont);
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn otl_gsub_apply_chain(mut gsub_list: *mut otl_gsub,
                                              mut gid: *mut USHORT)
 -> libc::c_int {
    let mut retval: libc::c_int = -1i32;
    let mut gsub: *mut otl_gsub_tab = 0 as *mut otl_gsub_tab;
    ...
    while !entry.is_null() {
        ...
        if !(idx < 0i32 || idx >= (*gsub_list).num_gsubs) {
            gsub =
                &mut *(*gsub_list).gsubs.as_mut_ptr().offset(idx as isize) as
                    *mut otl_gsub_tab;
            i = 0i32;
            retval = -1i32;
            while retval < 0i32 && i < (*gsub).num_subtables {
                subtab =
                    &mut *(*gsub).subtables.offset(i as isize) as
                        *mut otl_gsub_subtab;
                match (*subtab).LookupType as libc::c_int {
                    1 => { retval = otl_gsub_apply_single(subtab, gid) }
                    _ => { }
