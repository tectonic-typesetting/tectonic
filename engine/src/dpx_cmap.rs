...
*/
    ...
    #[no_mangle]
    fn CMap_parse(cmap: *mut CMap, handle: rust_input_handle_t)
     -> libc::c_int;
}
...
pub unsafe extern "C" fn CMap_new() -> *mut CMap {
    ...
    cmap =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<CMap>() as
    ...
    (*cmap).codespace.ranges =
        new((10i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<rangeDef>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut rangeDef;
    (*cmap).mapTbl = 0 as *mut mapDef;
    (*cmap).mapData =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<mapData>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut mapData;
    (*(*cmap).mapData).prev = 0 as *mut mapData;
    (*(*cmap).mapData).pos = 0i32;
    (*(*cmap).mapData).data =
        new((4096i32 as uint32_t as
    ...
    memset((*cmap).reverseMap as *mut libc::c_void, 0i32,
           (65536i32 as
                libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_int>()
                                                as libc::c_ulong));
    return cmap;
...
pub unsafe extern "C" fn CMap_release(mut cmap: *mut CMap) {
    ...
    if !(*cmap).mapTbl.is_null() { mapDef_release((*cmap).mapTbl); }
    ...
    if !cmap.is_null() {
        ...
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 31],
                                                &[libc::c_char; 31]>(b"_Bool CMap_is_Identity(CMap *)\x00")).as_ptr());
    }
    return streq_ptr((*cmap).name,
                     b"Identity-H\x00" as *const u8 as *const libc::c_char) as
               libc::c_int != 0 ||
               streq_ptr((*cmap).name,
...
pub unsafe extern "C" fn CMap_is_valid(mut cmap: *mut CMap) -> bool {
    /* Quick check */
    if cmap.is_null() || (*cmap).name.is_null() || (*cmap).type_0 < 0i32 ||
           (*cmap).type_0 > 3i32 ||
    ...
    if !(*cmap).useCMap.is_null() {
        ...
        if strcmp((*csi1).registry, (*csi2).registry) != 0 ||
            ...
            dpx_warning(b"CIDSystemInfo mismatched %s <--> %s\x00" as
...
#[no_mangle]
pub unsafe extern "C" fn CMap_get_profile(mut cmap: *mut CMap,
    ...
    if !cmap.is_null() {
        ...
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 34],
                                                &[libc::c_char; 34]>(b"int CMap_get_profile(CMap *, int)\x00")).as_ptr());
    }
    match type_0 {
        ...
        _ => {
            _tt_abort(b"%s: Unrecognized profile type %d.\x00" as *const u8 as
                          *const libc::c_char,
 ...
 */
unsafe extern "C" fn handle_undefined(mut cmap: *mut CMap,
    ...
    if *outbytesleft < 2i32 as libc::c_ulong {
        _tt_abort(b"%s: Buffer overflow.\x00" as *const u8 as
                      *const libc::c_char,
                  b"CMap\x00" as *const u8 as *const libc::c_char);
    }
    match (*cmap).type_0 {
        1 => {
            memcpy(*outbuf as *mut libc::c_void,
                   b"\x00\x00\x00" as *const u8 as *const libc::c_char as
                       *const libc::c_void, 2i32 as libc::c_ulong);
        }
        2 => {
            memcpy(*outbuf as *mut libc::c_void,
                   b"\xff\xfd\x00" as *const u8 as *const libc::c_char as
                       *const libc::c_void, 2i32 as libc::c_ulong);
        }
        _ => {
            dpx_warning(b"Cannot handle undefined mapping for this type of CMap mapping: %d\x00"
                            as *const u8 as *const libc::c_char,
                        (*cmap).type_0);
            dpx_warning(b"<0000> is used for .notdef char.\x00" as *const u8
    ...
    *outbytesleft =
        (*outbytesleft as libc::c_ulong).wrapping_sub(2i32 as libc::c_ulong)
            as size_t as size_t;
    len = bytes_consumed(cmap, *inbuf, *inbytesleft);
    *inbuf = (*inbuf).offset(len as isize);
    *inbytesleft =
        (*inbytesleft as libc::c_ulong).wrapping_sub(len) as size_t as size_t;
}
#[no_mangle]
pub unsafe extern "C" fn CMap_decode_char(mut cmap: *mut CMap,
                                          mut inbuf:
    ...
    if (*cmap).type_0 == 0i32 {
        if (*inbytesleft).wrapping_rem(2i32 as libc::c_ulong) != 0 {
            _tt_abort(b"%s: Invalid/truncated input string.\x00" as *const u8
                          as *const libc::c_char,
                      b"CMap\x00" as *const u8 as *const libc::c_char);
        }
        if *outbytesleft < 2i32 as libc::c_ulong {
        ...
        memcpy(*outbuf as *mut libc::c_void, *inbuf as *const libc::c_void,
               2i32 as libc::c_ulong);
        *inbuf = (*inbuf).offset(2);
        *outbuf = (*outbuf).offset(2);
        *outbytesleft =
            (*outbytesleft as
                 libc::c_ulong).wrapping_sub(2i32 as libc::c_ulong) as size_t
                as size_t;
        *inbytesleft =
            (*inbytesleft as
                 libc::c_ulong).wrapping_sub(2i32 as libc::c_ulong) as size_t
        ...
        if (*cmap).mapTbl.is_null() {
            if !(*cmap).useCMap.is_null() {
                CMap_decode_char((*cmap).useCMap, inbuf, inbytesleft, outbuf,
                                 outbytesleft);
                return
            } else {
                /* no mapping available in this CMap */
                dpx_warning(b"No mapping available for this character.\x00" as
                                *const u8 as *const libc::c_char);
                handle_undefined(cmap, inbuf, inbytesleft, outbuf,
                                 outbytesleft);
                return
            }
        }
    ...
    while count < *inbytesleft {
        ...
        if (*t.offset(c as isize)).flag & 1i32 << 4i32 == 0 { break ; }
        t = (*t.offset(c as isize)).next
    }
    if (*t.offset(c as isize)).flag & 1i32 << 4i32 != 0 {
        /* need more bytes */
        _tt_abort(b"%s: Premature end of input string.\x00" as *const u8 as
                      *const libc::c_char,
                  b"CMap\x00" as *const u8 as *const libc::c_char);
    } else {
        if if (*t.offset(c as isize)).flag & 0xfi32 != 0i32 {
            ...
            if !(*cmap).useCMap.is_null() {
                ...
                /* no mapping available in this CMap */
                dpx_warning(b"No character mapping available.\x00" as
                                *const u8 as *const libc::c_char);
                dpx_message(b" CMap name: %s\n\x00" as *const u8 as
                                *const libc::c_char, CMap_get_name(cmap));
                dpx_message(b" input str: \x00" as *const u8 as
                                *const libc::c_char);
            ...
            match (*t.offset(c as isize)).flag & 0xfi32 {
                8 => {
                    dpx_warning(b"Character mapped to .notdef found.\x00" as
                                    *const u8 as *const libc::c_char);
                }
                1 | 4 => { }
                2 => {
                    _tt_abort(b"%s: CharName mapping not supported.\x00" as
                                  *const u8 as *const libc::c_char,
                              b"CMap\x00" as *const u8 as
                                  *const libc::c_char);
                }
                _ => {
                    _tt_abort(b"%s: Unknown mapping type.\x00" as *const u8 as
                                  *const libc::c_char,
                              b"CMap\x00" as *const u8 as
                                  *const libc::c_char);
                }
            ...
            *outbytesleft =
                (*outbytesleft as
                     libc::c_ulong).wrapping_sub((*t.offset(c as isize)).len)
                    as size_t as size_t;
            if !inbytesleft.is_null() {
                *inbytesleft =
                    (*inbytesleft as libc::c_ulong).wrapping_sub(count) as
                        size_t as size_t
            }
            *inbuf = p
        }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn CMap_decode(mut cmap: *mut CMap,
                                     mut inbuf: *mut *const libc::c_uchar,
                                     mut inbytesleft: *mut size_t,
                                     mut outbuf: *mut *mut libc::c_uchar,
                                     mut outbytesleft: *mut size_t)
 -> size_t {
    ...
    while *inbytesleft > 0i32 as libc::c_ulong &&
              *outbytesleft > 0i32 as libc::c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn CMap_reverse_decode(mut cmap: *mut CMap,
                                             mut cid: CID) -> libc::c_int {
    let mut ch: libc::c_int =
        if !(*cmap).reverseMap.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn CMap_get_name(mut cmap: *mut CMap)
 -> *mut libc::c_char {
    if !cmap.is_null() {
    } else {
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 28],
                                                &[libc::c_char; 28]>(b"char *CMap_get_name(CMap *)\x00")).as_ptr());
    }
    return (*cmap).name;
}
#[no_mangle]
    ...
    if !cmap.is_null() {
        ...
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 26],
                                                &[libc::c_char; 26]>(b"int CMap_get_type(CMap *)\x00")).as_ptr());
    }
    return (*cmap).type_0;
}
#[no_mangle]
    ...
    if !cmap.is_null() {
        ...
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 27],
                                                &[libc::c_char; 27]>(b"int CMap_get_wmode(CMap *)\x00")).as_ptr());
    }
    return (*cmap).wmode;
}
#[no_mangle]
pub unsafe extern "C" fn CMap_get_CIDSysInfo(mut cmap: *mut CMap)
 -> *mut CIDSysInfo {
    if !cmap.is_null() {
    } else {
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 40],
                                                &[libc::c_char; 40]>(b"CIDSysInfo *CMap_get_CIDSysInfo(CMap *)\x00")).as_ptr());
    }
    return (*cmap).CSI;
}
#[no_mangle]
pub unsafe extern "C" fn CMap_set_name(mut cmap: *mut CMap,
    ...
    if !cmap.is_null() {
        ...
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 41],
                                                &[libc::c_char; 41]>(b"void CMap_set_name(CMap *, const char *)\x00")).as_ptr());
    }
    free((*cmap).name as *mut libc::c_void);
    (*cmap).name =
        new((strlen(name).wrapping_add(1i32 as libc::c_ulong) as uint32_t as
...
#[no_mangle]
pub unsafe extern "C" fn CMap_set_type(mut cmap: *mut CMap,
                                       mut type_0: libc::c_int) {
    if !cmap.is_null() {
    } else {
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 32],
                                                &[libc::c_char; 32]>(b"void CMap_set_type(CMap *, int)\x00")).as_ptr());
    }
    (*cmap).type_0 = type_0;
}
#[no_mangle]
pub unsafe extern "C" fn CMap_set_wmode(mut cmap: *mut CMap,
    ...
    if !cmap.is_null() {
        ...
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 33],
                                                &[libc::c_char; 33]>(b"void CMap_set_wmode(CMap *, int)\x00")).as_ptr());
    }
    (*cmap).wmode = wmode;
}
#[no_mangle]
pub unsafe extern "C" fn CMap_set_CIDSysInfo(mut cmap: *mut CMap,
                                             mut csi: *const CIDSysInfo) {
    if !cmap.is_null() {
    } else {
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      b"dpx-cmap.c\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"void CMap_set_CIDSysInfo(CMap *, const CIDSysInfo *)\x00")).as_ptr());
    }
    if !(*cmap).CSI.is_null() {
        free((*(*cmap).CSI).registry as *mut libc::c_void);
        free((*(*cmap).CSI).ordering as *mut libc::c_void);
    ...
    if !csi.is_null() && !(*csi).registry.is_null() &&
           !(*csi).ordering.is_null() {
        (*cmap).CSI =
            new((1i32 as uint32_t as
        ...
        (*(*cmap).CSI).registry =
            new((strlen((*csi).registry).wrapping_add(1i32 as libc::c_ulong)
                     as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut libc::c_char;
        ...
        (*(*cmap).CSI).ordering =
            new((strlen((*csi).ordering).wrapping_add(1i32 as libc::c_ulong)
                     as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut libc::c_char;
        ...
        dpx_warning(b"Invalid CIDSystemInfo.\x00" as *const u8 as
                        *const libc::c_char);
        (*cmap).CSI = 0 as *mut CIDSysInfo
    };
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn CMap_set_usecmap(mut cmap: *mut CMap,
                                          mut ucmap: *mut CMap) {
    let mut i: libc::c_uint =
        0; /* Maybe if (!ucmap) _tt_abort() is better for this. */
    if !cmap.is_null() {
    } else {
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      b"dpx-cmap.c\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 38],
                                                &[libc::c_char; 38]>(b"void CMap_set_usecmap(CMap *, CMap *)\x00")).as_ptr());
    }
    if !ucmap.is_null() {
    } else {
        __assert_fail(b"ucmap\x00" as *const u8 as *const libc::c_char,
                      b"dpx-cmap.c\x00" as *const u8 as *const libc::c_char,
    ...
    if cmap == ucmap {
        _tt_abort(b"%s: Identical CMap object cannot be used for usecmap CMap: 0x%p=0x%p\x00"
                      as *const u8 as *const libc::c_char,
                  b"CMap\x00" as *const u8 as *const libc::c_char, cmap,
                  ucmap);
    }
    /* Check if ucmap have neccesary information. */
    if !CMap_is_valid(ucmap) {
        _tt_abort(b"%s: Invalid CMap.\x00" as *const u8 as
                      *const libc::c_char,
                  b"CMap\x00" as *const u8 as *const libc::c_char);
    }
    /*
    ...
    if streq_ptr((*cmap).name, (*ucmap).name) {
        _tt_abort(b"%s: CMap refering itself not allowed: CMap %s --> %s\x00"
                      as *const u8 as *const libc::c_char,
                  b"CMap\x00" as *const u8 as *const libc::c_char,
                  (*cmap).name, (*ucmap).name);
    }
    if !(*cmap).CSI.is_null() && !(*(*cmap).CSI).registry.is_null() &&
           !(*(*cmap).CSI).ordering.is_null() {
        if strcmp((*(*cmap).CSI).registry, (*(*ucmap).CSI).registry) != 0 ||
               strcmp((*(*cmap).CSI).ordering, (*(*ucmap).CSI).ordering) != 0
           {
            _tt_abort(b"%s: CMap %s required by %s have different CSI.\x00" as
                          *const u8 as *const libc::c_char,
                      b"CMap\x00" as *const u8 as *const libc::c_char,
                      CMap_get_name(cmap), CMap_get_name(ucmap));
        }
    }
    /* We must copy codespaceranges. */
    i = 0i32 as libc::c_uint;
    while i < (*ucmap).codespace.num {
        let mut csr: *mut rangeDef =
            (*ucmap).codespace.ranges.offset(i as isize);
        CMap_add_codespacerange(cmap, (*csr).codeLo, (*csr).codeHi,
                                (*csr).dim);
        i = i.wrapping_add(1)
    }
    (*cmap).useCMap = ucmap;
...
unsafe extern "C" fn CMap_match_codespace(mut cmap: *mut CMap,
                                          mut c: *const libc::c_uchar,
                                          mut dim: size_t) -> libc::c_int {
    ...
    if !cmap.is_null() {
        ...
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 64],
                                                &[libc::c_char; 64]>(b"int CMap_match_codespace(CMap *, const unsigned char *, size_t)\x00")).as_ptr());
    }
    i = 0i32 as libc::c_uint;
    while i < (*cmap).codespace.num {
        let mut csr: *mut rangeDef =
            (*cmap).codespace.ranges.offset(i as isize);
        if !((*csr).dim != dim) {
            ...
            if pos as libc::c_ulong == dim { return 0i32 }
        }
        i = i.wrapping_add(1)
        /* Valid */
    }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn CMap_add_codespacerange(mut cmap: *mut CMap,
                                                 mut codelo:
                                                     *const libc::c_uchar,
                                                 mut codehi:
                                                     *const libc::c_uchar,
 ...
 -> libc::c_int {
    ...
    while i < (*cmap).codespace.num {
        ...
        j = 0i32 as size_t;
        while j < (if (*csr).dim < dim { (*csr).dim } else { dim }) &&
                  overlap as libc::c_int != 0 {
        ...
        if overlap {
            dpx_warning(b"Overlapping codespace found. (ingored)\x00" as
                            *const u8 as *const libc::c_char);
            return -1i32
        }
        i = i.wrapping_add(1)
    }
    if dim < (*cmap).profile.minBytesIn { (*cmap).profile.minBytesIn = dim }
    if dim > (*cmap).profile.maxBytesIn { (*cmap).profile.maxBytesIn = dim }
    if (*cmap).codespace.num.wrapping_add(1i32 as libc::c_uint) >
           (*cmap).codespace.max {
        (*cmap).codespace.max =
            (*cmap).codespace.max.wrapping_add(10i32 as libc::c_uint);
        (*cmap).codespace.ranges =
            renew((*cmap).codespace.ranges as *mut libc::c_void,
                  ((*cmap).codespace.max as
                       libc::c_ulong).wrapping_mul(::std::mem::size_of::<rangeDef>()
                                                       as libc::c_ulong) as
                      uint32_t) as *mut rangeDef
    }
    csr = (*cmap).codespace.ranges.offset((*cmap).codespace.num as isize);
    (*csr).dim = dim;
    (*csr).codeHi = get_mem(cmap, dim as libc::c_int);
    (*csr).codeLo = get_mem(cmap, dim as libc::c_int);
    memcpy((*csr).codeHi as *mut libc::c_void, codehi as *const libc::c_void,
           dim);
    memcpy((*csr).codeLo as *mut libc::c_void, codelo as *const libc::c_void,
           dim);
    (*cmap).codespace.num = (*cmap).codespace.num.wrapping_add(1);
    return 0i32;
}
#[no_mangle]
pub unsafe extern "C" fn CMap_add_notdefchar(mut cmap: *mut CMap,
                                             mut src: *const libc::c_uchar,
                                             mut srcdim: size_t, mut dst: CID)
 -> libc::c_int {
    return CMap_add_notdefrange(cmap, src, src, srcdim, dst);
}
#[no_mangle]
pub unsafe extern "C" fn CMap_add_notdefrange(mut cmap: *mut CMap,
                                              mut srclo: *const libc::c_uchar,
                                              mut srchi: *const libc::c_uchar,
                                              mut srcdim: size_t,
                                              mut dst: CID) -> libc::c_int {
    ...
    /* dst not used here */
    /* FIXME */
    if check_range(cmap, srclo, srchi, srcdim,
                   &mut dst as *mut CID as *const libc::c_uchar,
                   2i32 as size_t) < 0i32 {
        return -1i32
    }
    if (*cmap).mapTbl.is_null() { (*cmap).mapTbl = mapDef_new() }
    cur = (*cmap).mapTbl;
    if locate_tbl(&mut cur, srclo, srcdim as libc::c_int) < 0i32 {
        return -1i32
    }
    c =
        *srclo.offset(srcdim.wrapping_sub(1i32 as libc::c_ulong) as isize) as
            libc::c_int;
    while c <=
              *srchi.offset(srcdim.wrapping_sub(1i32 as libc::c_ulong) as
                                isize) as libc::c_int {
        if if (*cur.offset(c as isize)).flag & 0xfi32 != 0i32 {
               1i32
           } else { 0i32 } != 0 {
            if __silent == 0 {
                dpx_warning(b"Trying to redefine already defined code mapping. (ignored)\x00"
                                as *const u8 as *const libc::c_char);
            }
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn CMap_add_bfchar(mut cmap: *mut CMap,
                                         mut src: *const libc::c_uchar,
                                         mut srcdim: size_t,
                                         mut dst: *const libc::c_uchar,
                                         mut dstdim: size_t) -> libc::c_int {
    return CMap_add_bfrange(cmap, src, src, srcdim, dst, dstdim);
}
#[no_mangle]
pub unsafe extern "C" fn CMap_add_bfrange(mut cmap: *mut CMap,
                                          mut srclo: *const libc::c_uchar,
                                          mut srchi: *const libc::c_uchar,
                                          mut srcdim: size_t,
    ...
    while c <=
        ...
        if (if (*cur.offset(c as isize)).flag & 0xfi32 != 0i32 {
                1i32
            } else { 0i32 }) == 0 || (*cur.offset(c as isize)).len < dstdim {
        ...
        memcpy((*cur.offset(c as isize)).code as *mut libc::c_void,
               base as *const libc::c_void, dstdim);
        last_byte =
            c -
                *srclo.offset(srcdim.wrapping_sub(1i32 as libc::c_ulong) as
                                  isize) as libc::c_int +
                *base.offset(dstdim.wrapping_sub(1i32 as libc::c_ulong) as
                                 isize) as libc::c_int;
        *(*cur.offset(c as
                          isize)).code.offset(dstdim.wrapping_sub(1i32 as
                                                                      libc::c_ulong)
                                                  as isize) =
        ...
        while i >= 0i32 && last_byte > 255i32 {
            last_byte =
                *(*cur.offset(c as isize)).code.offset(i as isize) as
                    libc::c_int + 1i32;
...
#[no_mangle]
pub unsafe extern "C" fn CMap_add_cidchar(mut cmap: *mut CMap,
                                          mut src: *const libc::c_uchar,
                                          mut srcdim: size_t, mut dst: CID)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn CMap_add_cidrange(mut cmap: *mut CMap,
                                           mut srclo: *const libc::c_uchar,
                                           mut srchi: *const libc::c_uchar,
                                           mut srcdim: size_t, mut base: CID)
 -> libc::c_int {
    let mut i: size_t = 0;
    let mut c: size_t = 0;
    let mut v: size_t = 0;
    ...
    while i < srcdim.wrapping_sub(1i32 as libc::c_ulong) {
        v =
            (v <<
                 8i32).wrapping_add(*srclo.offset(i as isize) as
                                        libc::c_ulong);
        i = i.wrapping_add(1)
    }
    *(*cmap).reverseMap.offset(base as isize) = v as libc::c_int;
    ...
    while c <=
              *srchi.offset(srcdim.wrapping_sub(1i32 as libc::c_ulong) as
                                isize) as libc::c_ulong {
        if (*cur.offset(c as isize)).flag != 0i32 {
            if __silent == 0 {
                dpx_warning(b"Trying to redefine already defined CID mapping. (ignored)\x00"
                                as *const u8 as *const libc::c_char);
            }
        } else {
            ...
            *(*cmap).reverseMap.offset(base as isize) =
                (v << 8i32).wrapping_add(c) as libc::c_int
        }
        if base as libc::c_int >= 65535i32 {
            dpx_warning(b"CID number too large.\x00" as *const u8 as
                            *const libc::c_char);
        }
...
unsafe extern "C" fn mapDef_release(mut t: *mut mapDef) {
    ...
    if !t.is_null() {
        ...
        __assert_fail(b"t\x00" as *const u8 as *const libc::c_char,
                      b"dpx-cmap.c\x00" as *const u8 as *const libc::c_char,
                      709i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 30],
                                                &[libc::c_char; 30]>(b"void mapDef_release(mapDef *)\x00")).as_ptr());
    }
    c = 0i32;
    while c < 256i32 {
        if (*t.offset(c as isize)).flag & 1i32 << 4i32 != 0 {
...
unsafe extern "C" fn mapDef_new() -> *mut mapDef {
    ...
    t =
        new((256i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<mapDef>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut mapDef;
    c = 0i32;
    while c < 256i32 {
...
unsafe extern "C" fn get_mem(mut cmap: *mut CMap, mut size: libc::c_int)
 -> *mut libc::c_uchar {
    let mut map: *mut mapData = 0 as *mut mapData;
    let mut p: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    if !cmap.is_null() && !(*cmap).mapData.is_null() && size >= 0i32 {
    } else {
        __assert_fail(b"cmap && cmap->mapData && size >= 0\x00" as *const u8
                          as *const libc::c_char,
                      b"dpx-cmap.c\x00" as *const u8 as *const libc::c_char,
                      739i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 36],
                                                &[libc::c_char; 36]>(b"unsigned char *get_mem(CMap *, int)\x00")).as_ptr());
    }
    map = (*cmap).mapData;
...
unsafe extern "C" fn locate_tbl(mut cur: *mut *mut mapDef,
                                mut code: *const libc::c_uchar,
                                mut dim: libc::c_int) -> libc::c_int {
    let mut i: libc::c_int = 0;
    let mut c: libc::c_int = 0;
    if !cur.is_null() && !(*cur).is_null() {
    } else {
        __assert_fail(b"cur && *cur\x00" as *const u8 as *const libc::c_char,
                      b"dpx-cmap.c\x00" as *const u8 as *const libc::c_char,
                      760i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 54],
                                                &[libc::c_char; 54]>(b"int locate_tbl(mapDef **, const unsigned char *, int)\x00")).as_ptr());
    }
    i = 0i32;
    while i < dim - 1i32 {
        ...
        if if (*(*cur).offset(c as isize)).flag & 0xfi32 != 0i32 {
            ...
            dpx_warning(b"Ambiguous CMap entry.\x00" as *const u8 as
                            *const libc::c_char);
            return -1i32
        }
 ...
 */
unsafe extern "C" fn bytes_consumed(mut cmap: *mut CMap,
                                    mut instr: *const libc::c_uchar,
                                    mut inbytes: size_t) -> size_t {
    let mut i: size_t = 0;
    ...
    if !cmap.is_null() {
        ...
        __assert_fail(b"cmap\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 61],
                                                &[libc::c_char; 61]>(b"size_t bytes_consumed(CMap *, const unsigned char *, size_t)\x00")).as_ptr());
    }
    i = 0i32 as size_t;
...
unsafe extern "C" fn check_range(mut cmap: *mut CMap,
                                 mut srclo: *const libc::c_uchar,
                                 mut srchi: *const libc::c_uchar,
                                 mut srcdim: size_t,
                                 mut dst: *const libc::c_uchar,
                                 mut dstdim: size_t) -> libc::c_int {
    if srcdim < 1i32 as libc::c_ulong || dstdim < 1i32 as libc::c_ulong ||
           (srclo.is_null() || srchi.is_null() || dst.is_null()) ||
           memcmp(srclo as *const libc::c_void, srchi as *const libc::c_void,
                  srcdim.wrapping_sub(1i32 as libc::c_ulong)) != 0 ||
           *srclo.offset(srcdim.wrapping_sub(1i32 as libc::c_ulong) as isize)
               as libc::c_int >
               *srchi.offset(srcdim.wrapping_sub(1i32 as libc::c_ulong) as
                                 isize) as libc::c_int {
        dpx_warning(b"Invalid CMap mapping entry. (ignored)\x00" as *const u8
                        as *const libc::c_char);
        return -1i32
    }
...
static mut __cache: *mut CMap_cache =
    0 as *const CMap_cache as *mut CMap_cache;
#[no_mangle]
pub unsafe extern "C" fn CMap_cache_init() {
    ...
    if !__cache.is_null() {
        _tt_abort(b"%s: Already initialized.\x00" as *const u8 as
                      *const libc::c_char,
                  b"CMap\x00" as *const u8 as *const libc::c_char);
    }
    __cache =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<CMap_cache>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut CMap_cache;
    (*__cache).max = 16u32 as libc::c_int;
    (*__cache).cmaps =
        new(((*__cache).max as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<*mut CMap>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut *mut CMap;
    (*__cache).num = 0i32;
    /* Create Identity mapping */
    let ref mut fresh7 = *(*__cache).cmaps.offset(0);
    *fresh7 = CMap_new();
    CMap_set_name(*(*__cache).cmaps.offset(0),
    ...
    CMap_add_codespacerange(*(*__cache).cmaps.offset(0),
                            range_min.as_mut_ptr(), range_max.as_mut_ptr(),
                            2i32 as size_t);
    let ref mut fresh8 = *(*__cache).cmaps.offset(1);
    *fresh8 = CMap_new();
    CMap_set_name(*(*__cache).cmaps.offset(1),
    ...
    CMap_add_codespacerange(*(*__cache).cmaps.offset(1),
                            range_min.as_mut_ptr(), range_max.as_mut_ptr(),
                            2i32 as size_t);
    (*__cache).num += 2i32;
}
...
pub unsafe extern "C" fn CMap_cache_get(mut id: libc::c_int) -> *mut CMap {
    if __cache.is_null() {
        _tt_abort(b"%s: CMap cache not initialized.\x00" as *const u8 as
                      *const libc::c_char,
                  b"CMap\x00" as *const u8 as *const libc::c_char);
    }
    if id < 0i32 || id >= (*__cache).num {
        _tt_abort(b"Invalid CMap ID %d\x00" as *const u8 as
                      *const libc::c_char, id);
    }
    return *(*__cache).cmaps.offset(id as isize);
}
#[no_mangle]
pub unsafe extern "C" fn CMap_cache_find(mut cmap_name: *const libc::c_char)
 -> libc::c_int {
    let mut id: libc::c_int = 0i32;
    let mut handle: rust_input_handle_t = 0 as *mut libc::c_void;
    if __cache.is_null() { CMap_cache_init(); }
    if !__cache.is_null() {
    } else {
        __assert_fail(b"__cache\x00" as *const u8 as *const libc::c_char,
                      b"dpx-cmap.c\x00" as *const u8 as *const libc::c_char,
                      914i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 34],
                                                &[libc::c_char; 34]>(b"int CMap_cache_find(const char *)\x00")).as_ptr());
    }
    id = 0i32;
    ...
    if __verbose != 0 {
        dpx_message(b"(CMap:%s\x00" as *const u8 as *const libc::c_char,
                    cmap_name);
    }
    if (*__cache).num >= (*__cache).max {
        (*__cache).max =
            ((*__cache).max as libc::c_uint).wrapping_add(16u32) as
                libc::c_int as libc::c_int;
        (*__cache).cmaps =
            renew((*__cache).cmaps as *mut libc::c_void,
                  ((*__cache).max as uint32_t as
                       libc::c_ulong).wrapping_mul(::std::mem::size_of::<*mut CMap>()
                                                       as libc::c_ulong) as
                      uint32_t) as *mut *mut CMap
    }
    ...
    *fresh9 = CMap_new();
    if CMap_parse(*(*__cache).cmaps.offset(id as isize), handle) < 0i32 {
        _tt_abort(b"%s: Parsing CMap file failed.\x00" as *const u8 as
                      *const libc::c_char,
                  b"CMap\x00" as *const u8 as *const libc::c_char);
    }
    ttstub_input_close(handle);
...
pub unsafe extern "C" fn CMap_cache_add(mut cmap: *mut CMap) -> libc::c_int {
    ...
    while id < (*__cache).num {
        ...
        if streq_ptr(cmap_name0, cmap_name1) {
            _tt_abort(b"%s: CMap \"%s\" already defined.\x00" as *const u8 as
                          *const libc::c_char,
                      b"CMap\x00" as *const u8 as *const libc::c_char,
                      cmap_name0);
        }
