...
extern "C" {
    ...
    #[no_mangle]
    fn pdf_ximage_set_form(ximage: *mut pdf_ximage, info: *mut libc::c_void,
    ...
    #[no_mangle]
    fn pdf_open(ident: *const libc::c_char, handle: rust_input_handle_t)
     -> *mut pdf_file;
    #[no_mangle]
    ...
    #[no_mangle]
    fn pdf_doc_get_page(pf: *mut pdf_file, page_no: libc::c_int,
                        options: libc::c_int, bbox: *mut pdf_rect,
                        matrix: *mut pdf_tmatrix,
                        resources_p: *mut *mut pdf_obj) -> *mut pdf_obj;
    #[no_mangle]
    ...
    #[no_mangle]
    fn pdf_dev_vcurveto(x0: libc::c_double, y0: libc::c_double,
                        x1: libc::c_double, y1: libc::c_double)
     -> libc::c_int;
    #[no_mangle]
    fn pdf_dev_ycurveto(x0: libc::c_double, y0: libc::c_double,
                        x1: libc::c_double, y1: libc::c_double)
     -> libc::c_int;
    #[no_mangle]
    fn pdf_dev_rectadd(x: libc::c_double, y: libc::c_double,
 ...
 */
unsafe extern "C" fn rect_equal(mut rect1: *mut pdf_obj,
                                mut rect2: *mut pdf_obj) -> libc::c_int {
    let mut i: libc::c_int = 0;
    if rect1.is_null() || rect2.is_null() { return 0i32 }
    i = 0i32;
    while i < 4i32 {
...
unsafe extern "C" fn pdf_get_page_obj(mut pf: *mut pdf_file,
 ...
 -> *mut pdf_obj {
   ...
   */
    ...
    if !pdf_lookup_dict(trailer,
                        b"Encrypt\x00" as *const u8 as
                            *const libc::c_char).is_null() {
        dpx_warning(b"This PDF document is encrypted.\x00" as *const u8 as
                        *const libc::c_char);
        pdf_release_obj(trailer);
        return 0 as *mut pdf_obj
    }
    catalog =
        pdf_deref_obj(pdf_lookup_dict(trailer,
                                      b"Root\x00" as *const u8 as
                                          *const libc::c_char));
    if !(!catalog.is_null() && pdf_obj_typeof(catalog) == 6i32) {
        dpx_warning(b"Can\'t read document catalog.\x00" as *const u8 as
                        *const libc::c_char);
        pdf_release_obj(trailer);
    ...
    markinfo =
        pdf_deref_obj(pdf_lookup_dict(catalog,
                                      b"MarkInfo\x00" as *const u8 as
                                          *const libc::c_char));
    if !markinfo.is_null() {
        tmp =
            pdf_lookup_dict(markinfo,
                            b"Marked\x00" as *const u8 as
                                *const libc::c_char);
        if !tmp.is_null() && pdf_obj_typeof(tmp) == 1i32 &&
               pdf_boolean_value(tmp) as libc::c_int != 0 {
            dpx_warning(b"PDF file is tagged... Ignoring tags.\x00" as
    ...
    if page_tree.is_null() {
        dpx_warning(b"Page tree not found.\x00" as *const u8 as
                        *const libc::c_char);
        return 0 as *mut pdf_obj
    }
    /*
   ...
   */
    let mut count: libc::c_int =
        pdf_number_value(pdf_lookup_dict(page_tree,
   ...
   */
    ...
    tmp_0 =
        pdf_lookup_dict(page_tree,
                        b"Resources\x00" as *const u8 as *const libc::c_char);
    resources =
        if !tmp_0.is_null() { pdf_deref_obj(tmp_0) } else { pdf_new_dict() };
    loop  {
        ...
        tmp_0 =
            pdf_deref_obj(pdf_lookup_dict(page_tree,
                                          b"MediaBox\x00" as *const u8 as
                                              *const libc::c_char));
        if !tmp_0.is_null() { pdf_release_obj(bbox); bbox = tmp_0 }
        tmp_0 =
            pdf_deref_obj(pdf_lookup_dict(page_tree,
        ...
        tmp_0 =
            pdf_deref_obj(pdf_lookup_dict(page_tree,
                                          b"CropBox\x00" as *const u8 as
                                              *const libc::c_char));
        if !tmp_0.is_null() { pdf_release_obj(crop_box); crop_box = tmp_0 }
        tmp_0 =
            pdf_deref_obj(pdf_lookup_dict(page_tree,
                                          b"Rotate\x00" as *const u8 as
                                              *const libc::c_char));
        if !tmp_0.is_null() { pdf_release_obj(rotate); rotate = tmp_0 }
        tmp_0 =
            pdf_deref_obj(pdf_lookup_dict(page_tree,
                                          b"Resources\x00" as *const u8 as
                                              *const libc::c_char));
        if !tmp_0.is_null() { pdf_release_obj(resources); resources = tmp_0 }
        kids_ref =
            pdf_lookup_dict(page_tree,
                            b"Kids\x00" as *const u8 as *const libc::c_char);
        if kids_ref.is_null() { break ; }
        ...
        if i == kids_length {
            dpx_warning(b"Page %d not found! Broken PDF file?\x00" as
    ...
    if !crop_box.is_null() { pdf_release_obj(bbox); bbox = crop_box }
    if bbox.is_null() {
        dpx_warning(b"No BoundingBox information available.\x00" as *const u8
    ...
    if !ret_bbox.is_null() { *ret_bbox = bbox }
    if !ret_resources.is_null() { *ret_resources = resources }
    return page_tree;
}
unsafe extern "C" fn pdf_get_page_content(mut page: *mut pdf_obj)
 -> *mut pdf_obj {
    let mut contents: *mut pdf_obj = 0 as *mut pdf_obj;
    let mut content_new: *mut pdf_obj = 0 as *mut pdf_obj;
    contents =
        pdf_deref_obj(pdf_lookup_dict(page,
                                      b"Contents\x00" as *const u8 as
                                          *const libc::c_char));
    if contents.is_null() { return 0 as *mut pdf_obj }
     ...
     */
        ...
        loop  {
            ...
            if content_seg.is_null() { break ; }
            if !(!content_seg.is_null() &&
                     pdf_obj_typeof(content_seg) == 8i32) {
                if !(!content_seg.is_null() &&
                         pdf_obj_typeof(content_seg) == 7i32) {
                    dpx_warning(b"Page content not a stream object. Broken PDF file?\x00"
                    ...
                    if pdf_concat_stream(content_new, content_seg) < 0i32 {
                        dpx_warning(b"Could not handle content stream with multiple segments.\x00"
                                        as *const u8 as *const libc::c_char);
                        pdf_release_obj(content_seg);
                        pdf_release_obj(content_new);
                        pdf_release_obj(contents);
        ...
        if pdf_concat_stream(content_new, contents) < 0i32 {
            dpx_warning(b"Could not handle a content stream.\x00" as *const u8
                            as *const libc::c_char);
            pdf_release_obj(contents);
            pdf_release_obj(content_new);
            return 0 as *mut pdf_obj
...
#[no_mangle]
pub unsafe extern "C" fn pdf_include_page(mut ximage: *mut pdf_ximage,
 ...
 -> libc::c_int {
    ...
    if pf.is_null() { return -1i32 }
    if pdf_file_get_version(pf) > pdf_get_version() {
        dpx_warning(b"Trying to include PDF file which has newer version number than output PDF: 1.%d.\x00"
                        as *const u8 as *const libc::c_char,
                    pdf_get_version());
    }
    pdf_ximage_init_form_info(&mut info);
    if options.page_no == 0i32 { options.page_no = 1i32 }
    page =
        pdf_doc_get_page(pf, options.page_no, options.bbox_type,
                         &mut info.bbox, &mut info.matrix, &mut resources);
    if !page.is_null() {
        ...
        if !markinfo.is_null() {
            let mut tmp: *mut pdf_obj =
                pdf_deref_obj(pdf_lookup_dict(markinfo,
                                              b"Marked\x00" as *const u8 as
                                                  *const libc::c_char));
            pdf_release_obj(markinfo);
            if !(!tmp.is_null() && pdf_obj_typeof(tmp) == 1i32) {
   ...
   */
       ...
       */
                    ...
                    current_block = 2480299350034459858;
                              ...
                              pdf_obj_typeof(contents) == 5i32 {
                    /*
       * Concatenate all content streams.
       */
                    let mut idx: libc::c_int = 0;
                    let mut len: libc::c_int =
                        pdf_array_length(contents) as libc::c_int;
                    content_new = pdf_new_stream(1i32 << 0i32);
                    idx = 0i32;
                    loop  {
                        if !(idx < len) {
                        ...
                        if !(!content_seg.is_null() &&
                            ...
                            current_block = 3699483483911207084;
                            break ;
                        } else { pdf_release_obj(content_seg); idx += 1 }
                    }
                } else { current_block = 3699483483911207084; }
                match current_block {
                    3699483483911207084 => { }
                    _ => {
                        pdf_release_obj(contents);
   ...
   */
                        let mut contents_dict: *mut pdf_obj =
                            0 as *mut pdf_obj;
                        let mut bbox: *mut pdf_obj = 0 as *mut pdf_obj;
                        ...
                        pdf_add_dict(contents_dict,
                                     pdf_new_name(b"Type\x00" as *const u8 as
                                                      *const libc::c_char),
                                     pdf_new_name(b"XObject\x00" as *const u8
                                                      as
                                                      *const libc::c_char));
                        pdf_add_dict(contents_dict,
                                     pdf_new_name(b"Subtype\x00" as *const u8
                                                      as *const libc::c_char),
                                     pdf_new_name(b"Form\x00" as *const u8 as
                                                      *const libc::c_char));
                        pdf_add_dict(contents_dict,
                                     pdf_new_name(b"FormType\x00" as *const u8
                                                      as *const libc::c_char),
                        ...
                        pdf_add_dict(contents_dict,
                                     pdf_new_name(b"Matrix\x00" as *const u8
                                                      as *const libc::c_char),
                                     matrix);
                        pdf_add_dict(contents_dict,
                                     pdf_new_name(b"Resources\x00" as
                                                      *const u8 as
                                                      *const libc::c_char),
                                     pdf_import_object(resources));
                        pdf_release_obj(resources);
                        pdf_close(pf);
                        pdf_ximage_set_form(ximage,
                                            &mut info as *mut xform_info as
                                                *mut libc::c_void, contents);
                        return 0i32
                    }
                }
            }
...
static mut pdf_operators: [operator; 39] =
    [{
         let mut init =
             operator{token: b"SCN\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_SETCOLOR as libc::c_int,};
         init
     },
     {
         let mut init =
             operator{token: b"b*\x00" as *const u8 as *const libc::c_char,
     ...
     {
         let mut init =
             operator{token: b"cm\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_CONCATMATRIX as libc::c_int,};
         init
     },
     {
         let mut init =
             operator{token: b"CS\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_SETCOLORSPACE as libc::c_int,};
         init
     },
     {
         let mut init =
             operator{token: b"f*\x00" as *const u8 as *const libc::c_char,
                      opcode: 0i32,};
         init
     },
     {
         let mut init =
             operator{token: b"gs\x00" as *const u8 as *const libc::c_char,
                      opcode: -1i32,};
         init
     },
     {
         let mut init =
             operator{token: b"re\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_RECTANGLE as libc::c_int,};
         init
     },
     {
         let mut init =
             operator{token: b"rg\x00" as *const u8 as *const libc::c_char,
                      opcode: -3i32,};
         init
     },
     {
     ...
     {
         let mut init =
             operator{token: b"sc\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_SETCOLOR as libc::c_int,};
         init
     },
     {
     ...
     {
         let mut init =
             operator{token: b"W*\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_CLIP as libc::c_int,};
         init
     },
     {
     ...
     {
         let mut init =
             operator{token: b"c\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_CURVETO as libc::c_int,};
         init
     },
     {
         let mut init =
             operator{token: b"d\x00" as *const u8 as *const libc::c_char,
                      opcode: -2i32,};
         init
     },
     {
     ...
     {
         let mut init =
             operator{token: b"g\x00" as *const u8 as *const libc::c_char,
                      opcode: -1i32,};
         init
     },
     {
     ...
     {
         let mut init =
             operator{token: b"h\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_CLOSEPATH as libc::c_int,};
         init
     },
     {
         let mut init =
             operator{token: b"i\x00" as *const u8 as *const libc::c_char,
                      opcode: -1i32,};
         init
     },
     {
         let mut init =
             operator{token: b"j\x00" as *const u8 as *const libc::c_char,
                      opcode: -1i32,};
         init
     },
     {
     ...
     {
         let mut init =
             operator{token: b"k\x00" as *const u8 as *const libc::c_char,
                      opcode: -4i32,};
         init
     },
     {
     ...
     {
         let mut init =
             operator{token: b"l\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_LINETO as libc::c_int,};
         init
     },
     {
         let mut init =
             operator{token: b"m\x00" as *const u8 as *const libc::c_char,
     ...
     {
         let mut init =
             operator{token: b"n\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_NOOP as libc::c_int,};
         init
     },
     {
         let mut init =
             operator{token: b"q\x00" as *const u8 as *const libc::c_char,
     ...
     {
         let mut init =
             operator{token: b"s\x00" as *const u8 as *const libc::c_char,
                      opcode: OP_CLOSEandCLIP as libc::c_int,};
         init
     },
     {
     ...
     {
         let mut init =
             operator{token: b"v\x00" as *const u8 as *const libc::c_char,
     ...
     {
         let mut init =
             operator{token: b"y\x00" as *const u8 as *const libc::c_char,
...
*/
#[no_mangle]
pub unsafe extern "C" fn pdf_copy_clip(mut image_file: *mut FILE,
                                       mut pageNo: libc::c_int,
                                       mut x_user: libc::c_double,
                                       mut y_user: libc::c_double)
 -> libc::c_int {
    let mut page_tree: *mut pdf_obj =
        0 as *mut pdf_obj; /* silence uninitialized warning */
    let mut contents: *mut pdf_obj = 0 as *mut pdf_obj;
    ...
    let mut pf: *mut pdf_file = 0 as *mut pdf_file;
    pf =
        pdf_open(0 as *const libc::c_char, image_file as rust_input_handle_t);
    if pf.is_null() { return -1i32 }
    ...
    M.f += y_user;
    page_tree =
        pdf_get_page_obj(pf, pageNo, 0 as *mut *mut pdf_obj,
                         0 as *mut *mut pdf_obj);
    if page_tree.is_null() { pdf_close(pf); return -1i32 }
    contents = pdf_get_page_content(page_tree);
    pdf_release_obj(page_tree);
    if contents.is_null() { pdf_close(pf); return -1i32 }
    pdf_doc_add_page_content(b" \x00" as *const u8 as *const libc::c_char,
                             1i32 as libc::c_uint);
    save_path =
        xmalloc((pdf_stream_length(contents) + 1i32) as size_t) as
            *mut libc::c_char;
    strncpy(save_path, pdf_stream_dataptr(contents) as *const libc::c_char,
    ...
    while clip_path < end_path {
        ...
        if clip_path == end_path { break ; }
        if depth > 1i32 {
            if *clip_path as libc::c_int == 'q' as i32 { depth += 1 }
            if *clip_path as libc::c_int == 'Q' as i32 { depth -= 1 }
            parse_ident(&mut clip_path, end_path);
        } else if *clip_path as libc::c_int == '-' as i32 ||
                      *clip_path as libc::c_int == '+' as i32 ||
                      *clip_path as libc::c_int == '.' as i32 ||
                      *(*__ctype_b_loc()).offset(*clip_path as libc::c_uchar
            ...
            if strncmp(b"/DeviceGray\x00" as *const u8 as *const libc::c_char,
                       clip_path, 11i32 as libc::c_ulong) == 0i32 ||
                   strncmp(b"/Indexed\x00" as *const u8 as
                               *const libc::c_char, clip_path,
                           8i32 as libc::c_ulong) == 0i32 ||
                   strncmp(b"/CalGray\x00" as *const u8 as
                               *const libc::c_char, clip_path,
                           8i32 as libc::c_ulong) == 0i32 {
                color_dimen = 1i32
            } else if strncmp(b"/DeviceRGB\x00" as *const u8 as
                                  *const libc::c_char, clip_path,
                              10i32 as libc::c_ulong) == 0i32 ||
                          strncmp(b"/CalRGB\x00" as *const u8 as
                                      *const libc::c_char, clip_path,
                                  7i32 as libc::c_ulong) == 0i32 ||
                          strncmp(b"/Lab\x00" as *const u8 as
                                      *const libc::c_char, clip_path,
                                  4i32 as libc::c_ulong) == 0i32 {
                color_dimen = 3i32
            } else if strncmp(b"/DeviceCMYK\x00" as *const u8 as
                                  *const libc::c_char, clip_path,
                              11i32 as libc::c_ulong) == 0i32 {
                color_dimen = 4i32
            } else {
            ...
            while (j as libc::c_ulong) <
                      (::std::mem::size_of::<[operator; 39]>() as
                           libc::c_ulong).wrapping_div(::std::mem::size_of::<operator>()
                                                           as libc::c_ulong) {
            ...
            match pdf_operators[j as usize].opcode {
                ...
                3 => { current_block_157 = 17294711039657812359; }
                4 => {
                    if top < 5i32 { return -1i32 }
                    let fresh0 = top;
                    top = top - 1;
                ...
                5 => { current_block_157 = 6328367678128271922; }
                6 => {
                    if top < 3i32 { return -1i32 }
                    let fresh6 = top;
                    top = top - 1;
                    ...
                    if M.b == 0i32 as libc::c_double &&
                           M.c == 0i32 as libc::c_double {
                ...
                11 => {
                    pdf_doc_add_page_content(b" n\x00" as *const u8 as
                                                 *const libc::c_char,
                                             2i32 as libc::c_uint);
                    current_block_157 = 6328367678128271922;
                }
                12 => { depth += 1; current_block_157 = 6328367678128271922; }
                13 => { depth -= 1; current_block_157 = 6328367678128271922; }
                14 => {
                    if top < 3i32 { return -1i32 }
                    let fresh20 = top;
                    top = top - 1;
