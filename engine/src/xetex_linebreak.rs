...
extern "C" {
    ...
    #[no_mangle]
    fn measure_native_node(node: *mut libc::c_void,
    ...
    #[no_mangle]
    fn new_ligature(f: internal_font_number, c: uint16_t, q: int32_t)
     -> int32_t;
    #[no_mangle]
    ...
    #[no_mangle]
    fn new_margin_kern(w: scaled_t, p: int32_t, side: small_number)
     -> int32_t;
    #[no_mangle]
    ...
    #[no_mangle]
    fn fract(x: int32_t, n: int32_t, d: int32_t, max_answer: int32_t)
     -> int32_t;
    #[no_mangle]
...
#[inline]
unsafe extern "C" fn get_native_usv(mut p: int32_t, mut i: int32_t)
 -> UnicodeScalar {
    let mut c: libc::c_ushort =
        *(&mut *mem.offset((p + 6i32) as isize) as *mut memory_word as
              *mut libc::c_ushort).offset(i as isize);
    if c as libc::c_int >= 0xd800i32 && (c as libc::c_int) < 0xdc00i32 {
        return 0x10000i32 + (c as libc::c_int - 0xd800i32) * 0x400i32 +
                   *(&mut *mem.offset((p + 6i32) as isize) as *mut memory_word
                         as *mut libc::c_ushort).offset((i + 1i32) as isize)
                       as libc::c_int - 0xdc00i32
    }
...
pub unsafe extern "C" fn line_break(mut d: bool) {
    let mut current_block:
            u64; /* "this is for over/underfull box messages" */
    ...
    } else if (*mem.offset(cur_list.tail as isize)).b16.s1 as libc::c_int !=
                  10i32 {
        let ref mut fresh1 = (*mem.offset(cur_list.tail as isize)).b32.s1;
        *fresh1 = new_penalty(10000i32);
        cur_list.tail = *fresh1
    } else {
        (*mem.offset(cur_list.tail as isize)).b16.s1 = 12i32 as uint16_t;
        delete_glue_ref((*mem.offset((cur_list.tail + 1i32) as
                                         isize)).b32.s0);
        flush_node_list((*mem.offset((cur_list.tail + 1i32) as
                                         isize)).b32.s1);
    ...
    *fresh2 = new_param_glue(14i32 as small_number);
    ...
    init_cur_lang =
        (cur_list.prev_graf as libc::c_long % 65536i64) as libc::c_uchar;
    init_l_hyf = cur_list.prev_graf / 0x400000i32;
    init_r_hyf =
        (cur_list.prev_graf as libc::c_long / 65536i64 %
             64i32 as libc::c_long) as int32_t;
    pop_nest();
    no_shrink_error_yet = 1i32 != 0;
    if (*mem.offset((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                       (0x10ffffi32 + 1i32) + 1i32 + 15000i32
                                       + 12i32 + 9000i32 + 1i32 + 1i32 + 7i32)
                                      as isize)).b32.s1 as isize)).b16.s0 as
           libc::c_int != 0i32 &&
           (*mem.offset(((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                            (0x10ffffi32 + 1i32) + 1i32 +
                                            15000i32 + 12i32 + 9000i32 + 1i32
                                            + 1i32 + 7i32) as isize)).b32.s1 +
                             3i32) as isize)).b32.s1 != 0i32 {
        (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                           1i32 + 15000i32 + 12i32 + 9000i32 + 1i32 + 1i32 +
                           7i32) as isize)).b32.s1 =
            finite_shrink((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                             (0x10ffffi32 + 1i32) + 1i32 +
                                             15000i32 + 12i32 + 9000i32 + 1i32
                                             + 1i32 + 7i32) as isize)).b32.s1)
    }
    if (*mem.offset((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                       (0x10ffffi32 + 1i32) + 1i32 + 15000i32
                                       + 12i32 + 9000i32 + 1i32 + 1i32 + 8i32)
                                      as isize)).b32.s1 as isize)).b16.s0 as
           libc::c_int != 0i32 &&
           (*mem.offset(((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                            (0x10ffffi32 + 1i32) + 1i32 +
                                            15000i32 + 12i32 + 9000i32 + 1i32
                                            + 1i32 + 8i32) as isize)).b32.s1 +
                             3i32) as isize)).b32.s1 != 0i32 {
        (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                           1i32 + 15000i32 + 12i32 + 9000i32 + 1i32 + 1i32 +
                           8i32) as isize)).b32.s1 =
            finite_shrink((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                             (0x10ffffi32 + 1i32) + 1i32 +
                                             15000i32 + 12i32 + 9000i32 + 1i32
                                             + 1i32 + 8i32) as isize)).b32.s1)
    ...
    background[4] = 0i32;
    background[5] = 0i32;
    background[(2i32 + (*mem.offset(q as isize)).b16.s1 as libc::c_int) as
                   usize] = (*mem.offset((q + 2i32) as isize)).b32.s1;
    background[(2i32 + (*mem.offset(r as isize)).b16.s1 as libc::c_int) as
                   usize] += (*mem.offset((r + 2i32) as isize)).b32.s1;
    background[6] =
    ...
    if (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                          ...
                          (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                          (0x10ffffi32 + 1i32) + 64i32) as isize)).b32.s1 >
           0i32 {
        ...
        if (*mem.offset((q + 2i32) as isize)).b32.s1 > 0i32 &&
            ...
            if background[3] == 0i32 && background[4] == 0i32 &&
                   background[5] == 0i32 {
                ...
                fill_width[1] = 0i32;
                fill_width[2] = 0i32;
                fill_width[((*mem.offset(q as isize)).b16.s1 as libc::c_int -
                                1i32) as usize] =
    ...
    if (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                          1i32 + 15000i32 + 12i32 + 9000i32 + 1i32 + 1i32 +
                          19i32 + 256i32 + 256i32 + 0i32) as isize)).b32.s1 ==
           -0xfffffffi32 {
        if (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                              1i32 + 15000i32 + 12i32 + 9000i32 + 1i32 + 1i32
                              ...
                              (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                              (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                              85i32 + 256i32 + (0x10ffffi32 + 1i32) + 17i32)
        ...
        second_width =
            (*mem.offset(((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                             ...
                                             15000i32 + 12i32 + 9000i32 + 1i32
                                             + 1i32 + 19i32 + 256i32 + 256i32
                                             + 0i32) as isize)).b32.s1 +
                              2i32 * (last_special_line + 1i32)) as
                             isize)).b32.s1; /*:877*/
        second_indent =
            (*mem.offset(((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                             (0x10ffffi32 + 1i32) + 1i32 +
    ...
    if (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                          ...
                          + (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                          (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                          (0x10ffffi32 + 1i32) + 19i32) as isize)).b32.s1 ==
           0i32 {
        easy_line = last_special_line
    } else { easy_line = 0x3fffffffi32 }
    ...
    if threshold >= 0i32 {
        ...
        final_pass =
            (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32)
                               ...
                               (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                               (0x10ffffi32 + 1i32) + (0x10ffffi32 + 1i32) +
                               85i32 + 256i32 + (0x10ffffi32 + 1i32) + 20i32)
                              as isize)).b32.s1 <= 0i32
    }
    loop  {
        if threshold > 10000i32 { threshold = 10000i32 }
        if second_pass {
            /*920:*/
            if trie_not_ready {
                init_trie(); /*893:*/
            ...
            l_hyf = init_l_hyf;
            r_hyf = init_r_hyf;
            if *trie_trc.offset((hyph_start + cur_lang as libc::c_int) as
                                    isize) as libc::c_int !=
                   cur_lang as libc::c_int {
                hyph_index = 0i32
            } else {
                hyph_index =
                    *trie_trl.offset((hyph_start + cur_lang as libc::c_int) as
                                         isize)
            }
        }
        q = get_node(active_node_size as int32_t);
        (*mem.offset(q as isize)).b16.s1 = 0i32 as uint16_t;
        (*mem.offset(q as isize)).b16.s0 = 2i32 as uint16_t;
        ...
        while cur_p != -0xfffffffi32 &&
            ...
            if is_char_node(cur_p) {
                ...
                loop  {
                    ...
                    f =
                        (*mem.offset(cur_p as isize)).b16.s1 as
                            internal_font_number;
                    eff_char =
                        effective_char(1i32 != 0, f,
                                       (*mem.offset(cur_p as isize)).b16.s0);
                    active_width[1] +=
            ...
            match (*mem.offset(cur_p as isize)).b16.s1 as libc::c_int {
                ...
                8 => {
                    if (*mem.offset(cur_p as isize)).b16.s0 as libc::c_int ==
                           4i32 {
                        cur_lang =
                            (*mem.offset((cur_p + 1i32) as isize)).b32.s1 as
                                libc::c_uchar;
                        l_hyf =
                            (*mem.offset((cur_p + 1i32) as isize)).b16.s1 as
                                int32_t;
                        r_hyf =
                            (*mem.offset((cur_p + 1i32) as isize)).b16.s0 as
                                int32_t;
                        if *trie_trc.offset((hyph_start +
                                                 cur_lang as libc::c_int) as
                                                isize) as libc::c_int !=
                               cur_lang as libc::c_int {
                            hyph_index = 0i32
                        } else {
                            hyph_index =
                                *trie_trl.offset((hyph_start +
                                                      cur_lang as libc::c_int)
                                                     as isize)
                        }
                    } else if (*mem.offset(cur_p as isize)).b16.s0 as
                                  libc::c_int == 40i32 ||
                                  (*mem.offset(cur_p as isize)).b16.s0 as
                                      libc::c_int == 41i32 ||
                                  (*mem.offset(cur_p as isize)).b16.s0 as
                                      libc::c_int == 42i32 ||
                                  (*mem.offset(cur_p as isize)).b16.s0 as
                ...
                10 => {
                    if auto_breaking {
                        if is_char_node(prev_p) {
                            ...
                            try_break(0i32, 0i32 as small_number);
                        } else if (*mem.offset(prev_p as isize)).b16.s1 as
                                      libc::c_int == 11i32 &&
                                      (*mem.offset(prev_p as isize)).b16.s0 as
                                          libc::c_int != 1i32 {
                            try_break(0i32, 0i32 as small_number);
                        }
                    }
                    ...
                    if (*mem.offset(q as isize)).b16.s0 as libc::c_int != 0i32
                        ...
                        let ref mut fresh3 =
                            (*mem.offset((cur_p + 1i32) as isize)).b32.s0;
                    ...
                    /*:895*/
                    active_width[6] +=
                        (*mem.offset((q + 3i32) as isize)).b32.s1; /*:897*/
                    if second_pass as libc::c_int != 0 &&
                        ...
                        if s != -0xfffffffi32 {
                                    ...
                                    if is_char_node(s) {
                                        c =
                                            (*mem.offset(s as isize)).b16.s0
                                                as UnicodeScalar; /*:930*/
                                        hf =
                                            (*mem.offset(s as isize)).b16.s1
                                                as internal_font_number;
                                        current_block = 11202235766349324107;
                                    } else if (*mem.offset(s as isize)).b16.s1
                                                  as libc::c_int == 6i32 {
                                        if (*mem.offset((s + 1i32) as
                                                            isize)).b32.s1 ==
                                               -0xfffffffi32 {
                                            current_block =
                                                13855806088735179493;
                                        } else {
                                            q =
                                                (*mem.offset((s + 1i32) as
                                                                 isize)).b32.s1;
                                            c =
                                                (*mem.offset(q as
                                                                 isize)).b16.s0
                                        ...
                                        if (*mem.offset(s as isize)).b16.s0 as
                                               libc::c_int == 40i32 ||
                                               (*mem.offset(s as
                                                                isize)).b16.s0
                                                   as libc::c_int == 41i32 {
                                            ...
                                            if hyph_index == 0i32 ||
                                                ...
                                                hc[0] =
                                                    (*eqtb.offset((1i32 +
                                                                       ...
                                                                       + c) as
                                                                      isize)).b32.s1
                                            } else if *trie_trc.offset((hyph_index
                                                                            +
                                                                            c)
                                                                           as
                                                                           isize)
                            ...
                            match current_block {
                                ...
                                _ => {
                                    hyf_char =
                                        *hyphen_char.offset(hf as isize);
                                    if !(hyf_char < 0i32) {
                ...
                11 => {
                    ...
                    if (*mem.offset(cur_p as isize)).b16.s0 as libc::c_int ==
                           1i32 {
                        if (!is_char_node((*mem.offset(cur_p as
                                                           isize)).b32.s1) as
                                libc::c_int) < hi_mem_min &&
                               auto_breaking as libc::c_int != 0 {
                            if (*mem.offset((*mem.offset(cur_p as
                                                             isize)).b32.s1 as
                ...
                7 => {
                    ...
                    disc_width = 0i32;
                    if s == -0xfffffffi32 {
                        try_break((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                                     (0x10ffffi32 + 1i32) +
                                                     1i32 + 15000i32 + 12i32 +
                                                     9000i32 + 1i32 + 1i32 +
                                                     19i32 + 256i32 + 256i32 +
                                                     ...
                                                     (0x10ffffi32 + 1i32) +
                                                     (0x10ffffi32 + 1i32) +
                                                     4i32) as isize)).b32.s1,
                                  1i32 as small_number);
                    } else {
                        loop  {
                            /*899:*/
                            if is_char_node(s) {
                                let mut eff_char_0: int32_t =
                                    0; /*:898 big DISC_NODE case */
                                f =
                                    (*mem.offset(s as isize)).b16.s1 as
                                        internal_font_number;
                                eff_char_0 =
                                    effective_char(1i32 != 0, f,
                                                   (*mem.offset(s as
                                ...
                                match (*mem.offset(s as isize)).b16.s1 as
                                          libc::c_int {
                                    6 => {
                                    ...
                                    8 => {
                                        if (*mem.offset(s as isize)).b16.s0 as
                                            ...
                                            confusion(b"disc3a\x00" as
                                                          *const u8 as
                                                          *const libc::c_char);
                                        }
                                    }
                                    _ => {
                                        confusion(b"disc3\x00" as *const u8 as
                                                      *const libc::c_char);
                                    }
                                }
                            }
                            s = (*mem.offset(s as isize)).b32.s1;
                            if !(s != -0xfffffffi32) { break ; }
                        }
                        ...
                        if is_char_node(s) {
                            ...
                            match (*mem.offset(s as isize)).b16.s1 as
                                ...
                                8 => {
                                    if (*mem.offset(s as isize)).b16.s0 as
                                           libc::c_int == 40i32 ||
                                           (*mem.offset(s as isize)).b16.s0 as
                                               libc::c_int == 41i32 ||
                                           (*mem.offset(s as isize)).b16.s0 as
                                               libc::c_int == 42i32 ||
                                           (*mem.offset(s as isize)).b16.s0 as
                                        ...
                                        confusion(b"disc4a\x00" as *const u8
                                                      as *const libc::c_char);
                                    }
                                }
                                _ => {
                                    confusion(b"disc4\x00" as *const u8 as
                                                  *const libc::c_char);
                                }
                            }
                        }
                ...
                9 => {
                    ...
                    if !is_char_node((*mem.offset(cur_p as isize)).b32.s1) &&
                           auto_breaking as libc::c_int != 0 {
                        if (*mem.offset((*mem.offset(cur_p as isize)).b32.s1
                                            as isize)).b16.s1 as libc::c_int
                               == 10i32 {
                            try_break(0i32, 0i32 as small_number);
                        }
                    }
                ...
                12 => {
                    try_break((*mem.offset((cur_p + 1i32) as isize)).b32.s1,
                              0i32 as small_number);
                }
                4 | 3 | 5 => { }
                _ => {
                    confusion(b"paragraph\x00" as *const u8 as
                                  *const libc::c_char);
                }
            }
            global_prev_p = cur_p;
        ...
        if cur_p == -0xfffffffi32 {
            ...
            if (*mem.offset((4999999i32 - 7i32) as isize)).b32.s1 !=
                   4999999i32 - 7i32 {
                /*:902*/
                /*903:*/
                r =
                    (*mem.offset((4999999i32 - 7i32) as
                                     isize)).b32.s1; /*:903*/
                fewest_demerits = 0x3fffffffi32; /*904:*/
                loop  {
                    if (*mem.offset(r as isize)).b16.s1 as libc::c_int != 2i32
                       {
                        if (*mem.offset((r + 2i32) as isize)).b32.s1 <
                               fewest_demerits {
                            fewest_demerits =
                                (*mem.offset((r + 2i32) as
                                                 isize)).b32.s1; /*:904*/
                            best_bet = r
                        }
                    }
                    r = (*mem.offset(r as isize)).b32.s1;
                    if !(r != 4999999i32 - 7i32) { break ; }
                }
        ...
        while q != 4999999i32 - 7i32 {
            ...
            if (*mem.offset(q as isize)).b16.s1 as libc::c_int == 2i32 {
                free_node(q, 7i32);
            } else { free_node(q, active_node_size as int32_t); }
            q = cur_p
        }
        q = passive;
    ...
    if do_last_line_fit {
        ...
        if (*mem.offset((best_bet + 3i32) as isize)).b32.s1 == 0i32 {
            ...
            q =
                new_spec((*mem.offset((last_line_fill + 1i32) as
                                          isize)).b32.s0);
            delete_glue_ref((*mem.offset((last_line_fill + 1i32) as
                                             isize)).b32.s0);
            let ref mut fresh4 = (*mem.offset((q + 1i32) as isize)).b32.s1;
            *fresh4 +=
                (*mem.offset((best_bet + 3i32) as isize)).b32.s1 -
        ...
        if q == -0xfffffffi32 {
            ...
            (*mem.offset((q + 1i32) as isize)).b32.s0 =
                (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                  ...
                                  isize)).b32.s1;
            (*mem.offset(q as isize)).b16.s0 = (8i32 + 1i32) as uint16_t;
            let ref mut fresh5 =
                (*mem.offset((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                                (0x10ffffi32 + 1i32) + 1i32 +
                                                15000i32 + 12i32 + 9000i32 +
...
unsafe extern "C" fn try_break(mut pi: int32_t,
                               mut break_type: small_number) {
    ...
    if semantic_pagination_enabled as libc::c_int != 0 &&
           cur_p != -0xfffffffi32 {
        return
    }
    if abs(pi) >= 10000i32 { if pi > 0i32 { return } pi = -10000i32 }
    no_break_yet = 1i32 != 0;
    ...
    loop  {
         ...
         * last_active, otherwise compute the new line_width." */
            ...
            if l > old_l {
                 ...
                 * just found." */
                            ...
                            if cur_p != -0xfffffffi32 {
                                ...
                                while t > 0i32 {
                                    ...
                                    if is_char_node(v) {
                                        ...
                                        match (*mem.offset(v as isize)).b16.s1
                                                  as libc::c_int {
                                            6 => {
                                                let mut eff_char_0: int32_t =
                                                    0;
                                                f =
                                                    (*mem.offset((v + 1i32) as
                                                                     isize)).b16.s1
                                                        as
                                                        internal_font_number;
                                            ...
                                            8 => {
                                                if (*mem.offset(v as
                                                    ...
                                                    confusion(b"disc1a\x00" as
                                                                  *const u8 as
                                                                  *const libc::c_char);
                                                }
                                            }
                                            _ => {
                                                confusion(b"disc1\x00" as
                                                              *const u8 as
                                                              *const libc::c_char);
                                            }
                                        }
                                        ...
                                        match (*mem.offset(s as isize)).b16.s1
                                            ...
                                            8 => {
                                                if (*mem.offset(s as
                                                    ...
                                                    confusion(b"disc2a\x00" as
                                                                  *const u8 as
                                                                  *const libc::c_char);
                                                }
                                            }
                                            _ => {
                                                confusion(b"disc2\x00" as
                                                              *const u8 as
                                                              *const libc::c_char);
                                            }
                                        }
                                ...
                                10 => {
                                    ...
                                    break_width[(2i32 +
                                                     (*mem.offset(v as
                                                         ...
                                                         as libc::c_int) as
                                                    usize] -=
                                        (*mem.offset((v + 2i32) as
                                                         isize)).b32.s1;
                                    break_width[6] -=
                                        (*mem.offset((v + 3i32) as
                                                         isize)).b32.s1
                                }
                                12 => { }
                                9 => {
                    ...
                    if (*mem.offset(prev_r as isize)).b16.s1 as libc::c_int ==
                           2i32 {
                        let ref mut fresh6 =
                            (*mem.offset((prev_r + 1i32) as
                                             isize)).b32.s1; /* this is unused */
                        *fresh6 += -cur_active_width[1] + break_width[1];
                        let ref mut fresh7 =
                            (*mem.offset((prev_r + 2i32) as isize)).b32.s1;
                        *fresh7 += -cur_active_width[2] + break_width[2];
                        let ref mut fresh8 =
                            (*mem.offset((prev_r + 3i32) as isize)).b32.s1;
                        *fresh8 += -cur_active_width[3] + break_width[3];
                        let ref mut fresh9 =
                            (*mem.offset((prev_r + 4i32) as isize)).b32.s1;
                        *fresh9 += -cur_active_width[4] + break_width[4];
                        let ref mut fresh10 =
                            (*mem.offset((prev_r + 5i32) as isize)).b32.s1;
                        *fresh10 += -cur_active_width[5] + break_width[5];
                        let ref mut fresh11 =
                            (*mem.offset((prev_r + 6i32) as isize)).b32.s1;
                        *fresh11 += -cur_active_width[6] + break_width[6]
                        ...
                        q = get_node(7i32);
                        (*mem.offset(q as isize)).b32.s1 = r;
                        (*mem.offset(q as isize)).b16.s1 = 2i32 as uint16_t;
                        (*mem.offset(q as isize)).b16.s0 = 0i32 as uint16_t;
                        (*mem.offset((q + 1i32) as isize)).b32.s1 =
                    ...
                    /* ... resuming 865 ... */
                    if abs((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                              (0x10ffffi32 + 1i32) + 1i32 +
                                              15000i32 + 12i32 + 9000i32 +
                                              1i32 + 1i32 + 19i32 + 256i32 +
                                              256i32 + 13i32 + 256i32 + 4i32 +
                    ...
                    while fit_class as libc::c_int <= 3i32 {
                        if minimal_demerits[fit_class as usize] <=
                               minimum_demerits {
                            ...
                            (*mem.offset(q as isize)).b16.s0 =
                                fit_class as uint16_t;
                            (*mem.offset(q as isize)).b16.s1 =
                                break_type as uint16_t;
                            (*mem.offset((q + 2i32) as isize)).b32.s1 =
         ...
         */
             ...
             * and compute the corresponding fit_class" */
                if cur_active_width[3] != 0i32 || cur_active_width[4] != 0i32
                       || cur_active_width[5] != 0i32 {
                    if do_last_line_fit {
                        if cur_p == -0xfffffffi32 {
                            /*1634: "Perform computations for the last line and goto found" */
                            if (*mem.offset((r + 3i32) as isize)).b32.s1 ==
                                   0i32 ||
                        ...
                        } else { current_block = 5565703735569783978; }
                        match current_block {
                            11849408527845460430 => { }
                            _ => {
                                shortfall = 0i32;
                    ...
                    } else { current_block = 16988252441985098516; }
                    match current_block {
                        11849408527845460430 => { }
                        _ => {
                            b = 0i32;
                    ...
                    if shortfall as libc::c_long > 7230584i64 {
                        ...
                        } else { current_block_230 = 15455430299222214173; }
                    } else { current_block_230 = 15455430299222214173; }
                    match current_block_230 {
                        15455430299222214173 => {
                            ...
                            if b > 12i32 {
                                if b > 99i32 {
                                    fit_class = 0i32 as libc::c_uchar
                                } else { fit_class = 1i32 as libc::c_uchar }
                            } else { fit_class = 2i32 as libc::c_uchar }
                        }
                        _ => { }
                    }
                    current_block = 8633396468472091231;
            ...
            * and compute the corresponding fit_class" */
            ...
            match current_block {
                8633396468472091231 => {
                    if do_last_line_fit {
                        ...
                        if cur_p == -0xfffffffi32 { shortfall = 0i32 }
                        if shortfall > 0i32 {
                            g = cur_active_width[2]
             ...
             * there is a reason to consider lines of text from r to cur_p" */
                ...
                } else { current_block = 8298116646536739282; }
                match current_block {
                    4955522990288899513 => { }
                    _ => {
                    ...
                    if artificial_demerits {
                        ...
                        d =
                            (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                               ...
                                               (0x10ffffi32 + 1i32) +
                                               (0x10ffffi32 + 1i32) +
                                               (0x10ffffi32 + 1i32) + 2i32) as
                                              isize)).b32.s1 +
                                b; /* algorithmic constant */
                        if abs(d) >= 10000i32 {
                        ...
                        if pi != 0i32 {
                            if pi > 0i32 {
                                d = d + pi * pi
                            } else if pi > -10000i32 { d = d - pi * pi }
                        }
                        if break_type as libc::c_int == 1i32 &&
                               (*mem.offset(r as isize)).b16.s1 as libc::c_int
                                   == 1i32 {
                            if cur_p != -0xfffffffi32 {
                                d =
                                    d +
                        ...
                        if abs(fit_class as libc::c_int -
                                   (*mem.offset(r as isize)).b16.s0 as
                                       libc::c_int) > 1i32 {
                            d =
                                d +
                                    (*eqtb.offset((1i32 + (0x10ffffi32 + 1i32)
            ...
            (*mem.offset(prev_r as isize)).b32.s1 =
                (*mem.offset(r as isize)).b32.s1;
            ...
            if prev_r == 4999999i32 - 7i32 {
                ...
                if (*mem.offset(r as isize)).b16.s1 as libc::c_int == 2i32 {
                    ...
                    active_width[6] +=
                        (*mem.offset((r + 6i32) as isize)).b32.s1;
                    cur_active_width[1] = active_width[1];
                    cur_active_width[2] = active_width[2];
                    cur_active_width[3] = active_width[3];
                    cur_active_width[4] = active_width[4];
            ...
            } else if (*mem.offset(prev_r as isize)).b16.s1 as libc::c_int ==
                          2i32 {
                r = (*mem.offset(prev_r as isize)).b32.s1;
                if r == 4999999i32 - 7i32 {
                    cur_active_width[1] -=
                        (*mem.offset((prev_r + 1i32) as isize)).b32.s1;
                    cur_active_width[2] -=
                        (*mem.offset((prev_r + 2i32) as isize)).b32.s1;
                    cur_active_width[3] -=
                        (*mem.offset((prev_r + 3i32) as isize)).b32.s1;
                    ...
                    cur_active_width[6] -=
                        (*mem.offset((prev_r + 6i32) as isize)).b32.s1;
                    (*mem.offset(prev_prev_r as isize)).b32.s1 =
                        4999999i32 - 7i32;
                    free_node(prev_r, 7i32);
                    prev_r = prev_prev_r
                } else if (*mem.offset(r as isize)).b16.s1 as libc::c_int ==
                              2i32 {
                    cur_active_width[1] +=
                        (*mem.offset((r + 1i32) as isize)).b32.s1;
                    cur_active_width[2] +=
...
unsafe extern "C" fn hyphenate() {
    ...
    if j as libc::c_int <= for_end {
        loop  {
            ...
            let fresh18 = j;
            j = j + 1;
            if !((fresh18 as libc::c_int) < for_end) { break ; }
        }
    }
    ...
    if j as libc::c_int <= for_end_0 {
        loop  {
            h =
                ((h as libc::c_int + h as libc::c_int + hc[j as usize]) %
                     607i32) as hyph_pointer;
            let fresh19 = j;
            j = j + 1;
            if !((fresh19 as libc::c_int) < for_end_0) { break ; }
        }
    }
    loop  {
        k = *hyph_word.offset(h as isize);
        if k == 0i32 { current_block = 10027897684796195291; break ; }
        if length(k) == hn as libc::c_int {
            ...
            match current_block {
                ...
                _ => {
                    ...
                    while s != -0xfffffffi32 {
                        hyf[(*mem.offset(s as isize)).b32.s0 as usize] =
    ...
    match current_block {
        10027897684796195291 => {
            hn -= 1;
            if *trie_trc.offset((cur_lang as libc::c_int + 1i32) as isize) as
                   libc::c_int != cur_lang as libc::c_int {
                return
            }
            hc[0] = 0i32;
            ...
            if j as libc::c_int <= for_end_1 {
                loop  {
                    z =
                        *trie_trl.offset((cur_lang as libc::c_int + 1i32) as
                                             isize) + hc[j as usize];
                    l = j;
                    while hc[l as usize] ==
                              *trie_trc.offset(z as isize) as libc::c_int {
                    ...
                    let fresh20 = j;
                    j = j + 1;
                    if !((fresh20 as libc::c_int) < for_end_1) { break ; }
                }
            }
        }
        _ => { }
    ...
    if j as libc::c_int <= for_end_2 {
        loop  {
            ...
            let fresh21 = j;
            j = j + 1;
            if !((fresh21 as libc::c_int) < for_end_2) { break ; }
        }
    }
    ...
    if j as libc::c_int <= for_end_3 {
        loop  {
            hyf[(hn as libc::c_int - j as libc::c_int) as usize] =
                0i32 as libc::c_uchar;
            let fresh22 = j;
            j = j + 1;
            if !((fresh22 as libc::c_int) < for_end_3) { break ; }
        }
    }
    ...
    } else { current_block = 8102658916883067714; }
    loop  {
        match current_block {
            8102658916883067714 => { return }
            _ => {
                if hyf[j as usize] as libc::c_int & 1i32 != 0 { break ; }
                let fresh23 = j;
                j = j + 1;
    ...
    if ha != -0xfffffffi32 && !is_char_node(ha) &&
        ...
        if j as libc::c_int <= for_end_5 {
            loop  {
                if hyf[j as usize] as libc::c_int & 1i32 != 0 {
                    ...
                    for_end_6 =
                        j as libc::c_int - hyphen_passed as libc::c_int -
                            1i32;
                    if i as libc::c_int <= for_end_6 {
                        loop  {
                            *(&mut *mem.offset((q + 6i32) as isize) as
                                  *mut memory_word as
                                  *mut libc::c_ushort).offset(i as isize) =
                                *(&mut *mem.offset((ha + 6i32) as isize) as
                                      *mut memory_word as
                                      *mut libc::c_ushort).offset((i as
                                                                       libc::c_int
                                                                       +
                                                                       hyphen_passed
                                                                           as
                    ...
                    measure_native_node(&mut *mem.offset(q as isize) as
                                            *mut memory_word as
                                            *mut libc::c_void,
                                        ((*eqtb.offset((1i32 +
                                                            (0x10ffffi32 +
                    ...
                    q = new_disc();
                    (*mem.offset((q + 1i32) as isize)).b32.s0 =
                        new_native_character(hf, hyf_char);
                    (*mem.offset(s as isize)).b32.s1 = q;
                    s = q;
                    hyphen_passed = j
                }
                let fresh25 = j;
                j = j + 1;
                if !((fresh25 as libc::c_int) < for_end_5) { break ; }
            }
        }
        ...
        if i as libc::c_int <= for_end_7 {
            loop  {
                *(&mut *mem.offset((q + 6i32) as isize) as *mut memory_word as
                      *mut libc::c_ushort).offset(i as isize) =
                    *(&mut *mem.offset((ha + 6i32) as isize) as
                          *mut memory_word as
                          *mut libc::c_ushort).offset((i as libc::c_int +
                                                           hyphen_passed as
                                                               libc::c_int) as
                                                          isize);
                let fresh26 = i;
                i = i + 1;
                if !((fresh26 as libc::c_int) < for_end_7) { break ; }
            }
        }
        measure_native_node(&mut *mem.offset(q as isize) as *mut memory_word
                                as *mut libc::c_void,
                            ((*eqtb.offset((1i32 + (0x10ffffi32 + 1i32) +
                                                (0x10ffffi32 + 1i32) + 1i32 +
                                                15000i32 + 12i32 + 9000i32 +
            ...
            if (*mem.offset((ha + 1i32) as isize)).b16.s1 as libc::c_int != hf
               {
                ...
                init_lig = 1i32 != 0;
                init_lft =
                    (*mem.offset(ha as isize)).b16.s0 as libc::c_int > 1i32;
            ...
            if !is_char_node(r) {
                if (*mem.offset(r as isize)).b16.s1 as libc::c_int == 6i32 {
                    if (*mem.offset(r as isize)).b16.s0 as libc::c_int > 1i32
                       {
                        current_block = 6826215413708131726;
                    } else { current_block = 2415422468722899689; }
                } else { current_block = 2415422468722899689; }
            } else { current_block = 2415422468722899689; }
            match current_block {
                6826215413708131726 => { }
        ...
        loop  {
            l = j;
            j =
                (reconstitute(j, hn, bchar, hyf_char) as libc::c_int + 1i32)
                    as libc::c_short;
            if hyphen_passed as libc::c_int == 0i32 {
                ...
                if hyf[(j as libc::c_int - 1i32) as usize] as libc::c_int &
                       1i32 != 0 {
                    l = j;
            ...
            if hyphen_passed as libc::c_int > 0i32 {
                loop 
                    ...
                    (*mem.offset(r as isize)).b32.s1 =
                        (*mem.offset((4999999i32 - 4i32) as isize)).b32.s1;
                    (*mem.offset(r as isize)).b16.s1 = 7i32 as uint16_t;
                    major_tail = r;
                    r_count = 0i32;
                    while (*mem.offset(major_tail as isize)).b32.s1 >
                              -0xfffffffi32 {
                        major_tail =
                        ...
                        l =
                            (reconstitute(l, i,
                                          *font_bchar.offset(hf as isize),
                                          65536i32) as libc::c_int + 1i32) as
                                libc::c_short;
                        if (*mem.offset((4999999i32 - 4i32) as isize)).b32.s1
                               > -0xfffffffi32 {
                            if minor_tail == -0xfffffffi32 {
                                (*mem.offset((r + 1i32) as isize)).b32.s0 =
                                    (*mem.offset((4999999i32 - 4i32) as
                                                     isize)).b32.s1
                            } else {
                    ...
                    while (l as libc::c_int) < j as libc::c_int {
                        loop  {
                            l =
                                (reconstitute(l, hn, bchar, 65536i32) as
                                     libc::c_int + 1i32) as libc::c_short;
                            if c_loc as libc::c_int > 0i32 {
                                hu[c_loc as usize] = c;
                                c_loc = 0i32 as libc::c_short
                            }
                            if (*mem.offset((4999999i32 - 4i32) as
                                                isize)).b32.s1 > -0xfffffffi32
                               {
                                ...
                                minor_tail =
                                    (*mem.offset((4999999i32 - 4i32) as
                                                     isize)).b32.s1;
                                while (*mem.offset(minor_tail as
                                                       isize)).b32.s1 >
                                          -0xfffffffi32 {
                                    minor_tail =
                                        (*mem.offset(minor_tail as
                                                         isize)).b32.s1
                                }
                            }
                        ...
                        while l as libc::c_int > j as libc::c_int {
                            /*952: */
                            j =
                                (reconstitute(j, hn, bchar, 65536i32) as
                                     libc::c_int + 1i32) as
                                    libc::c_short; /*:944*/
                            (*mem.offset(major_tail as isize)).b32.s1 =
                                (*mem.offset((4999999i32 - 4i32) as
                    ...
                    (*mem.offset((4999999i32 - 4i32) as isize)).b32.s1 =
                        -0xfffffffi32;
                    if !(hyf[(j as libc::c_int - 1i32) as usize] as
                             libc::c_int & 1i32 != 0) {
                        break ;
                    }
                }
            }
            if j as libc::c_int > hn as libc::c_int { break ; }
        }
        (*mem.offset(s as isize)).b32.s1 = q;
...
unsafe extern "C" fn finite_shrink(mut p: int32_t) -> int32_t {
    ...
    if no_shrink_error_yet {
        ...
        print_cstr(b"Infinite glue shrinkage found in a paragraph\x00" as
                       *const u8 as *const libc::c_char);
        help_ptr = 5i32 as libc::c_uchar;
        help_line[4] =
            b"The paragraph just ended includes some glue that has\x00" as
                *const u8 as *const libc::c_char;
        help_line[3] =
            b"infinite shrinkability, e.g., `\\hskip 0pt minus 1fil\'.\x00" as
                *const u8 as *const libc::c_char;
        help_line[2] =
            b"Such glue doesn\'t belong there---it allows a paragraph\x00" as
                *const u8 as *const libc::c_char;
        help_line[1] =
            b"of any length to fit on one line. But it\'s safe to proceed,\x00"
                as *const u8 as *const libc::c_char;
        help_line[0] =
            b"since the offensive shrinkability has been made finite.\x00" as
                *const u8 as *const libc::c_char;
        error();
    }
    q = new_spec(p);
...
unsafe extern "C" fn reconstitute(mut j: small_number, mut n: small_number,
                                  mut bchar: int32_t, mut hchar: int32_t)
 -> small_number {
    let mut current_block: u64;
    let mut p: int32_t = 0;
    let mut t: int32_t = 0;
    ...
    'c_27176:
        loop  {
            if cur_l == 65536i32 {
                ...
                q =
                    (*font_info.offset((*char_base.offset(hf as isize) +
                                            effective_char(1i32 != 0, hf,
                                                           cur_l as uint16_t))
                                           as isize)).b16;
                if q.s1 as libc::c_int % 4i32 != 1i32 {
                    ...
                    k =
                        *lig_kern_base.offset(hf as isize) +
                            q.s0 as libc::c_int;
                    q = (*font_info.offset(k as isize)).b16;
                    if q.s3 as libc::c_int > 128i32 {
                        k =
                            ((*lig_kern_base.offset(hf as isize) +
                                 ...
                                 32768i64 - (256i32 * 128i32) as libc::c_long)
                                as font_index;
                        q = (*font_info.offset(k as isize)).b16
                    }
                    current_block = 1434579379687443766;
                        ...
                        if q.s2 as libc::c_int == test_char {
                            if q.s3 as libc::c_int <= 128i32 {
                                if cur_rh < 65536i32 {
                                    ...
                                    if hchar < 65536i32 {
                                        if hyf[j as usize] as libc::c_int &
                                               1i32 != 0 {
                                            hyphen_passed = j;
                                            hchar = 65536i32
                                        }
                                    ...
                                    if (q.s1 as libc::c_int) < 128i32 {
                                        ...
                                        match q.s1 as libc::c_int {
                                            ...
                                            2 | 6 => {
                                                ...
                                                if lig_stack > -0xfffffffi32 {
                                                    (*mem.offset(lig_stack as
                                                                     isize)).b16.s0
                                                        = cur_r as uint16_t
                                                } else {
                                                    lig_stack =
                                                        new_lig_item(cur_r as
                                                                         uint16_t);
                                                    if j as libc::c_int ==
                                                           n as libc::c_int {
                                                        bchar = 65536i32
                                        ...
                                        if q.s1 as libc::c_int != 7i32 {
                                            break ;
                                        } else { continue 'c_27176 ; }
                                    } else {
                                        w =
                                            (*font_info.offset((*kern_base.offset(hf
                                                                                      as
                                                                                      isize)
                                                                    +
                                                                    256i32 *
            ...
            if ligature_present {
                p =
                    new_ligature(hf, cur_l as uint16_t,
                                 (*mem.offset(cur_q as isize)).b32.s1);
                if lft_hit {
                    (*mem.offset(p as isize)).b16.s0 = 2i32 as uint16_t;
                    lft_hit = 0i32 != 0
                }
                if rt_hit {
                    if lig_stack == -0xfffffffi32 {
            ...
            if !(lig_stack > -0xfffffffi32) { break ; }
            cur_q = t;
            ...
            if (*mem.offset((lig_stack + 1i32) as isize)).b32.s1 >
                ...
                (*mem.offset(t as isize)).b32.s1 =
                    (*mem.offset((lig_stack + 1i32) as isize)).b32.s1;
                t = (*mem.offset(t as isize)).b32.s1;
                j += 1
            }
            p = lig_stack;
...
unsafe extern "C" fn total_pw(mut q: int32_t, mut p: int32_t) -> scaled_t {
    ...
    if (*mem.offset((q + 1i32) as isize)).b32.s1 == -0xfffffffi32 {
        ...
        l =
            (*mem.offset(((*mem.offset((q + 1i32) as isize)).b32.s1 + 1i32) as
                             isize)).b32.s1
    }
    ...
    return char_pw(l, 0i32 as small_number) +
               char_pw(r, 1i32 as small_number);
}
unsafe extern "C" fn find_protchar_left(mut l: int32_t, mut d: bool)
 -> int32_t {
    let mut t: int32_t = 0;
    ...
    loop  {
        ...
        while run as libc::c_int != 0 &&
                  (!is_char_node(l) &&
                       ((*mem.offset(l as isize)).b16.s1 as libc::c_int ==
                            3i32 ||
                            (*mem.offset(l as isize)).b16.s1 as libc::c_int ==
                                4i32 ||
                            (*mem.offset(l as isize)).b16.s1 as libc::c_int ==
                            ...
                            (*mem.offset(l as isize)).b16.s1 as libc::c_int ==
                                7i32 &&
                                (*mem.offset((l + 1i32) as isize)).b32.s0 ==
                                    -0xfffffffi32 &&
                                (*mem.offset((l + 1i32) as isize)).b32.s1 ==
                                    -0xfffffffi32 &&
                                (*mem.offset(l as isize)).b16.s0 as
                                    libc::c_int == 0i32 ||
                            (*mem.offset(l as isize)).b16.s1 as libc::c_int ==
                                9i32 &&
                                (*mem.offset((l + 1i32) as isize)).b32.s1 ==
                            ...
                            (*mem.offset(l as isize)).b16.s1 as libc::c_int ==
                                ...
                                (*mem.offset((l + 1i32) as isize)).b32.s1 ==
                                    0i32 &&
                                (*mem.offset((l + 3i32) as isize)).b32.s1 ==
                                    0i32 &&
                                (*mem.offset((l + 2i32) as isize)).b32.s1 ==
                                    0i32 &&
                                (*mem.offset((l + 5i32) as isize)).b32.s1 ==
                                    -0xfffffffi32)) {
            while (*mem.offset(l as isize)).b32.s1 == -0xfffffffi32 &&
...
unsafe extern "C" fn find_protchar_right(mut l: int32_t, mut r: int32_t)
 -> int32_t {
    let mut t: int32_t = 0;
    let mut run: bool = false;
    if r == -0xfffffffi32 { return -0xfffffffi32 }
    hlist_stack_level = 0i32 as libc::c_short;
    run = 1i32 != 0;
    loop  {
        t = r;
...
unsafe extern "C" fn push_node(mut p: int32_t) {
    if hlist_stack_level as libc::c_int > 512i32 {
        pdf_error(b"push_node\x00" as *const u8 as *const libc::c_char,
                  b"stack overflow\x00" as *const u8 as *const libc::c_char);
    }
    hlist_stack[hlist_stack_level as usize] = p;
    hlist_stack_level =
        (hlist_stack_level as libc::c_int + 1i32) as libc::c_short;
}
unsafe extern "C" fn pop_node() -> int32_t {
    hlist_stack_level =
        (hlist_stack_level as libc::c_int - 1i32) as libc::c_short;
    if (hlist_stack_level as libc::c_int) < 0i32 {
        pdf_error(b"pop_node\x00" as *const u8 as *const libc::c_char,
                  b"stack underflow (internal error)\x00" as *const u8 as
                      *const libc::c_char);
    }
