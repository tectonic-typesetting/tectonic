...
unsafe extern "C" fn lookup_cmap12(mut map: *mut cmap12, mut cccc: SFNT_ULONG) -> u16 {
    let mut gid: u16 = 0i32 as u16;
    let mut i: i32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn tt_cmap_lookup(mut cmap: *mut tt_cmap, mut cc: SFNT_ULONG) -> u16 {
    let mut gid: u16 = 0i32 as u16;
    if !cmap.is_null() {
    } else {
        __assert_fail(
