...
unsafe extern "C" fn p_itoa(mut value: libc::c_int, mut buf: *mut i8) -> libc::c_uint {
...
unsafe extern "C" fn p_dtoa(
    ...
    if i != 0. {
        let mut m: libc::c_int = sprintf(c, b"%.0f\x00" as *const u8 as *const i8, i);
