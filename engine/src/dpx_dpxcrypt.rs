...
unsafe extern "C" fn _gcry_burn_stack(mut bytes: libc::c_int) {
    ...
    bytes =
        (bytes as
             libc::c_ulong).wrapping_sub(::std::mem::size_of::<[libc::c_char; 64]>()
                                             as libc::c_ulong) as libc::c_int
            as libc::c_int;
    if bytes > 0i32 { _gcry_burn_stack(bytes); };
}
...
unsafe extern "C" fn transform(mut ctx: *mut MD5_CONTEXT,
    ...
    memcpy(correct_words.as_mut_ptr() as *mut libc::c_void,
           data as *const libc::c_void,
           (::std::mem::size_of::<uint32_t>() as
                libc::c_ulong).wrapping_mul(16i32 as libc::c_ulong));
   ...
   */
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((D ^
                                             B &
                                                 (C ^
                                                      D)).wrapping_add(*fresh0).wrapping_add(0xd76aa478u32))
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((C ^
                                             A &
                                                 (B ^
                                                      C)).wrapping_add(*fresh1).wrapping_add(0xe8c7b756u32))
            as uint32_t as uint32_t;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((B ^
                                             D &
                                                 (A ^
                                                      B)).wrapping_add(*fresh2).wrapping_add(0x242070dbi32
                                                                                                 as
                                                                                                 libc::c_uint))
            as uint32_t as uint32_t;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((A ^
                                             C &
                                                 (D ^
                                                      A)).wrapping_add(*fresh3).wrapping_add(0xc1bdceeeu32))
            as uint32_t as uint32_t;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((D ^
                                             B &
                                                 (C ^
                                                      D)).wrapping_add(*fresh4).wrapping_add(0xf57c0fafu32))
            as uint32_t as uint32_t;
    A = A << 7i32 | A >> 32i32 - 7i32;
    A = (A as libc::c_uint).wrapping_add(B) as uint32_t as uint32_t;
    let fresh5 = cwp;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((C ^
                                             A &
                                                 (B ^
                                                      C)).wrapping_add(*fresh5).wrapping_add(0x4787c62ai32
                                                                                                 as
                                                                                                 libc::c_uint))
            as uint32_t as uint32_t;
    D = D << 12i32 | D >> 32i32 - 12i32;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((B ^
                                             D &
                                                 (A ^
                                                      B)).wrapping_add(*fresh6).wrapping_add(0xa8304613u32))
            as uint32_t as uint32_t;
    C = C << 17i32 | C >> 32i32 - 17i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    let fresh7 = cwp;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((A ^
                                             C &
                                                 (D ^
                                                      A)).wrapping_add(*fresh7).wrapping_add(0xfd469501u32))
            as uint32_t as uint32_t;
    B = B << 22i32 | B >> 32i32 - 22i32;
    B = (B as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    let fresh8 = cwp;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((D ^
                                             B &
                                                 (C ^
                                                      D)).wrapping_add(*fresh8).wrapping_add(0x698098d8i32
                                                                                                 as
                                                                                                 libc::c_uint))
            as uint32_t as uint32_t;
    A = A << 7i32 | A >> 32i32 - 7i32;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((C ^
                                             A &
                                                 (B ^
                                                      C)).wrapping_add(*fresh9).wrapping_add(0x8b44f7afu32))
            as uint32_t as uint32_t;
    D = D << 12i32 | D >> 32i32 - 12i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    let fresh10 = cwp;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((B ^
                                             D &
                                                 (A ^
                                                      B)).wrapping_add(*fresh10).wrapping_add(0xffff5bb1u32))
            as uint32_t as uint32_t;
    C = C << 17i32 | C >> 32i32 - 17i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    let fresh11 = cwp;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((A ^
                                             C &
                                                 (D ^
                                                      A)).wrapping_add(*fresh11).wrapping_add(0x895cd7beu32))
            as uint32_t as uint32_t;
    B = B << 22i32 | B >> 32i32 - 22i32;
    B = (B as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    let fresh12 = cwp;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((D ^
                                             B &
                                                 (C ^
                                                      D)).wrapping_add(*fresh12).wrapping_add(0x6b901122i32
                                                                                                  as
                                                                                                  libc::c_uint))
            as uint32_t as uint32_t;
    A = A << 7i32 | A >> 32i32 - 7i32;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((C ^
                                             A &
                                                 (B ^
                                                      C)).wrapping_add(*fresh13).wrapping_add(0xfd987193u32))
            as uint32_t as uint32_t;
    D = D << 12i32 | D >> 32i32 - 12i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    let fresh14 = cwp;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((B ^
                                             D &
                                                 (A ^
                                                      B)).wrapping_add(*fresh14).wrapping_add(0xa679438eu32))
            as uint32_t as uint32_t;
    C = C << 17i32 | C >> 32i32 - 17i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    let fresh15 = cwp;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((A ^
                                             C &
                                                 (D ^
                                                      A)).wrapping_add(*fresh15).wrapping_add(0x49b40821i32
                                                                                                  as
                                                                                                  libc::c_uint))
            as uint32_t as uint32_t;
    B = B << 22i32 | B >> 32i32 - 22i32;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((C ^
                                             D &
                                                 (B ^
                                                      C)).wrapping_add(correct_words[1]).wrapping_add(0xf61e2562u32))
            as uint32_t as uint32_t;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((B ^
                                             C &
                                                 (A ^
                                                      B)).wrapping_add(correct_words[6]).wrapping_add(0xc040b340u32))
            as uint32_t as uint32_t;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((A ^
                                             B &
                                                 (D ^
                                                      A)).wrapping_add(correct_words[11]).wrapping_add(0x265e5a51i32
                                                                                                           as
                                                                                                           libc::c_uint))
            as uint32_t as uint32_t;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((D ^
                                             A &
                                                 (C ^
                                                      D)).wrapping_add(correct_words[0]).wrapping_add(0xe9b6c7aau32))
            as uint32_t as uint32_t;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((C ^
                                             D &
                                                 (B ^
                                                      C)).wrapping_add(correct_words[5]).wrapping_add(0xd62f105du32))
            as uint32_t as uint32_t;
    A = A << 5i32 | A >> 32i32 - 5i32;
    A = (A as libc::c_uint).wrapping_add(B) as uint32_t as uint32_t;
    D =
        (D as
             libc::c_uint).wrapping_add((B ^
                                             C &
                                                 (A ^
                                                      B)).wrapping_add(correct_words[10]).wrapping_add(0x2441453i32
                                                                                                           as
                                                                                                           libc::c_uint))
            as uint32_t as uint32_t;
    D = D << 9i32 | D >> 32i32 - 9i32;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((A ^
                                             B &
                                                 (D ^
                                                      A)).wrapping_add(correct_words[15]).wrapping_add(0xd8a1e681u32))
            as uint32_t as uint32_t;
    C = C << 14i32 | C >> 32i32 - 14i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    B =
        (B as
             libc::c_uint).wrapping_add((D ^
                                             A &
                                                 (C ^
                                                      D)).wrapping_add(correct_words[4]).wrapping_add(0xe7d3fbc8u32))
            as uint32_t as uint32_t;
    B = B << 20i32 | B >> 32i32 - 20i32;
    B = (B as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    A =
        (A as
             libc::c_uint).wrapping_add((C ^
                                             D &
                                                 (B ^
                                                      C)).wrapping_add(correct_words[9]).wrapping_add(0x21e1cde6i32
                                                                                                          as
                                                                                                          libc::c_uint))
            as uint32_t as uint32_t;
    A = A << 5i32 | A >> 32i32 - 5i32;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((B ^
                                             C &
                                                 (A ^
                                                      B)).wrapping_add(correct_words[14]).wrapping_add(0xc33707d6u32))
            as uint32_t as uint32_t;
    D = D << 9i32 | D >> 32i32 - 9i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    C =
        (C as
             libc::c_uint).wrapping_add((A ^
                                             B &
                                                 (D ^
                                                      A)).wrapping_add(correct_words[3]).wrapping_add(0xf4d50d87u32))
            as uint32_t as uint32_t;
    C = C << 14i32 | C >> 32i32 - 14i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    B =
        (B as
             libc::c_uint).wrapping_add((D ^
                                             A &
                                                 (C ^
                                                      D)).wrapping_add(correct_words[8]).wrapping_add(0x455a14edi32
                                                                                                          as
                                                                                                          libc::c_uint))
            as uint32_t as uint32_t;
    B = B << 20i32 | B >> 32i32 - 20i32;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((C ^
                                             D &
                                                 (B ^
                                                      C)).wrapping_add(correct_words[13]).wrapping_add(0xa9e3e905u32))
            as uint32_t as uint32_t;
    A = A << 5i32 | A >> 32i32 - 5i32;
    A = (A as libc::c_uint).wrapping_add(B) as uint32_t as uint32_t;
    D =
        (D as
             libc::c_uint).wrapping_add((B ^
                                             C &
                                                 (A ^
                                                      B)).wrapping_add(correct_words[2]).wrapping_add(0xfcefa3f8u32))
            as uint32_t as uint32_t;
    D = D << 9i32 | D >> 32i32 - 9i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    C =
        (C as
             libc::c_uint).wrapping_add((A ^
                                             B &
                                                 (D ^
                                                      A)).wrapping_add(correct_words[7]).wrapping_add(0x676f02d9i32
                                                                                                          as
                                                                                                          libc::c_uint))
            as uint32_t as uint32_t;
    C = C << 14i32 | C >> 32i32 - 14i32;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((D ^
                                             A &
                                                 (C ^
                                                      D)).wrapping_add(correct_words[12]).wrapping_add(0x8d2a4c8au32))
            as uint32_t as uint32_t;
    B = B << 20i32 | B >> 32i32 - 20i32;
    B = (B as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    /* Round 3. */
    A =
        (A as
             libc::c_uint).wrapping_add((B ^ C ^
                                             D).wrapping_add(correct_words[5]).wrapping_add(0xfffa3942u32))
            as uint32_t as uint32_t;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((A ^ B ^
                                             C).wrapping_add(correct_words[8]).wrapping_add(0x8771f681u32))
            as uint32_t as uint32_t;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((D ^ A ^
                                             B).wrapping_add(correct_words[11]).wrapping_add(0x6d9d6122i32
                                                                                                 as
                                                                                                 libc::c_uint))
            as uint32_t as uint32_t;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((C ^ D ^
                                             A).wrapping_add(correct_words[14]).wrapping_add(0xfde5380cu32))
            as uint32_t as uint32_t;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((B ^ C ^
                                             D).wrapping_add(correct_words[1]).wrapping_add(0xa4beea44u32))
            as uint32_t as uint32_t;
    A = A << 4i32 | A >> 32i32 - 4i32;
    A = (A as libc::c_uint).wrapping_add(B) as uint32_t as uint32_t;
    D =
        (D as
             libc::c_uint).wrapping_add((A ^ B ^
                                             C).wrapping_add(correct_words[4]).wrapping_add(0x4bdecfa9i32
                                                                                                as
                                                                                                libc::c_uint))
            as uint32_t as uint32_t;
    D = D << 11i32 | D >> 32i32 - 11i32;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((D ^ A ^
                                             B).wrapping_add(correct_words[7]).wrapping_add(0xf6bb4b60u32))
            as uint32_t as uint32_t;
    C = C << 16i32 | C >> 32i32 - 16i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    B =
        (B as
             libc::c_uint).wrapping_add((C ^ D ^
                                             A).wrapping_add(correct_words[10]).wrapping_add(0xbebfbc70u32))
            as uint32_t as uint32_t;
    B = B << 23i32 | B >> 32i32 - 23i32;
    B = (B as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    A =
        (A as
             libc::c_uint).wrapping_add((B ^ C ^
                                             D).wrapping_add(correct_words[13]).wrapping_add(0x289b7ec6i32
                                                                                                 as
                                                                                                 libc::c_uint))
            as uint32_t as uint32_t;
    A = A << 4i32 | A >> 32i32 - 4i32;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((A ^ B ^
                                             C).wrapping_add(correct_words[0]).wrapping_add(0xeaa127fau32))
            as uint32_t as uint32_t;
    D = D << 11i32 | D >> 32i32 - 11i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    C =
        (C as
             libc::c_uint).wrapping_add((D ^ A ^
                                             B).wrapping_add(correct_words[3]).wrapping_add(0xd4ef3085u32))
            as uint32_t as uint32_t;
    C = C << 16i32 | C >> 32i32 - 16i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    B =
        (B as
             libc::c_uint).wrapping_add((C ^ D ^
                                             A).wrapping_add(correct_words[6]).wrapping_add(0x4881d05i32
                                                                                                as
                                                                                                libc::c_uint))
            as uint32_t as uint32_t;
    B = B << 23i32 | B >> 32i32 - 23i32;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((B ^ C ^
                                             D).wrapping_add(correct_words[9]).wrapping_add(0xd9d4d039u32))
            as uint32_t as uint32_t;
    A = A << 4i32 | A >> 32i32 - 4i32;
    A = (A as libc::c_uint).wrapping_add(B) as uint32_t as uint32_t;
    D =
        (D as
             libc::c_uint).wrapping_add((A ^ B ^
                                             C).wrapping_add(correct_words[12]).wrapping_add(0xe6db99e5u32))
            as uint32_t as uint32_t;
    D = D << 11i32 | D >> 32i32 - 11i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    C =
        (C as
             libc::c_uint).wrapping_add((D ^ A ^
                                             B).wrapping_add(correct_words[15]).wrapping_add(0x1fa27cf8i32
                                                                                                 as
                                                                                                 libc::c_uint))
            as uint32_t as uint32_t;
    C = C << 16i32 | C >> 32i32 - 16i32;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((C ^ D ^
                                             A).wrapping_add(correct_words[2]).wrapping_add(0xc4ac5665u32))
            as uint32_t as uint32_t;
    B = B << 23i32 | B >> 32i32 - 23i32;
    B = (B as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    /* Round 4.  */
    A =
        (A as
             libc::c_uint).wrapping_add((C ^
                                             (B |
                                                  !D)).wrapping_add(correct_words[0]).wrapping_add(0xf4292244u32))
            as uint32_t as uint32_t;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((B ^
                                             (A |
                                                  !C)).wrapping_add(correct_words[7]).wrapping_add(0x432aff97i32
                                                                                                       as
                                                                                                       libc::c_uint))
            as uint32_t as uint32_t;
    ...
    C =
        (C as
             libc::c_uint).wrapping_add((A ^
                                             (D |
                                                  !B)).wrapping_add(correct_words[14]).wrapping_add(0xab9423a7u32))
            as uint32_t as uint32_t;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((D ^
                                             (C |
                                                  !A)).wrapping_add(correct_words[5]).wrapping_add(0xfc93a039u32))
            as uint32_t as uint32_t;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((C ^
                                             (B |
                                                  !D)).wrapping_add(correct_words[12]).wrapping_add(0x655b59c3i32
                                                                                                        as
                                                                                                        libc::c_uint))
            as uint32_t as uint32_t;
    A = A << 6i32 | A >> 32i32 - 6i32;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((B ^
                                             (A |
                                                  !C)).wrapping_add(correct_words[3]).wrapping_add(0x8f0ccc92u32))
            as uint32_t as uint32_t;
    D = D << 10i32 | D >> 32i32 - 10i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    C =
        (C as
             libc::c_uint).wrapping_add((A ^
                                             (D |
                                                  !B)).wrapping_add(correct_words[10]).wrapping_add(0xffeff47du32))
            as uint32_t as uint32_t;
    C = C << 15i32 | C >> 32i32 - 15i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    B =
        (B as
             libc::c_uint).wrapping_add((D ^
                                             (C |
                                                  !A)).wrapping_add(correct_words[1]).wrapping_add(0x85845dd1u32))
            as uint32_t as uint32_t;
    B = B << 21i32 | B >> 32i32 - 21i32;
    B = (B as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    A =
        (A as
             libc::c_uint).wrapping_add((C ^
                                             (B |
                                                  !D)).wrapping_add(correct_words[8]).wrapping_add(0x6fa87e4fi32
                                                                                                       as
                                                                                                       libc::c_uint))
            as uint32_t as uint32_t;
    A = A << 6i32 | A >> 32i32 - 6i32;
    ...
    D =
        (D as
             libc::c_uint).wrapping_add((B ^
                                             (A |
                                                  !C)).wrapping_add(correct_words[15]).wrapping_add(0xfe2ce6e0u32))
            as uint32_t as uint32_t;
    D = D << 10i32 | D >> 32i32 - 10i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    C =
        (C as
             libc::c_uint).wrapping_add((A ^
                                             (D |
                                                  !B)).wrapping_add(correct_words[6]).wrapping_add(0xa3014314u32))
            as uint32_t as uint32_t;
    C = C << 15i32 | C >> 32i32 - 15i32;
    C = (C as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
    B =
        (B as
             libc::c_uint).wrapping_add((D ^
                                             (C |
                                                  !A)).wrapping_add(correct_words[13]).wrapping_add(0x4e0811a1i32
                                                                                                        as
                                                                                                        libc::c_uint))
            as uint32_t as uint32_t;
    B = B << 21i32 | B >> 32i32 - 21i32;
    ...
    A =
        (A as
             libc::c_uint).wrapping_add((C ^
                                             (B |
                                                  !D)).wrapping_add(correct_words[4]).wrapping_add(0xf7537e82u32))
            as uint32_t as uint32_t;
    A = A << 6i32 | A >> 32i32 - 6i32;
    A = (A as libc::c_uint).wrapping_add(B) as uint32_t as uint32_t;
    D =
        (D as
             libc::c_uint).wrapping_add((B ^
                                             (A |
                                                  !C)).wrapping_add(correct_words[11]).wrapping_add(0xbd3af235u32))
            as uint32_t as uint32_t;
    D = D << 10i32 | D >> 32i32 - 10i32;
    D = (D as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    C =
        (C as
             libc::c_uint).wrapping_add((A ^
                                             (D |
                                                  !B)).wrapping_add(correct_words[2]).wrapping_add(0x2ad7d2bbi32
                                                                                                       as
                                                                                                       libc::c_uint))
            as uint32_t as uint32_t;
    C = C << 15i32 | C >> 32i32 - 15i32;
    ...
    B =
        (B as
             libc::c_uint).wrapping_add((D ^
                                             (C |
                                                  !A)).wrapping_add(correct_words[9]).wrapping_add(0xeb86d391u32))
            as uint32_t as uint32_t;
    B = B << 21i32 | B >> 32i32 - 21i32;
    B = (B as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    /* Put checksum in context given as argument. */
    (*ctx).A =
        ((*ctx).A as libc::c_uint).wrapping_add(A) as uint32_t as uint32_t;
    (*ctx).B =
        ((*ctx).B as libc::c_uint).wrapping_add(B) as uint32_t as uint32_t;
    (*ctx).C =
        ((*ctx).C as libc::c_uint).wrapping_add(C) as uint32_t as uint32_t;
    (*ctx).D =
        ((*ctx).D as libc::c_uint).wrapping_add(D) as uint32_t as uint32_t;
}
/* The routine updates the message-digest context to
 * account for the presence of each of the characters inBuf[0..inLen-1]
 * in the message whose digest is being computed. */
#[no_mangle]
pub unsafe extern "C" fn MD5_write(mut hd: *mut MD5_CONTEXT,
                                   mut inbuf: *const libc::c_uchar,
                                   mut inlen: libc::c_uint) {
    if (*hd).count == 64i32 {
        /* flush the buffer */
        transform(hd, (*hd).buf.as_mut_ptr());
        _gcry_burn_stack((80i32 as
                              libc::c_ulong).wrapping_add((6i32 as
...
#[no_mangle]
pub unsafe extern "C" fn MD5_final(mut outbuf: *mut libc::c_uchar,
                                   mut hd: *mut MD5_CONTEXT) {
    let mut t: uint32_t = 0; /* flush */
    let mut msb: uint32_t = 0;
    let mut lsb: uint32_t = 0;
    let mut p: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    MD5_write(hd, 0 as *const libc::c_uchar, 0i32 as libc::c_uint);
    t = (*hd).nblocks as uint32_t;
    ...
    t = lsb;
    lsb =
        (lsb as libc::c_uint).wrapping_add((*hd).count as libc::c_uint) as
            uint32_t as uint32_t;
    if lsb < t { msb = msb.wrapping_add(1) }
    ...
    if (*hd).count < 56i32 {
        ...
        MD5_write(hd, 0 as *const libc::c_uchar,
                  0i32 as libc::c_uint); /* flush */
        memset((*hd).buf.as_mut_ptr() as *mut libc::c_void, 0i32,
               56i32 as libc::c_ulong);
    }
    /* append the 64 bit count */
    (*hd).buf[56] =
        (lsb & 0xffi32 as libc::c_uint) as libc::c_uchar; /* p = hd->buf; */
    ...
    p = outbuf;
    /* little endian */
    *(p as *mut uint32_t) = (*hd).A;
    p = p.offset(::std::mem::size_of::<uint32_t>() as libc::c_ulong as isize);
    *(p as *mut uint32_t) = (*hd).B;
    p = p.offset(::std::mem::size_of::<uint32_t>() as libc::c_ulong as isize);
    *(p as *mut uint32_t) = (*hd).C;
    p = p.offset(::std::mem::size_of::<uint32_t>() as libc::c_ulong as isize);
    *(p as *mut uint32_t) = (*hd).D;
    p = p.offset(::std::mem::size_of::<uint32_t>() as libc::c_ulong as isize);
}
/*
 ...
 */
unsafe extern "C" fn _gcry_bswap32(mut x: uint32_t) -> uint32_t {
    return ((x << 8i32 | x >> 32i32 - 8i32) as libc::c_long & 0xff00ffi64 |
                (x >> (8i32 & 32i32 - 1i32) |
                     x << (32i32 - 8i32 & 32i32 - 1i32)) as libc::c_long &
                    0xff00ff00i64) as uint32_t;
}
unsafe extern "C" fn _gcry_bswap64(mut x: uint64_t) -> uint64_t {
    return (_gcry_bswap32(x as uint32_t) as uint64_t) << 32i32 |
               _gcry_bswap32((x >> 32i32) as uint32_t) as libc::c_ulong;
}
/* Endian dependent byte swap operations.  */
unsafe extern "C" fn buf_get_be32(mut _buf: *const libc::c_void) -> uint32_t {
    let mut in_0: *const uint8_t = _buf as *const uint8_t;
    return (*in_0.offset(0) as uint32_t) << 24i32 |
               (*in_0.offset(1) as uint32_t) << 16i32 |
               (*in_0.offset(2) as uint32_t) << 8i32 |
               *in_0.offset(3) as uint32_t;
}
unsafe extern "C" fn buf_put_be32(mut _buf: *mut libc::c_void,
                                  mut val: uint32_t) {
...
unsafe extern "C" fn buf_put_be64(mut _buf: *mut libc::c_void,
                                  mut val: uint64_t) {
    let mut out: *mut uint8_t = _buf as *mut uint8_t;
...
pub unsafe extern "C" fn SHA256_init(mut hd: *mut SHA256_CONTEXT) {
    (*hd).h0 = 0x6a09e667i32 as uint32_t;
    (*hd).h1 = 0xbb67ae85u32;
    (*hd).h2 = 0x3c6ef372i32 as uint32_t;
    (*hd).h3 = 0xa54ff53au32;
    (*hd).h4 = 0x510e527fi32 as uint32_t;
    (*hd).h5 = 0x9b05688cu32;
    (*hd).h6 = 0x1f83d9abi32 as uint32_t;
    (*hd).h7 = 0x5be0cd19i32 as uint32_t;
...
/* (4.6) */
/* (4.7) */
unsafe extern "C" fn _SHA256_transform(mut hd: *mut SHA256_CONTEXT,
                                       mut data: *const libc::c_uchar)
 -> libc::c_uint {
    static mut K: [uint32_t; 64] =
        [0x428a2f98i32 as uint32_t, 0x71374491i32 as uint32_t, 0xb5c0fbcfu32,
         0xe9b5dba5u32, 0x3956c25bi32 as uint32_t, 0x59f111f1i32 as uint32_t,
         0x923f82a4u32, 0xab1c5ed5u32, 0xd807aa98u32,
         0x12835b01i32 as uint32_t, 0x243185bei32 as uint32_t,
         0x550c7dc3i32 as uint32_t, 0x72be5d74i32 as uint32_t, 0x80deb1feu32,
         0x9bdc06a7u32, 0xc19bf174u32, 0xe49b69c1u32, 0xefbe4786u32,
         0xfc19dc6i32 as uint32_t, 0x240ca1cci32 as uint32_t,
         0x2de92c6fi32 as uint32_t, 0x4a7484aai32 as uint32_t,
         0x5cb0a9dci32 as uint32_t, 0x76f988dai32 as uint32_t, 0x983e5152u32,
         0xa831c66du32, 0xb00327c8u32, 0xbf597fc7u32, 0xc6e00bf3u32,
         0xd5a79147u32, 0x6ca6351i32 as uint32_t, 0x14292967i32 as uint32_t,
         0x27b70a85i32 as uint32_t, 0x2e1b2138i32 as uint32_t,
         0x4d2c6dfci32 as uint32_t, 0x53380d13i32 as uint32_t,
         0x650a7354i32 as uint32_t, 0x766a0abbi32 as uint32_t, 0x81c2c92eu32,
         0x92722c85u32, 0xa2bfe8a1u32, 0xa81a664bu32, 0xc24b8b70u32,
         0xc76c51a3u32, 0xd192e819u32, 0xd6990624u32, 0xf40e3585u32,
         0x106aa070i32 as uint32_t, 0x19a4c116i32 as uint32_t,
         0x1e376c08i32 as uint32_t, 0x2748774ci32 as uint32_t,
         0x34b0bcb5i32 as uint32_t, 0x391c0cb3i32 as uint32_t,
         0x4ed8aa4ai32 as uint32_t, 0x5b9cca4fi32 as uint32_t,
         0x682e6ff3i32 as uint32_t, 0x748f82eei32 as uint32_t,
         0x78a5636fi32 as uint32_t, 0x84c87814u32, 0x8cc70208u32,
    ...
    while i < 16i32 {
        w[i as usize] =
            buf_get_be32(data.offset((i * 4i32) as isize) as
                             *const libc::c_void);
        i += 1
    }
    while i < 64i32 {
        w[i as usize] =
            ((w[(i - 2i32) as usize] >> (17i32 & 32i32 - 1i32) |
                  w[(i - 2i32) as usize] << (32i32 - 17i32 & 32i32 - 1i32)) ^
                 (w[(i - 2i32) as usize] >> (19i32 & 32i32 - 1i32) |
                      w[(i - 2i32) as usize] <<
                          (32i32 - 19i32 & 32i32 - 1i32)) ^
                 w[(i - 2i32) as usize] >>
                     10i32).wrapping_add(w[(i - 7i32) as
                                               usize]).wrapping_add((w[(i -
                                                                            15i32)
                                                                           as
                                                                           usize]
                                                                         >>
    ...
    while i < 64i32 {
        t1 =
            h.wrapping_add((e >> (6i32 & 32i32 - 1i32) |
                                e << (32i32 - 6i32 & 32i32 - 1i32)) ^
                               (e >> (11i32 & 32i32 - 1i32) |
                                    e << (32i32 - 11i32 & 32i32 - 1i32)) ^
                               (e >> (25i32 & 32i32 - 1i32) |
                                    e <<
                                        (32i32 - 25i32 &
                                             32i32 -
                                                                              ...
                                                                              (f
                                                                                   ...
                                                                                   g)).wrapping_add(K[i
                                                                                                          ...
                                                                                                          usize]).wrapping_add(w[i
                                                                                                                                     ...
                                                                                                                                     usize]);
        t2 =
            ((a >> (2i32 & 32i32 - 1i32) | a << (32i32 - 2i32 & 32i32 - 1i32))
                 ^
                 (a >> (13i32 & 32i32 - 1i32) |
                      a << (32i32 - 13i32 & 32i32 - 1i32)) ^
                 (a >> (22i32 & 32i32 - 1i32) |
                      a <<
                          (32i32 - 22i32 &
                               32i32 -
                                   1i32))).wrapping_add(a & b | c & (a | b));
        d = (d as libc::c_uint).wrapping_add(t1) as uint32_t as uint32_t;
        h = t1.wrapping_add(t2);
        t1 =
            g.wrapping_add((d >> (6i32 & 32i32 - 1i32) |
                                d << (32i32 - 6i32 & 32i32 - 1i32)) ^
                               (d >> (11i32 & 32i32 - 1i32) |
                                    d << (32i32 - 11i32 & 32i32 - 1i32)) ^
                               (d >> (25i32 & 32i32 - 1i32) |
                                    d <<
                                        (32i32 - 25i32 &
                                             32i32 -
                                                                              ...
                                                                              (e
                                                                                   ...
                                                                                   f)).wrapping_add(K[(i
                                                                                                          ...
                                                                                                          usize]).wrapping_add(w[(i
                                                                                                                                     ...
                                                                                                                                     usize]);
        t2 =
            ((h >> (2i32 & 32i32 - 1i32) | h << (32i32 - 2i32 & 32i32 - 1i32))
                 ^
                 (h >> (13i32 & 32i32 - 1i32) |
                      h << (32i32 - 13i32 & 32i32 - 1i32)) ^
                 (h >> (22i32 & 32i32 - 1i32) |
                      h <<
                          (32i32 - 22i32 &
                               32i32 -
                                   1i32))).wrapping_add(h & a | b & (h | a));
        c = (c as libc::c_uint).wrapping_add(t1) as uint32_t as uint32_t;
        g = t1.wrapping_add(t2);
        t1 =
            f.wrapping_add((c >> (6i32 & 32i32 - 1i32) |
                                c << (32i32 - 6i32 & 32i32 - 1i32)) ^
                               (c >> (11i32 & 32i32 - 1i32) |
                                    c << (32i32 - 11i32 & 32i32 - 1i32)) ^
                               (c >> (25i32 & 32i32 - 1i32) |
                                    c <<
                                        (32i32 - 25i32 &
                                             32i32 -
                                                                              ...
                                                                              (d
                                                                                   ...
                                                                                   e)).wrapping_add(K[(i
                                                                                                          ...
                                                                                                          usize]).wrapping_add(w[(i
                                                                                                                                     ...
                                                                                                                                     usize]);
        t2 =
            ((g >> (2i32 & 32i32 - 1i32) | g << (32i32 - 2i32 & 32i32 - 1i32))
                 ^
                 (g >> (13i32 & 32i32 - 1i32) |
                      g << (32i32 - 13i32 & 32i32 - 1i32)) ^
                 (g >> (22i32 & 32i32 - 1i32) |
                      g <<
                          (32i32 - 22i32 &
                               32i32 -
                                   1i32))).wrapping_add(g & h | a & (g | h));
        b = (b as libc::c_uint).wrapping_add(t1) as uint32_t as uint32_t;
        f = t1.wrapping_add(t2);
        t1 =
            e.wrapping_add((b >> (6i32 & 32i32 - 1i32) |
                                b << (32i32 - 6i32 & 32i32 - 1i32)) ^
                               (b >> (11i32 & 32i32 - 1i32) |
                                    b << (32i32 - 11i32 & 32i32 - 1i32)) ^
                               (b >> (25i32 & 32i32 - 1i32) |
                                    b <<
                                        (32i32 - 25i32 &
                                             32i32 -
                                                                              ...
                                                                              (c
                                                                                   ...
                                                                                   d)).wrapping_add(K[(i
                                                                                                          ...
                                                                                                          usize]).wrapping_add(w[(i
                                                                                                                                     ...
                                                                                                                                     usize]);
        t2 =
            ((f >> (2i32 & 32i32 - 1i32) | f << (32i32 - 2i32 & 32i32 - 1i32))
                 ^
                 (f >> (13i32 & 32i32 - 1i32) |
                      f << (32i32 - 13i32 & 32i32 - 1i32)) ^
                 (f >> (22i32 & 32i32 - 1i32) |
                      f <<
                          (32i32 - 22i32 &
                               32i32 -
                                   1i32))).wrapping_add(f & g | h & (f | g));
        a = (a as libc::c_uint).wrapping_add(t1) as uint32_t as uint32_t;
        e = t1.wrapping_add(t2);
        t1 =
            d.wrapping_add((a >> (6i32 & 32i32 - 1i32) |
                                a << (32i32 - 6i32 & 32i32 - 1i32)) ^
                               (a >> (11i32 & 32i32 - 1i32) |
                                    a << (32i32 - 11i32 & 32i32 - 1i32)) ^
                               (a >> (25i32 & 32i32 - 1i32) |
                                    a <<
                                        (32i32 - 25i32 &
                                             32i32 -
                                                                              ...
                                                                              (b
                                                                                   ...
                                                                                   c)).wrapping_add(K[(i
                                                                                                          ...
                                                                                                          usize]).wrapping_add(w[(i
                                                                                                                                     ...
                                                                                                                                     usize]);
        t2 =
            ((e >> (2i32 & 32i32 - 1i32) | e << (32i32 - 2i32 & 32i32 - 1i32))
                 ^
                 (e >> (13i32 & 32i32 - 1i32) |
                      e << (32i32 - 13i32 & 32i32 - 1i32)) ^
                 (e >> (22i32 & 32i32 - 1i32) |
                      e <<
                          (32i32 - 22i32 &
                               32i32 -
                                   1i32))).wrapping_add(e & f | g & (e | f));
        h = (h as libc::c_uint).wrapping_add(t1) as uint32_t as uint32_t;
        d = t1.wrapping_add(t2);
        t1 =
            c.wrapping_add((h >> (6i32 & 32i32 - 1i32) |
                                h << (32i32 - 6i32 & 32i32 - 1i32)) ^
                               (h >> (11i32 & 32i32 - 1i32) |
                                    h << (32i32 - 11i32 & 32i32 - 1i32)) ^
                               (h >> (25i32 & 32i32 - 1i32) |
                                    h <<
                                        (32i32 - 25i32 &
                                             32i32 -
                                                                              ...
                                                                              (a
                                                                                   ...
                                                                                   b)).wrapping_add(K[(i
                                                                                                          ...
                                                                                                          usize]).wrapping_add(w[(i
                                                                                                                                     ...
                                                                                                                                     usize]);
        t2 =
            ((d >> (2i32 & 32i32 - 1i32) | d << (32i32 - 2i32 & 32i32 - 1i32))
                 ^
                 (d >> (13i32 & 32i32 - 1i32) |
                      d << (32i32 - 13i32 & 32i32 - 1i32)) ^
                 (d >> (22i32 & 32i32 - 1i32) |
                      d <<
                          (32i32 - 22i32 &
                               32i32 -
                                   1i32))).wrapping_add(d & e | f & (d | e));
        g = (g as libc::c_uint).wrapping_add(t1) as uint32_t as uint32_t;
        c = t1.wrapping_add(t2);
        t1 =
            b.wrapping_add((g >> (6i32 & 32i32 - 1i32) |
                                g << (32i32 - 6i32 & 32i32 - 1i32)) ^
                               (g >> (11i32 & 32i32 - 1i32) |
                                    g << (32i32 - 11i32 & 32i32 - 1i32)) ^
                               (g >> (25i32 & 32i32 - 1i32) |
                                    g <<
                                        (32i32 - 25i32 &
                                             32i32 -
                                                                              ...
                                                                              (h
                                                                                   ...
                                                                                   a)).wrapping_add(K[(i
                                                                                                          ...
                                                                                                          usize]).wrapping_add(w[(i
                                                                                                                                     ...
                                                                                                                                     usize]);
        t2 =
            ((c >> (2i32 & 32i32 - 1i32) | c << (32i32 - 2i32 & 32i32 - 1i32))
                 ^
                 (c >> (13i32 & 32i32 - 1i32) |
                      c << (32i32 - 13i32 & 32i32 - 1i32)) ^
                 (c >> (22i32 & 32i32 - 1i32) |
                      c <<
                          (32i32 - 22i32 &
                               32i32 -
                                   1i32))).wrapping_add(c & d | e & (c | d));
        f = (f as libc::c_uint).wrapping_add(t1) as uint32_t as uint32_t;
        b = t1.wrapping_add(t2);
        t1 =
            a.wrapping_add((f >> (6i32 & 32i32 - 1i32) |
                                f << (32i32 - 6i32 & 32i32 - 1i32)) ^
                               (f >> (11i32 & 32i32 - 1i32) |
                                    f << (32i32 - 11i32 & 32i32 - 1i32)) ^
                               (f >> (25i32 & 32i32 - 1i32) |
                                    f <<
                                        (32i32 - 25i32 &
                                             32i32 -
                                                                              ...
                                                                              (g
                                                                                   ...
                                                                                   h)).wrapping_add(K[(i
                                                                                                          ...
                                                                                                          usize]).wrapping_add(w[(i
                                                                                                                                     ...
                                                                                                                                     usize]);
        t2 =
            ((b >> (2i32 & 32i32 - 1i32) | b << (32i32 - 2i32 & 32i32 - 1i32))
                 ^
                 (b >> (13i32 & 32i32 - 1i32) |
                      b << (32i32 - 13i32 & 32i32 - 1i32)) ^
                 (b >> (22i32 & 32i32 - 1i32) |
                      b <<
                          (32i32 - 22i32 &
                               32i32 -
                                   1i32))).wrapping_add(b & c | d & (b | c));
        e = (e as libc::c_uint).wrapping_add(t1) as uint32_t as uint32_t;
        a = t1.wrapping_add(t2);
        i += 8i32
    }
    (*hd).h0 =
        ((*hd).h0 as libc::c_uint).wrapping_add(a) as uint32_t as uint32_t;
    (*hd).h1 =
        ((*hd).h1 as libc::c_uint).wrapping_add(b) as uint32_t as uint32_t;
    (*hd).h2 =
        ((*hd).h2 as libc::c_uint).wrapping_add(c) as uint32_t as uint32_t;
    (*hd).h3 =
        ((*hd).h3 as libc::c_uint).wrapping_add(d) as uint32_t as uint32_t;
    (*hd).h4 =
        ((*hd).h4 as libc::c_uint).wrapping_add(e) as uint32_t as uint32_t;
    (*hd).h5 =
        ((*hd).h5 as libc::c_uint).wrapping_add(f) as uint32_t as uint32_t;
    (*hd).h6 =
        ((*hd).h6 as libc::c_uint).wrapping_add(g) as uint32_t as uint32_t;
    (*hd).h7 =
        ((*hd).h7 as libc::c_uint).wrapping_add(h) as uint32_t as uint32_t;
    return (74i32 * 4i32 + 32i32) as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn SHA256_write(mut hd: *mut SHA256_CONTEXT,
                                      mut inbuf: *const libc::c_uchar,
                                      mut inlen: libc::c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn SHA256_final(mut outbuf: *mut libc::c_uchar,
    ...
    p = outbuf;
    *(p as *mut uint32_t) = _gcry_bswap32((*hd).h0);
    p = p.offset(4);
    *(p as *mut uint32_t) = _gcry_bswap32((*hd).h1);
    p = p.offset(4);
    *(p as *mut uint32_t) = _gcry_bswap32((*hd).h2);
    p = p.offset(4);
    *(p as *mut uint32_t) = _gcry_bswap32((*hd).h3);
    p = p.offset(4);
    *(p as *mut uint32_t) = _gcry_bswap32((*hd).h4);
    p = p.offset(4);
    *(p as *mut uint32_t) = _gcry_bswap32((*hd).h5);
    p = p.offset(4);
    *(p as *mut uint32_t) = _gcry_bswap32((*hd).h6);
    p = p.offset(4);
    *(p as *mut uint32_t) = _gcry_bswap32((*hd).h7);
    p = p.offset(4);
}
...
static mut k: [uint64_t; 80] =
    [0x428a2f98d728ae22u64, 0x7137449123ef65cdu64, 0xb5c0fbcfec4d3b2fu64,
     0xe9b5dba58189dbbcu64, 0x3956c25bf348b538u64, 0x59f111f1b605d019u64,
     0x923f82a4af194f9bu64, 0xab1c5ed5da6d8118u64, 0xd807aa98a3030242u64,
     0x12835b0145706fbeu64, 0x243185be4ee4b28cu64, 0x550c7dc3d5ffb4e2u64,
     0x72be5d74f27b896fu64, 0x80deb1fe3b1696b1u64, 0x9bdc06a725c71235u64,
     0xc19bf174cf692694u64, 0xe49b69c19ef14ad2u64, 0xefbe4786384f25e3u64,
     0xfc19dc68b8cd5b5u64, 0x240ca1cc77ac9c65u64, 0x2de92c6f592b0275u64,
     0x4a7484aa6ea6e483u64, 0x5cb0a9dcbd41fbd4u64, 0x76f988da831153b5u64,
     0x983e5152ee66dfabu64, 0xa831c66d2db43210u64, 0xb00327c898fb213fu64,
     0xbf597fc7beef0ee4u64, 0xc6e00bf33da88fc2u64, 0xd5a79147930aa725u64,
     0x6ca6351e003826fu64, 0x142929670a0e6e70u64, 0x27b70a8546d22ffcu64,
     0x2e1b21385c26c926u64, 0x4d2c6dfc5ac42aedu64, 0x53380d139d95b3dfu64,
     0x650a73548baf63deu64, 0x766a0abb3c77b2a8u64, 0x81c2c92e47edaee6u64,
     0x92722c851482353bu64, 0xa2bfe8a14cf10364u64, 0xa81a664bbc423001u64,
     0xc24b8b70d0f89791u64, 0xc76c51a30654be30u64, 0xd192e819d6ef5218u64,
     0xd69906245565a910u64, 0xf40e35855771202au64, 0x106aa07032bbd1b8u64,
     0x19a4c116b8d2d0c8u64, 0x1e376c085141ab53u64, 0x2748774cdf8eeb99u64,
     0x34b0bcb5e19b48a8u64, 0x391c0cb3c5c95a63u64, 0x4ed8aa4ae3418acbu64,
     0x5b9cca4f7763e373u64, 0x682e6ff3d6b2b8a3u64, 0x748f82ee5defb2fcu64,
     0x78a5636f43172f60u64, 0x84c87814a1f0ab72u64, 0x8cc702081a6439ecu64,
     0x90befffa23631e28u64, 0xa4506cebde82bde9u64, 0xbef9a3f7b2c67915u64,
     0xc67178f2e372532bu64, 0xca273eceea26619cu64, 0xd186b8c721c0c207u64,
     0xeada7dd6cde0eb1eu64, 0xf57d4f7fee6ed178u64, 0x6f067aa72176fbau64,
     0xa637dc5a2c898a6u64, 0x113f9804bef90daeu64, 0x1b710b35131c471bu64,
     0x28db77f523047d84u64, 0x32caab7b40c72493u64, 0x3c9ebe0a15c9bebcu64,
     0x431d67c49c100d4cu64, 0x4cc5d4becb3e42b6u64, 0x597f299cfc657e2au64,
     0x5fcb6fab3ad6faecu64, 0x6c44198c4a475817u64];
/* ***************
 * Transform the message W which consists of 16 64-bit-words
 */
unsafe extern "C" fn __transform(mut hd: *mut SHA512_STATE,
                                 mut data: *const libc::c_uchar)
 -> libc::c_uint {
    ...
    while t < 16i32 {
        w[t as usize] =
            buf_get_be64(data.offset((t * 8i32) as isize) as
                             *const libc::c_void);
        t += 1
    }
    t = 0i32;
    while t < 80i32 - 16i32 {
      ...
      */
        ...
        t1 =
            h.wrapping_add((e >> 14i32 | e << 64i32 - 14i32) ^
                               (e >> 18i32 | e << 64i32 - 18i32) ^
                               (e >> 41i32 |
                                    e <<
                                        64i32 -
                                            41i32)).wrapping_add(e & f ^
                                                                     !e &
                                                                         g).wrapping_add(k[t
                                                                                               as
                                                                                               usize]).wrapping_add(w[0]);
        w[0] =
            (w[0] as
                 libc::c_ulong).wrapping_add(((w[14] >> 19i32 |
                                                   w[14] << 64i32 - 19i32) ^
                                                  (w[14] >> 61i32 |
                                                       w[14] << 64i32 - 61i32)
                                                  ^
                                                  w[14] >>
                                                      6i32).wrapping_add(w[9]).wrapping_add((w[1]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[1]
        ...
        t2 =
            ((a >> 28i32 | a << 64i32 - 28i32) ^
                 (a >> 34i32 | a << 64i32 - 34i32) ^
                 (a >> 39i32 |
                      a <<
                          64i32 - 39i32)).wrapping_add(a & b ^ a & c ^ b & c);
        d = (d as libc::c_ulong).wrapping_add(t1) as uint64_t as uint64_t;
        h = t1.wrapping_add(t2);
        t1 =
            g.wrapping_add((d >> 14i32 | d << 64i32 - 14i32) ^
                               (d >> 18i32 | d << 64i32 - 18i32) ^
                               (d >> 41i32 |
                                    d <<
                                        64i32 -
                                            41i32)).wrapping_add(d & e ^
                                                                     !d &
                                                                         f).wrapping_add(k[(t
                                                                                                +
                                                                                                1i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[1]);
        w[1] =
            (w[1] as
                 libc::c_ulong).wrapping_add(((w[15] >> 19i32 |
                                                   w[15] << 64i32 - 19i32) ^
                                                  (w[15] >> 61i32 |
                                                       w[15] << 64i32 - 61i32)
                                                  ^
                                                  w[15] >>
                                                      6i32).wrapping_add(w[10]).wrapping_add((w[2]
                                                                                                  >>
                                                                                                  1i32
                                                                                                  |
                                                                                                  w[2]
                ...
                as uint64_t as uint64_t;
        t2 =
            ((h >> 28i32 | h << 64i32 - 28i32) ^
                 (h >> 34i32 | h << 64i32 - 34i32) ^
                 (h >> 39i32 |
                      h <<
                          64i32 - 39i32)).wrapping_add(h & a ^ h & b ^ a & b);
        c = (c as libc::c_ulong).wrapping_add(t1) as uint64_t as uint64_t;
        g = t1.wrapping_add(t2);
        t1 =
            f.wrapping_add((c >> 14i32 | c << 64i32 - 14i32) ^
                               (c >> 18i32 | c << 64i32 - 18i32) ^
                               (c >> 41i32 |
                                    c <<
                                        64i32 -
                                            41i32)).wrapping_add(c & d ^
                                                                     !c &
                                                                         e).wrapping_add(k[(t
                                                                                                +
                                                                                                2i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[2]);
        w[2] =
            (w[2] as
                 libc::c_ulong).wrapping_add(((w[0] >> 19i32 |
                                                   w[0] << 64i32 - 19i32) ^
                                                  (w[0] >> 61i32 |
                                                       w[0] << 64i32 - 61i32)
                                                  ^
                                                  w[0] >>
                                                      6i32).wrapping_add(w[11]).wrapping_add((w[3]
                                                                                                  >>
                                                                                                  1i32
                                                                                                  |
                                                                                                  w[3]
                ...
                as uint64_t as uint64_t;
        t2 =
            ((g >> 28i32 | g << 64i32 - 28i32) ^
                 (g >> 34i32 | g << 64i32 - 34i32) ^
                 (g >> 39i32 |
                      g <<
                          64i32 - 39i32)).wrapping_add(g & h ^ g & a ^ h & a);
        b = (b as libc::c_ulong).wrapping_add(t1) as uint64_t as uint64_t;
        f = t1.wrapping_add(t2);
        t1 =
            e.wrapping_add((b >> 14i32 | b << 64i32 - 14i32) ^
                               (b >> 18i32 | b << 64i32 - 18i32) ^
                               (b >> 41i32 |
                                    b <<
                                        64i32 -
                                            41i32)).wrapping_add(b & c ^
                                                                     !b &
                                                                         d).wrapping_add(k[(t
                                                                                                +
                                                                                                3i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[3]);
        w[3] =
            (w[3] as
                 libc::c_ulong).wrapping_add(((w[1] >> 19i32 |
                                                   w[1] << 64i32 - 19i32) ^
                                                  (w[1] >> 61i32 |
                                                       w[1] << 64i32 - 61i32)
                                                  ^
                                                  w[1] >>
                                                      6i32).wrapping_add(w[12]).wrapping_add((w[4]
                                                                                                  >>
                                                                                                  1i32
                                                                                                  |
                                                                                                  w[4]
                ...
                as uint64_t as uint64_t;
        t2 =
            ((f >> 28i32 | f << 64i32 - 28i32) ^
                 (f >> 34i32 | f << 64i32 - 34i32) ^
                 (f >> 39i32 |
                      f <<
                          64i32 - 39i32)).wrapping_add(f & g ^ f & h ^ g & h);
        a = (a as libc::c_ulong).wrapping_add(t1) as uint64_t as uint64_t;
        e = t1.wrapping_add(t2);
        t1 =
            d.wrapping_add((a >> 14i32 | a << 64i32 - 14i32) ^
                               (a >> 18i32 | a << 64i32 - 18i32) ^
                               (a >> 41i32 |
                                    a <<
                                        64i32 -
                                            41i32)).wrapping_add(a & b ^
                                                                     !a &
                                                                         c).wrapping_add(k[(t
                                                                                                +
                                                                                                4i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[4]);
        w[4] =
            (w[4] as
                 libc::c_ulong).wrapping_add(((w[2] >> 19i32 |
                                                   w[2] << 64i32 - 19i32) ^
                                                  (w[2] >> 61i32 |
                                                       w[2] << 64i32 - 61i32)
                                                  ^
                                                  w[2] >>
                                                      6i32).wrapping_add(w[13]).wrapping_add((w[5]
                                                                                                  >>
                                                                                                  1i32
                                                                                                  |
                                                                                                  w[5]
                ...
                as uint64_t as uint64_t;
        t2 =
            ((e >> 28i32 | e << 64i32 - 28i32) ^
                 (e >> 34i32 | e << 64i32 - 34i32) ^
                 (e >> 39i32 |
                      e <<
                          64i32 - 39i32)).wrapping_add(e & f ^ e & g ^ f & g);
        h = (h as libc::c_ulong).wrapping_add(t1) as uint64_t as uint64_t;
        d = t1.wrapping_add(t2);
        t1 =
            c.wrapping_add((h >> 14i32 | h << 64i32 - 14i32) ^
                               (h >> 18i32 | h << 64i32 - 18i32) ^
                               (h >> 41i32 |
                                    h <<
                                        64i32 -
                                            41i32)).wrapping_add(h & a ^
                                                                     !h &
                                                                         b).wrapping_add(k[(t
                                                                                                +
                                                                                                5i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[5]);
        w[5] =
            (w[5] as
                 libc::c_ulong).wrapping_add(((w[3] >> 19i32 |
                                                   w[3] << 64i32 - 19i32) ^
                                                  (w[3] >> 61i32 |
                                                       w[3] << 64i32 - 61i32)
                                                  ^
                                                  w[3] >>
                                                      6i32).wrapping_add(w[14]).wrapping_add((w[6]
                                                                                                  >>
                                                                                                  1i32
                                                                                                  |
                                                                                                  w[6]
                ...
                as uint64_t as uint64_t;
        t2 =
            ((d >> 28i32 | d << 64i32 - 28i32) ^
                 (d >> 34i32 | d << 64i32 - 34i32) ^
                 (d >> 39i32 |
                      d <<
                          64i32 - 39i32)).wrapping_add(d & e ^ d & f ^ e & f);
        g = (g as libc::c_ulong).wrapping_add(t1) as uint64_t as uint64_t;
        c = t1.wrapping_add(t2);
        t1 =
            b.wrapping_add((g >> 14i32 | g << 64i32 - 14i32) ^
                               (g >> 18i32 | g << 64i32 - 18i32) ^
                               (g >> 41i32 |
                                    g <<
                                        64i32 -
                                            41i32)).wrapping_add(g & h ^
                                                                     !g &
                                                                         a).wrapping_add(k[(t
                                                                                                +
                                                                                                6i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[6]);
        w[6] =
            (w[6] as
                 libc::c_ulong).wrapping_add(((w[4] >> 19i32 |
                                                   w[4] << 64i32 - 19i32) ^
                                                  (w[4] >> 61i32 |
                                                       w[4] << 64i32 - 61i32)
                                                  ^
                                                  w[4] >>
                                                      6i32).wrapping_add(w[15]).wrapping_add((w[7]
                                                                                                  >>
                                                                                                  1i32
                                                                                                  |
                                                                                                  w[7]
                ...
                as uint64_t as uint64_t;
        t2 =
            ((c >> 28i32 | c << 64i32 - 28i32) ^
                 (c >> 34i32 | c << 64i32 - 34i32) ^
                 (c >> 39i32 |
                      c <<
                          64i32 - 39i32)).wrapping_add(c & d ^ c & e ^ d & e);
        f = (f as libc::c_ulong).wrapping_add(t1) as uint64_t as uint64_t;
        b = t1.wrapping_add(t2);
        t1 =
            a.wrapping_add((f >> 14i32 | f << 64i32 - 14i32) ^
                               (f >> 18i32 | f << 64i32 - 18i32) ^
                               (f >> 41i32 |
                                    f <<
                                        64i32 -
                                            41i32)).wrapping_add(f & g ^
                                                                     !f &
                                                                         h).wrapping_add(k[(t
                                                                                                +
                                                                                                7i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[7]);
        w[7] =
            (w[7] as
                 libc::c_ulong).wrapping_add(((w[5] >> 19i32 |
                                                   w[5] << 64i32 - 19i32) ^
                                                  (w[5] >> 61i32 |
                                                       w[5] << 64i32 - 61i32)
                                                  ^
                                                  w[5] >>
                                                      6i32).wrapping_add(w[0]).wrapping_add((w[8]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[8]
                ...
                as uint64_t as uint64_t;
        t2 =
            ((b >> 28i32 | b << 64i32 - 28i32) ^
                 (b >> 34i32 | b << 64i32 - 34i32) ^
                 (b >> 39i32 |
                      b <<
                          64i32 - 39i32)).wrapping_add(b & c ^ b & d ^ c & d);
                                            ...
                                            41i32)).wrapping_add(e & f ^
                                                                     !e &
                                                                         g).wrapping_add(k[(t
                                                                                                ...
                                                                                                8i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[8]);
        w[8] =
            (w[8] as
                 libc::c_ulong).wrapping_add(((w[6] >> 19i32 |
                                                   w[6] << 64i32 - 19i32) ^
                                                  (w[6] >> 61i32 |
                                                       w[6] << 64i32 - 61i32)
                                                  ^
                                                  w[6] >>
                                                      6i32).wrapping_add(w[1]).wrapping_add((w[9]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[9]
                                            ...
                                            41i32)).wrapping_add(d & e ^
                                                                     !d &
                                                                         f).wrapping_add(k[(t
                                                                                                ...
                                                                                                9i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[9]);
        w[9] =
            (w[9] as
                 libc::c_ulong).wrapping_add(((w[7] >> 19i32 |
                                                   w[7] << 64i32 - 19i32) ^
                                                  (w[7] >> 61i32 |
                                                       w[7] << 64i32 - 61i32)
                                                  ^
                                                  w[7] >>
                                                      6i32).wrapping_add(w[2]).wrapping_add((w[10]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[10]
                                            ...
                                            41i32)).wrapping_add(c & d ^
                                                                     !c &
                                                                         e).wrapping_add(k[(t
                                                                                                ...
                                                                                                10i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[10]);
        w[10] =
            (w[10] as
                 libc::c_ulong).wrapping_add(((w[8] >> 19i32 |
                                                   w[8] << 64i32 - 19i32) ^
                                                  (w[8] >> 61i32 |
                                                       w[8] << 64i32 - 61i32)
                                                  ^
                                                  w[8] >>
                                                      6i32).wrapping_add(w[3]).wrapping_add((w[11]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[11]
                                            ...
                                            41i32)).wrapping_add(b & c ^
                                                                     !b &
                                                                         d).wrapping_add(k[(t
                                                                                                ...
                                                                                                11i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[11]);
        w[11] =
            (w[11] as
                 libc::c_ulong).wrapping_add(((w[9] >> 19i32 |
                                                   w[9] << 64i32 - 19i32) ^
                                                  (w[9] >> 61i32 |
                                                       w[9] << 64i32 - 61i32)
                                                  ^
                                                  w[9] >>
                                                      6i32).wrapping_add(w[4]).wrapping_add((w[12]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[12]
                                            ...
                                            41i32)).wrapping_add(a & b ^
                                                                     !a &
                                                                         c).wrapping_add(k[(t
                                                                                                ...
                                                                                                12i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[12]);
        w[12] =
            (w[12] as
                 libc::c_ulong).wrapping_add(((w[10] >> 19i32 |
                                                   w[10] << 64i32 - 19i32) ^
                                                  (w[10] >> 61i32 |
                                                       w[10] << 64i32 - 61i32)
                                                  ^
                                                  w[10] >>
                                                      6i32).wrapping_add(w[5]).wrapping_add((w[13]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[13]
                                            ...
                                            41i32)).wrapping_add(h & a ^
                                                                     !h &
                                                                         b).wrapping_add(k[(t
                                                                                                ...
                                                                                                13i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[13]);
        w[13] =
            (w[13] as
                 libc::c_ulong).wrapping_add(((w[11] >> 19i32 |
                                                   w[11] << 64i32 - 19i32) ^
                                                  (w[11] >> 61i32 |
                                                       w[11] << 64i32 - 61i32)
                                                  ^
                                                  w[11] >>
                                                      6i32).wrapping_add(w[6]).wrapping_add((w[14]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[14]
                                            ...
                                            41i32)).wrapping_add(g & h ^
                                                                     !g &
                                                                         a).wrapping_add(k[(t
                                                                                                ...
                                                                                                14i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[14]);
        w[14] =
            (w[14] as
                 libc::c_ulong).wrapping_add(((w[12] >> 19i32 |
                                                   w[12] << 64i32 - 19i32) ^
                                                  (w[12] >> 61i32 |
                                                       w[12] << 64i32 - 61i32)
                                                  ^
                                                  w[12] >>
                                                      6i32).wrapping_add(w[7]).wrapping_add((w[15]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[15]
                                            ...
                                            41i32)).wrapping_add(f & g ^
                                                                     !f &
                                                                         h).wrapping_add(k[(t
                                                                                                ...
                                                                                                15i32)
                                                                                               as
                                                                                               usize]).wrapping_add(w[15]);
        w[15] =
            (w[15] as
                 libc::c_ulong).wrapping_add(((w[13] >> 19i32 |
                                                   w[13] << 64i32 - 19i32) ^
                                                  (w[13] >> 61i32 |
                                                       w[13] << 64i32 - 61i32)
                                                  ^
                                                  w[13] >>
                                                      6i32).wrapping_add(w[8]).wrapping_add((w[0]
                                                                                                 >>
                                                                                                 1i32
                                                                                                 |
                                                                                                 w[0]
    ...
    (*hd).h0 =
        ((*hd).h0 as libc::c_ulong).wrapping_add(a) as uint64_t as uint64_t;
    (*hd).h1 =
        ((*hd).h1 as libc::c_ulong).wrapping_add(b) as uint64_t as uint64_t;
    (*hd).h2 =
        ((*hd).h2 as libc::c_ulong).wrapping_add(c) as uint64_t as uint64_t;
    (*hd).h3 =
        ((*hd).h3 as libc::c_ulong).wrapping_add(d) as uint64_t as uint64_t;
    (*hd).h4 =
        ((*hd).h4 as libc::c_ulong).wrapping_add(e) as uint64_t as uint64_t;
    (*hd).h5 =
        ((*hd).h5 as libc::c_ulong).wrapping_add(f) as uint64_t as uint64_t;
    (*hd).h6 =
        ((*hd).h6 as libc::c_ulong).wrapping_add(g) as uint64_t as uint64_t;
    (*hd).h7 =
        ((*hd).h7 as libc::c_ulong).wrapping_add(h) as uint64_t as uint64_t;
    return ((8i32 + 16i32) as
...
unsafe extern "C" fn _SHA512_transform(mut ctx: *mut SHA512_CONTEXT,
                                       mut data: *const libc::c_uchar)
 -> libc::c_uint {
    return (__transform(&mut (*ctx).state, data) as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn SHA512_write(mut hd: *mut SHA512_CONTEXT,
                                      mut inbuf: *const libc::c_uchar,
                                      mut inlen: libc::c_uint) {
    let mut stack_burn: libc::c_uint = 0i32 as libc::c_uint;
    if (*hd).count == 128i32 {
...
#[no_mangle]
pub unsafe extern "C" fn SHA512_final(mut outbuf: *mut libc::c_uchar,
    ...
    t = lsb;
    lsb =
        (lsb as libc::c_ulong).wrapping_add((*hd).count as libc::c_ulong) as
    ...
    buf_put_be64((*hd).buf.as_mut_ptr().offset(112) as *mut libc::c_void,
                 msb);
    buf_put_be64((*hd).buf.as_mut_ptr().offset(120) as *mut libc::c_void,
                 lsb);
 ...
 * heavily modified for GnuPG by Werner Koch <wk@gnupg.org>
 */
unsafe extern "C" fn do_encrypt_stream(mut ctx: *mut ARC4_CONTEXT,
                                       mut outbuf: *mut libc::c_uchar,
                                       mut inbuf: *const libc::c_uchar,
                                       mut len: libc::c_uint) {
    let mut i: libc::c_int =
        (*ctx).idx_i; /* and seems to be faster than mod */
    ...
    loop  {
        ...
        *fresh42 =
            (*fresh41 as libc::c_int ^
                 *sbox.offset((*sbox.offset(i as isize) as libc::c_int +
                                   *sbox.offset(j as isize) as libc::c_int &
                                   255i32) as isize) as libc::c_int) as
                libc::c_uchar
    }
    (*ctx).idx_i = i;
    (*ctx).idx_j = j;
...
#[no_mangle]
pub unsafe extern "C" fn ARC4(mut ctx: *mut ARC4_CONTEXT,
                              mut len: libc::c_uint,
                              mut inbuf: *const libc::c_uchar,
                              mut outbuf: *mut libc::c_uchar) {
...
unsafe extern "C" fn do_arcfour_setkey(mut ctx: *mut ARC4_CONTEXT,
    ...
    (*ctx).idx_i = (*ctx).idx_j;
    i = 0i32;
    while i < 256i32 { (*ctx).sbox[i as usize] = i as libc::c_uchar; i += 1 }
    i = 0i32;
    while i < 256i32 {
        karr[i as usize] =
            *key.offset((i as libc::c_uint).wrapping_rem(keylen) as isize);
        i += 1
    }
    j = 0i32;
    i = j;
    while i < 256i32 {
        let mut t: libc::c_int = 0;
        j =
            (j + (*ctx).sbox[i as usize] as libc::c_int +
                 karr[i as usize] as libc::c_int) % 256i32;
        t = (*ctx).sbox[i as usize] as libc::c_int;
        (*ctx).sbox[i as usize] = (*ctx).sbox[j as usize];
        (*ctx).sbox[j as usize] = t as libc::c_uchar;
        i += 1
    }
    memset(karr.as_mut_ptr() as *mut libc::c_void, 0i32,
           256i32 as libc::c_ulong);
}
#[no_mangle]
pub unsafe extern "C" fn ARC4_set_key(mut ctx: *mut ARC4_CONTEXT,
                                      mut keylen: libc::c_uint,
                                      mut key: *const libc::c_uchar) {
...
#[no_mangle]
pub unsafe extern "C" fn AES_ecb_encrypt(mut key: *const libc::c_uchar,
                                         mut key_len: size_t,
    ...
    let mut aes: AES_CONTEXT =
        AES_CONTEXT{nrounds: 0, rk: [0; 60], iv: [0; 16],};
    ...
    *cipher =
        new((*cipher_len as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_uchar>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_uchar;
    (*ctx).nrounds =
        rijndaelSetupEncrypt((*ctx).rk.as_mut_ptr(), key,
                             key_len.wrapping_mul(8i32 as libc::c_ulong) as
                                 libc::c_int);
    inptr = plain;
    outptr = *cipher;
    len = plain_len;
    while len >= 16i32 as libc::c_ulong {
        rijndaelEncrypt((*ctx).rk.as_mut_ptr(), (*ctx).nrounds, inptr,
                        outptr);
        inptr = inptr.offset(16);
        outptr = outptr.offset(16);
        len =
            (len as libc::c_ulong).wrapping_sub(16i32 as libc::c_ulong) as
                size_t as size_t
    }
    if len > 0i32 as libc::c_ulong {
        let mut block: [libc::c_uchar; 16] = [0; 16];
        memcpy(block.as_mut_ptr() as *mut libc::c_void,
               inptr as *const libc::c_void, len);
        rijndaelEncrypt((*ctx).rk.as_mut_ptr(), (*ctx).nrounds,
                        block.as_mut_ptr() as *const uint8_t, outptr);
...
#[no_mangle]
pub unsafe extern "C" fn AES_cbc_encrypt_tectonic(mut key:
                                                      *const libc::c_uchar,
                                                  mut key_len: size_t,
                                                  mut iv:
                                                      *const libc::c_uchar,
    ...
    ctx = &mut aes;
    if !iv.is_null() {
        memcpy((*ctx).iv.as_mut_ptr() as *mut libc::c_void,
               iv as *const libc::c_void, 16i32 as libc::c_ulong);
    } else {
        i = 0i32 as size_t;
   ...
   */
    padbytes =
        (if padding != 0 {
             (16i32 as
                  libc::c_ulong).wrapping_sub(plain_len.wrapping_rem(16i32 as
                                                                         libc::c_ulong))
    ...
    *cipher_len =
        plain_len.wrapping_add((if !iv.is_null() { 0i32 } else { 16i32 }) as
                                   libc::c_ulong).wrapping_add(padbytes as
                                                                   libc::c_ulong);
    *cipher =
        new((*cipher_len as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_uchar>()
    ...
    outptr = *cipher;
    if iv.is_null() {
        memcpy(outptr as *mut libc::c_void,
    ...
    while len >= 16i32 as libc::c_ulong {
        ...
        while i < 16i32 as libc::c_ulong {
            block[i as usize] =
                (*inptr.offset(i as isize) as libc::c_int ^
                     (*ctx).iv[i as usize] as libc::c_int) as libc::c_uchar;
            i = i.wrapping_add(1)
        }
        rijndaelEncrypt((*ctx).rk.as_mut_ptr(), (*ctx).nrounds,
                        block.as_mut_ptr() as *const uint8_t, outptr);
        memcpy((*ctx).iv.as_mut_ptr() as *mut libc::c_void,
               outptr as *const libc::c_void, 16i32 as libc::c_ulong);
        inptr = inptr.offset(16);
        outptr = outptr.offset(16);
        len =
            (len as libc::c_ulong).wrapping_sub(16i32 as libc::c_ulong) as
    ...
    if len > 0i32 as libc::c_ulong || padding != 0 {
        ...
        while i < 16i32 as libc::c_ulong {
            block[i as usize] =
                (padbytes ^ (*ctx).iv[i as usize] as libc::c_int) as
                    libc::c_uchar;
            i = i.wrapping_add(1)
        }
        rijndaelEncrypt((*ctx).rk.as_mut_ptr(), (*ctx).nrounds,
 ...
 */
unsafe extern "C" fn rijndaelSetupEncrypt(mut rk: *mut uint32_t,
 ...
 -> libc::c_int {
    ...
    *rk.offset(0) =
        (*key.offset(0) as uint32_t) << 24i32 ^
            (*key.offset(1) as uint32_t) << 16i32 ^
            (*key.offset(2) as uint32_t) << 8i32 ^ *key.offset(3) as uint32_t;
    *rk.offset(1) =
        (*key.offset(4).offset(0) as uint32_t) << 24i32 ^
            (*key.offset(4).offset(1) as uint32_t) << 16i32 ^
            (*key.offset(4).offset(2) as uint32_t) << 8i32 ^
            *key.offset(4).offset(3) as uint32_t;
    *rk.offset(2) =
        (*key.offset(8).offset(0) as uint32_t) << 24i32 ^
            (*key.offset(8).offset(1) as uint32_t) << 16i32 ^
            (*key.offset(8).offset(2) as uint32_t) << 8i32 ^
            *key.offset(8).offset(3) as uint32_t;
    *rk.offset(3) =
        (*key.offset(12).offset(0) as uint32_t) << 24i32 ^
            (*key.offset(12).offset(1) as uint32_t) << 16i32 ^
            (*key.offset(12).offset(2) as uint32_t) << 8i32 ^
            *key.offset(12).offset(3) as uint32_t;
    if keybits == 128i32 {
        loop  {
            temp = *rk.offset(3);
            *rk.offset(4) =
            ...
            *rk.offset(7) = *rk.offset(3) ^ *rk.offset(6);
            i = i.wrapping_add(1);
            if i == 10i32 as libc::c_uint { return 10i32 }
            rk = rk.offset(4)
        }
    }
    *rk.offset(4) =
        (*key.offset(16).offset(0) as uint32_t) << 24i32 ^
            (*key.offset(16).offset(1) as uint32_t) << 16i32 ^
            (*key.offset(16).offset(2) as uint32_t) << 8i32 ^
            *key.offset(16).offset(3) as uint32_t;
    *rk.offset(5) =
        (*key.offset(20).offset(0) as uint32_t) << 24i32 ^
            (*key.offset(20).offset(1) as uint32_t) << 16i32 ^
            (*key.offset(20).offset(2) as uint32_t) << 8i32 ^
            *key.offset(20).offset(3) as uint32_t;
    if keybits == 192i32 {
        loop  {
            temp = *rk.offset(5);
            *rk.offset(6) =
            ...
            *rk.offset(9) = *rk.offset(3) ^ *rk.offset(8);
            i = i.wrapping_add(1);
            if i == 8i32 as libc::c_uint { return 12i32 }
    ...
    *rk.offset(6) =
        (*key.offset(24).offset(0) as uint32_t) << 24i32 ^
            (*key.offset(24).offset(1) as uint32_t) << 16i32 ^
            (*key.offset(24).offset(2) as uint32_t) << 8i32 ^
            *key.offset(24).offset(3) as uint32_t;
    *rk.offset(7) =
        (*key.offset(28).offset(0) as uint32_t) << 24i32 ^
            (*key.offset(28).offset(1) as uint32_t) << 16i32 ^
            (*key.offset(28).offset(2) as uint32_t) << 8i32 ^
            *key.offset(28).offset(3) as uint32_t;
    if keybits == 256i32 {
        loop  {
            temp = *rk.offset(7);
            *rk.offset(8) =
            ...
            *rk.offset(11) = *rk.offset(3) ^ *rk.offset(10);
            i = i.wrapping_add(1);
            if i == 7i32 as libc::c_uint { return 14i32 }
            temp = *rk.offset(11);
            *rk.offset(12) =
...
unsafe extern "C" fn rijndaelEncrypt(mut rk: *const uint32_t,
  ...
  */
    s0 =
        (*plaintext.offset(0) as uint32_t) << 24i32 ^
            (*plaintext.offset(1) as uint32_t) << 16i32 ^
            (*plaintext.offset(2) as uint32_t) << 8i32 ^
            *plaintext.offset(3) as uint32_t ^ *rk.offset(0);
    s1 =
        (*plaintext.offset(4).offset(0) as uint32_t) << 24i32 ^
            (*plaintext.offset(4).offset(1) as uint32_t) << 16i32 ^
            (*plaintext.offset(4).offset(2) as uint32_t) << 8i32 ^
            *plaintext.offset(4).offset(3) as uint32_t ^ *rk.offset(1);
    s2 =
        (*plaintext.offset(8).offset(0) as uint32_t) << 24i32 ^
            (*plaintext.offset(8).offset(1) as uint32_t) << 16i32 ^
            (*plaintext.offset(8).offset(2) as uint32_t) << 8i32 ^
            *plaintext.offset(8).offset(3) as uint32_t ^ *rk.offset(2);
    s3 =
        (*plaintext.offset(12).offset(0) as uint32_t) << 24i32 ^
            (*plaintext.offset(12).offset(1) as uint32_t) << 16i32 ^
            (*plaintext.offset(12).offset(2) as uint32_t) << 8i32 ^
            *plaintext.offset(12).offset(3) as uint32_t ^ *rk.offset(3);
    /* round 1: */
    t0 =
