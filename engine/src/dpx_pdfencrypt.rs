...
extern "C" {
    ...
    #[no_mangle]
    fn SHA256_write(ctx: *mut SHA256_CONTEXT, inbuf: *const libc::c_uchar,
                    inlen: libc::c_uint);
    #[no_mangle]
    ...
    #[no_mangle]
    fn SHA512_write(ctx: *mut SHA512_CONTEXT, inbuf: *const libc::c_uchar,
                    inlen: libc::c_uint);
    #[no_mangle]
    fn SHA512_final(outbuf: *mut libc::c_uchar, ctx: *mut SHA512_CONTEXT);
    #[no_mangle]
    fn ARC4(ctx: *mut ARC4_CONTEXT, len: libc::c_uint,
            inbuf: *const libc::c_uchar, outbuf: *mut libc::c_uchar);
    #[no_mangle]
    fn ARC4_set_key(ctx: *mut ARC4_CONTEXT, keylen: libc::c_uint,
                    key: *const libc::c_uchar);
    #[no_mangle]
    fn AES_ecb_encrypt(key: *const libc::c_uchar, key_len: size_t,
                       plain: *const libc::c_uchar, plain_len: size_t,
                       cipher: *mut *mut libc::c_uchar,
                       cipher_len: *mut size_t);
    #[no_mangle]
    fn AES_cbc_encrypt_tectonic(key: *const libc::c_uchar, key_len: size_t,
...
static mut sec_data: pdf_sec =
    pdf_sec{key: [0; 32],
            ...
            R: 0,
            P: 0,
            setting: C2RustUnnamed_0{use_aes: 0, encrypt_metadata: 0,},
            label: C2RustUnnamed{objnum: 0, gennum: 0,},};
static mut padding_bytes: [libc::c_uchar; 32] =
    [0x28i32 as libc::c_uchar, 0xbfi32 as libc::c_uchar,
     0x4ei32 as libc::c_uchar, 0x5ei32 as libc::c_uchar,
     0x4ei32 as libc::c_uchar, 0x75i32 as libc::c_uchar,
     0x8ai32 as libc::c_uchar, 0x41i32 as libc::c_uchar,
     0x64i32 as libc::c_uchar, 0i32 as libc::c_uchar,
     0x4ei32 as libc::c_uchar, 0x56i32 as libc::c_uchar,
     0xffi32 as libc::c_uchar, 0xfai32 as libc::c_uchar,
     0x1i32 as libc::c_uchar, 0x8i32 as libc::c_uchar,
     0x2ei32 as libc::c_uchar, 0x2ei32 as libc::c_uchar,
     0i32 as libc::c_uchar, 0xb6i32 as libc::c_uchar,
     0xd0i32 as libc::c_uchar, 0x68i32 as libc::c_uchar,
     0x3ei32 as libc::c_uchar, 0x80i32 as libc::c_uchar,
     0x2fi32 as libc::c_uchar, 0xci32 as libc::c_uchar,
     0xa9i32 as libc::c_uchar, 0xfei32 as libc::c_uchar,
     0x64i32 as libc::c_uchar, 0x53i32 as libc::c_uchar,
     0x69i32 as libc::c_uchar, 0x7ai32 as libc::c_uchar];
...
unsafe extern "C" fn pdf_enc_init(mut use_aes: libc::c_int,
                                  mut encrypt_metadata: libc::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn pdf_enc_compute_id_string(mut dviname:
                                                       *const libc::c_char,
                                                   mut pdfname:
                                                       *const libc::c_char) {
    let mut p: *mut pdf_sec = &mut sec_data;
    ...
    } else { bd_time = gmtime(&mut current_time) }
    sprintf(date_string,
    ...
    MD5_write(&mut md5, date_string as *mut libc::c_uchar,
              strlen(date_string) as libc::c_uint);
    free(date_string as *mut libc::c_void);
    producer =
        new((strlen(b"%s-%s, Copyright 2002-2015 by Jin-Hwan Cho, Matthias Franz, and Shunsaku Hirata\x00"
                        as *const u8 as
                        *const libc::c_char).wrapping_add(strlen(b"xdvipdfmx\x00"
                                                                     as
                                                                     *const u8
                                                                     as
                                                                     *const libc::c_char)).wrapping_add(strlen(b"0.1\x00"
                                                                                                                   as
                                                                                                                   *const u8
                                                                                                                   as
                                                                                                                   *const libc::c_char))
    ...
    MD5_write(&mut md5, producer as *mut libc::c_uchar,
              strlen(producer) as libc::c_uint);
    free(producer as *mut libc::c_void);
    if !dviname.is_null() {
        MD5_write(&mut md5, dviname as *const libc::c_uchar,
                  strlen(dviname) as libc::c_uint);
    }
    if !pdfname.is_null() {
        MD5_write(&mut md5, pdfname as *const libc::c_uchar,
                  strlen(pdfname) as libc::c_uint);
    }
    MD5_final((*p).ID.as_mut_ptr(), &mut md5);
}
unsafe extern "C" fn passwd_padding(mut src: *const libc::c_char,
                                    mut dst: *mut libc::c_uchar) {
    let mut len: libc::c_int = 0;
    len =
        (if (32i32 as libc::c_ulong) < strlen(src) {
             32i32 as libc::c_ulong
         } else { strlen(src) }) as libc::c_int;
    memcpy(dst as *mut libc::c_void, src as *const libc::c_void,
           len as libc::c_ulong);
    memcpy(dst.offset(len as isize) as *mut libc::c_void,
           padding_bytes.as_ptr() as *const libc::c_void,
           (32i32 - len) as libc::c_ulong);
}
unsafe extern "C" fn compute_owner_password(mut p: *mut pdf_sec,
    ...
    let mut md5: MD5_CONTEXT =
        MD5_CONTEXT{A: 0,
                    ...
                    buf: [0; 64],
                    count: 0,};
    let mut arc4: ARC4_CONTEXT =
        ARC4_CONTEXT{idx_i: 0, idx_j: 0, sbox: [0; 256],};
    let mut hash: [libc::c_uchar; 32] = [0; 32];
    passwd_padding(if strlen(opasswd) > 0i32 as libc::c_ulong {
                       opasswd
                   } else { upasswd }, padded.as_mut_ptr());
    MD5_init(&mut md5);
    ...
    if (*p).R >= 3i32 {
       ...
       */
            MD5_init(&mut md5);
            MD5_write(&mut md5, hash.as_mut_ptr(),
    ...
    ARC4(&mut arc4, 32i32 as libc::c_uint, padded.as_mut_ptr(),
         tmp1.as_mut_ptr());
    if (*p).R >= 3i32 {
        i = 1i32;
        while i <= 19i32 {
            memcpy(tmp2.as_mut_ptr() as *mut libc::c_void,
                   tmp1.as_mut_ptr() as *const libc::c_void,
                   32i32 as libc::c_ulong);
            j = 0i32;
            while j < (*p).key_size {
                key[j as usize] =
                    (hash[j as usize] as libc::c_int ^ i) as libc::c_uchar;
                j += 1
            }
            ARC4_set_key(&mut arc4, (*p).key_size as libc::c_uint,
                         key.as_mut_ptr());
            ARC4(&mut arc4, 32i32 as libc::c_uint, tmp2.as_mut_ptr(),
                 tmp1.as_mut_ptr());
            i += 1
        }
    }
    memcpy((*p).O.as_mut_ptr() as *mut libc::c_void,
           hash.as_mut_ptr() as *const libc::c_void, 32i32 as libc::c_ulong);
}
unsafe extern "C" fn compute_encryption_key(mut p: *mut pdf_sec,
    ...
    tmp[0] =
        ((*p).P as libc::c_uchar as libc::c_int & 0xffi32) as libc::c_uchar;
    tmp[1] =
        (((*p).P >> 8i32) as libc::c_uchar as libc::c_int & 0xffi32) as
            libc::c_uchar;
    tmp[2] =
        (((*p).P >> 16i32) as libc::c_uchar as libc::c_int & 0xffi32) as
            libc::c_uchar;
    tmp[3] =
        (((*p).P >> 24i32) as libc::c_uchar as libc::c_int & 0xffi32) as
            libc::c_uchar;
    ...
    memcpy((*p).key.as_mut_ptr() as *mut libc::c_void,
           hash.as_mut_ptr() as *const libc::c_void,
           (*p).key_size as libc::c_ulong);
}
unsafe extern "C" fn compute_user_password(mut p: *mut pdf_sec,
    ...
    match (*p).R {
        2 => {
            ARC4_set_key(&mut arc4, (*p).key_size as libc::c_uint,
                         (*p).key.as_mut_ptr());
            ARC4(&mut arc4, 32i32 as libc::c_uint, padding_bytes.as_ptr(),
                 upasswd.as_mut_ptr());
        }
        3 | 4 => {
            let mut hash: [libc::c_uchar; 32] = [0; 32];
            ...
            let mut tmp2: [libc::c_uchar; 32] = [0; 32];
            MD5_init(&mut md5);
            MD5_write(&mut md5, padding_bytes.as_ptr(),
                      32i32 as libc::c_uint);
            MD5_write(&mut md5, (*p).ID.as_mut_ptr(), 16i32 as libc::c_uint);
            MD5_final(hash.as_mut_ptr(), &mut md5);
            ARC4_set_key(&mut arc4, (*p).key_size as libc::c_uint,
                         (*p).key.as_mut_ptr());
            ARC4(&mut arc4, 16i32 as libc::c_uint, hash.as_mut_ptr(),
                 tmp1.as_mut_ptr());
            i = 1i32;
            while i <= 19i32 {
                let mut key: [libc::c_uchar; 16] = [0; 16];
                ...
                while j < (*p).key_size {
                    key[j as usize] =
                        ((*p).key[j as usize] as libc::c_int ^ i) as
                            libc::c_uchar;
                    j += 1
                }
                ARC4_set_key(&mut arc4, (*p).key_size as libc::c_uint,
                             key.as_mut_ptr());
                ARC4(&mut arc4, 16i32 as libc::c_uint, tmp2.as_mut_ptr(),
                     tmp1.as_mut_ptr());
                i += 1
            }
            memcpy(upasswd.as_mut_ptr() as *mut libc::c_void,
                   tmp1.as_mut_ptr() as *const libc::c_void,
                   32i32 as libc::c_ulong);
        }
        _ => {
            _tt_abort(b"Invalid revision number.\x00" as *const u8 as
                          *const libc::c_char);
        }
    }
    memcpy((*p).U.as_mut_ptr() as *mut libc::c_void,
           upasswd.as_mut_ptr() as *const libc::c_void,
           32i32 as libc::c_ulong);
}
/* Algorithm 2.B from ISO 32000-1 chapter 7 */
unsafe extern "C" fn compute_hash_V5(mut hash: *mut libc::c_uchar,
                                     mut passwd: *const libc::c_char,
 ...
 /* revision */
 {
    ...
    SHA256_init(&mut sha);
    SHA256_write(&mut sha, passwd as *const libc::c_uchar,
    ...
    if R == 5i32 { return }
    memcpy(K.as_mut_ptr() as *mut libc::c_void, hash as *const libc::c_void,
           32i32 as libc::c_ulong);
    ...
    loop 
        ...
        K1_len =
            strlen(passwd).wrapping_add(K_len).wrapping_add((if !user_key.is_null()
                                                                {
                                                                 48i32
                                                             } else { 0i32 })
                                                                as
        ...
        memcpy(K1.as_mut_ptr() as *mut libc::c_void,
               passwd as *const libc::c_void, strlen(passwd));
        memcpy(K1.as_mut_ptr().offset(strlen(passwd) as isize) as
                   *mut libc::c_void, K.as_mut_ptr() as *const libc::c_void,
               K_len);
        if !user_key.is_null() {
            memcpy(K1.as_mut_ptr().offset(strlen(passwd) as
                                              isize).offset(K_len as isize) as
                       *mut libc::c_void, user_key as *const libc::c_void,
                   48i32 as libc::c_ulong);
        }
        Kr =
            new((K1_len.wrapping_mul(64i32 as libc::c_ulong) as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_uchar>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut libc::c_uchar;
        i = 0i32;
        while i < 64i32 {
            memcpy(Kr.offset((i as libc::c_ulong).wrapping_mul(K1_len) as
                                 isize) as *mut libc::c_void,
                   K1.as_mut_ptr() as *const libc::c_void, K1_len);
            i += 1
        }
        AES_cbc_encrypt_tectonic(K.as_mut_ptr(), 16i32 as size_t,
                                 K.as_mut_ptr().offset(16), 0i32, Kr,
        ...
        c =
            *E.offset(E_len.wrapping_sub(1i32 as libc::c_ulong) as isize) as
                libc::c_int;
        free(E as *mut libc::c_void);
        if nround >= 64i32 && c <= nround - 32i32 { break ; }
        nround += 1
    }
    memcpy(hash as *mut libc::c_void, K.as_mut_ptr() as *const libc::c_void,
           32i32 as libc::c_ulong);
}
unsafe extern "C" fn compute_owner_password_V5(mut p: *mut pdf_sec,
                                               mut oplain:
                                                   *const libc::c_char) {
    ...
    compute_hash_V5(hash.as_mut_ptr(), oplain, vsalt.as_mut_ptr(),
                    (*p).U.as_mut_ptr(), (*p).R);
    memcpy((*p).O.as_mut_ptr() as *mut libc::c_void,
           hash.as_mut_ptr() as *const libc::c_void, 32i32 as libc::c_ulong);
    memcpy((*p).O.as_mut_ptr().offset(32) as *mut libc::c_void,
           vsalt.as_mut_ptr() as *const libc::c_void, 8i32 as libc::c_ulong);
    memcpy((*p).O.as_mut_ptr().offset(40) as *mut libc::c_void,
           ksalt.as_mut_ptr() as *const libc::c_void, 8i32 as libc::c_ulong);
    compute_hash_V5(hash.as_mut_ptr(), oplain, ksalt.as_mut_ptr(),
                    (*p).U.as_mut_ptr(), (*p).R);
    memset(iv.as_mut_ptr() as *mut libc::c_void, 0i32,
           16i32 as libc::c_ulong);
    AES_cbc_encrypt_tectonic(hash.as_mut_ptr(), 32i32 as size_t,
                             iv.as_mut_ptr(), 0i32, (*p).key.as_mut_ptr(),
                             (*p).key_size as size_t, &mut OE, &mut OE_len);
    memcpy((*p).OE.as_mut_ptr() as *mut libc::c_void,
           OE as *const libc::c_void, 32i32 as libc::c_ulong);
    free(OE as *mut libc::c_void);
}
unsafe extern "C" fn compute_user_password_V5(mut p: *mut pdf_sec,
                                              mut uplain:
                                                  *const libc::c_char) {
    let mut vsalt: [libc::c_uchar; 8] = [0; 8];
    let mut ksalt: [libc::c_uchar; 8] = [0; 8];
    ...
    compute_hash_V5(hash.as_mut_ptr(), uplain, vsalt.as_mut_ptr(),
                    0 as *const libc::c_uchar, (*p).R);
    memcpy((*p).U.as_mut_ptr() as *mut libc::c_void,
           hash.as_mut_ptr() as *const libc::c_void, 32i32 as libc::c_ulong);
    memcpy((*p).U.as_mut_ptr().offset(32) as *mut libc::c_void,
           vsalt.as_mut_ptr() as *const libc::c_void, 8i32 as libc::c_ulong);
    memcpy((*p).U.as_mut_ptr().offset(40) as *mut libc::c_void,
           ksalt.as_mut_ptr() as *const libc::c_void, 8i32 as libc::c_ulong);
    compute_hash_V5(hash.as_mut_ptr(), uplain, ksalt.as_mut_ptr(),
                    0 as *const libc::c_uchar, (*p).R);
    memset(iv.as_mut_ptr() as *mut libc::c_void, 0i32,
           16i32 as libc::c_ulong);
    AES_cbc_encrypt_tectonic(hash.as_mut_ptr(), 32i32 as size_t,
                             iv.as_mut_ptr(), 0i32, (*p).key.as_mut_ptr(),
                             (*p).key_size as size_t, &mut UE, &mut UE_len);
    memcpy((*p).UE.as_mut_ptr() as *mut libc::c_void,
           UE as *const libc::c_void, 32i32 as libc::c_ulong);
    free(UE as *mut libc::c_void);
}
unsafe extern "C" fn check_version(mut p: *mut pdf_sec,
                                   mut version: libc::c_int) {
    if (*p).V > 2i32 && version < 4i32 {
        dpx_warning(b"Current encryption setting requires PDF version >= 1.4.\x00"
                        as *const u8 as *const libc::c_char);
        (*p).V = 1i32;
        (*p).key_size = 5i32
    } else if (*p).V == 4i32 && version < 5i32 {
        dpx_warning(b"Current encryption setting requires PDF version >= 1.5.\x00"
                        as *const u8 as *const libc::c_char);
        (*p).V = 2i32
...
unsafe extern "C" fn stringprep_profile(mut input: *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    while p < endptr {
        let mut ucv: int32_t =
            UC_UTF8_decode_char(&mut p as *mut *const libc::c_char as
                                    *mut *const libc::c_uchar,
                                endptr as *const libc::c_uchar);
        if !UC_is_valid(ucv) { return -1i32 }
    }
    *output =
        new((strlen(input).wrapping_add(1i32 as libc::c_ulong) as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
    strcpy(*output, input);
...
unsafe extern "C" fn preproc_password(mut passwd: *const libc::c_char,
                                      mut outbuf: *mut libc::c_char,
                                      mut V: libc::c_int) -> libc::c_int {
    ...
    match V {
        1 | 2 | 3 | 4 => {
            ...
            while i < strlen(passwd) {
                if (*passwd.offset(i as isize) as libc::c_int) < 0x20i32 ||
                    ...
                    dpx_warning(b"Non-ASCII-printable character found in password.\x00"
                                    as *const u8 as *const libc::c_char);
                }
                i = i.wrapping_add(1)
            }
            memcpy(outbuf as *mut libc::c_void, passwd as *const libc::c_void,
        ...
        5 => {
            ...
            if stringprep_profile(passwd, &mut saslpwd,
                                  b"SASLprep\x00" as *const u8 as
                                      *const libc::c_char, 0i32) != 0i32 {
                return -1i32
            } else {
                if !saslpwd.is_null() {
                    memcpy(outbuf as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn pdf_enc_set_passwd(mut bits: libc::c_uint,
    ...
    if (*p).key_size == 5i32 {
        ...
        dpx_warning(b"Key length %d unsupported.\x00" as *const u8 as
    ...
    match (*p).V {
        1 => {
            (*p).R =
                if ((*p).P as libc::c_long) < 0x100i64 { 2i32 } else { 3i32 }
        }
        2 | 3 => { (*p).R = 3i32 }
        4 => { (*p).R = 4i32 }
        5 => { (*p).R = 6i32 }
    ...
    memset(opasswd.as_mut_ptr() as *mut libc::c_void, 0i32,
           128i32 as libc::c_ulong);
    memset(upasswd.as_mut_ptr() as *mut libc::c_void, 0i32,
           128i32 as libc::c_ulong);
    /* Password must be preprocessed. */
    if preproc_password(oplain, opasswd.as_mut_ptr(), (*p).V) < 0i32 {
        dpx_warning(b"Invaid UTF-8 string for password.\x00" as *const u8 as
                        *const libc::c_char);
    }
    if preproc_password(uplain, upasswd.as_mut_ptr(), (*p).V) < 0i32 {
        dpx_warning(b"Invalid UTF-8 string for passowrd.\x00" as *const u8 as
                        *const libc::c_char);
    }
    if (*p).R >= 3i32 {
...
unsafe extern "C" fn calculate_key(mut p: *mut pdf_sec,
    ...
    tmp[(*p).key_size as usize] =
        ((*p).label.objnum as libc::c_uchar as libc::c_int & 0xffi32) as
            libc::c_uchar;
    tmp[((*p).key_size + 1i32) as usize] =
        (((*p).label.objnum >> 8i32) as libc::c_uchar as libc::c_int &
             0xffi32) as libc::c_uchar;
    tmp[((*p).key_size + 2i32) as usize] =
        (((*p).label.objnum >> 16i32) as libc::c_uchar as libc::c_int &
             0xffi32) as libc::c_uchar;
    tmp[((*p).key_size + 3i32) as usize] =
        ((*p).label.gennum as libc::c_uchar as libc::c_int & 0xffi32) as
            libc::c_uchar;
    tmp[((*p).key_size + 4i32) as usize] =
        (((*p).label.gennum as libc::c_int >> 8i32) as libc::c_uchar as
             libc::c_int & 0xffi32) as libc::c_uchar;
    if (*p).V >= 4i32 {
...
#[no_mangle]
pub unsafe extern "C" fn pdf_encrypt_data(mut plain: *const libc::c_uchar,
            ...
            *cipher =
                new((*cipher_len as uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_uchar>()
                                                         as libc::c_ulong) as
                        uint32_t) as *mut libc::c_uchar;
            ARC4_set_key(&mut arc4,
                         (if 16i32 < (*p).key_size + 5i32 {
                              16i32
                          } else { (*p).key_size + 5i32 }) as libc::c_uint,
                         key.as_mut_ptr());
            ARC4(&mut arc4, plain_len as libc::c_uint, plain, *cipher);
        }
        4 => {
            calculate_key(p, key.as_mut_ptr());
            AES_cbc_encrypt_tectonic(key.as_mut_ptr(),
                                     (if 16i32 < (*p).key_size + 5i32 {
                                          16i32
                                      } else { (*p).key_size + 5i32 }) as
                                         size_t, 0 as *const libc::c_uchar,
                                     1i32, plain, plain_len, cipher,
                                     cipher_len);
        }
        5 => {
            AES_cbc_encrypt_tectonic((*p).key.as_mut_ptr(),
                                     (*p).key_size as size_t,
                                     0 as *const libc::c_uchar, 1i32, plain,
                                     plain_len, cipher, cipher_len);
        }
        _ => {
            _tt_abort(b"pdfencrypt: Unexpected V value: %d\x00" as *const u8
                          as *const libc::c_char, (*p).V);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn pdf_encrypt_obj() -> *mut pdf_obj {
    ...
    pdf_add_dict(doc_encrypt,
                 pdf_new_name(b"Filter\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_name(b"Standard\x00" as *const u8 as
                                  *const libc::c_char));
    pdf_add_dict(doc_encrypt,
    ...
    if (*p).V >= 4i32 {
        ...
        StdCF = pdf_new_dict();
        pdf_add_dict(StdCF,
                     pdf_new_name(b"CFM\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_name(if (*p).V == 4i32 {
                                      b"AESV2\x00" as *const u8 as
                                          *const libc::c_char
                                  } else {
                                      b"AESV3\x00" as *const u8 as
                                          *const libc::c_char
                                  }));
        pdf_add_dict(StdCF,
                     pdf_new_name(b"AuthEvent\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_name(b"DocOpen\x00" as *const u8 as
                                      *const libc::c_char));
        pdf_add_dict(StdCF,
                     pdf_new_name(b"Length\x00" as *const u8 as
                                      *const libc::c_char),
        ...
        pdf_add_dict(CF,
                     pdf_new_name(b"StdCF\x00" as *const u8 as
                                      *const libc::c_char), StdCF);
        pdf_add_dict(doc_encrypt,
                     pdf_new_name(b"CF\x00" as *const u8 as
                                      *const libc::c_char), CF);
        pdf_add_dict(doc_encrypt,
                     pdf_new_name(b"StmF\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_name(b"StdCF\x00" as *const u8 as
                                      *const libc::c_char));
        pdf_add_dict(doc_encrypt,
                     pdf_new_name(b"StrF\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_name(b"StdCF\x00" as *const u8 as
                                      *const libc::c_char));
    }
    ...
    if (*p).V < 5i32 {
        pdf_add_dict(doc_encrypt,
                     pdf_new_name(b"O\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string((*p).O.as_mut_ptr() as
                                        *const libc::c_void,
                                    32i32 as size_t));
        pdf_add_dict(doc_encrypt,
                     pdf_new_name(b"U\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string((*p).U.as_mut_ptr() as
                                        *const libc::c_void,
                                    32i32 as size_t));
    } else if (*p).V == 5i32 {
        pdf_add_dict(doc_encrypt,
    ...
    if (*p).V == 5i32 {
        ...
        pdf_add_dict(doc_encrypt,
                     pdf_new_name(b"OE\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string((*p).OE.as_mut_ptr() as
                                        *const libc::c_void,
                                    32i32 as size_t));
        pdf_add_dict(doc_encrypt,
                     pdf_new_name(b"UE\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string((*p).UE.as_mut_ptr() as
                                        *const libc::c_void,
                                    32i32 as size_t));
        ...
        perms[8] =
            (if (*p).setting.encrypt_metadata != 0 {
                 'T' as i32
             } else { 'F' as i32 }) as libc::c_uchar;
        ...
        AES_ecb_encrypt((*p).key.as_mut_ptr(), (*p).key_size as size_t,
                        perms.as_mut_ptr(), 16i32 as size_t, &mut cipher,
                        &mut cipher_len);
        pdf_add_dict(doc_encrypt,
                     pdf_new_name(b"Perms\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string(cipher as *const libc::c_void,
                                    cipher_len));
    ...
    if (*p).R > 5i32 {
        ...
        pdf_add_dict(adbe,
                     pdf_new_name(b"BaseVersion\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_name(b"1.7\x00" as *const u8 as
                                      *const libc::c_char));
        pdf_add_dict(adbe,
                     pdf_new_name(b"ExtensionLevel\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_number((if (*p).R == 5i32 { 3i32 } else { 8i32 })
                                        as libc::c_double));
        pdf_add_dict(ext,
                     pdf_new_name(b"ADBE\x00" as *const u8 as
                                      *const libc::c_char), adbe);
        pdf_add_dict(catalog,
                     pdf_new_name(b"Extensions\x00" as *const u8 as
                                      *const libc::c_char), ext);
    }
    return doc_encrypt;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_enc_id_array() -> *mut pdf_obj {
    ...
    pdf_add_array(id,
                  pdf_new_string((*p).ID.as_mut_ptr() as *const libc::c_void,
                                 16i32 as size_t));
    pdf_add_array(id,
                  pdf_new_string((*p).ID.as_mut_ptr() as *const libc::c_void,
                                 16i32 as size_t));
...
#[no_mangle]
pub unsafe extern "C" fn pdf_enc_set_generation(mut generation:
                                                    libc::c_uint) {
    let mut p: *mut pdf_sec = &mut sec_data;
