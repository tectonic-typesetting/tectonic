...
*/
    #[no_mangle]
    fn bibtex_main(aux_file_name: *const libc::c_char) -> tt_history_t;
...
*/
    #[no_mangle]
    fn dvipdfmx_main(pdfname: *const libc::c_char,
                     dviname: *const libc::c_char,
                     pagespec: *const libc::c_char, opt_flags: libc::c_int,
                     translate: bool, compress: bool,
                     deterministic_tags: bool, quiet: bool,
                     verbose: libc::c_uint) -> libc::c_int;
 ...
 * "zzzbb". */
    ...
    #[no_mangle]
    fn tt_run_engine(dump_name: *mut libc::c_char,
                     input_file_name: *mut libc::c_char) -> tt_history_t;
}
...
pub struct tt_bridge_api_t {
    ...
    pub issue_warning: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                   _: *const libc::c_char)
                                  -> ()>,
    pub issue_error: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                 _: *const libc::c_char)
                                -> ()>,
    pub get_file_md5: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                  _: *const libc::c_char,
                                                  _: *mut libc::c_char)
                                 -> libc::c_int>,
    pub get_data_md5: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                  _: *const libc::c_char,
                                                  _: size_t,
                                                  _: *mut libc::c_char)
                                 -> libc::c_int>,
    pub output_open: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                 _: *const libc::c_char,
                                                 _: libc::c_int)
                                -> rust_output_handle_t>,
    pub output_open_stdout: Option<unsafe extern "C" fn(_: *mut libc::c_void)
                                       -> rust_output_handle_t>,
    pub output_putc: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                 _: rust_output_handle_t,
                                                 _: libc::c_int)
                                -> libc::c_int>,
    pub output_write: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                  _: rust_output_handle_t,
                                                  _: *const libc::c_char,
                                                  _: size_t) -> size_t>,
    pub output_flush: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                  _: rust_output_handle_t)
                                 -> libc::c_int>,
    pub output_close: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                  _: rust_output_handle_t)
                                 -> libc::c_int>,
    pub input_open: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                _: *const libc::c_char,
                                                _: tt_input_format_type,
                                                _: libc::c_int)
                               -> rust_input_handle_t>,
    pub input_open_primary: Option<unsafe extern "C" fn(_: *mut libc::c_void)
                                       -> rust_input_handle_t>,
    pub input_get_size: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                    _: rust_input_handle_t)
                                   -> size_t>,
    pub input_seek: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                _: rust_input_handle_t,
                                                _: ssize_t, _: libc::c_int,
                                                _: *mut libc::c_int)
                               -> size_t>,
    pub input_read: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                _: rust_input_handle_t,
                                                _: *mut libc::c_char,
                                                _: size_t) -> ssize_t>,
    pub input_getc: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                _: rust_input_handle_t)
                               -> libc::c_int>,
    pub input_ungetc: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                  _: rust_input_handle_t,
                                                  _: libc::c_int)
                                 -> libc::c_int>,
    pub input_close: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                                 _: rust_input_handle_t)
                                -> libc::c_int>,
}
#[derive ( Copy , Clone )]
...
static mut tectonic_global_bridge: *mut tt_bridge_api_t =
    0 as *const tt_bridge_api_t as *mut tt_bridge_api_t;
static mut jump_buffer: jmp_buf =
    [__jmp_buf_tag{__jmpbuf: [0; 8],
                   __mask_was_saved: 0,
                   __saved_mask: __sigset_t{__val: [0; 16],},}; 1];
static mut error_buf: [libc::c_char; 1024] =
...
#[no_mangle]
pub unsafe extern "C" fn _tt_abort(mut format: *const libc::c_char,
                                   mut args: ...) -> ! {
    let mut ap: ::std::ffi::VaListImpl;
    ap = args.clone();
    vsnprintf(error_buf.as_mut_ptr(), 1024i32 as libc::c_ulong, format,
              ap.as_va_list());
    longjmp(jump_buffer.as_mut_ptr(), 1i32);
}
#[no_mangle]
pub unsafe extern "C" fn tt_get_error_message() -> *const libc::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn tex_simple_main(mut api: *mut tt_bridge_api_t,
 ...
 -> libc::c_int {
    ...
    if _setjmp(jump_buffer.as_mut_ptr()) != 0 {
        ...
        return HISTORY_FATAL_ERROR as libc::c_int
    }
    rv = tt_run_engine(dump_name, input_file_name) as libc::c_int;
    tectonic_global_bridge = 0 as *mut tt_bridge_api_t;
    return rv;
}
#[no_mangle]
pub unsafe extern "C" fn dvipdfmx_simple_main(mut api: *mut tt_bridge_api_t,
                                              mut dviname: *mut libc::c_char,
                                              mut pdfname: *mut libc::c_char,
                                              mut compress: bool,
 ...
 -> libc::c_int {
    ...
    rv =
        dvipdfmx_main(pdfname, dviname, 0 as *const libc::c_char, 0i32,
                      0i32 != 0, compress, deterministic_tags, 0i32 != 0,
                      0i32 as libc::c_uint);
    tectonic_global_bridge = 0 as *mut tt_bridge_api_t;
    return rv;
}
#[no_mangle]
pub unsafe extern "C" fn bibtex_simple_main(mut api: *mut tt_bridge_api_t,
                                            mut aux_file_name:
                                                *mut libc::c_char)
 -> libc::c_int {
    let mut rv: libc::c_int = 0;
    ...
    rv = bibtex_main(aux_file_name) as libc::c_int;
    tectonic_global_bridge = 0 as *mut tt_bridge_api_t;
    return rv;
}
...
#[no_mangle]
pub unsafe extern "C" fn ttstub_issue_warning(mut format: *const libc::c_char,
                                              mut args: ...) {
    let mut ap:
            ::std::ffi::VaListImpl; /* Not ideal to (ab)use error_buf here */
    ap = args.clone(); /* Not ideal to (ab)use error_buf here */
    vsnprintf(error_buf.as_mut_ptr(), 1024i32 as libc::c_ulong, format,
              ap.as_va_list());
    (*tectonic_global_bridge).issue_warning.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                error_buf.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_issue_error(mut format: *const libc::c_char,
                                            mut args: ...) {
    let mut ap: ::std::ffi::VaListImpl;
    ap = args.clone();
    vsnprintf(error_buf.as_mut_ptr(), 1024i32 as libc::c_ulong, format,
              ap.as_va_list());
    (*tectonic_global_bridge).issue_error.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                              error_buf.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_fprintf(mut handle: rust_output_handle_t,
                                        mut format: *const libc::c_char,
                                        mut args: ...) -> libc::c_int {
    static mut fprintf_buf: [libc::c_char; 1024] =
    ...
    let mut len: libc::c_int =
        vsnprintf(fprintf_buf.as_mut_ptr(), 1024i32 as libc::c_ulong, format,
                  ap.as_va_list());
    if len >= 1024i32 {
        len = 1024i32 - 1i32;
        fprintf_buf[len as usize] = '\u{0}' as i32 as libc::c_char
    }
    if len >= 0i32 {
...
#[no_mangle]
pub unsafe extern "C" fn ttstub_get_file_md5(mut path: *const libc::c_char,
                                             mut digest: *mut libc::c_char)
 -> libc::c_int {
    return (*tectonic_global_bridge).get_file_md5.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                      path,
                                                                                      digest);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_get_data_md5(mut data: *const libc::c_char,
                                             mut len: size_t,
                                             mut digest: *mut libc::c_char)
 -> libc::c_int {
    return (*tectonic_global_bridge).get_data_md5.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                      data,
                                                                                      len,
                                                                                      digest);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_output_open(mut path: *const libc::c_char,
                                            mut is_gz: libc::c_int)
 -> rust_output_handle_t {
    return (*tectonic_global_bridge).output_open.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                     path,
                                                                                     is_gz);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_output_open_stdout() -> rust_output_handle_t {
    return (*tectonic_global_bridge).output_open_stdout.expect("non-null function pointer")((*tectonic_global_bridge).context);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_output_putc(mut handle: rust_output_handle_t,
                                            mut c: libc::c_int)
 -> libc::c_int {
    return (*tectonic_global_bridge).output_putc.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                     handle,
                                                                                     c);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_output_write(mut handle: rust_output_handle_t,
                                             mut data: *const libc::c_char,
                                             mut len: size_t) -> size_t {
    return (*tectonic_global_bridge).output_write.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                      handle,
                                                                                      data,
                                                                                      len);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_output_flush(mut handle: rust_output_handle_t)
 -> libc::c_int {
    return (*tectonic_global_bridge).output_flush.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                      handle);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_output_close(mut handle: rust_output_handle_t)
 -> libc::c_int {
    return (*tectonic_global_bridge).output_close.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                      handle);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_input_open(mut path: *const libc::c_char,
                                           mut format: tt_input_format_type,
                                           mut is_gz: libc::c_int)
 -> rust_input_handle_t {
    return (*tectonic_global_bridge).input_open.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                    path,
                                                                                    format,
                                                                                    is_gz);
}
...
pub unsafe extern "C" fn ttstub_input_open_primary() -> rust_input_handle_t {
    return (*tectonic_global_bridge).input_open_primary.expect("non-null function pointer")((*tectonic_global_bridge).context);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_input_get_size(mut handle:
                                                   rust_input_handle_t)
 -> size_t {
    return (*tectonic_global_bridge).input_get_size.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                        handle);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_input_seek(mut handle: rust_input_handle_t,
                                           mut offset: ssize_t,
                                           mut whence: libc::c_int)
 -> size_t {
    let mut internal_error: libc::c_int = 0i32;
    let mut rv: size_t =
        (*tectonic_global_bridge).input_seek.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                 handle,
                                                                                 offset,
                                                                                 whence,
                                                                                 &mut internal_error);
...
#[no_mangle]
pub unsafe extern "C" fn ttstub_input_read(mut handle: rust_input_handle_t,
                                           mut data: *mut libc::c_char,
                                           mut len: size_t) -> ssize_t {
    return (*tectonic_global_bridge).input_read.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                    handle,
                                                                                    data,
                                                                                    len);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_input_getc(mut handle: rust_input_handle_t)
 -> libc::c_int {
    return (*tectonic_global_bridge).input_getc.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                    handle);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_input_ungetc(mut handle: rust_input_handle_t,
                                             mut ch: libc::c_int)
 -> libc::c_int {
    return (*tectonic_global_bridge).input_ungetc.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                      handle,
                                                                                      ch);
}
#[no_mangle]
pub unsafe extern "C" fn ttstub_input_close(mut handle: rust_input_handle_t)
 -> libc::c_int {
    if (*tectonic_global_bridge).input_close.expect("non-null function pointer")((*tectonic_global_bridge).context,
                                                                                 handle)
           != 0 {
