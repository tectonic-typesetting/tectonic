 ...
 */
unsafe extern "C" fn check_stream_is_truetype(mut handle: rust_input_handle_t)
 -> bool {
    let mut n: libc::c_int = 0;
    ttstub_input_seek(handle, 0i32 as ssize_t, 0i32);
    n =
        ttstub_input_read(handle, _sbuf.as_mut_ptr(), 4i32 as size_t) as
            libc::c_int;
    ttstub_input_seek(handle, 0i32 as ssize_t, 0i32);
    if n != 4i32 { return 0i32 != 0 }
    if memcmp(_sbuf.as_mut_ptr() as *const libc::c_void,
              b"true\x00" as *const u8 as *const libc::c_char as
                  *const libc::c_void, 4i32 as libc::c_ulong) == 0 ||
           memcmp(_sbuf.as_mut_ptr() as *const libc::c_void,
                  b"\x00\x01\x00\x00\x00" as *const u8 as *const libc::c_char
                      as *const libc::c_void, 4i32 as libc::c_ulong) == 0 {
        /* This doesn't help... */
        return 1i32 != 0
    }
    if memcmp(_sbuf.as_mut_ptr() as *const libc::c_void,
              b"ttcf\x00" as *const u8 as *const libc::c_char as
                  *const libc::c_void, 4i32 as libc::c_ulong) == 0 {
        return 1i32 != 0
    }
    return 0i32 != 0;
...
unsafe extern "C" fn check_stream_is_opentype(mut handle: rust_input_handle_t)
 -> bool {
    let mut n: libc::c_int = 0;
    ttstub_input_seek(handle, 0i32 as ssize_t, 0i32);
    n =
    ...
    if n != 4i32 { return 0i32 != 0 }
    if memcmp(_sbuf.as_mut_ptr() as *const libc::c_void,
              b"OTTO\x00" as *const u8 as *const libc::c_char as
                  *const libc::c_void, 4i32 as libc::c_ulong) == 0 {
        return 1i32 != 0
    }
    return 0i32 != 0;
}
unsafe extern "C" fn check_stream_is_type1(mut handle: rust_input_handle_t)
 -> bool {
...
unsafe extern "C" fn check_stream_is_dfont(mut handle: rust_input_handle_t)
 -> bool {
    ...
    ttstub_input_seek(handle,
                      ...
                      0i32);
    ttstub_input_seek(handle,
                      pos.wrapping_add(tt_get_unsigned_pair(handle) as
                                           libc::c_uint) as ssize_t, 0i32);
...
unsafe extern "C" fn ensuresuffix(mut basename: *const libc::c_char,
                                  mut sfx: *const libc::c_char)
 -> *mut libc::c_char {
    let mut q: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    p =
        new((strlen(basename).wrapping_add(strlen(sfx)).wrapping_add(1i32 as
                                                                         libc::c_ulong)
                 as uint32_t as
    ...
    strcpy(p, basename);
    q = strrchr(p, '.' as i32);
    if q.is_null() && *sfx.offset(0) as libc::c_int != 0 { strcat(p, sfx); }
    return p;
}
/* tmp freed here */
/* Tectonic-enabled I/O alternatives */
#[no_mangle]
pub unsafe extern "C" fn dpx_tt_open(mut filename: *const libc::c_char,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn dpx_open_type1_file(mut filename:
                                                 *const libc::c_char)
 -> rust_input_handle_t {
    let mut handle: rust_input_handle_t = 0 as *mut libc::c_void;
...
#[no_mangle]
pub unsafe extern "C" fn dpx_open_truetype_file(mut filename:
                                                    *const libc::c_char)
 -> rust_input_handle_t {
    let mut handle: rust_input_handle_t = 0 as *mut libc::c_void;
...
#[no_mangle]
pub unsafe extern "C" fn dpx_open_opentype_file(mut filename:
                                                    *const libc::c_char)
 -> rust_input_handle_t {
    let mut handle: rust_input_handle_t = 0 as *mut libc::c_void;
    let mut q: *mut libc::c_char = 0 as *mut libc::c_char;
    q =
        ensuresuffix(filename,
                     b".otf\x00" as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn dpx_open_dfont_file(mut filename:
                                                 *const libc::c_char)
 -> rust_input_handle_t {
    let mut q: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut handle: rust_input_handle_t = 0 as *mut libc::c_void;
    ...
    if len > 6i32 &&
           strncmp(filename.offset(len as isize).offset(-6),
...
unsafe extern "C" fn dpx_get_tmpdir() -> *mut libc::c_char {
    ...
    while i > 1i32 as libc::c_ulong &&
              *ret.offset(i.wrapping_sub(1i32 as libc::c_ulong) as isize) as
                  libc::c_int == '/' as i32 {
...
pub unsafe extern "C" fn dpx_create_temp_file() -> *mut libc::c_char {
    ...
    n =
        strlen(tmpdir).wrapping_add(strlen(b"/dvipdfmx.XXXXXX\x00" as
                                               *const u8 as
    ...
    strcat(tmp, b"/dvipdfmx.XXXXXX\x00" as *const u8 as *const libc::c_char);
    let mut _fd: libc::c_int = mkstemp(tmp);
    if _fd != -1i32 {
        close(_fd);
    } else { tmp = mfree(tmp as *mut libc::c_void) as *mut libc::c_char }
    return tmp;
}
#[no_mangle]
pub unsafe extern "C" fn dpx_delete_old_cache(mut life: libc::c_int) {
    ...
    if life == -2i32 { keep_cache = -1i32 };
}
#[no_mangle]
pub unsafe extern "C" fn dpx_delete_temp_file(mut tmp: *mut libc::c_char,
                                              mut force: libc::c_int) {
    if tmp.is_null() { return }
    if force != 0 || keep_cache != 1i32 { remove(tmp); }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn dpx_file_apply_filter(mut cmdtmpl:
                                                   *const libc::c_char,
