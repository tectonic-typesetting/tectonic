...
#[no_mangle]
pub unsafe extern "C" fn sfnt_open(mut handle: rust_input_handle_t)
 -> *mut sfnt {
    ...
    if !handle.is_null() {
        ...
        __assert_fail(b"handle\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 37],
                                                &[libc::c_char; 37]>(b"sfnt *sfnt_open(rust_input_handle_t)\x00")).as_ptr()); /* resource name position from name_list */
    } /* resource flag (byte) + resource offset */
    ttstub_input_seek(handle, 0i32 as ssize_t, 0i32); /* mbz */
    sfont =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<sfnt>() as
                                                 libc::c_ulong) as uint32_t)
            as *mut sfnt;
    (*sfont).handle = handle;
    type_0 = tt_get_unsigned_quad((*sfont).handle);
    if type_0 as libc::c_ulong == 0x10000u64 ||
           type_0 as libc::c_ulong == 0x74727565u64 {
...
#[no_mangle]
pub unsafe extern "C" fn dfont_open(mut handle: rust_input_handle_t,
                                    mut index: libc::c_int) -> *mut sfnt {
    ...
    if !handle.is_null() {
        ...
        __assert_fail(b"handle\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 43],
                                                &[libc::c_char; 43]>(b"sfnt *dfont_open(rust_input_handle_t, int)\x00")).as_ptr());
    }
    ttstub_input_seek(handle, 0i32 as ssize_t, 0i32);
    sfont =
        new((1i32 as uint32_t as
    ...
    ttstub_input_seek((*sfont).handle,
                      map_pos.wrapping_add(0x18i32 as libc::c_uint) as
                          ssize_t, 0i32);
    tags_pos =
        map_pos.wrapping_add(tt_get_unsigned_pair((*sfont).handle) as
                                 libc::c_uint);
    ...
    while i as libc::c_int <= tags_num as libc::c_int {
        ...
        types_pos =
            tags_pos.wrapping_add(tt_get_unsigned_pair((*sfont).handle) as
                                      libc::c_uint);
        if tag as libc::c_ulong == 0x73666e74u64 { break ; }
        i = i.wrapping_add(1)
    }
    ...
    if index > types_num as libc::c_int {
        _tt_abort(b"Invalid index %d for dfont.\x00" as *const u8 as
    ...
    while i as libc::c_int <= types_num as libc::c_int {
        ...
        if i as libc::c_int == index { break ; }
        i = i.wrapping_add(1)
    }
    ...
    (*sfont).directory = 0 as *mut sfnt_table_directory;
    (*sfont).offset =
        (res_pos as libc::c_ulong &
             0xffffffu64).wrapping_add(rdata_pos as
    ...
    if !td.is_null() {
        if !(*td).tables.is_null() {
            ...
            while i < (*td).num_tables as libc::c_uint {
                free((*(*td).tables.offset(i as isize)).data as
                         *mut libc::c_void);
                i = i.wrapping_add(1)
            }
...
#[no_mangle]
pub unsafe extern "C" fn put_big_endian(mut s: *mut libc::c_void,
                                        mut q: SFNT_LONG, mut n: libc::c_int)
 -> libc::c_int {
 ...
 */
unsafe extern "C" fn convert_tag(mut tag: *mut libc::c_char,
                                 mut u_tag: uint32_t) {
    let mut i: libc::c_int = 0;
    i = 3i32;
    while i >= 0i32 {
        *tag.offset(i as isize) =
            u_tag.wrapping_rem(256i32 as libc::c_uint) as libc::c_char;
        u_tag =
            (u_tag as libc::c_uint).wrapping_div(256i32 as libc::c_uint) as
...
unsafe extern "C" fn sfnt_calc_checksum(mut data: *mut libc::c_void,
 ...
 -> SFNT_ULONG {
    ...
    while p < endptr {
        chksum =
            (chksum as
                 libc::c_uint).wrapping_add(((*p.offset(0) as libc::c_int) <<
                                                 8i32 * (3i32 - count)) as
                                                libc::c_uint) as SFNT_ULONG as
                SFNT_ULONG;
...
unsafe extern "C" fn find_table_index(mut td: *mut sfnt_table_directory,
                                      mut tag: *const libc::c_char)
 -> libc::c_int {
    let mut idx: libc::c_int = 0;
    if td.is_null() { return -1i32 }
    idx = 0i32;
    while idx < (*td).num_tables as libc::c_int {
        if memcmp((*(*td).tables.offset(idx as isize)).tag.as_mut_ptr() as
                      *const libc::c_void, tag as *const libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn sfnt_set_table(mut sfont: *mut sfnt,
                                        mut tag: *const libc::c_char,
    ...
    if !sfont.is_null() {
        ...
        __assert_fail(b"sfont\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 62],
                                                &[libc::c_char; 62]>(b"void sfnt_set_table(sfnt *, const char *, void *, SFNT_ULONG)\x00")).as_ptr());
    }
    td = (*sfont).directory;
    ...
    if idx < 0i32 {
        ...
        (*td).tables =
            renew((*td).tables as *mut libc::c_void,
                  ((*td).num_tables as uint32_t as
                       libc::c_ulong).wrapping_mul(::std::mem::size_of::<sfnt_table>()
                                                       as libc::c_ulong) as
                      uint32_t) as *mut sfnt_table;
        memcpy((*(*td).tables.offset(idx as isize)).tag.as_mut_ptr() as
                   *mut libc::c_void, tag as *const libc::c_void,
               4i32 as libc::c_ulong);
    }
    (*(*td).tables.offset(idx as isize)).check_sum =
        sfnt_calc_checksum(data, length);
...
#[no_mangle]
pub unsafe extern "C" fn sfnt_find_table_len(mut sfont: *mut sfnt,
                                             mut tag: *const libc::c_char)
 -> SFNT_ULONG {
    ...
    if !sfont.is_null() && !tag.is_null() {
        ...
        __assert_fail(b"sfont && tag\x00" as *const u8 as *const libc::c_char,
                      b"dpx-sfnt.c\x00" as *const u8 as *const libc::c_char,
                      299i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"SFNT_ULONG sfnt_find_table_len(sfnt *, const char *)\x00")).as_ptr());
    }
    td = (*sfont).directory;
    idx = find_table_index(td, tag);
    if idx < 0i32 {
        length = 0i32 as SFNT_ULONG
    } else { length = (*(*td).tables.offset(idx as isize)).length }
    return length;
}
#[no_mangle]
pub unsafe extern "C" fn sfnt_find_table_pos(mut sfont: *mut sfnt,
                                             mut tag: *const libc::c_char)
 -> SFNT_ULONG {
    ...
    if !sfont.is_null() && !tag.is_null() {
        ...
        __assert_fail(b"sfont && tag\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"SFNT_ULONG sfnt_find_table_pos(sfnt *, const char *)\x00")).as_ptr());
    }
    td = (*sfont).directory;
    idx = find_table_index(td, tag);
    if idx < 0i32 {
        offset = 0i32 as SFNT_ULONG
    } else { offset = (*(*td).tables.offset(idx as isize)).offset }
    return offset;
}
#[no_mangle]
pub unsafe extern "C" fn sfnt_locate_table(mut sfont: *mut sfnt,
                                           mut tag: *const libc::c_char)
 -> SFNT_ULONG {
    let mut offset: SFNT_ULONG = 0;
    if !sfont.is_null() && !tag.is_null() {
        ...
        __assert_fail(b"sfont && tag\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 51],
                                                &[libc::c_char; 51]>(b"SFNT_ULONG sfnt_locate_table(sfnt *, const char *)\x00")).as_ptr());
    }
    offset = sfnt_find_table_pos(sfont, tag);
    if offset == 0i32 as libc::c_uint {
        _tt_abort(b"sfnt: table not found...\x00" as *const u8 as
                      *const libc::c_char);
    }
...
#[no_mangle]
pub unsafe extern "C" fn sfnt_read_table_directory(mut sfont: *mut sfnt,
                                                   mut offset: SFNT_ULONG)
 -> libc::c_int {
    let mut td: *mut sfnt_table_directory = 0 as *mut sfnt_table_directory;
    let mut i: libc::c_uint = 0;
    let mut u_tag: uint32_t = 0;
    if !sfont.is_null() {
    } else {
        __assert_fail(b"sfont\x00" as *const u8 as *const libc::c_char,
                      b"dpx-sfnt.c\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 50],
                                                &[libc::c_char; 50]>(b"int sfnt_read_table_directory(sfnt *, SFNT_ULONG)\x00")).as_ptr());
    }
    if !(*sfont).directory.is_null() {
        release_directory((*sfont).directory);
    }
    td =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<sfnt_table_directory>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut sfnt_table_directory;
    (*sfont).directory = td;
    if !(*sfont).handle.is_null() {
    } else {
        __assert_fail(b"sfont->handle\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-sfnt.c\x00" as *const u8 as *const libc::c_char,
    ...
    (*td).flags =
        new(((*td).num_tables as uint32_t as
    ...
    while i < (*td).num_tables as libc::c_uint {
        ...
        convert_tag((*(*td).tables.offset(i as isize)).tag.as_mut_ptr(),
                    u_tag);
        (*(*td).tables.offset(i as isize)).check_sum =
            tt_get_unsigned_quad((*sfont).handle);
        (*(*td).tables.offset(i as isize)).offset =
            tt_get_unsigned_quad((*sfont).handle).wrapping_add((*sfont).offset);
        (*(*td).tables.offset(i as isize)).length =
            tt_get_unsigned_quad((*sfont).handle);
...
#[no_mangle]
pub unsafe extern "C" fn sfnt_require_table(mut sfont: *mut sfnt,
                                            mut tag: *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    if !sfont.is_null() && !(*sfont).directory.is_null() {
        ...
        __assert_fail(b"sfont && sfont->directory\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-sfnt.c\x00" as *const u8 as *const libc::c_char,
                      399i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 50],
                                                &[libc::c_char; 50]>(b"int sfnt_require_table(sfnt *, const char *, int)\x00")).as_ptr());
    }
    td = (*sfont).directory;
    idx = find_table_index(td, tag);
    if idx < 0i32 {
        if must_exist != 0 { return -1i32 }
    } else {
...
/* table directory */
#[no_mangle]
pub unsafe extern "C" fn sfnt_create_FontFile_stream(mut sfont: *mut sfnt)
 -> *mut pdf_obj {
    ...
    if !sfont.is_null() && !(*sfont).directory.is_null() {
        ...
        __assert_fail(b"sfont && sfont->directory\x00" as *const u8 as
                      ...
                      (*::std::mem::transmute::<&[u8; 45],
                                                &[libc::c_char; 45]>(b"pdf_obj *sfnt_create_FontFile_stream(sfnt *)\x00")).as_ptr());
    }
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*td).version as SFNT_LONG, 4i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*td).num_kept_tables as SFNT_LONG, 2i32) as
                     isize);
    sr =
        max2floor((*td).num_kept_tables as
                      libc::c_uint).wrapping_mul(16i32 as libc::c_uint) as
            libc::c_int;
    p = p.offset(put_big_endian(p as *mut libc::c_void, sr, 2i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                log2floor((*td).num_kept_tables as
                                              libc::c_uint) as SFNT_LONG,
                                2i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*td).num_kept_tables as libc::c_int * 16i32 -
                                    sr, 2i32) as isize);
    ...
    while i < (*td).num_tables as libc::c_int {
        ...
        if *(*td).flags.offset(i as isize) as libc::c_int & 1i32 << 0i32 != 0
           {
            if offset % 4i32 != 0i32 { offset += 4i32 - offset % 4i32 }
            p = wbuf.as_mut_ptr() as *mut libc::c_char;
            memcpy(p as *mut libc::c_void,
                   (*(*td).tables.offset(i as isize)).tag.as_mut_ptr() as
                       *const libc::c_void, 4i32 as libc::c_ulong);
            p = p.offset(4);
            p =
                p.offset(put_big_endian(p as *mut libc::c_void,
                                        (*(*td).tables.offset(i as
                                                                  isize)).check_sum
                                            as SFNT_LONG, 4i32) as isize);
            p =
                p.offset(put_big_endian(p as *mut libc::c_void, offset, 4i32)
                             as isize);
            p =
                p.offset(put_big_endian(p as *mut libc::c_void,
                                        (*(*td).tables.offset(i as
                                                                  isize)).length
                                            as SFNT_LONG, 4i32) as isize);
            pdf_add_stream(stream, wbuf.as_mut_ptr() as *const libc::c_void,
                           16i32);
            offset =
                (offset as
                     libc::c_uint).wrapping_add((*(*td).tables.offset(i as
                                                                          isize)).length)
        ...
        if *(*td).flags.offset(i as isize) as libc::c_int & 1i32 << 0i32 != 0
           {
            if offset % 4i32 != 0i32 {
                ...
                pdf_add_stream(stream,
                               padbytes.as_mut_ptr() as *const libc::c_void,
                               length);
                offset += length
            }
            if (*(*td).tables.offset(i as isize)).data.is_null() {
                if (*sfont).handle.is_null() {
                    ...
                    _tt_abort(b"Font file not opened or already closed...\x00"
                                  as *const u8 as *const libc::c_char);
                }
                length =
                    (*(*td).tables.offset(i as isize)).length as libc::c_int;
                ttstub_input_seek((*sfont).handle,
                                  (*(*td).tables.offset(i as isize)).offset as
                                      ssize_t, 0i32);
                while length > 0i32 {
                    nb_read =
                        ttstub_input_read((*sfont).handle,
                                          wbuf.as_mut_ptr() as
                                              *mut libc::c_char,
                                          (if length < 1024i32 {
                                               length
                                           } else { 1024i32 }) as size_t) as
                            libc::c_int;
                    if nb_read < 0i32 {
                        pdf_release_obj(stream);
                        _tt_abort(b"Reading file failed...\x00" as *const u8
                ...
                pdf_add_stream(stream,
                               (*(*td).tables.offset(i as isize)).data as
                                   *const libc::c_void,
                               (*(*td).tables.offset(i as isize)).length as
                                   libc::c_int);
                let ref mut fresh3 = (*(*td).tables.offset(i as isize)).data;
                *fresh3 =
                    mfree((*(*td).tables.offset(i as isize)).data as
    ...
    pdf_add_dict(stream_dict,
                 pdf_new_name(b"Length1\x00" as *const u8 as
                                  *const libc::c_char),
