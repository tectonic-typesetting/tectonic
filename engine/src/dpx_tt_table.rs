...
extern "C" {
    ...
    fn put_big_endian(s: *mut libc::c_void, q: SFNT_LONG, n: libc::c_int)
     -> libc::c_int;
    #[no_mangle]
    fn sfnt_find_table_len(sfont: *mut sfnt, tag: *const libc::c_char)
     -> SFNT_ULONG;
    #[no_mangle]
...
*/
#[no_mangle]
pub unsafe extern "C" fn tt_pack_head_table(mut table: *mut tt_head_table)
 -> *mut libc::c_char {
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).version as SFNT_LONG, 4i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).fontRevision as SFNT_LONG, 4i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).magicNumber as SFNT_LONG, 4i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).flags as SFNT_LONG, 2i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).unitsPerEm as SFNT_LONG, 2i32) as
                     isize);
    i = 0i32;
    while i < 8i32 {
        let fresh0 = p;
        p = p.offset(1);
        *fresh0 = (*table).created[i as usize] as libc::c_char;
        i += 1
    }
    i = 0i32;
    while i < 8i32 {
        let fresh1 = p;
        p = p.offset(1);
        *fresh1 = (*table).modified[i as usize] as libc::c_char;
        i += 1
    }
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).xMin as SFNT_LONG, 2i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).yMin as SFNT_LONG, 2i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).xMax as SFNT_LONG, 2i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).yMax as SFNT_LONG, 2i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).macStyle as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).lowestRecPPEM as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).fontDirectionHint as SFNT_LONG, 2i32)
                     as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).indexToLocFormat as SFNT_LONG, 2i32)
                     as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).glyphDataFormat as SFNT_LONG, 2i32)
                     as isize);
    return data;
}
#[no_mangle]
pub unsafe extern "C" fn tt_read_head_table(mut sfont: *mut sfnt)
 -> *mut tt_head_table {
    let mut i: libc::c_int = 0;
    let mut table: *mut tt_head_table =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<tt_head_table>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut tt_head_table;
...
#[no_mangle]
pub unsafe extern "C" fn tt_pack_maxp_table(mut table: *mut tt_maxp_table)
 -> *mut libc::c_char {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut data: *mut libc::c_char = 0 as *mut libc::c_char;
    data =
        new((32u64 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
    p = data;
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).numGlyphs as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).maxPoints as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).maxContours as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).maxZones as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).maxTwilightPoints as SFNT_LONG, 2i32)
                     as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).maxStorage as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).maxFunctionDefs as SFNT_LONG, 2i32)
                     as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).maxStackElements as SFNT_LONG, 2i32)
                     as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).maxComponentDepth as SFNT_LONG, 2i32)
                     as isize);
    return data;
}
#[no_mangle]
pub unsafe extern "C" fn tt_read_maxp_table(mut sfont: *mut sfnt)
 -> *mut tt_maxp_table {
    let mut table: *mut tt_maxp_table =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<tt_maxp_table>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut tt_maxp_table;
...
#[no_mangle]
pub unsafe extern "C" fn tt_pack_hhea_table(mut table: *mut tt_hhea_table)
 -> *mut libc::c_char {
    let mut i: libc::c_int = 0;
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut data: *mut libc::c_char = 0 as *mut libc::c_char;
    data =
        new((36u64 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
    p = data;
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).ascent as SFNT_LONG, 2i32) as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).descent as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).lineGap as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).advanceWidthMax as SFNT_LONG, 2i32)
                     as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
    ...
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).xMaxExtent as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).caretSlopeRise as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).caretSlopeRun as SFNT_LONG, 2i32) as
                     isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).caretOffset as SFNT_LONG, 2i32) as
                     isize);
    i = 0i32;
    while i < 4i32 {
        p =
            p.offset(put_big_endian(p as *mut libc::c_void,
                                    (*table).reserved[i as usize] as
                                        SFNT_LONG, 2i32) as isize);
        i += 1
    }
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
                                (*table).metricDataFormat as SFNT_LONG, 2i32)
                     as isize);
    p =
        p.offset(put_big_endian(p as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn tt_read_hhea_table(mut sfont: *mut sfnt)
 -> *mut tt_hhea_table {
    let mut i: libc::c_int = 0;
    let mut len: SFNT_ULONG = 0;
    let mut table: *mut tt_hhea_table =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<tt_hhea_table>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut tt_hhea_table;
    ...
    len =
        sfnt_find_table_len(sfont,
                            b"hmtx\x00" as *const u8 as *const libc::c_char);
    (*table).numOfExSideBearings =
        len.wrapping_sub(((*table).numOfLongHorMetrics as libc::c_int * 4i32)
                             as
...
/* vhea */
#[no_mangle]
pub unsafe extern "C" fn tt_read_vhea_table(mut sfont: *mut sfnt)
 -> *mut tt_vhea_table {
    let mut i: libc::c_int = 0; /* ushort ? */
    let mut len: SFNT_ULONG = 0;
    let mut table: *mut tt_vhea_table =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<tt_vhea_table>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut tt_vhea_table;
    ...
    (*table).numOfExSideBearings =
        len.wrapping_sub(((*table).numOfLongVerMetrics as libc::c_int * 4i32)
                             as
                             libc::c_uint).wrapping_div(2i32 as libc::c_uint)
            as USHORT;
    return table;
...
#[no_mangle]
pub unsafe extern "C" fn tt_read_VORG_table(mut sfont: *mut sfnt)
 -> *mut tt_VORG_table {
    ...
    if offset > 0i32 as libc::c_uint {
        vorg =
            new((1i32 as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<tt_VORG_table>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut tt_VORG_table;
        ...
        if tt_get_unsigned_pair((*sfont).handle) as libc::c_int != 1i32 ||
            ...
            _tt_abort(b"Unsupported VORG version.\x00" as *const u8 as
                          *const libc::c_char);
        }
        ...
        (*vorg).vertOriginYMetrics =
            new(((*vorg).numVertOriginYMetrics as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<tt_vertOriginYMetrics>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut tt_vertOriginYMetrics;
        /*
    ...
    } else { vorg = 0 as *mut tt_VORG_table }
    return vorg;
}
/*
 * hmtx and vmtx
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn tt_read_longMetrics(mut sfont: *mut sfnt,
 ...
 -> *mut tt_longMetrics {
    ...
    m =
        new((numGlyphs as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<tt_longMetrics>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut tt_longMetrics;
    gid = 0i32 as USHORT;
    while (gid as libc::c_int) < numGlyphs as libc::c_int {
        ...
        if (gid as libc::c_int) <
               numLongMetrics as libc::c_int +
                   numExSideBearings as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tt_read_os2__table(mut sfont: *mut sfnt)
 -> *mut tt_os2__table {
    let mut table: *mut tt_os2__table = 0 as *mut tt_os2__table;
    let mut i: libc::c_int = 0;
    table =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<tt_os2__table>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut tt_os2__table;
    if sfnt_find_table_pos(sfont,
        ...
        i = 0i32;
        while i < 4i32 {
            (*table).achVendID[i as usize] =
                tt_get_signed_byte((*sfont).handle);
            i += 1
        }
...
unsafe extern "C" fn tt_get_name(mut sfont: *mut sfnt,
                                 mut dest: *mut libc::c_char,
                                 mut destlen: USHORT, mut plat_id: USHORT,
                                 mut enco_id: USHORT, mut lang_id: USHORT,
                                 mut name_id: USHORT) -> USHORT {
    ...
    if tt_get_unsigned_pair((*sfont).handle) != 0 {
        _tt_abort(b"Expecting zero\x00" as *const u8 as *const libc::c_char);
    }
    ...
    while i < num_names as libc::c_int {
        ...
        if p_id as libc::c_int == plat_id as libc::c_int &&
            ...
            if length as libc::c_int > destlen as libc::c_int - 1i32 {
                dpx_warning(b"Name string too long (%u), truncating to %u\x00"
                                as *const u8 as *const libc::c_char,
                            length as libc::c_int, destlen as libc::c_int);
                length = (destlen as libc::c_int - 1i32) as USHORT
            }
            ttstub_input_seek((*sfont).handle,
                              name_offset.wrapping_add(string_offset as
    ...
    if i == num_names as libc::c_int { length = 0i32 as USHORT }
    return length;
}
/* This is dvipdfmx, an eXtended version of dvipdfm by Mark A. Wicks.
...
/* name table */
#[no_mangle]
pub unsafe extern "C" fn tt_get_ps_fontname(mut sfont: *mut sfnt,
                                            mut dest: *mut libc::c_char,
                                            mut destlen: USHORT) -> USHORT {
    let mut namelen: USHORT = 0i32 as USHORT;
    /* First try Mac-Roman PS name and then Win-Unicode PS name */
    namelen =
        tt_get_name(sfont, dest, destlen, 1i32 as USHORT, 0i32 as USHORT,
                    0i32 as USHORT, 6i32 as USHORT);
    if namelen as libc::c_int != 0i32 ||
           {
               namelen =
                   tt_get_name(sfont, dest, destlen, 3i32 as USHORT,
                               1i32 as USHORT, 0x409u32 as USHORT,
                               6i32 as USHORT);
           ...
           } ||
           {
               namelen =
                   tt_get_name(sfont, dest, destlen, 3i32 as USHORT,
                               5i32 as USHORT, 0x412u32 as USHORT,
                               6i32 as USHORT);
               namelen as libc::c_int != 0i32
           } {
        return namelen
    }
    dpx_warning(b"No valid PostScript name available\x00" as *const u8 as
                    *const libc::c_char);
    /*
  ...
  */
    namelen =
        tt_get_name(sfont, dest, destlen, 1i32 as USHORT, 0i32 as USHORT,
                    0xffffu32 as USHORT, 6i32 as USHORT);
    if namelen as libc::c_int == 0i32 {
        /*
