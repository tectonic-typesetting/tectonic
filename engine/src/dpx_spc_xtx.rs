 ...
 */
    ...
    fn spc_util_read_colorspec(spe: *mut spc_env, colorspec: *mut pdf_color,
     ...
     -> libc::c_int;
    #[no_mangle]
    fn spc_util_read_numbers(values: *mut libc::c_double,
                             num_values: libc::c_int, args: *mut spc_arg)
     -> libc::c_int;
}
...
*/
#[no_mangle]
pub unsafe extern "C" fn spc_handler_xtx_do_transform(mut x_user:
                                                          libc::c_double,
                                                      mut y_user:
                                                          libc::c_double,
                                                      mut a: libc::c_double,
...
unsafe extern "C" fn spc_handler_xtx_scale(mut spe: *mut spc_env,
                                           mut args: *mut spc_arg)
 -> libc::c_int {
    let mut values: [libc::c_double; 2] = [0.; 2];
    if spc_util_read_numbers(&mut *values.as_mut_ptr().offset(0), 2i32, args)
           < 2i32 {
        return -1i32
    }
    (*args).curptr = (*args).endptr;
    return spc_handler_xtx_do_transform((*spe).x_user, (*spe).y_user,
                                        values[0], 0i32 as libc::c_double,
                                        0i32 as libc::c_double, values[1],
                                        0i32 as libc::c_double,
                                        0i32 as libc::c_double);
}
/* Scaling without gsave/grestore. */
static mut scaleFactors: *mut pdf_coord =
    0 as *const pdf_coord as *mut pdf_coord;
static mut scaleFactorCount: libc::c_int = -1i32;
unsafe extern "C" fn spc_handler_xtx_bscale(mut spe: *mut spc_env,
                                            mut args: *mut spc_arg)
 -> libc::c_int {
    let mut values: [libc::c_double; 2] = [0.; 2];
    scaleFactorCount += 1;
    if scaleFactorCount & 0xfi32 == 0 {
        scaleFactors =
            xrealloc(scaleFactors as *mut libc::c_void,
                     ((scaleFactorCount + 16i32) as
    ...
    (*scaleFactors.offset(scaleFactorCount as isize)).x =
        1i32 as libc::c_double / values[0];
    (*scaleFactors.offset(scaleFactorCount as isize)).y =
        1i32 as libc::c_double / values[1];
    (*args).curptr = (*args).endptr;
    return spc_handler_xtx_do_transform((*spe).x_user, (*spe).y_user,
                                        values[0], 0i32 as libc::c_double,
                                        0i32 as libc::c_double, values[1],
...
unsafe extern "C" fn spc_handler_xtx_escale(mut spe: *mut spc_env,
                                            mut args: *mut spc_arg)
 -> libc::c_int {
    ...
    (*args).curptr = (*args).endptr;
    return spc_handler_xtx_do_transform((*spe).x_user, (*spe).y_user,
                                        factor.x, 0i32 as libc::c_double,
                                        0i32 as libc::c_double, factor.y,
                                        0i32 as libc::c_double,
                                        0i32 as libc::c_double);
}
unsafe extern "C" fn spc_handler_xtx_rotate(mut spe: *mut spc_env,
                                            mut args: *mut spc_arg)
 -> libc::c_int {
    let mut value: libc::c_double = 0.;
    if spc_util_read_numbers(&mut value, 1i32, args) < 1i32 { return -1i32 }
    (*args).curptr = (*args).endptr;
    return spc_handler_xtx_do_transform((*spe).x_user, (*spe).y_user,
                                        cos(value * 3.14159265358979323846f64
                                                / 180i32 as libc::c_double),
                                        sin(value * 3.14159265358979323846f64
                                                / 180i32 as libc::c_double),
                                        -sin(value * 3.14159265358979323846f64
                                                 / 180i32 as libc::c_double),
                                        cos(value * 3.14159265358979323846f64
...
#[no_mangle]
pub unsafe extern "C" fn spc_handler_xtx_gsave(mut spe: *mut spc_env,
                                               mut args: *mut spc_arg)
 -> libc::c_int {
    pdf_dev_gsave();
    return 0i32;
...
#[no_mangle]
pub unsafe extern "C" fn spc_handler_xtx_grestore(mut spe: *mut spc_env,
                                                  mut args: *mut spc_arg)
 -> libc::c_int {
    pdf_dev_grestore();
    /*
 ...
 */
unsafe extern "C" fn spc_handler_xtx_papersize(mut spe: *mut spc_env,
                                               mut args: *mut spc_arg)
 -> libc::c_int {
    return 0i32;
}
unsafe extern "C" fn spc_handler_xtx_backgroundcolor(mut spe: *mut spc_env,
                                                     mut args: *mut spc_arg)
 -> libc::c_int {
...
unsafe extern "C" fn spc_handler_xtx_fontmapline(mut spe: *mut spc_env,
                                                 mut ap: *mut spc_arg)
 -> libc::c_int {
    ...
    if (*ap).curptr >= (*ap).endptr {
        spc_warn(spe,
                 b"Empty fontmapline special?\x00" as *const u8 as
                     *const libc::c_char);
        return -1i32
    }
...
unsafe extern "C" fn spc_handler_xtx_fontmapfile(mut spe: *mut spc_env,
                                                 mut args: *mut spc_arg)
 -> libc::c_int {
...
unsafe extern "C" fn spc_handler_xtx_initoverlay(mut spe: *mut spc_env,
                                                 mut args: *mut spc_arg)
 -> libc::c_int {
    skip_white(&mut (*args).curptr, (*args).endptr);
    if (*args).curptr >= (*args).endptr { return -1i32 }
    strncpy(overlay_name.as_mut_ptr(), (*args).curptr,
            (*args).endptr.wrapping_offset_from((*args).curptr) as
                libc::c_long as libc::c_ulong);
    overlay_name[(*args).endptr.wrapping_offset_from((*args).curptr) as
                     libc::c_long as usize] = 0i32 as libc::c_char;
    (*args).curptr = (*args).endptr;
    return 0i32;
}
unsafe extern "C" fn spc_handler_xtx_clipoverlay(mut spe: *mut spc_env,
                                                 mut args: *mut spc_arg)
 -> libc::c_int {
    skip_white(&mut (*args).curptr, (*args).endptr);
    if (*args).curptr >= (*args).endptr { return -1i32 }
    pdf_dev_grestore();
    pdf_dev_gsave();
    if strncmp(overlay_name.as_mut_ptr(), (*args).curptr,
               strlen(overlay_name.as_mut_ptr())) != 0i32 &&
           strncmp(b"all\x00" as *const u8 as *const libc::c_char,
                   (*args).curptr,
                   strlen(b"all\x00" as *const u8 as *const libc::c_char)) !=
               0i32 {
        pdf_doc_add_page_content(b" 0 0 m W n\x00" as *const u8 as
                                     *const libc::c_char,
...
unsafe extern "C" fn spc_handler_xtx_renderingmode(mut spe: *mut spc_env,
                                                   mut args: *mut spc_arg)
 -> libc::c_int {
    let mut value: libc::c_double = 0.;
    if spc_util_read_numbers(&mut value, 1i32, args) < 1i32 { return -1i32 }
    ...
    pdf_doc_add_page_content(work_buffer.as_mut_ptr(),
                             strlen(work_buffer.as_mut_ptr()) as
                                 libc::c_uint);
    skip_white(&mut (*args).curptr, (*args).endptr);
...
unsafe extern "C" fn spc_handler_xtx_unsupportedcolor(mut spe: *mut spc_env,
                                                      mut args: *mut spc_arg)
 -> libc::c_int {
    spc_warn(spe,
...
unsafe extern "C" fn spc_handler_xtx_unsupported(mut spe: *mut spc_env,
                                                 mut args: *mut spc_arg)
 -> libc::c_int {
    spc_warn(spe,
             b"xetex-style \\special{x:%s} is not supported by this driver.\x00"
                 as *const u8 as *const libc::c_char, (*args).command);
    (*args).curptr = (*args).endptr;
    return 0i32;
}
static mut xtx_handlers: [spc_handler; 21] =
    unsafe {
        [{
             let mut init =
                 spc_handler{key:
                                 b"textcolor\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_unsupportedcolor as
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"textcolorpush\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_unsupportedcolor as
                                          unsafe extern "C" fn(_:
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"textcolorpop\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_unsupportedcolor as
                                          unsafe extern "C" fn(_:
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"rulecolor\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_unsupportedcolor as
                                          unsafe extern "C" fn(_:
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"rulecolorpush\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_unsupportedcolor as
                                          unsafe extern "C" fn(_:
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"rulecolorpop\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_unsupportedcolor as
                                          unsafe extern "C" fn(_:
             ...
             let mut init =
                 spc_handler{key:
                                 b"papersize\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_papersize as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"backgroundcolor\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_backgroundcolor as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"gsave\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_gsave as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
             ...
             let mut init =
                 spc_handler{key:
                                 b"grestore\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_grestore as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"bscale\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_bscale as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"escale\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_escale as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
             ...
             let mut init =
                 spc_handler{key:
                                 b"rotate\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_rotate as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"fontmapline\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_fontmapline as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"fontmapfile\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_fontmapfile as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"shadow\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_unsupported as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"colorshadow\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_unsupported as
                                          unsafe extern "C" fn(_:
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"renderingmode\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_renderingmode as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"initoverlay\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_initoverlay as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
         ...
         },
         {
             let mut init =
                 spc_handler{key:
                                 b"clipoverlay\x00" as *const u8 as
                                     *const libc::c_char,
                             exec:
                                 Some(spc_handler_xtx_clipoverlay as
                                          unsafe extern "C" fn(_:
                                                                   *mut spc_env,
                                                               _:
                                                                   *mut spc_arg)
...
#[no_mangle]
pub unsafe extern "C" fn spc_xtx_check_special(mut buf: *const libc::c_char,
    ...
    if p.offset(strlen(b"x:\x00" as *const u8 as *const libc::c_char) as
                    isize) <= endptr &&
           memcmp(p as *const libc::c_void,
                  b"x:\x00" as *const u8 as *const libc::c_char as
                      *const libc::c_void,
                  strlen(b"x:\x00" as *const u8 as *const libc::c_char)) == 0
       {
        return 1i32 != 0
    }
    return 0i32 != 0;
...
*/
#[no_mangle]
pub unsafe extern "C" fn spc_xtx_setup_handler(mut sph: *mut spc_handler,
                                               mut spe: *mut spc_env,
                                               mut ap: *mut spc_arg)
 -> libc::c_int {
    ...
    skip_white(&mut (*ap).curptr, (*ap).endptr);
    if (*ap).curptr.offset(strlen(b"x:\x00" as *const u8 as
       ...
       {
        spc_warn(spe,
                 b"Not x: special???\x00" as *const u8 as
                     *const libc::c_char);
        return -1i32
    }
    (*ap).curptr =
        (*ap).curptr.offset(strlen(b"x:\x00" as *const u8 as
                                       *const libc::c_char) as isize);
    skip_white(&mut (*ap).curptr, (*ap).endptr);
    ...
    if !q.is_null() {
        ...
        while (i as libc::c_ulong) <
                  (::std::mem::size_of::<[spc_handler; 21]>() as
