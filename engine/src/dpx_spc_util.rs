...
extern "C" {
    ...
    #[no_mangle]
    fn pdf_color_spotcolor(color: *mut pdf_color,
                           color_name: *mut libc::c_char, c: libc::c_double)
     -> libc::c_int;
    #[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn spc_util_read_numbers(mut values:
                                                   *mut libc::c_double,
...
unsafe extern "C" fn rgb_color_from_hsv(mut color: *mut pdf_color,
                                        mut h: libc::c_double,
                                        mut s: libc::c_double,
                                        mut v: libc::c_double) {
    ...
    if !color.is_null() {
        ...
        __assert_fail(b"color\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 61],
                                                &[libc::c_char; 61]>(b"void rgb_color_from_hsv(pdf_color *, double, double, double)\x00")).as_ptr());
    }
    b = v;
    g = b;
    r = g;
...
unsafe extern "C" fn spc_read_color_color(mut spe: *mut spc_env,
 ...
 -> libc::c_int {
    ...
    if streq_ptr(q, b"rgb\x00" as *const u8 as *const libc::c_char) {
        ...
        if nc != 3i32 {
            spc_warn(spe,
                     b"Invalid value for RGB color specification.\x00" as
                         *const u8 as *const libc::c_char);
            error = -1i32
        } else { pdf_color_rgbcolor(colorspec, cv[0], cv[1], cv[2]); }
    } else if streq_ptr(q, b"cmyk\x00" as *const u8 as *const libc::c_char) {
        /* Handle cmyk color */
        nc = spc_util_read_numbers(cv.as_mut_ptr(), 4i32, ap);
        if nc != 4i32 {
            spc_warn(spe,
                     b"Invalid value for CMYK color specification.\x00" as
                         *const u8 as *const libc::c_char);
            error = -1i32
        } else { pdf_color_cmykcolor(colorspec, cv[0], cv[1], cv[2], cv[3]); }
    } else if streq_ptr(q, b"gray\x00" as *const u8 as *const libc::c_char) {
        /* Handle gray */
        nc = spc_util_read_numbers(cv.as_mut_ptr(), 1i32, ap);
        if nc != 1i32 {
            spc_warn(spe,
                     b"Invalid value for gray color specification.\x00" as
                         *const u8 as *const libc::c_char);
            error = -1i32
        } else { pdf_color_graycolor(colorspec, cv[0]); }
    } else if streq_ptr(q, b"spot\x00" as *const u8 as *const libc::c_char) {
        /* Handle spot colors */
        let mut color_name: *mut libc::c_char =
            parse_c_ident(&mut (*ap).curptr,
                          (*ap).endptr); /* Must be a "named" color */
        if color_name.is_null() {
            spc_warn(spe,
                     b"No valid spot color name specified?\x00" as *const u8
        ...
        if nc != 1i32 {
            spc_warn(spe,
                     b"Invalid value for spot color specification.\x00" as
                         *const u8 as *const libc::c_char);
            error = -1i32;
            free(color_name as *mut libc::c_void);
        } else { pdf_color_spotcolor(colorspec, color_name, cv[0]); }
    } else if streq_ptr(q, b"hsb\x00" as *const u8 as *const libc::c_char) {
        nc = spc_util_read_numbers(cv.as_mut_ptr(), 3i32, ap);
        if nc != 3i32 {
            spc_warn(spe,
                     b"Invalid value for HSB color specification.\x00" as
                         *const u8 as *const libc::c_char);
            error = -1i32
        } else {
            ...
            spc_warn(spe,
                     b"HSB color converted to RGB: hsb: <%g, %g, %g> ==> rgb: <%g, %g, %g>\x00"
                         as *const u8 as *const libc::c_char, cv[0], cv[1],
                     cv[2], (*colorspec).values[0], (*colorspec).values[1],
                     (*colorspec).values[2]);
        }
    } else {
        ...
        if error != 0 {
            spc_warn(spe,
                     b"Unrecognized color name: %s\x00" as *const u8 as
                         *const libc::c_char, q);
        }
    }
    free(q as *mut libc::c_void);
 ...
 */
unsafe extern "C" fn spc_read_color_pdf(mut spe: *mut spc_env,
                                        mut colorspec: *mut pdf_color,
    ...
    nc = spc_util_read_numbers(cv.as_mut_ptr(), 4i32, ap);
    match nc {
        1 => { pdf_color_graycolor(colorspec, cv[0]); }
        3 => { pdf_color_rgbcolor(colorspec, cv[0], cv[1], cv[2]); }
        4 => { pdf_color_cmykcolor(colorspec, cv[0], cv[1], cv[2], cv[3]); }
        _ => {
            ...
            if error != 0 {
                spc_warn(spe,
                         b"Unrecognized color name: %s, keep the current color\x00"
                             as *const u8 as *const libc::c_char, q);
            }
            free(q as *mut libc::c_void);
        }
    }
    if isarry != 0 {
        ...
        if (*ap).curptr >= (*ap).endptr ||
            ...
            spc_warn(spe,
                     b"Unbalanced \'[\' and \']\' in color specification.\x00"
                         as *const u8 as *const libc::c_char);
            error = -1i32
        } else { (*ap).curptr = (*ap).curptr.offset(1) }
    }
    return error;
}
/* This is for reading *single* color specification. */
#[no_mangle]
pub unsafe extern "C" fn spc_util_read_colorspec(mut spe: *mut spc_env,
                                                 mut colorspec:
                                                     *mut pdf_color,
                                                 mut ap: *mut spc_arg,
 ...
 -> libc::c_int {
    ...
    skip_blank(&mut (*ap).curptr, (*ap).endptr);
    if (*ap).curptr >= (*ap).endptr { return -1i32 }
    if syntax != 0 {
        return spc_read_color_color(spe, colorspec, ap)
    } else { return spc_read_color_pdf(spe, colorspec, ap) };
}
#[no_mangle]
pub unsafe extern "C" fn spc_util_read_pdfcolor(mut spe: *mut spc_env,
                                                mut colorspec: *mut pdf_color,
                                                mut ap: *mut spc_arg,
                                                mut defaultcolor:
                                                    *mut pdf_color)
...
unsafe extern "C" fn spc_util_read_length(mut spe: *mut spc_env,
                                          mut vp: *mut libc::c_double,
                                          mut ap: *mut spc_arg)
 -> libc::c_int {
    let mut q: *mut libc::c_char =
        0 as *mut libc::c_char; /* inverse magnify */
    ...
    if !q.is_null() {
        ...
        if !q.is_null() {
            k = 0i32;
            while !ukeys[k as usize].is_null() &&
                      strcmp(ukeys[k as usize], q) != 0 {
                k += 1
            }
            match k {
                ...
                _ => {
                    spc_warn(spe,
                             b"Unknown unit of measure: %s\x00" as *const u8
                                 as *const libc::c_char, q);
                    error = -1i32
                }
            }
            free(qq as *mut libc::c_void);
            ...
            spc_warn(spe,
                     b"Missing unit of measure after \"true\"\x00" as
                         *const u8 as *const libc::c_char);
            error = -1i32
        }
    }
 ...
 */
unsafe extern "C" fn make_transmatrix(mut M: *mut pdf_tmatrix,
...
unsafe extern "C" fn spc_read_dimtrns_dvips(mut spe: *mut spc_env,
 ...
 -> libc::c_int {
    ...
    while error == 0 && (*ap).curptr < (*ap).endptr {
        ...
        if kp.is_null() { break ; }
        k = 0i32;
        while !_dtkeys[k as usize].is_null() &&
                  strcmp(kp, _dtkeys[k as usize]) != 0 {
            k += 1
        }
        if _dtkeys[k as usize].is_null() {
            spc_warn(spe,
                     b"Unrecognized dimension/transformation key: %s\x00" as
                         *const u8 as *const libc::c_char, kp);
            error = -1i32;
            ...
            if k == 7i32 {
                ...
                if *(*ap).curptr.offset(0) as libc::c_int == '\'' as i32 ||
                    ...
                    if !vp.is_null() &&
                           qchr as libc::c_int !=
                               *(*ap).curptr.offset(0) as libc::c_int {
                        spc_warn(spe,
                                 b"Syntax error in dimension/transformation specification.\x00"
                                     as *const u8 as *const libc::c_char);
                        error = -1i32;
                        vp =
                            mfree(vp as *mut libc::c_void) as
                                *mut libc::c_char
                    }
                    (*ap).curptr = (*ap).curptr.offset(1)
                } else {
                ...
                if error == 0 && vp.is_null() {
                    spc_warn(spe,
                             b"Missing value for dimension/transformation: %s\x00"
                                 as *const u8 as *const libc::c_char, kp);
                    error = -1i32
                }
                free(kp as *mut libc::c_void);
                if vp.is_null() || error != 0 { break ; }
                match k {
                    0 => { xoffset = atof(vp) }
                    1 => { yoffset = atof(vp) }
                    2 => { (*t).width = atof(vp); (*t).flags |= 1i32 << 1i32 }
                    3 => {
                        (*t).height = atof(vp);
                        (*t).flags |= 1i32 << 2i32
                    }
                    ...
                    6 => {
                        rotate =
                            3.14159265358979323846f64 * atof(vp) / 180.0f64
                    }
                    8 => {
                        (*t).bbox.llx = atof(vp);
                        (*t).flags |= 1i32 << 0i32
    ...
    make_transmatrix(&mut (*t).matrix, xoffset, yoffset, xscale, yscale,
                     rotate);
    return error;
}
 ...
 */
unsafe extern "C" fn spc_read_dimtrns_pdfm(mut spe: *mut spc_env,
 ...
 -> libc::c_int {
    ...
    while error == 0 && (*ap).curptr < (*ap).endptr {
        ...
        k = 0i32;
        while !_dtkeys[k as usize].is_null() &&
                  strcmp(_dtkeys[k as usize], kp) != 0 {
            k += 1
        }
        match k {
            0 => {
        ...
        if error != 0 {
            spc_warn(spe,
                     b"Unrecognized key or invalid value for dimension/transformation: %s\x00"
                         as *const u8 as *const libc::c_char, kp);
        } else { skip_blank(&mut (*ap).curptr, (*ap).endptr); }
        free(kp as *mut libc::c_void);
    }
    if error == 0 {
        /* Check consistency */
        if has_xscale != 0 && (*p).flags & 1i32 << 1i32 != 0 {
            spc_warn(spe,
                     b"Can\'t supply both width and xscale. Ignore xscale.\x00"
                         as *const u8 as *const libc::c_char);
            xscale = 1.0f64
        } else if has_yscale != 0 && (*p).flags & 1i32 << 2i32 != 0 {
            spc_warn(spe,
                     b"Can\'t supply both height/depth and yscale. Ignore yscale.\x00"
                         as *const u8 as *const libc::c_char);
            yscale = 1.0f64
        } else if has_scale != 0 && (has_xscale != 0 || has_yscale != 0) {
            spc_warn(spe,
                     b"Can\'t supply overall scale along with axis scales.\x00"
                         as *const u8 as *const libc::c_char);
            error = -1i32
        } else if has_matrix != 0 &&
                      (has_scale != 0 || has_xscale != 0 || has_yscale != 0 ||
                           has_rotate != 0) {
            spc_warn(spe,
    ...
    if has_matrix == 0 {
        make_transmatrix(&mut (*p).matrix, 0.0f64, 0.0f64, xscale, yscale,
                         rotate);
    }
...
#[no_mangle]
pub unsafe extern "C" fn spc_util_read_dimtrns(mut spe: *mut spc_env,
                                               mut ti: *mut transform_info,
                                               mut args: *mut spc_arg,
                                               mut syntax: libc::c_int)
 -> libc::c_int {
    if ti.is_null() || spe.is_null() || args.is_null() { return -1i32 }
    if syntax != 0 {
        return spc_read_dimtrns_dvips(spe, ti, args)
    } else { return spc_read_dimtrns_pdfm(spe, ti, args) };
}
/* This is dvipdfmx, an eXtended version of dvipdfm by Mark A. Wicks.
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn spc_util_read_blahblah(mut spe: *mut spc_env,
                                                mut p: *mut transform_info,
    ...
    while error == 0 && (*ap).curptr < (*ap).endptr {
        ...
        match k {
            ...
            11 => {
                ...
                if !page_no.is_null() &&
                       spc_util_read_numbers(&mut page, 1i32, ap) == 1i32 {
            ...
            12 => {
                ...
                if !q.is_null() {
                    if !bbox_type.is_null() {
                        if strcasecmp(q,
                                      b"cropbox\x00" as *const u8 as
                                          *const libc::c_char) == 0i32 {
                            *bbox_type = 1i32
                        } else if strcasecmp(q,
                                             b"mediabox\x00" as *const u8 as
                                                 *const libc::c_char) == 0i32
                         {
                            *bbox_type = 2i32
                        } else if strcasecmp(q,
                                             b"artbox\x00" as *const u8 as
                                                 *const libc::c_char) == 0i32
                         {
                            *bbox_type = 3i32
                        } else if strcasecmp(q,
                                             b"trimbox\x00" as *const u8 as
                                                 *const libc::c_char) == 0i32
                         {
                            *bbox_type = 4i32
                        } else if strcasecmp(q,
                                             b"bleedbox\x00" as *const u8 as
                                                 *const libc::c_char) == 0i32
                         {
                            *bbox_type = 5i32
                        }
                    ...
                    free(q as *mut libc::c_void);
                } else if !bbox_type.is_null() { *bbox_type = 0i32 }
            }
            _ => { error = -1i32 }
        }
        if error != 0 {
...
static mut colordefs: [colordef_; 69] =
    [{
         let mut init =
             colordef_{key:
                           b"GreenYellow\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
                                             spot_color_name:
                                                 0 as *const libc::c_char as
                                                     *mut libc::c_char,
                                             values:
                                                 [0.15f64, 0.00f64, 0.69f64,
                                                  0.00f64],};
                               init
                           },};
         init
     ...
     {
         let mut init =
             colordef_{key: b"Yellow\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Goldenrod\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Dandelion\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Apricot\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Peach\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Melon\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"YellowOrange\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     {
         let mut init =
             colordef_{key: b"Orange\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"BurntOrange\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Bittersweet\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"RedOrange\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     {
         let mut init =
             colordef_{key: b"Maroon\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Red\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"OrangeRed\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"RubineRed\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"WildStrawberry\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     {
         let mut init =
             colordef_{key: b"Salmon\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"CarnationPink\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"VioletRed\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Rhodamine\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"RedViolet\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Fuchsia\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Thistle\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Orchid\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"DarkOrchid\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     {
         let mut init =
             colordef_{key: b"Purple\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Plum\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Violet\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"RoyalPurple\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"BlueViolet\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Periwinkle\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"CadetBlue\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"CornflowerBlue\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"MidnightBlue\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"RoyalBlue\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     {
         let mut init =
             colordef_{key: b"Blue\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Cyan\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"ProcessBlue\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"SkyBlue\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Turquoise\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"Aquamarine\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"BlueGreen\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"JungleGreen\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     {
         let mut init =
             colordef_{key: b"Green\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"ForestGreen\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"PineGreen\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"LimeGreen\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"YellowGreen\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"SpringGreen\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"OliveGreen\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     },
     {
         let mut init =
             colordef_{key:
                           b"RawSienna\x00" as *const u8 as
                               *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     {
         let mut init =
             colordef_{key: b"Sepia\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Brown\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Tan\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 4i32,
     ...
     {
         let mut init =
             colordef_{key: b"Gray\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
     ...
     {
         let mut init =
             colordef_{key: b"Black\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 1i32,
     ...
     {
         let mut init =
             colordef_{key: b"White\x00" as *const u8 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 1i32,
     ...
     {
         let mut init =
             colordef_{key: 0 as *const libc::c_char,
                       color:
                           {
                               let mut init =
                                   pdf_color{num_components: 0i32,
                                             spot_color_name:
                                                 0 as *const libc::c_char as
                                                     *mut libc::c_char,
                                             values: [0.0f64, 0., 0., 0.],};
...
/* From pdfcolor.c */
unsafe extern "C" fn pdf_color_namedcolor(mut color: *mut pdf_color,
 ...
 -> libc::c_int {
    ...
    while !colordefs[i as usize].key.is_null() {
        if streq_ptr(colordefs[i as usize].key, name) {
            pdf_color_copycolor(color,
                                &mut (*colordefs.as_mut_ptr().offset(i as
                                                                         isize)).color);
            return 0i32
        }
        i += 1
