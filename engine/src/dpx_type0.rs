...
extern "C" {
    ...
    #[no_mangle]
    fn CIDFont_attach_parent(font: *mut CIDFont, parent_id: libc::c_int,
                             wmode: libc::c_int);
    #[no_mangle]
    ...
    #[no_mangle]
    fn CIDFont_cache_find(map_name: *const libc::c_char,
                          cmap_csi: *mut CIDSysInfo,
                          fmap_opt: *mut fontmap_opt) -> libc::c_int;
    #[no_mangle]
...
*/
    ...
    /* Indirect reference */
    #[no_mangle]
    fn otf_create_ToUnicode_stream(map_name: *const libc::c_char,
                                   ttc_index: libc::c_int,
                                   used_chars: *const libc::c_char,
                                   cmap_id: libc::c_int) -> *mut pdf_obj;
...
unsafe extern "C" fn new_used_chars2() -> *mut libc::c_char {
    ...
    memset(used_chars as *mut libc::c_void, 0i32, 8192i32 as libc::c_ulong);
    return used_chars;
}
/* MUST BE NULL */
    ...
    if !font.is_null() {
        ...
        __assert_fail(b"font\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 45],
                                                &[libc::c_char; 45]>(b"void Type0Font_init_font_struct(Type0Font *)\x00")).as_ptr());
    }
...
unsafe extern "C" fn Type0Font_clean(mut font: *mut Type0Font) {
    if !font.is_null() {
        ...
        if !(*font).descriptor.is_null() {
            _tt_abort(b"%s: FontDescriptor unexpected for Type0 font.\x00" as
...
/* PLEASE FIX THIS */
unsafe extern "C" fn Type0Font_create_ToUnicode_stream(mut font:
                                                           *mut Type0Font)
 -> *mut pdf_obj {
...
unsafe extern "C" fn Type0Font_try_load_ToUnicode_stream(mut font:
                                                             *mut Type0Font,
                                                         mut cmap_base:
                                                             *mut libc::c_char)
 -> *mut pdf_obj {
    let mut cmap_name: *mut libc::c_char =
        new((strlen(cmap_base).wrapping_add(strlen(b"-UTF-16\x00" as *const u8
                                                       as
                                                       *const libc::c_char))
                 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
    ...
    if tounicode.is_null() {
        sprintf(cmap_name, b"%s-UCS2\x00" as *const u8 as *const libc::c_char,
                cmap_base);
        tounicode = pdf_read_ToUnicode_file(cmap_name)
    }
...
unsafe extern "C" fn add_ToUnicode(mut font: *mut Type0Font) {
   ...
   */
    ...
    if cidfont.is_null() {
        _tt_abort(b"%s: No descendant CID-keyed font.\x00" as *const u8 as
                      *const libc::c_char,
                  b"Type0\x00" as *const u8 as *const libc::c_char);
    }
     ...
     */
            tounicode =
                pdf_read_ToUnicode_file(b"Adobe-Identity-UCS2\x00" as
                                            *const u8 as *const libc::c_char);
            if tounicode.is_null() {
                /* This should work */
                tounicode =
                    pdf_new_name(b"Identity-H\x00" as *const u8 as
                                     *const libc::c_char)
            }
            pdf_add_dict((*font).fontdict,
                         pdf_new_name(b"ToUnicode\x00" as *const u8 as
                                          *const libc::c_char), tounicode);
            return
        }
    }
        ...
        match CIDFont_get_subtype(cidfont) {
            ...
            _ => {
                if CIDFont_get_flag(cidfont, 1i32 << 9i32) != 0 {
                    ...
                    tounicode =
                        Type0Font_try_load_ToUnicode_stream(font, fontname)
                }
            }
        }
    } else {
        let mut cmap_base: *mut libc::c_char =
            new((strlen((*csi).registry).wrapping_add(strlen((*csi).ordering)).wrapping_add(2i32
                                                                                                as
                                                                                                libc::c_ulong)
                     as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut libc::c_char;
        sprintf(cmap_base, b"%s-%s\x00" as *const u8 as *const libc::c_char,
    ...
    if !tounicode.is_null() {
        ...
        dpx_warning(b"Failed to load ToUnicode CMap for font \"%s\"\x00" as
                        *const u8 as *const libc::c_char, fontname);
    };
}
#[no_mangle]
pub unsafe extern "C" fn Type0Font_set_ToUnicode(mut font: *mut Type0Font,
    ...
    if !font.is_null() {
        ...
        __assert_fail(b"font\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"void Type0Font_set_ToUnicode(Type0Font *, pdf_obj *)\x00")).as_ptr());
    }
    pdf_add_dict((*font).fontdict,
                 pdf_new_name(b"ToUnicode\x00" as *const u8 as
                                  *const libc::c_char), cmap_ref);
}
unsafe extern "C" fn Type0Font_dofont(mut font: *mut Type0Font) {
    if font.is_null() || (*font).indirect.is_null() { return }
    if pdf_lookup_dict((*font).fontdict,
...
#[no_mangle]
pub unsafe extern "C" fn Type0Font_get_wmode(mut font: *mut Type0Font)
 -> libc::c_int {
    if !font.is_null() {
    } else {
        __assert_fail(b"font\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 37],
                                                &[libc::c_char; 37]>(b"int Type0Font_get_wmode(Type0Font *)\x00")).as_ptr());
    }
    return (*font).wmode;
}
#[no_mangle]
pub unsafe extern "C" fn Type0Font_get_usedchars(mut font: *mut Type0Font)
 -> *mut libc::c_char {
    if !font.is_null() {
    } else {
        __assert_fail(b"font\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 43],
                                                &[libc::c_char; 43]>(b"char *Type0Font_get_usedchars(Type0Font *)\x00")).as_ptr());
    }
    return (*font).used_chars;
}
#[no_mangle]
pub unsafe extern "C" fn Type0Font_get_resource(mut font: *mut Type0Font)
 -> *mut pdf_obj {
    if !font.is_null() {
    } else {
        __assert_fail(b"font\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 45],
                                                &[libc::c_char; 45]>(b"pdf_obj *Type0Font_get_resource(Type0Font *)\x00")).as_ptr());
    }
    /*
   ...
   */
    if (*font).indirect.is_null() {
        ...
        pdf_add_dict((*font).fontdict,
                     pdf_new_name(b"DescendantFonts\x00" as *const u8 as
                                      *const libc::c_char), array);
...
#[no_mangle]
pub unsafe extern "C" fn Type0Font_cache_get(mut id: libc::c_int)
 -> *mut Type0Font {
    if id < 0i32 || id >= __cache.count {
        _tt_abort(b"%s: Invalid ID %d\x00" as *const u8 as
                      *const libc::c_char,
                  b"Type0\x00" as *const u8 as *const libc::c_char, id);
    }
    return &mut *__cache.fonts.offset(id as isize) as *mut Type0Font;
}
#[no_mangle]
pub unsafe extern "C" fn Type0Font_cache_find(mut map_name:
                                                  *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    if map_name.is_null() || cmap_id < 0i32 || pdf_ver < 2i32 { return -1i32 }
    /*
   ...
   */
    ...
    csi =
        if CMap_is_Identity(cmap) as libc::c_int != 0 {
            0 as *mut CIDSysInfo
        } else { CMap_get_CIDSysInfo(cmap) };
    cid_id = CIDFont_cache_find(map_name, csi, fmap_opt);
    if cid_id < 0i32 { return -1i32 }
    /*
   ...
   */
    ...
    parent_id =
        CIDFont_get_parent_id(cidfont,
                              wmode); /* If so, we don't need new one. */
    if parent_id >= 0i32 { return parent_id }
    /*
   ...
   */
    if __cache.count >= __cache.capacity {
        __cache.capacity =
            (__cache.capacity as libc::c_uint).wrapping_add(16u32) as
                libc::c_int as libc::c_int;
        __cache.fonts =
            renew(__cache.fonts as *mut libc::c_void,
                  (__cache.capacity as uint32_t as
                       libc::c_ulong).wrapping_mul(::std::mem::size_of::<Type0Font>()
                                                       as libc::c_ulong) as
                      uint32_t) as *mut Type0Font
    }
   ...
   */
    if wmode != 0 {
        (*font).encoding =
            new((strlen(b"Identity-V\x00" as *const u8 as
                     ...
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut libc::c_char;
        strcpy((*font).encoding,
               b"Identity-V\x00" as *const u8 as *const libc::c_char);
    } else {
        (*font).encoding =
            new((strlen(b"Identity-H\x00" as *const u8 as
                            *const libc::c_char).wrapping_add(1i32 as
                                                                  libc::c_ulong)
                     as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
   ...
   */
    ...
    pdf_add_dict((*font).fontdict,
                 pdf_new_name(b"Subtype\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_name(b"Type0\x00" as *const u8 as
                                  *const libc::c_char));
    /*
   ...
   */
    ...
    if __verbose != 0 {
        if CIDFont_get_embedding(cidfont) != 0 &&
               strlen(fontname) > 7i32 as libc::c_ulong {
            dpx_message(b"(CID:%s)\x00" as *const u8 as *const libc::c_char,
                        fontname.offset(7));
        } else {
            dpx_message(b"(CID:%s)\x00" as *const u8 as *const libc::c_char,
                        fontname);
   ...
   */
    ...
    match CIDFont_get_subtype(cidfont) {
        1 => {
            (*font).fontname =
                new((strlen(fontname).wrapping_add(strlen((*font).encoding)).wrapping_add(2i32
                                                                                              as
                                                                                              libc::c_ulong)
                         as uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
     ...
     */
            parent_id =
                CIDFont_get_parent_id(cidfont,
                                      (if wmode != 0 { 0i32 } else { 1i32 }));
            if parent_id < 0i32 {
                (*font).used_chars = new_used_chars2()
            } else {
                /* Don't allocate new one. */
                (*font).used_chars =
                    Type0Font_get_usedchars(Type0Font_cache_get(parent_id));
     ...
     */
        ...
        _ => {
            _tt_abort(b"Unrecognized CIDFont Type\x00" as *const u8 as
                          *const libc::c_char);
        }
    }
    pdf_add_dict((*font).fontdict,
...
unsafe extern "C" fn pdf_read_ToUnicode_file(mut cmap_name:
                                                 *const libc::c_char)
 -> *mut pdf_obj {
    let mut stream: *mut pdf_obj = 0 as *mut pdf_obj;
    ...
    if !cmap_name.is_null() {
        ...
        __assert_fail(b"cmap_name\x00" as *const u8 as *const libc::c_char,
                      b"dpx-type0.c\x00" as *const u8 as *const libc::c_char,
                      646i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 47],
                                                &[libc::c_char; 47]>(b"pdf_obj *pdf_read_ToUnicode_file(const char *)\x00")).as_ptr());
    }
    res_id =
        pdf_findresource(b"CMap\x00" as *const u8 as *const libc::c_char,
                         cmap_name);
    if res_id < 0i32 {
        if streq_ptr(cmap_name,
                     b"Adobe-Identity-UCS2\x00" as *const u8 as
                         *const libc::c_char) {
            stream = create_dummy_CMap()
        } else { stream = pdf_load_ToUnicode_stream(cmap_name) }
        if !stream.is_null() {
            res_id =
                pdf_defineresource(b"CMap\x00" as *const u8 as
                                       *const libc::c_char, cmap_name, stream,
                                   1i32)
        }
    }
    return if res_id < 0i32 {
               0 as *mut pdf_obj
           } else { pdf_get_resource_reference(res_id) };
}
/* !WITHOUT_COMPAT */
