...
extern "C" {
    ...
    #[no_mangle]
    fn pdf_new_indirect(pf: *mut pdf_file, label: libc::c_uint,
                        generation: libc::c_ushort) -> *mut pdf_obj;
    #[no_mangle]
...
static mut parser_state: C2RustUnnamed_0 =
    { let mut init = C2RustUnnamed_0{tainted: 0i32,}; init };
static mut save: *const libc::c_char = 0 as *const libc::c_char;
#[no_mangle]
pub unsafe extern "C" fn dump(mut start: *const libc::c_char,
                              mut end: *const libc::c_char) {
    let mut p: *const libc::c_char = start;
    dpx_message(b"\nCurrent input buffer is -->\x00" as *const u8 as
                    *const libc::c_char);
    while p < end && p < start.offset(50) {
        let fresh0 = p;
        p = p.offset(1);
        dpx_message(b"%c\x00" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn pdfparse_skip_line(mut start:
                                                *mut *const libc::c_char,
                                            mut end: *const libc::c_char) {
    while *start < end && **start as libc::c_int != '\n' as i32 &&
...
#[no_mangle]
pub unsafe extern "C" fn skip_white(mut start: *mut *const libc::c_char,
                                    mut end: *const libc::c_char) {
    /*
   ...
   */
    while *start < end &&
        ...
        } else { *start = (*start).offset(1) }
    };
}
unsafe extern "C" fn parsed_string(mut start: *const libc::c_char,
                                   mut end: *const libc::c_char)
 -> *mut libc::c_char {
    ...
    if len > 0i32 {
        ...
        memcpy(result as *mut libc::c_void, start as *const libc::c_void,
               len as libc::c_ulong);
...
#[no_mangle]
pub unsafe extern "C" fn parse_number(mut start: *mut *const libc::c_char,
                                      mut end: *const libc::c_char)
 -> *mut libc::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn parse_unsigned(mut start: *mut *const libc::c_char,
                                        mut end: *const libc::c_char)
 -> *mut libc::c_char {
    let mut number: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut p: *const libc::c_char = 0 as *const libc::c_char;
...
unsafe extern "C" fn parse_gen_ident(mut start: *mut *const libc::c_char,
                                     mut end: *const libc::c_char,
 ...
 -> *mut libc::c_char {
    ...
    p = *start;
    while p < end {
        if strchr(valid_chars, *p as libc::c_int).is_null() { break ; }
        p = p.offset(1)
    }
...
#[no_mangle]
pub unsafe extern "C" fn parse_ident(mut start: *mut *const libc::c_char,
                                     mut end: *const libc::c_char)
 -> *mut libc::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn parse_val_ident(mut start: *mut *const libc::c_char,
                                         mut end: *const libc::c_char)
 -> *mut libc::c_char {
    static mut valid_chars: *const libc::c_char =
        b"!\"#$&\'*+,-./0123456789:;?@ABCDEFGHIJKLMNOPQRSTUVWXYZ\\^_`abcdefghijklmnopqrstuvwxyz|~\x00"
...
#[no_mangle]
pub unsafe extern "C" fn parse_opt_ident(mut start: *mut *const libc::c_char,
                                         mut end: *const libc::c_char)
 -> *mut libc::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_number(mut pp: *mut *const libc::c_char,
 ...
 -> *mut pdf_obj {
    ...
    if p >= endptr ||
           *(*__ctype_b_loc()).offset(*p.offset(0) as libc::c_uchar as
                                          libc::c_int as isize) as libc::c_int
               & _ISdigit as libc::c_int as libc::c_ushort as libc::c_int == 0
               && *p.offset(0) as libc::c_int != '.' as i32 &&
               *p.offset(0) as libc::c_int != '+' as i32 &&
               *p.offset(0) as libc::c_int != '-' as i32 {
        dpx_warning(b"Could not find a numeric object.\x00" as *const u8 as
                        *const libc::c_char);
        return 0 as *mut pdf_obj
    }
    if *p.offset(0) as libc::c_int == '-' as i32 {
        if p.offset(1) >= endptr {
            dpx_warning(b"Could not find a numeric object.\x00" as *const u8
    ...
    while p < endptr &&
        ...
        if *p.offset(0) as libc::c_int == '.' as i32 {
            if has_dot != 0 {
                /* Two dots */
                dpx_warning(b"Could not find a numeric object.\x00" as
                                *const u8 as *const libc::c_char);
                return 0 as *mut pdf_obj
            } else { has_dot = 1i32 }
        } else if *(*__ctype_b_loc()).offset(*p.offset(0) as libc::c_uchar as
                                                 libc::c_int as isize) as
                      libc::c_int &
                      _ISdigit as libc::c_int as libc::c_ushort as libc::c_int
                      != 0 {
            if has_dot != 0 {
                v +=
                    (*p.offset(0) as libc::c_int - '0' as i32) as
                        libc::c_double /
                        pow(10i32 as libc::c_double,
                            (nddigits + 1i32) as libc::c_double);
                nddigits += 1
            } else {
                v =
                    v * 10.0f64 +
                        *p.offset(0) as libc::c_int as libc::c_double -
 ...
 */
unsafe extern "C" fn pn_getc(mut pp: *mut *const libc::c_char,
                             mut endptr: *const libc::c_char) -> libc::c_int {
    let mut ch: libc::c_int = 0i32;
    let mut p: *const libc::c_char = 0 as *const libc::c_char;
    p = *pp;
    if *p.offset(0) as libc::c_int == '#' as i32 {
        if p.offset(2) >= endptr { *pp = endptr; return -1i32 }
        if *(*__ctype_b_loc()).offset(*p.offset(1) as libc::c_uchar as
                                          libc::c_int as isize) as libc::c_int
               & _ISxdigit as libc::c_int as libc::c_ushort as libc::c_int ==
               0 ||
               *(*__ctype_b_loc()).offset(*p.offset(2) as libc::c_uchar as
                                              libc::c_int as isize) as
                   libc::c_int &
                   _ISxdigit as libc::c_int as libc::c_ushort as libc::c_int
                   == 0 {
        ...
        ch += xtoi(*p.offset(2));
        *pp = (*pp).offset(3)
    } else { ch = *p.offset(0) as libc::c_int; *pp = (*pp).offset(1) }
    return ch;
}
static mut sbuf: [libc::c_char; 65536] = [0; 65536];
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_name(mut pp: *mut *const libc::c_char,
                                        mut endptr: *const libc::c_char)
 -> *mut pdf_obj {
    ...
    if *pp >= endptr || **pp as libc::c_int != '/' as i32 {
        dpx_warning(b"Could not find a name object.\x00" as *const u8 as
                        *const libc::c_char);
        return 0 as *mut pdf_obj
    }
    *pp = (*pp).offset(1);
    while *pp < endptr &&
        ...
        if ch < 0i32 || ch > 0xffi32 {
            dpx_warning(b"Invalid char in PDF name object. (ignored)\x00" as
                            *const u8 as *const libc::c_char);
        } else if ch == 0i32 {
            dpx_warning(b"Null char not allowed in PDF name object. (ignored)\x00"
                            as *const u8 as *const libc::c_char);
        } else if len < 65535i32 + 1i32 {
            if len == 128i32 {
                dpx_warning(b"PDF name length too long. (>= %d bytes)\x00" as
            ...
            dpx_warning(b"PDF name length too long. (>= %d bytes, truncated)\x00"
                            as *const u8 as *const libc::c_char,
                        65535i32 + 1i32);
        }
    }
    if len < 1i32 {
        dpx_warning(b"No valid name object found.\x00" as *const u8 as
                        *const libc::c_char);
        return 0 as *mut pdf_obj
    }
...
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_boolean(mut pp: *mut *const libc::c_char,
                                           mut endptr: *const libc::c_char)
 -> *mut pdf_obj {
    skip_white(pp, endptr);
    ...
    dpx_warning(b"Not a boolean object.\x00" as *const u8 as
                    *const libc::c_char);
    return 0 as *mut pdf_obj;
}
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_null(mut pp: *mut *const libc::c_char,
                                        mut endptr: *const libc::c_char)
 -> *mut pdf_obj {
    skip_white(pp, endptr);
    if (*pp).offset(4) > endptr {
        dpx_warning(b"Not a null object.\x00" as *const u8 as
                        *const libc::c_char);
        return 0 as *mut pdf_obj
    } else {
        if (*pp).offset(4) < endptr &&
 ...
 * PDF Literal String
 */
unsafe extern "C" fn ps_getescc(mut pp: *mut *const libc::c_char,
                                mut endptr: *const libc::c_char)
 -> libc::c_int {
    ...
    match *p.offset(0) as libc::c_int {
        110 => { ch = '\n' as i32; p = p.offset(1) }
        114 => { ch = '\r' as i32; p = p.offset(1) }
        116 => { ch = '\t' as i32; p = p.offset(1) }
        98 => { ch = '\u{8}' as i32; p = p.offset(1) }
        102 => { ch = '\u{c}' as i32; p = p.offset(1) }
        10 => {
            /*
     ...
     */
        ...
        _ => {
            if *p.offset(0) as libc::c_int == '\\' as i32 ||
                ...
                ch =
                    *p.offset(0) as libc::c_uchar as
                        libc::c_int; /* Ignore only backslash. */
                p = p.offset(1)
            }
        }
    }
...
unsafe extern "C" fn parse_pdf_literal_string(mut pp:
                                                  *mut *const libc::c_char,
                                              mut endptr: *const libc::c_char)
 -> *mut pdf_obj {
    let mut ch: libc::c_int = 0;
   ...
   * [PDF Reference, 6th ed., version 1.7, p. 55] */
    while p < endptr {
        ch = *p.offset(0) as libc::c_int;
        if ch == ')' as i32 && op_count < 1i32 { break ; }
        if parser_state.tainted != 0 {
            if p.offset(1) < endptr && ch & 0x80i32 != 0 {
                if len + 2i32 >= 65535i32 {
                    dpx_warning(b"PDF string length too long. (limit: %d)\x00"
                                    as *const u8 as *const libc::c_char,
                                65535i32);
                    return 0 as *mut pdf_obj
                }
        ...
        if len + 1i32 >= 65535i32 {
            dpx_warning(b"PDF string length too long. (limit: %d)\x00" as
                            *const u8 as *const libc::c_char, 65535i32);
            return 0 as *mut pdf_obj
        }
        match ch {
            92 => {
    ...
    if op_count > 0i32 || p >= endptr ||
           *p.offset(0) as libc::c_int != ')' as i32 {
        dpx_warning(b"Unbalanced parens/truncated PDF literal string.\x00" as
                        *const u8 as *const libc::c_char);
        return 0 as *mut pdf_obj
    }
    *pp = p.offset(1);
    return pdf_new_string(sbuf.as_mut_ptr() as *const libc::c_void,
                          len as size_t);
}
/*
 * PDF Hex String
 */
unsafe extern "C" fn parse_pdf_hex_string(mut pp: *mut *const libc::c_char,
                                          mut endptr: *const libc::c_char)
 -> *mut pdf_obj {
    let mut p: *const libc::c_char = 0 as *const libc::c_char;
    let mut len: libc::c_int = 0;
   ...
   */
    ...
    if p >= endptr {
        dpx_warning(b"Premature end of input hex string.\x00" as *const u8 as
                        *const libc::c_char);
        return 0 as *mut pdf_obj
    } else {
        if *p.offset(0) as libc::c_int != '>' as i32 {
...
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_string(mut pp: *mut *const libc::c_char,
                                          mut endptr: *const libc::c_char)
 -> *mut pdf_obj {
    skip_white(pp, endptr);
        ...
        if **pp as libc::c_int == '(' as i32 {
            ...
            if **pp as libc::c_int == '<' as i32 &&
                   (*(*pp).offset(1) as libc::c_int == '>' as i32 ||
                        *(*__ctype_b_loc()).offset(*(*pp).offset(1) as
                                                       libc::c_uchar as
                                                       libc::c_int as isize)
                            as libc::c_int &
    ...
    dpx_warning(b"Could not find a string object.\x00" as *const u8 as
                    *const libc::c_char);
    return 0 as *mut pdf_obj;
}
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_tainted_dict(mut pp:
                                                    *mut *const libc::c_char,
                                                mut endptr:
                                                    *const libc::c_char)
 -> *mut pdf_obj {
...
/* !PDF_PARSE_STRICT */
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_dict(mut pp: *mut *const libc::c_char,
                                        mut endptr: *const libc::c_char,
                                        mut pf: *mut pdf_file)
 -> *mut pdf_obj {
    let mut result: *mut pdf_obj = 0 as *mut pdf_obj;
    ...
    if p.offset(4) > endptr || *p.offset(0) as libc::c_int != '<' as i32 ||
    ...
    while p < endptr && *p.offset(0) as libc::c_int != '>' as i32 {
        ...
        if key.is_null() {
            dpx_warning(b"Could not find a key in dictionary object.\x00" as
                            *const u8 as *const libc::c_char);
        ...
        if value.is_null() {
            ...
            pdf_release_obj(result);
            dpx_warning(b"Could not find a value in dictionary object.\x00" as
                            *const u8 as *const libc::c_char);
            return 0 as *mut pdf_obj
        }
    ...
    if p.offset(2) > endptr || *p.offset(0) as libc::c_int != '>' as i32 ||
           *p.offset(1) as libc::c_int != '>' as i32 {
        dpx_warning(b"Syntax error: Dictionary object ended prematurely.\x00"
                        as *const u8 as *const libc::c_char);
        pdf_release_obj(result);
        return 0 as *mut pdf_obj
    }
...
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_array(mut pp: *mut *const libc::c_char,
                                         mut endptr: *const libc::c_char,
                                         mut pf: *mut pdf_file)
 -> *mut pdf_obj {
    let mut result: *mut pdf_obj = 0 as *mut pdf_obj;
    ...
    skip_white(&mut p, endptr);
    if p.offset(2) > endptr || *p.offset(0) as libc::c_int != '[' as i32 {
        dpx_warning(b"Could not find an array object.\x00" as *const u8 as
                        *const libc::c_char);
        return 0 as *mut pdf_obj
    }
    ...
    while p < endptr && *p.offset(0) as libc::c_int != ']' as i32 {
        ...
        if elem.is_null() {
            pdf_release_obj(result);
            dpx_warning(b"Could not find a valid object in array object.\x00"
                            as *const u8 as *const libc::c_char);
            return 0 as *mut pdf_obj
        }
    ...
    if p >= endptr || *p.offset(0) as libc::c_int != ']' as i32 {
        dpx_warning(b"Array object ended prematurely.\x00" as *const u8 as
                        *const libc::c_char);
        pdf_release_obj(result);
        return 0 as *mut pdf_obj
    }
...
unsafe extern "C" fn parse_pdf_stream(mut pp: *mut *const libc::c_char,
                                      mut endptr: *const libc::c_char,
 ...
 -> *mut pdf_obj {
   ...
   * [PDF Reference, 6th ed., version 1.7, pp. 60-61] */
    ...
    if !tmp.is_null() {
        ...
        if pdf_obj_typeof(tmp2) != 2i32 {
            stream_length = -1i32
        } else { stream_length = pdf_number_value(tmp2) as libc::c_int }
        pdf_release_obj(tmp2);
    } else { return 0 as *mut pdf_obj }
   ...
   */
    ...
    } else { result = pdf_new_stream(0i32) }
    ...
    if p.offset(9) > endptr ||
           memcmp(p as *const libc::c_void,
                  b"endstream\x00" as *const u8 as *const libc::c_char as
                      *const libc::c_void, 9i32 as libc::c_ulong) != 0 {
        pdf_release_obj(result);
        return 0 as *mut pdf_obj
    }
    p = p.offset(9);
...
unsafe extern "C" fn parse_pdf_reference(mut start: *mut *const libc::c_char,
                                         mut end: *const libc::c_char)
 -> *mut pdf_obj {
    let mut result: *mut pdf_obj = 0 as *mut pdf_obj;
    ...
    if !name.is_null() {
        ...
        if result.is_null() {
            dpx_warning(b"Could not find the named reference (@%s).\x00" as
        ...
        dpx_warning(b"Could not find a reference name.\x00" as *const u8 as
                        *const libc::c_char);
        dump(save, end);
        *start = save;
...
/* !PDF_PARSE_STRICT */
unsafe extern "C" fn try_pdf_reference(mut start: *const libc::c_char,
                                       mut end: *const libc::c_char,
 ...
 -> *mut pdf_obj {
    ...
    if start > end.offset(-5) ||
           *(*__ctype_b_loc()).offset(*start as libc::c_uchar as libc::c_int
    ...
    while !(*start as libc::c_int == ' ' as i32 ||
                ...
                *start as libc::c_int == '\u{0}' as i32) {
        if start >= end ||
               *(*__ctype_b_loc()).offset(*start as libc::c_uchar as
                                              libc::c_int as isize) as
                   libc::c_int &
                   _ISdigit as libc::c_int as libc::c_ushort as libc::c_int ==
                   0 {
        ...
        id =
            id.wrapping_mul(10i32 as
                                libc::c_uint).wrapping_add((*start as
                                                                libc::c_int -
                                                                '0' as i32) as
                                                               libc::c_uint);
        start = start.offset(1)
    ...
    while !(*start as libc::c_int == ' ' as i32 ||
        ...
        gen =
            (gen as libc::c_int * 10i32 +
                 (*start as libc::c_int - '0' as i32)) as libc::c_ushort;
        start = start.offset(1)
    }
    skip_white(&mut start, end);
    if start >= end || *start as libc::c_int != 'R' as i32 {
...
/* Please remove this */
#[no_mangle]
pub unsafe extern "C" fn parse_pdf_object(mut pp: *mut *const libc::c_char,
                                          mut endptr: *const libc::c_char,
                                          mut pf: *mut pdf_file)
 -> *mut pdf_obj 
 /* If pf is NULL, then indirect references are not allowed */
 {
    ...
    skip_white(pp, endptr);
    if *pp >= endptr {
        dpx_warning(b"Could not find any valid object.\x00" as *const u8 as
                        *const libc::c_char);
        return 0 as *mut pdf_obj
    }
    match **pp as libc::c_int {
        60 => {
            if *(*pp).offset(1) as libc::c_int != '<' as i32 {
                ...
                skip_white(pp, endptr);
                if !result.is_null() && *pp <= endptr.offset(-15) &&
                       memcmp(*pp as *const libc::c_void,
                              b"stream\x00" as *const u8 as
                                  *const libc::c_char as *const libc::c_void,
                              6i32 as libc::c_ulong) == 0 {
                    dict = result;
     ...
     */
            if !pf.is_null() &&
                   {
                       result =
                           try_pdf_reference(*pp, endptr, &mut nextptr, pf);
                       !result.is_null()
                   } {
                *pp = nextptr
            } else { result = parse_pdf_number(pp, endptr) }
        }
        64 => { result = parse_pdf_reference(pp, endptr) }
        _ => {
            dpx_warning(b"Unknown PDF object type.\x00" as *const u8 as
                            *const libc::c_char);
            result = 0 as *mut pdf_obj
        }
    }
