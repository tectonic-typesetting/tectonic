...
unsafe extern "C" fn printable_key(mut key: *const libc::c_char,
 ...
 -> *mut libc::c_char {
    ...
    while i < keylen && len < 32i32 {
        if *(*__ctype_b_loc()).offset(*key.offset(i as isize) as libc::c_uchar
            ...
            hi =
                (*key.offset(i as isize) as libc::c_int >> 4i32 & 0xffi32) as
                    libc::c_uchar;
            lo =
                (*key.offset(i as isize) as libc::c_int & 0xffi32) as
                    libc::c_uchar;
            let fresh1 = len;
            len = len + 1;
            ...
            let fresh2 = len;
            len = len + 1;
            pkey[fresh2 as usize] =
                (if (hi as libc::c_int) < 10i32 {
                     hi as libc::c_int + '0' as i32
                 } else { hi as libc::c_int - 10i32 + 'A' as i32 }) as
                    libc::c_char;
            let fresh3 = len;
            len = len + 1;
            pkey[fresh3 as usize] =
                (if (lo as libc::c_int) < 10i32 {
                     lo as libc::c_int + '0' as i32
                 } else { lo as libc::c_int - 10i32 + 'A' as i32 }) as
                    libc::c_char
        }
        i += 1
    }
            ...
            if !(*value).object.is_null() {
                ...
                __assert_fail(b"value->object\x00" as *const u8 as
                              ...
                              (*::std::mem::transmute::<&[u8; 46],
                                                        &[libc::c_char; 46]>(b"void check_objects_defined(struct ht_table *)\x00")).as_ptr());
            }
            if !(*value).object.is_null() &&
                   pdf_obj_typeof((*value).object) == 10i32 {
                pdf_names_add_object(ht_tab, key as *const libc::c_void,
                                     keylen, pdf_new_null());
                dpx_warning(b"Object @%s used, but not defined. Replaced by null.\x00"
...
pub unsafe extern "C" fn pdf_delete_name_tree(mut names: *mut *mut ht_table) {
    if !names.is_null() && !(*names).is_null() {
        ...
        __assert_fail(b"names && *names\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-pdfnames.c\x00" as *const u8 as
                          *const libc::c_char, 123i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 46],
                                                &[libc::c_char; 46]>(b"void pdf_delete_name_tree(struct ht_table **)\x00")).as_ptr());
    }
...
#[no_mangle]
pub unsafe extern "C" fn pdf_names_add_object(mut names: *mut ht_table,
 ...
 -> libc::c_int {
    ...
    if !names.is_null() && !object.is_null() {
        ...
        __assert_fail(b"names && object\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-pdfnames.c\x00" as *const u8 as
    ...
    if key.is_null() || keylen < 1i32 {
        dpx_warning(b"Null string used for name tree key.\x00" as *const u8 as
                        *const libc::c_char);
        return -1i32
    }
    ...
    if value.is_null() {
        value =
            new((1i32 as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<obj_data>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut obj_data;
        (*value).object = object;
        (*value).closed = 0i32;
        ...
        if !(*value).object.is_null() &&
            ...
            dpx_warning(b"Object @%s already defined.\x00" as *const u8 as
                            *const libc::c_char,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn pdf_names_lookup_reference(mut names: *mut ht_table,
                                                    mut key:
                                                        *const libc::c_void,
                                                    mut keylen: libc::c_int)
 -> *mut pdf_obj {
    ...
    if !names.is_null() {
        ...
        __assert_fail(b"names\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfnames.c\x00" as *const u8 as
                          *const libc::c_char, 176i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 74],
...
#[no_mangle]
pub unsafe extern "C" fn pdf_names_lookup_object(mut names: *mut ht_table,
                                                 mut key: *const libc::c_void,
                                                 mut keylen: libc::c_int)
 -> *mut pdf_obj {
    let mut value: *mut obj_data = 0 as *mut obj_data;
    if !names.is_null() {
        ...
        __assert_fail(b"names\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 71],
                                                &[libc::c_char; 71]>(b"pdf_obj *pdf_names_lookup_object(struct ht_table *, const void *, int)\x00")).as_ptr());
    }
    value = ht_lookup_table(names, key, keylen) as *mut obj_data;
    if value.is_null() ||
           !(*value).object.is_null() &&
               pdf_obj_typeof((*value).object) == 10i32 {
    ...
    if !(*value).object.is_null() {
        ...
        __assert_fail(b"value->object\x00" as *const u8 as
                          *const libc::c_char,
                      b"dpx-pdfnames.c\x00" as *const u8 as
                          *const libc::c_char, 206i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 71],
                                                &[libc::c_char; 71]>(b"pdf_obj *pdf_names_lookup_object(struct ht_table *, const void *, int)\x00")).as_ptr());
    }
    return (*value).object;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_names_close_object(mut names: *mut ht_table,
                                                mut key: *const libc::c_void,
                                                mut keylen: libc::c_int)
 -> libc::c_int {
    let mut value: *mut obj_data = 0 as *mut obj_data;
    if !names.is_null() {
        ...
        __assert_fail(b"names\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 65],
                                                &[libc::c_char; 65]>(b"int pdf_names_close_object(struct ht_table *, const void *, int)\x00")).as_ptr());
    }
    value = ht_lookup_table(names, key, keylen) as *mut obj_data;
    if value.is_null() ||
           !(*value).object.is_null() &&
               pdf_obj_typeof((*value).object) == 10i32 {
        dpx_warning(b"Cannot close undefined object @%s.\x00" as *const u8 as
                        *const libc::c_char,
                    printable_key(key as *const libc::c_char, keylen));
        return -1i32
    }
    ...
    if (*value).closed != 0 {
        dpx_warning(b"Object @%s already closed.\x00" as *const u8 as
                        *const libc::c_char,
                    printable_key(key as *const libc::c_char, keylen));
        return -1i32
    }
...
#[inline]
unsafe extern "C" fn cmp_key(mut d1: *const libc::c_void,
                             mut d2: *const libc::c_void) -> libc::c_int {
    ...
    if (*sd1).key.is_null() {
        ...
        keylen =
            if (*sd1).keylen < (*sd2).keylen {
                (*sd1).keylen
            } else { (*sd2).keylen };
        cmp =
            memcmp((*sd1).key as *const libc::c_void,
                   (*sd2).key as *const libc::c_void,
                   keylen as libc::c_ulong);
        if cmp == 0 { cmp = (*sd1).keylen - (*sd2).keylen }
    }
    return cmp;
}
unsafe extern "C" fn build_name_tree(mut first: *mut named_object,
 ...
 -> *mut pdf_obj {
   ...
   */
    if is_root == 0 {
        ...
        last =
            &mut *first.offset((num_leaves - 1i32) as isize) as
                *mut named_object;
        pdf_add_array(limits,
                      pdf_new_string((*first).key as *const libc::c_void,
                                     (*first).keylen as size_t));
        pdf_add_array(limits,
                      pdf_new_string((*last).key as *const libc::c_void,
                                     (*last).keylen as size_t));
        pdf_add_dict(result,
                     pdf_new_name(b"Limits\x00" as *const u8 as
                                      *const libc::c_char), limits);
    }
    if num_leaves > 0i32 && num_leaves <= 2i32 * 4i32 {
        ...
        while i < num_leaves {
            ...
            pdf_add_array(names,
                          pdf_new_string((*cur).key as *const libc::c_void,
            ...
            match pdf_obj_typeof((*cur).value) {
                ...
                0 => {
                    _tt_abort(b"Invalid object...: %s\x00" as *const u8 as
                                  *const libc::c_char,
                              printable_key((*cur).key, (*cur).keylen));
                }
                _ => { pdf_add_array(names, pdf_link_obj((*cur).value)); }
            }
        ...
        while i < 4i32 {
            ...
            subtree =
                build_name_tree(&mut *first.offset(start as isize),
                                end - start, 0i32);
...
unsafe extern "C" fn flat_table(mut ht_tab: *mut ht_table,
 ...
 -> *mut named_object {
    ...
    if !ht_tab.is_null() {
        ...
        __assert_fail(b"ht_tab\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfnames.c\x00" as *const u8 as
                          *const libc::c_char, 352i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 77],
                                                &[libc::c_char; 77]>(b"struct named_object *flat_table(struct ht_table *, int *, struct ht_table *)\x00")).as_ptr());
    }
    objects =
        new(((*ht_tab).count as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<named_object>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut named_object;
    count = 0i32;
    if ht_set_iter(ht_tab, &mut iter) >= 0i32 {
        ...
        loop  {
            ...
            if !filter.is_null() {
                let mut new_obj: *mut pdf_obj =
                    ht_lookup_table(filter, key as *const libc::c_void,
                                    keylen) as *mut pdf_obj;
                if new_obj.is_null() {
            ...
            } else { current_block_19 = 12800627514080957624; }
            match current_block_19 {
                12800627514080957624 => {
                    ...
                    if !(*value).object.is_null() &&
                           pdf_obj_typeof((*value).object) == 10i32 {
                        dpx_warning(b"Object @%s\" not defined. Replaced by null.\x00"
                                        as *const u8 as *const libc::c_char,
                                    printable_key(key, keylen));
                        let ref mut fresh4 =
                            (*objects.offset(count as isize)).key;
                        *fresh4 = key;
                        (*objects.offset(count as isize)).keylen = keylen;
                        let ref mut fresh5 =
                            (*objects.offset(count as isize)).value;
                        *fresh5 = pdf_new_null()
    ...
    *num_entries = count;
    objects =
        renew(objects as *mut libc::c_void,
              (count as uint32_t as
                   libc::c_ulong).wrapping_mul(::std::mem::size_of::<named_object>()
                                                   as libc::c_ulong) as
                  uint32_t) as *mut named_object;
    return objects;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_names_create_tree(mut names: *mut ht_table,
 ...
 -> *mut pdf_obj {
    ...
    if flat.is_null() {
        ...
        qsort(flat as *mut libc::c_void, *count as size_t,
