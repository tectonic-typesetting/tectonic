...
*/
    ...
    #[no_mangle]
    fn pdf_out_init(filename: *const libc::c_char, enable_encrypt: bool,
 ...
 */
    #[no_mangle]
    fn pdf_compare_reference(ref1: *mut pdf_obj, ref2: *mut pdf_obj)
     -> libc::c_int;
    #[no_mangle]
 ...
 */
    ...
    fn pdf_dev_eop();
    #[no_mangle]
    fn pdf_dev_get_coord(xpos: *mut libc::c_double,
                         ypos: *mut libc::c_double);
    #[no_mangle]
    fn pdf_color_graycolor(color: *mut pdf_color, g: libc::c_double)
     -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn ht_table_size(ht: *mut ht_table) -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn ht_iter_getkey(iter: *mut ht_iter, keylen: *mut libc::c_int)
     -> *mut libc::c_char;
    #[no_mangle]
...
*/
    ...
    #[no_mangle]
    fn pdf_ximage_set_verbose(level: libc::c_int);
    #[no_mangle]
    fn pdf_init_images();
    #[no_mangle]
    fn pdf_close_images();
 ...
 */
    #[no_mangle]
    fn pdf_ximage_findresource(ident: *const libc::c_char,
                               options: load_options) -> libc::c_int;
    #[no_mangle]
    fn pdf_ximage_defineresource(ident: *const libc::c_char,
                                 subtype: libc::c_int,
                                 cdata: *mut libc::c_void,
                                 resource: *mut pdf_obj) -> libc::c_int;
    #[no_mangle]
...
*/
    ...
    #[no_mangle]
    fn pdf_dev_rectfill(x: libc::c_double, y: libc::c_double,
 ...
 * the current gstate. */
    #[no_mangle]
    fn pdf_dev_push_gstate() -> libc::c_int;
    #[no_mangle]
    fn pdf_dev_pop_gstate() -> libc::c_int;
 ...
 */
    ...
    fn pdf_close_fonts();
    #[no_mangle]
    fn pdf_font_set_verbose(level: libc::c_int);
    /* This is dvipdfmx, an eXtended version of dvipdfm by Mark A. Wicks.
...
*/
    ...
    #[no_mangle]
    fn pdf_names_add_object(names: *mut ht_table, key: *const libc::c_void,
                            keylen: libc::c_int, object: *mut pdf_obj)
     -> libc::c_int;
    /* Really create name tree... */
    #[no_mangle]
    fn pdf_names_create_tree(names: *mut ht_table, count: *mut libc::c_int,
                             filter: *mut ht_table) -> *mut pdf_obj;
    /* This is dvipdfmx, an eXtended version of dvipdfm by Mark A. Wicks.
...
pub struct name_dict {
    pub category: *const libc::c_char,
...
static mut manual_thumb_enabled: libc::c_char = 0i32 as libc::c_char;
static mut thumb_basename: *mut libc::c_char =
    0 as *const libc::c_char as *mut libc::c_char;
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_enable_manual_thumbnails() {
    manual_thumb_enabled = 1i32 as libc::c_char;
    // without HAVE_LIBPNG:
  // dpx_warning("Manual thumbnail is not supported without the libpng library.");
}
unsafe extern "C" fn read_thumbnail(mut thumb_filename: *const libc::c_char)
 -> *mut pdf_obj {
    ...
    let mut options: load_options =
        {
            let mut init =
                load_options{page_no: 1i32,
                             bbox_type: 0i32,
                             dict: 0 as *mut pdf_obj,};
            init
        };
    handle =
        ttstub_input_open(thumb_filename, TTIF_PICT, 0i32) as
            *mut rust_input_handle_t;
    if handle.is_null() {
        dpx_warning(b"Could not open thumbnail file \"%s\"\x00" as *const u8
                        as *const libc::c_char, thumb_filename);
        return 0 as *mut pdf_obj
    }
    if check_for_png(handle as rust_input_handle_t) == 0 &&
           check_for_jpeg(handle as rust_input_handle_t) == 0 {
        dpx_warning(b"Thumbnail \"%s\" not a png/jpeg file!\x00" as *const u8
                        as *const libc::c_char, thumb_filename);
    ...
    if xobj_id < 0i32 {
        dpx_warning(b"Could not read thumbnail file \"%s\".\x00" as *const u8
                        as *const libc::c_char, thumb_filename);
        image_ref = 0 as *mut pdf_obj
    } else { image_ref = pdf_ximage_get_reference(xobj_id) }
    return image_ref;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_set_verbose(mut level: libc::c_int) {
    verbose = level;
    pdf_font_set_verbose(level);
    pdf_color_set_verbose(level);
    pdf_ximage_set_verbose(level);
}
static mut pdoc: pdf_doc =
    pdf_doc{root:
                C2RustUnnamed_3{dict: 0 as *const pdf_obj as *mut pdf_obj,
                                viewerpref:
                                    0 as *const pdf_obj as *mut pdf_obj,
                                pagelabels:
                                    0 as *const pdf_obj as *mut pdf_obj,
            ...
            pages:
                C2RustUnnamed_2{mediabox:
                                ...
                                max_entries: 0,
                                entries:
                                    0 as *const pdf_page as *mut pdf_page,},
            outlines:
                C2RustUnnamed_1{first:
                                    0 as *const pdf_olitem as *mut pdf_olitem,
                                current:
                                    0 as *const pdf_olitem as *mut pdf_olitem,
                                current_depth: 0,},
            articles:
                C2RustUnnamed_0{num_entries: 0,
                                max_entries: 0,
                                entries:
                                    0 as *const pdf_article as
                                        *mut pdf_article,},
            ...
            gotos:
                ht_table{count: 0,
                         hval_free_fn: None,
                         table:
                             [0 as *const ht_entry as *mut ht_entry; 503],},
            opt: C2RustUnnamed{outline_open_depth: 0, annot_grow: 0.,},
            pending_forms:
                0 as *const form_list_node as *mut form_list_node,};
...
unsafe extern "C" fn pdf_doc_close_catalog(mut p: *mut pdf_doc) {
    ...
    if !(*p).root.viewerpref.is_null() {
        tmp =
            pdf_lookup_dict((*p).root.dict,
                            b"ViewerPreferences\x00" as *const u8 as
                                *const libc::c_char);
        if tmp.is_null() {
            pdf_add_dict((*p).root.dict,
                         pdf_new_name(b"ViewerPreferences\x00" as *const u8 as
                                          *const libc::c_char),
            ...
            /* What should I do? */
            dpx_warning(b"Could not modify ViewerPreferences.\x00" as
                            *const u8 as
                            *const libc::c_char); /* Maybe reference */
        }
    ...
    if !(*p).root.pagelabels.is_null() {
        tmp =
            pdf_lookup_dict((*p).root.dict,
                            b"PageLabels\x00" as *const u8 as
                                *const libc::c_char);
        if tmp.is_null() {
            tmp = pdf_new_dict();
            pdf_add_dict(tmp,
                         pdf_new_name(b"Nums\x00" as *const u8 as
                                          *const libc::c_char),
                         pdf_link_obj((*p).root.pagelabels));
            pdf_add_dict((*p).root.dict,
                         pdf_new_name(b"PageLabels\x00" as *const u8 as
                                          *const libc::c_char),
                         pdf_ref_obj(tmp));
            pdf_release_obj(tmp);
        } else {
            /* What should I do? */
            dpx_warning(b"Could not modify PageLabels.\x00" as *const u8 as
                            *const libc::c_char);
        }
    ...
    pdf_add_dict((*p).root.dict,
                 pdf_new_name(b"Type\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_name(b"Catalog\x00" as *const u8 as
                                  *const libc::c_char));
 ...
 */
unsafe extern "C" fn doc_resize_page_entries(mut p: *mut pdf_doc,
                                             mut size: libc::c_uint) {
    if size > (*p).pages.max_entries {
        let mut i: libc::c_uint = 0; /* global bop */
        (*p).pages.entries =
            renew((*p).pages.entries as *mut libc::c_void,
                  (size as
                       libc::c_ulong).wrapping_mul(::std::mem::size_of::<pdf_page>()
                                                       as libc::c_ulong) as
                      uint32_t) as *mut pdf_page; /* background */
        i = (*p).pages.max_entries; /* page body  */
        while i < size {
            let ref mut fresh0 =
                (*(*p).pages.entries.offset(i as
                                                isize)).page_obj; /* global eop */
            *fresh0 = 0 as *mut pdf_obj;
            let ref mut fresh1 =
                (*(*p).pages.entries.offset(i as isize)).page_ref;
            *fresh1 = 0 as *mut pdf_obj;
            (*(*p).pages.entries.offset(i as isize)).flags = 0i32;
            let ref mut fresh2 =
                (*(*p).pages.entries.offset(i as isize)).resources;
            *fresh2 = 0 as *mut pdf_obj;
            let ref mut fresh3 =
                (*(*p).pages.entries.offset(i as isize)).background;
            *fresh3 = 0 as *mut pdf_obj;
            let ref mut fresh4 =
                (*(*p).pages.entries.offset(i as isize)).contents;
            *fresh4 = 0 as *mut pdf_obj;
            let ref mut fresh5 =
                (*(*p).pages.entries.offset(i as isize)).content_refs[0];
            *fresh5 = 0 as *mut pdf_obj;
            let ref mut fresh6 =
                (*(*p).pages.entries.offset(i as isize)).content_refs[1];
            *fresh6 = 0 as *mut pdf_obj;
            let ref mut fresh7 =
                (*(*p).pages.entries.offset(i as isize)).content_refs[2];
            *fresh7 = 0 as *mut pdf_obj;
            let ref mut fresh8 =
                (*(*p).pages.entries.offset(i as isize)).content_refs[3];
            *fresh8 = 0 as *mut pdf_obj;
            let ref mut fresh9 =
                (*(*p).pages.entries.offset(i as isize)).annots;
            *fresh9 = 0 as *mut pdf_obj;
            let ref mut fresh10 =
                (*(*p).pages.entries.offset(i as isize)).beads;
...
unsafe extern "C" fn doc_get_page_entry(mut p: *mut pdf_doc,
                                        mut page_no: libc::c_uint)
 -> *mut pdf_page {
    let mut page: *mut pdf_page = 0 as *mut pdf_page;
    if page_no as libc::c_ulong > 65535u64 {
        _tt_abort(b"Page number %ul too large!\x00" as *const u8 as
                      *const libc::c_char, page_no);
    } else {
        if page_no == 0i32 as libc::c_uint {
            _tt_abort(b"Invalid Page number %ul.\x00" as *const u8 as
                          *const libc::c_char, page_no);
        }
    }
    ...
    page =
        &mut *(*p).pages.entries.offset(page_no.wrapping_sub(1i32 as
                                                                 libc::c_uint)
                                            as isize) as *mut pdf_page;
    return page;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_set_bop_content(mut content:
                                                     *const libc::c_char,
                                                 mut length: libc::c_uint) {
    let mut p: *mut pdf_doc = &mut pdoc;
    if !p.is_null() {
    } else {
        __assert_fail(b"p\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdoc.c\x00" as *const u8 as *const libc::c_char,
                      392i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 57],
                                                &[libc::c_char; 57]>(b"void pdf_doc_set_bop_content(const char *, unsigned int)\x00")).as_ptr());
    }
    ...
    if length > 0i32 as libc::c_uint {
        ...
        pdf_add_stream((*p).pages.bop, content as *const libc::c_void,
                       length as libc::c_int);
    } else { (*p).pages.bop = 0 as *mut pdf_obj };
}
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_set_eop_content(mut content:
                                                     *const libc::c_char,
                                                 mut length: libc::c_uint) {
    let mut p: *mut pdf_doc = &mut pdoc;
    ...
    if length > 0i32 as libc::c_uint {
        ...
        pdf_add_stream((*p).pages.eop, content as *const libc::c_void,
                       length as libc::c_int);
    } else { (*p).pages.eop = 0 as *mut pdf_obj };
}
 ...
 * Docinfo
 */
unsafe extern "C" fn asn_date(mut date_string: *mut libc::c_char)
 -> libc::c_int {
    ...
    if current_time == -1i32 as time_t {
        ...
        /* HAVE_TIMEZONE */
        /* HAVE_TM_GMTOFF */
    } else { bd_time = gmtime(&mut current_time); tz_offset = 0i32 }
    sprintf(date_string,
            b"D:%04d%02d%02d%02d%02d%02d%c%02d\'%02d\'\x00" as *const u8 as
                *const libc::c_char, (*bd_time).tm_year + 1900i32,
            (*bd_time).tm_mon + 1i32, (*bd_time).tm_mday, (*bd_time).tm_hour,
            (*bd_time).tm_min, (*bd_time).tm_sec,
            if tz_offset > 0i32 { '+' as i32 } else { '-' as i32 },
            abs(tz_offset) / 3600i32, abs(tz_offset) / 60i32 % 60i32);
    return strlen(date_string) as libc::c_int;
}
...
unsafe extern "C" fn pdf_doc_close_docinfo(mut p: *mut pdf_doc) {
   ...
   */
    let mut keys: [*const libc::c_char; 9] =
        [b"Title\x00" as *const u8 as *const libc::c_char,
         ...
         b"CreationDate\x00" as *const u8 as *const libc::c_char,
         b"ModDate\x00" as *const u8 as *const libc::c_char,
    ...
    while !keys[i as usize].is_null() {
        ...
        if !value.is_null() {
            if !(!value.is_null() && pdf_obj_typeof(value) == 3i32) {
                dpx_warning(b"\"%s\" in DocInfo dictionary not string type.\x00"
                                as *const u8 as *const libc::c_char,
                            keys[i as usize]);
                pdf_remove_dict(docinfo, keys[i as usize]);
                dpx_warning(b"\"%s\" removed from DocInfo.\x00" as *const u8
                                as *const libc::c_char, keys[i as usize]);
    ...
    if pdf_lookup_dict(docinfo,
                       b"Producer\x00" as *const u8 as
                           *const libc::c_char).is_null() {
        let mut banner: [libc::c_char; 16] =
            *::std::mem::transmute::<&[u8; 16],
                                     &mut [libc::c_char; 16]>(b"xdvipdfmx (0.1)\x00");
        pdf_add_dict(docinfo,
                     pdf_new_name(b"Producer\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string(banner.as_mut_ptr() as
                                        *const libc::c_void,
                                    strlen(banner.as_mut_ptr())));
    }
    if pdf_lookup_dict(docinfo,
                       b"CreationDate\x00" as *const u8 as
                           *const libc::c_char).is_null() {
        let mut now: [libc::c_char; 80] = [0; 80];
        asn_date(now.as_mut_ptr());
        pdf_add_dict(docinfo,
                     pdf_new_name(b"CreationDate\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string(now.as_mut_ptr() as *const libc::c_void,
                                    strlen(now.as_mut_ptr())));
    }
    pdf_release_obj(docinfo);
    (*p).info = 0 as *mut pdf_obj;
}
unsafe extern "C" fn pdf_doc_get_page_resources(mut p: *mut pdf_doc,
                                                mut category:
                                                    *const libc::c_char)
 -> *mut pdf_obj {
    ...
    if p.is_null() || category.is_null() { return 0 as *mut pdf_obj }
    if !(*p).pending_forms.is_null() {
        ...
        currentpage =
            &mut *(*p).pages.entries.offset((*p).pages.num_entries as isize)
                as *mut pdf_page;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_add_page_resource(mut category:
                                                       *const libc::c_char,
                                                   mut resource_name:
                                                       *const libc::c_char,
                                                   mut resource_ref:
    ...
    if !(!resource_ref.is_null() && pdf_obj_typeof(resource_ref) == 9i32) {
        dpx_warning(b"Passed non indirect reference...\x00" as *const u8 as
                        *const libc::c_char);
    ...
    if !duplicate.is_null() &&
           pdf_compare_reference(duplicate, resource_ref) != 0 {
        dpx_warning(b"Conflicting page resource found (page: %d, category: %s, name: %s).\x00"
                        as *const u8 as *const libc::c_char,
                    pdf_doc_current_page_number(), category, resource_name);
        dpx_warning(b"Ignoring...\x00" as *const u8 as *const libc::c_char);
        pdf_release_obj(resource_ref);
    } else {
        pdf_add_dict(resources, pdf_new_name(resource_name), resource_ref);
    };
}
unsafe extern "C" fn doc_flush_page(mut p: *mut pdf_doc,
    ...
    pdf_add_dict((*page).page_obj,
                 pdf_new_name(b"Type\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_name(b"Page\x00" as *const u8 as
                                  *const libc::c_char));
    pdf_add_dict((*page).page_obj,
                 pdf_new_name(b"Parent\x00" as *const u8 as
                                  *const libc::c_char), parent_ref);
    /*
   ...
   */
    if (*page).flags & 1i32 << 0i32 != 0 {
        ...
        pdf_add_array(mediabox,
                      pdf_new_number(floor((*page).cropbox.llx / 0.01f64 +
                                               0.5f64) * 0.01f64));
        pdf_add_array(mediabox,
                      pdf_new_number(floor((*page).cropbox.lly / 0.01f64 +
                                               0.5f64) * 0.01f64));
        pdf_add_array(mediabox,
                      pdf_new_number(floor((*page).cropbox.urx / 0.01f64 +
                                               0.5f64) * 0.01f64));
        pdf_add_array(mediabox,
                      pdf_new_number(floor((*page).cropbox.ury / 0.01f64 +
                                               0.5f64) * 0.01f64));
        pdf_add_dict((*page).page_obj,
                     pdf_new_name(b"MediaBox\x00" as *const u8 as
                                      *const libc::c_char), mediabox);
    }
    ...
    } else if !(*p).pages.bop.is_null() &&
                  pdf_stream_length((*p).pages.bop) > 0i32 {
    ...
    if !(*page).content_refs[3].is_null() {
        ...
        count = count.wrapping_add(1)
    } else if !(*p).pages.eop.is_null() &&
                  pdf_stream_length((*p).pages.eop) > 0i32 {
        pdf_add_array(contents_array, pdf_ref_obj((*p).pages.eop));
        count = count.wrapping_add(1)
    }
    if count == 0i32 as libc::c_uint {
        dpx_warning(b"Page with empty content found!!!\x00" as *const u8 as
                        *const libc::c_char);
    }
    ...
    pdf_add_dict((*page).page_obj,
                 pdf_new_name(b"Contents\x00" as *const u8 as
                                  *const libc::c_char), contents_array);
    if !(*page).annots.is_null() {
        pdf_add_dict((*page).page_obj,
                     pdf_new_name(b"Annots\x00" as *const u8 as
                                      *const libc::c_char),
    ...
    if !(*page).beads.is_null() {
        pdf_add_dict((*page).page_obj,
                     pdf_new_name(b"B\x00" as *const u8 as
                                      *const libc::c_char),
...
unsafe extern "C" fn build_page_tree(mut p: *mut pdf_doc,
                                     mut firstpage: *mut pdf_page,
                                     mut num_pages: libc::c_int,
                                     mut parent_ref: *mut pdf_obj)
 -> *mut pdf_obj {
   ...
   */
    self_ref =
        if !parent_ref.is_null() {
            pdf_ref_obj(self_0)
        } else { pdf_ref_obj((*p).root.pages) };
    pdf_add_dict(self_0,
                 pdf_new_name(b"Type\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_name(b"Pages\x00" as *const u8 as
                                  *const libc::c_char));
    pdf_add_dict(self_0,
                 pdf_new_name(b"Count\x00" as *const u8 as
                                  *const libc::c_char),
    ...
    if num_pages > 0i32 && num_pages <= 4i32 {
        ...
        while i < 4i32 {
            ...
            if end - start > 1i32 {
                ...
                subtree =
                    build_page_tree(p, firstpage.offset(start as isize),
                                    end - start, pdf_link_obj(self_ref));
    ...
    pdf_add_dict(self_0,
                 pdf_new_name(b"Kids\x00" as *const u8 as
                                  *const libc::c_char), kids);
    pdf_release_obj(self_ref);
    return self_0;
}
unsafe extern "C" fn pdf_doc_init_page_tree(mut p: *mut pdf_doc,
...
unsafe extern "C" fn pdf_doc_close_page_tree(mut p: *mut pdf_doc) {
   ...
   */
    ...
    while page_no <= (*p).pages.max_entries {
        ...
        if !(*page).page_obj.is_null() {
            dpx_warning(b"Nonexistent page #%u refered.\x00" as *const u8 as
                            *const libc::c_char, page_no);
            pdf_release_obj((*page).page_ref);
            (*page).page_ref = 0 as *mut pdf_obj
        }
        if !(*page).page_obj.is_null() {
            dpx_warning(b"Entry for a nonexistent page #%u created.\x00" as
                            *const u8 as *const libc::c_char, page_no);
            pdf_release_obj((*page).page_obj);
            (*page).page_obj = 0 as *mut pdf_obj
        }
        if !(*page).annots.is_null() {
            dpx_warning(b"Annotation attached to a nonexistent page #%u.\x00"
                            as *const u8 as *const libc::c_char, page_no);
            pdf_release_obj((*page).annots);
            (*page).annots = 0 as *mut pdf_obj
        }
        if !(*page).beads.is_null() {
            dpx_warning(b"Article beads attached to a nonexistent page #%u.\x00"
                            as *const u8 as *const libc::c_char, page_no);
            pdf_release_obj((*page).beads);
            (*page).beads = 0 as *mut pdf_obj
        }
   ...
   */
    page_tree_root =
        build_page_tree(p, &mut *(*p).pages.entries.offset(0),
                        (*p).pages.num_entries as libc::c_int,
                        0 as *mut pdf_obj);
    ...
    mediabox = pdf_new_array();
    pdf_add_array(mediabox,
                  pdf_new_number(floor((*p).pages.mediabox.llx / 0.01f64 +
                                           0.5f64) * 0.01f64));
    pdf_add_array(mediabox,
                  pdf_new_number(floor((*p).pages.mediabox.lly / 0.01f64 +
                                           0.5f64) * 0.01f64));
    pdf_add_array(mediabox,
                  pdf_new_number(floor((*p).pages.mediabox.urx / 0.01f64 +
                                           0.5f64) * 0.01f64));
    pdf_add_array(mediabox,
                  pdf_new_number(floor((*p).pages.mediabox.ury / 0.01f64 +
                                           0.5f64) * 0.01f64));
    pdf_add_dict((*p).root.pages,
                 pdf_new_name(b"MediaBox\x00" as *const u8 as
                                  *const libc::c_char), mediabox);
    pdf_add_dict((*p).root.dict,
                 pdf_new_name(b"Pages\x00" as *const u8 as
    ...
    (*p).root.pages = 0 as *mut pdf_obj;
    (*p).pages.entries =
        mfree((*p).pages.entries as *mut libc::c_void) as *mut pdf_page;
    (*p).pages.num_entries = 0i32 as libc::c_uint;
    (*p).pages.max_entries = 0i32 as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_get_page_count(mut pf: *mut pdf_file)
 -> libc::c_int {
    ...
    page_tree =
        pdf_deref_obj(pdf_lookup_dict(catalog,
                                      b"Pages\x00" as *const u8 as
                                          *const libc::c_char));
    if !(!page_tree.is_null() && pdf_obj_typeof(page_tree) == 6i32) {
        return 0i32
    }
    let mut tmp: *mut pdf_obj =
        pdf_deref_obj(pdf_lookup_dict(page_tree,
    ...
    count = pdf_number_value(tmp) as libc::c_int;
    pdf_release_obj(tmp);
    return count;
}
/*
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_get_page(mut pf: *mut pdf_file,
 ...
 /* returned values */
 {
    ...
    if !(!page_tree.is_null() && pdf_obj_typeof(page_tree) == 6i32) {
        ...
        if !(!tmp.is_null() && pdf_obj_typeof(tmp) == 2i32) {
            ...
            if page_no <= 0i32 || page_no > count {
                dpx_warning(b"Page %d does not exist.\x00" as *const u8 as
                                *const libc::c_char, page_no);
   ...
   */
                ...
                let mut depth: libc::c_int = 30i32;
                let mut page_idx: libc::c_int = page_no - 1i32;
                let mut kids_length: libc::c_int = 1i32;
                        ...
                        if !(!kids.is_null() && pdf_obj_typeof(kids) == 5i32)
                           {
                            ...
                            kids_length =
                                pdf_array_length(kids) as libc::c_int;
                            i = 0i32;
                            while i < kids_length {
                                let mut count_0: libc::c_int = 0;
                                pdf_release_obj(page_tree);
                                page_tree =
                                    pdf_deref_obj(pdf_get_array(kids, i));
                                if !(!page_tree.is_null() &&
                                         pdf_obj_typeof(page_tree) == 6i32) {
                                    current_block = 7715203803291643663;
                                    break 's_83 ;
                                }
                                tmp_0 =
                ...
                match current_block {
                    ...
                    _ => {
                        if depth == 0 || kids_length == i {
                            ...
                            medbox = media_box;
                            if !(!(!box_0.is_null() &&
                                       pdf_obj_typeof(box_0) == 5i32) ||
                                     pdf_array_length(box_0) !=
                                         4i32 as libc::c_uint ||
                                     !(!resources.is_null() &&
                                           pdf_obj_typeof(resources) == 6i32))
                               {
                                ...
                                loop  {
                                    ...
                                    let mut tmp_1: *mut pdf_obj =
                                        pdf_deref_obj(pdf_get_array(box_0,
                                                                    i_0));
                                    if !(!tmp_1.is_null() &&
                                             pdf_obj_typeof(tmp_1) == 2i32) {
                                    ...
                                    /* New scheme only for XDV files */
                                    {
                                        if !medbox.is_null() &&
                                            ...
                                            loop  {
                                                ...
                                                let mut x_0: libc::c_double =
                                                    0.;
                                                let mut tmp_2: *mut pdf_obj =
                                                    pdf_deref_obj(pdf_get_array(medbox,
                                                                                i_0));
                                                if !(!tmp_2.is_null() &&
                                                         pdf_obj_typeof(tmp_2)
                                                             == 2i32) {
    ...
    match current_block {
        7715203803291643663 => {
            dpx_warning(b"Cannot parse document. Broken PDF file?\x00" as
...
unsafe extern "C" fn pdf_doc_init_bookmarks(mut p: *mut pdf_doc,
                                            mut bm_open_depth: libc::c_int) {
    let mut item: *mut pdf_olitem = 0 as *mut pdf_olitem;
    (*p).opt.outline_open_depth =
        (if bm_open_depth >= 0i32 {
             bm_open_depth as libc::c_uint
         } else { 256u32.wrapping_sub(bm_open_depth as libc::c_uint) }) as
            libc::c_int;
    (*p).outlines.current_depth = 1i32;
    item =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<pdf_olitem>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut pdf_olitem;
...
unsafe extern "C" fn clean_bookmarks(mut item: *mut pdf_olitem)
 -> libc::c_int {
    let mut next: *mut pdf_olitem = 0 as *mut pdf_olitem;
    while !item.is_null() {
        next = (*item).next;
        pdf_release_obj((*item).dict);
        if !(*item).first.is_null() { clean_bookmarks((*item).first); }
        free(item as *mut libc::c_void);
        item = next
    }
    return 0i32;
}
unsafe extern "C" fn flush_bookmarks(mut node: *mut pdf_olitem,
                                     mut parent_ref: *mut pdf_obj,
 ...
 -> libc::c_int {
    ...
    if !(*node).dict.is_null() {
        ...
        __assert_fail(b"node->dict\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdoc.c\x00" as *const u8 as *const libc::c_char,
                      1321i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 56],
                                                &[libc::c_char; 56]>(b"int flush_bookmarks(pdf_olitem *, pdf_obj *, pdf_obj *)\x00")).as_ptr());
    }
    ...
    while !item.is_null() && !(*item).dict.is_null() {
        ...
        if !prev_ref.is_null() {
            pdf_add_dict((*item).dict,
                         pdf_new_name(b"Prev\x00" as *const u8 as
                                          *const libc::c_char), prev_ref);
        }
        if !(*item).next.is_null() && !(*(*item).next).dict.is_null() {
            next_ref = pdf_ref_obj((*(*item).next).dict);
            pdf_add_dict((*item).dict,
                         pdf_new_name(b"Next\x00" as *const u8 as
                                          *const libc::c_char),
                         pdf_link_obj(next_ref));
        } else { next_ref = 0 as *mut pdf_obj }
        pdf_release_obj((*item).dict);
        (*item).dict = 0 as *mut pdf_obj;
        prev_ref = this_ref;
        this_ref = next_ref;
    ...
    pdf_add_dict(parent_dict,
                 pdf_new_name(b"Last\x00" as *const u8 as
                                  *const libc::c_char),
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_bookmarks_up() -> libc::c_int {
    let mut p: *mut pdf_doc = &mut pdoc;
    let mut parent: *mut pdf_olitem = 0 as *mut pdf_olitem;
    let mut item: *mut pdf_olitem = 0 as *mut pdf_olitem;
    item = (*p).outlines.current;
    if item.is_null() || (*item).parent.is_null() {
        dpx_warning(b"Can\'t go up above the bookmark root node!\x00" as
                        *const u8 as *const libc::c_char);
        return -1i32
    }
    parent = (*item).parent;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_bookmarks_down() -> libc::c_int {
    let mut p: *mut pdf_doc = &mut pdoc;
    let mut item: *mut pdf_olitem = 0 as *mut pdf_olitem;
    ...
    if (*item).dict.is_null() {
        ...
        dpx_warning(b"Empty bookmark node!\x00" as *const u8 as
                        *const libc::c_char);
        dpx_warning(b"You have tried to jump more than 1 level.\x00" as
                        *const u8 as *const libc::c_char);
        (*item).dict = pdf_new_dict();
        pdf_add_dict((*item).dict,
                     pdf_new_name(b"Title\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string(b"<No Title>\x00" as *const u8 as
                                        *const libc::c_char as
                                        *const libc::c_void,
                                    strlen(b"<No Title>\x00" as *const u8 as
                                               *const libc::c_char)));
        ...
        pdf_add_array(tcolor, pdf_new_number(0.0f64));
        pdf_add_dict((*item).dict,
                     pdf_new_name(b"C\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_link_obj(tcolor));
        pdf_release_obj(tcolor);
        pdf_add_dict((*item).dict,
                     pdf_new_name(b"F\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_number(1.0f64));
        action = pdf_new_dict();
        pdf_add_dict(action,
                     pdf_new_name(b"S\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_name(b"JavaScript\x00" as *const u8 as
                                      *const libc::c_char));
        pdf_add_dict(action,
                     ...
                     pdf_new_string(b"app.alert(\"The author of this document made this bookmark item empty!\", 3, 0)\x00"
                                    ...
                                    strlen(b"app.alert(\"The author of this document made this bookmark item empty!\", 3, 0)\x00"
                                               ...
                                               *const libc::c_char)));
        pdf_add_dict((*item).dict,
                     pdf_new_name(b"A\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_link_obj(action));
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_bookmarks_depth() -> libc::c_int {
    let mut p: *mut pdf_doc = &mut pdoc;
    return (*p).outlines.current_depth;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_bookmarks_add(mut dict: *mut pdf_obj,
    ...
    if !p.is_null() && !dict.is_null() {
        ...
        __assert_fail(b"p && dict\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdoc.c\x00" as *const u8 as *const libc::c_char,
                      1475i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 43],
                                                &[libc::c_char; 43]>(b"void pdf_doc_bookmarks_add(pdf_obj *, int)\x00")).as_ptr());
    }
    item = (*p).outlines.current;
    if item.is_null() {
        item =
...
unsafe extern "C" fn pdf_doc_close_bookmarks(mut p: *mut pdf_doc) {
    ...
    if !(*item).dict.is_null() {
        ...
        pdf_add_dict(catalog,
                     pdf_new_name(b"Outlines\x00" as *const u8 as
                                      *const libc::c_char), bm_root_ref);
...
static mut name_dict_categories: [*const libc::c_char; 10] =
    [b"Dests\x00" as *const u8 as *const libc::c_char,
     b"AP\x00" as *const u8 as *const libc::c_char,
     b"JavaScript\x00" as *const u8 as *const libc::c_char,
     b"Pages\x00" as *const u8 as *const libc::c_char,
     b"Templates\x00" as *const u8 as *const libc::c_char,
     b"IDS\x00" as *const u8 as *const libc::c_char,
     b"URLS\x00" as *const u8 as *const libc::c_char,
     b"EmbeddedFiles\x00" as *const u8 as *const libc::c_char,
     b"AlternatePresentations\x00" as *const u8 as *const libc::c_char,
     b"Renditions\x00" as *const u8 as *const libc::c_char];
unsafe extern "C" fn pdf_doc_init_names(mut p: *mut pdf_doc,
                                        mut check_gotos: libc::c_int) {
    let mut i: libc::c_uint = 0;
    (*p).root.names = 0 as *mut pdf_obj;
    (*p).names =
        new(((::std::mem::size_of::<[*const libc::c_char; 10]>() as
                  libc::c_ulong).wrapping_div(::std::mem::size_of::<*const libc::c_char>()
                                                  ...
                                                  libc::c_ulong).wrapping_add(1i32
                                                                                  ...
                                                                                  libc::c_ulong)
                 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<name_dict>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut name_dict;
    i = 0i32 as libc::c_uint;
    while (i as libc::c_ulong) <
        ...
        *fresh14 =
            if strcmp(name_dict_categories[i as usize],
                      b"Dests\x00" as *const u8 as *const libc::c_char) != 0 {
                0 as *mut ht_table
            } else { pdf_new_name_tree() };
        i = i.wrapping_add(1)
        /*
    ...
    let ref mut fresh15 =
        (*(*p).names.offset((::std::mem::size_of::<[*const libc::c_char; 10]>()
                                 as
                                 libc::c_ulong).wrapping_div(::std::mem::size_of::<*const libc::c_char>()
                                                                 as
                                                                 libc::c_ulong)
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_add_names(mut category: *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    if (*(*p).names.offset(i as isize)).category.is_null() {
        dpx_warning(b"Unknown name dictionary category \"%s\".\x00" as
                        *const u8 as *const libc::c_char, category);
        return -1i32
    }
    ...
    return pdf_names_add_object((*(*p).names.offset(i as isize)).data, key,
                                keylen, value);
}
unsafe extern "C" fn pdf_doc_add_goto(mut annot_dict: *mut pdf_obj) {
   ...
   */
    subtype =
        pdf_deref_obj(pdf_lookup_dict(annot_dict,
                                      b"Subtype\x00" as *const u8 as
                                          *const libc::c_char));
    if !subtype.is_null() {
        ...
        } else if strcmp(pdf_name_value(subtype),
                         b"Link\x00" as *const u8 as *const libc::c_char) != 0
         {
                ...
                if !A.is_null() {
                    if !A.is_null() && pdf_obj_typeof(A) == 10i32 {
                        current_block = 14825911176647684745;
                                  ...
                                  !(!A.is_null() && pdf_obj_typeof(A) == 6i32)
                     {
                        current_block = 10743935136377679094;
                    } else {
                        S =
                            pdf_deref_obj(pdf_lookup_dict(A,
                                                          b"S\x00" as
                                                              *const u8 as
                                                              *const libc::c_char));
                        if !S.is_null() && pdf_obj_typeof(S) == 10i32 {
                         ...
                         {
                            current_block = 10743935136377679094;
                        } else if strcmp(pdf_name_value(S),
                                         b"GoTo\x00" as *const u8 as
                                             *const libc::c_char) != 0 {
                            current_block = 6401626691277551363;
                        } else {
                            dict = A;
                ...
                match current_block {
                    ...
                    _ => {
                        if !D.is_null() && pdf_obj_typeof(D) == 3i32 {
                            dest = pdf_string_value(D) as *mut libc::c_char;
                            destlen = pdf_string_length(D) as libc::c_int;
                            D_new =
                                ht_lookup_table(&mut pdoc.gotos,
                                                dest as *const libc::c_void,
                                                destlen) as *mut pdf_obj;
                            if D_new.is_null() {
     ...
     */
                                sprintf(buf.as_mut_ptr(),
                                        b"%x\x00" as *const u8 as
                                            *const libc::c_char,
                                        ht_table_size(&mut pdoc.gotos)); /* Maybe reference */
                                D_new =
                                    pdf_new_string(buf.as_mut_ptr() as
                                                       *const libc::c_void,
                                                   strlen(buf.as_mut_ptr()));
                                ht_append_table(&mut pdoc.gotos,
                                                dest as *const libc::c_void,
                                                destlen,
                                                D_new as *mut libc::c_void);
                            }
                            let mut key_obj: *mut pdf_obj = pdf_new_name(key);
                            if pdf_add_dict(dict, key_obj,
                                            pdf_link_obj(D_new)) == 0 {
                            ...
                            current_block = 14825911176647684745;
                        } else { current_block = 10743935136377679094; }
                    }
                }
            }
        }
    ...
    match current_block {
        ...
        10743935136377679094 => {
            dpx_warning(b"Unknown PDF annotation format. Output file may be broken.\x00"
                            as *const u8 as *const libc::c_char);
        }
        _ => { }
    }
...
unsafe extern "C" fn warn_undef_dests(mut dests: *mut ht_table,
                                      mut gotos: *mut ht_table) {
    let mut iter: ht_iter =
        ht_iter{index: 0,
                curr: 0 as *mut libc::c_void,
                hash: 0 as *mut ht_table,};
    if ht_set_iter(gotos, &mut iter) < 0i32 { return }
    loop  {
        let mut keylen: libc::c_int = 0;
        let mut key: *mut libc::c_char =
            ht_iter_getkey(&mut iter, &mut keylen);
        if ht_lookup_table(dests, key as *const libc::c_void,
                           keylen).is_null() {
            let mut dest: *mut libc::c_char =
                new(((keylen + 1i32) as uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                         as libc::c_ulong) as
                        uint32_t) as *mut libc::c_char;
            memcpy(dest as *mut libc::c_void, key as *const libc::c_void,
                   keylen as libc::c_ulong);
            *dest.offset(keylen as isize) = 0i32 as libc::c_char;
            dpx_warning(b"PDF destination \"%s\" not defined.\x00" as
                            *const u8 as *const libc::c_char, dest);
            free(dest as *mut libc::c_void);
        }
        if !(ht_iter_next(&mut iter) >= 0i32) { break ; }
    }
...
unsafe extern "C" fn pdf_doc_close_names(mut p: *mut pdf_doc) {
    ...
    while !(*(*p).names.offset(i as isize)).category.is_null() {
        if !(*(*p).names.offset(i as isize)).data.is_null() {
            let mut data: *mut ht_table =
                (*(*p).names.offset(i as isize)).data;
            let mut name_tree: *mut pdf_obj = 0 as *mut pdf_obj;
            let mut count: libc::c_int = 0;
            if pdoc.check_gotos == 0 ||
                   strcmp((*(*p).names.offset(i as isize)).category,
                          b"Dests\x00" as *const u8 as *const libc::c_char) !=
                       0 {
                name_tree =
                    pdf_names_create_tree(data, &mut count,
                                          0 as *mut ht_table)
            } else {
                name_tree =
                    pdf_names_create_tree(data, &mut count, &mut pdoc.gotos);
            ...
            if !name_tree.is_null() {
                ...
                pdf_add_dict((*p).root.names,
                             pdf_new_name((*(*p).names.offset(i as
                                                                  isize)).category),
    ...
    if !(*p).root.names.is_null() {
        ...
        if tmp.is_null() {
            pdf_add_dict((*p).root.dict,
                         pdf_new_name(b"Names\x00" as *const u8 as
                                          *const libc::c_char),
            ...
            /* What should I do? */
            dpx_warning(b"Could not modify Names dictionary.\x00" as *const u8
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_add_annot(mut page_no: libc::c_uint,
                                           mut rect: *const pdf_rect,
                                           mut annot_dict: *mut pdf_obj,
                                           mut new_annot: libc::c_int) {
    let mut p: *mut pdf_doc = &mut pdoc;
    let mut page: *mut pdf_page = 0 as *mut pdf_page;
    ...
    let mut annbox: pdf_rect = pdf_rect{llx: 0., lly: 0., urx: 0., ury: 0.,};
    page = doc_get_page_entry(p, page_no);
    if (*page).annots.is_null() { (*page).annots = pdf_new_array() }
    ...
    if annbox.llx < mediabox.llx || annbox.urx > mediabox.urx ||
        ...
        dpx_warning(b"Annotation out of page boundary.\x00" as *const u8 as
                        *const libc::c_char);
        dpx_warning(b"Current page\'s MediaBox: [%g %g %g %g]\x00" as
                        *const u8 as *const libc::c_char, mediabox.llx,
                    mediabox.lly, mediabox.urx, mediabox.ury);
        dpx_warning(b"Annotation: [%g %g %g %g]\x00" as *const u8 as
                        *const libc::c_char, annbox.llx, annbox.lly,
                    annbox.urx, annbox.ury);
        dpx_warning(b"Maybe incorrect paper size specified.\x00" as *const u8
                        as *const libc::c_char);
    }
    if annbox.llx > annbox.urx || annbox.lly > annbox.ury {
        dpx_warning(b"Rectangle with negative width/height: [%g %g %g %g]\x00"
                        as *const u8 as *const libc::c_char, annbox.llx,
                    annbox.lly, annbox.urx, annbox.ury);
    }
    rect_array = pdf_new_array();
    pdf_add_array(rect_array,
                  pdf_new_number(floor((annbox.llx - annot_grow) / 0.001f64 +
                                           0.5f64) * 0.001f64));
    pdf_add_array(rect_array,
                  pdf_new_number(floor((annbox.lly - annot_grow) / 0.001f64 +
                                           0.5f64) * 0.001f64));
    pdf_add_array(rect_array,
                  pdf_new_number(floor((annbox.urx + annot_grow) / 0.001f64 +
                                           0.5f64) * 0.001f64));
    pdf_add_array(rect_array,
                  pdf_new_number(floor((annbox.ury + annot_grow) / 0.001f64 +
                                           0.5f64) * 0.001f64));
    pdf_add_dict(annot_dict,
                 pdf_new_name(b"Rect\x00" as *const u8 as
                                  *const libc::c_char), rect_array);
    pdf_add_array((*page).annots, pdf_ref_obj(annot_dict));
    if new_annot != 0 { pdf_doc_add_goto(annot_dict); };
}
/*
 * PDF Article Thread
 */
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_begin_article(mut article_id:
                                                   *const libc::c_char,
                                               mut article_info:
                                                   *mut pdf_obj) {
    let mut p: *mut pdf_doc = &mut pdoc;
    let mut article: *mut pdf_article = 0 as *mut pdf_article;
    if article_id.is_null() || strlen(article_id) == 0i32 as libc::c_ulong {
        _tt_abort(b"Article thread without internal identifier.\x00" as
                      *const u8 as *const libc::c_char);
    }
    if (*p).articles.num_entries >= (*p).articles.max_entries {
        (*p).articles.max_entries =
            (*p).articles.max_entries.wrapping_add(16i32 as libc::c_uint);
        (*p).articles.entries =
            renew((*p).articles.entries as *mut libc::c_void,
                  ((*p).articles.max_entries as
                       libc::c_ulong).wrapping_mul(::std::mem::size_of::<pdf_article>()
                                                       as libc::c_ulong) as
                      uint32_t) as *mut pdf_article
    }
    article =
        &mut *(*p).articles.entries.offset((*p).articles.num_entries as isize)
            as *mut pdf_article;
    (*article).id =
        new((strlen(article_id).wrapping_add(1i32 as libc::c_ulong) as
                 uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
...
unsafe extern "C" fn find_bead(mut article: *mut pdf_article,
                               mut bead_id: *const libc::c_char)
 -> *mut pdf_bead {
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_add_bead(mut article_id: *const libc::c_char,
                                          mut bead_id: *const libc::c_char,
                                          mut page_no: libc::c_int,
                                          mut rect: *const pdf_rect) {
    let mut p: *mut pdf_doc = &mut pdoc;
    ...
    if article_id.is_null() {
        _tt_abort(b"No article identifier specified.\x00" as *const u8 as
                      *const libc::c_char);
    }
    article = 0 as *mut pdf_article;
    i = 0i32 as libc::c_uint;
    while i < (*p).articles.num_entries {
        if streq_ptr((*(*p).articles.entries.offset(i as isize)).id,
                     article_id) {
            article =
                &mut *(*p).articles.entries.offset(i as isize) as
                    *mut pdf_article;
            break ;
        } else { i = i.wrapping_add(1) }
    }
    if article.is_null() {
        _tt_abort(b"Specified article thread that doesn\'t exist.\x00" as
                      *const u8 as *const libc::c_char);
    }
    bead =
        if !bead_id.is_null() {
            find_bead(article, bead_id)
        } else { 0 as *mut pdf_bead };
    if bead.is_null() {
        if (*article).num_beads >= (*article).max_beads {
            (*article).max_beads =
                (*article).max_beads.wrapping_add(16i32 as libc::c_uint);
            (*article).beads =
                renew((*article).beads as *mut libc::c_void,
                      ((*article).max_beads as
                           libc::c_ulong).wrapping_mul(::std::mem::size_of::<pdf_bead>()
                                                           as libc::c_ulong)
                          as uint32_t) as *mut pdf_bead;
            i = (*article).num_beads;
            while i < (*article).max_beads {
                let ref mut fresh18 =
                    (*(*article).beads.offset(i as isize)).id;
        ...
        bead =
            &mut *(*article).beads.offset((*article).num_beads as isize) as
                *mut pdf_bead;
        if !bead_id.is_null() {
            (*bead).id =
                new((strlen(bead_id).wrapping_add(1i32 as libc::c_ulong) as
                         uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                         as libc::c_ulong) as
                        uint32_t) as *mut libc::c_char;
            strcpy((*bead).id, bead_id);
        } else { (*bead).id = 0 as *mut libc::c_char }
...
unsafe extern "C" fn make_article(mut p: *mut pdf_doc,
                                  mut article: *mut pdf_article,
                                  mut bead_ids: *mut *const libc::c_char,
 ...
 -> *mut pdf_obj {
    ...
    if article.is_null() { return 0 as *mut pdf_obj }
   ...
   */
    n =
        (if !bead_ids.is_null() { num_beads } else { (*article).num_beads })
            as libc::c_int;
    i = 0i32;
    while i < n {
        let mut bead: *mut pdf_bead = 0 as *mut pdf_bead;
        ...
        if !(bead.is_null() || (*bead).page_no < 0i32) {
            ...
            if prev.is_null() {
                first = last;
                pdf_add_dict(first,
                             pdf_new_name(b"T\x00" as *const u8 as
                                              *const libc::c_char),
                             pdf_ref_obj(art_dict));
            } else {
                pdf_add_dict(prev,
                             pdf_new_name(b"N\x00" as *const u8 as
                                              *const libc::c_char),
                             pdf_ref_obj(last));
                pdf_add_dict(last,
                             pdf_new_name(b"V\x00" as *const u8 as
                                              *const libc::c_char),
                             pdf_ref_obj(prev));
                /* We must link first to last. */
                if prev != first { pdf_release_obj(prev); }
            }
            /* Realize bead now. */
            let mut page: *mut pdf_page = 0 as *mut pdf_page;
            let mut rect: *mut pdf_obj = 0 as *mut pdf_obj;
            page = doc_get_page_entry(p, (*bead).page_no as libc::c_uint);
            if (*page).beads.is_null() { (*page).beads = pdf_new_array() }
            pdf_add_dict(last,
                         pdf_new_name(b"P\x00" as *const u8 as
                                          *const libc::c_char),
                         pdf_link_obj((*page).page_ref));
            rect = pdf_new_array();
            pdf_add_array(rect,
                          pdf_new_number(floor((*bead).rect.llx / 0.01f64 +
                                                   0.5f64) * 0.01f64));
            pdf_add_array(rect,
                          pdf_new_number(floor((*bead).rect.lly / 0.01f64 +
                                                   0.5f64) * 0.01f64));
            pdf_add_array(rect,
                          pdf_new_number(floor((*bead).rect.urx / 0.01f64 +
                                                   0.5f64) * 0.01f64));
            pdf_add_array(rect,
                          pdf_new_number(floor((*bead).rect.ury / 0.01f64 +
                                                   0.5f64) * 0.01f64));
            pdf_add_dict(last,
                         pdf_new_name(b"R\x00" as *const u8 as
                                          *const libc::c_char), rect);
    ...
    if !first.is_null() && !last.is_null() {
        ...
        pdf_add_dict(first,
                     pdf_new_name(b"V\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_ref_obj(last));
        if first != last { pdf_release_obj(last); }
        ...
        if !article_info.is_null() {
            pdf_add_dict(art_dict,
                         pdf_new_name(b"I\x00" as *const u8 as
                                          *const libc::c_char), article_info);
    ...
    } else { pdf_release_obj(art_dict); art_dict = 0 as *mut pdf_obj }
    return art_dict;
}
unsafe extern "C" fn clean_article(mut article: *mut pdf_article) {
    if article.is_null() { return }
    if !(*article).beads.is_null() {
        let mut i: libc::c_uint = 0;
        i = 0i32 as libc::c_uint;
        while i < (*article).num_beads {
            free((*(*article).beads.offset(i as isize)).id as
                     *mut libc::c_void);
            i = i.wrapping_add(1)
        }
        (*article).beads =
            mfree((*article).beads as *mut libc::c_void) as *mut pdf_bead
    }
    (*article).id =
        mfree((*article).id as *mut libc::c_void) as *mut libc::c_char;
    (*article).num_beads = 0i32 as libc::c_uint;
    (*article).max_beads = 0i32 as libc::c_uint;
}
unsafe extern "C" fn pdf_doc_close_articles(mut p: *mut pdf_doc) {
    ...
    while i < (*p).articles.num_entries {
        ...
        if !(*article).beads.is_null() {
            let mut art_dict: *mut pdf_obj = 0 as *mut pdf_obj;
            art_dict =
                make_article(p, article, 0 as *mut *const libc::c_char,
                             0i32 as libc::c_uint, 0 as *mut pdf_obj);
    ...
    (*p).articles.entries =
        mfree((*p).articles.entries as *mut libc::c_void) as *mut pdf_article;
    (*p).articles.num_entries = 0i32 as libc::c_uint;
    (*p).articles.max_entries = 0i32 as libc::c_uint;
    if !(*p).root.threads.is_null() {
        pdf_add_dict((*p).root.dict,
                     pdf_new_name(b"Threads\x00" as *const u8 as
                                      *const libc::c_char),
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_set_mediabox(mut page_no: libc::c_uint,
...
unsafe extern "C" fn pdf_doc_get_mediabox(mut page_no: libc::c_uint,
                                          mut mediabox: *mut pdf_rect) {
    let mut p: *mut pdf_doc = &mut pdoc;
    let mut page: *mut pdf_page = 0 as *mut pdf_page;
    if page_no == 0i32 as libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_get_dictionary(mut category:
                                                    *const libc::c_char)
 -> *mut pdf_obj {
    let mut p: *mut pdf_doc = &mut pdoc;
    let mut dict: *mut pdf_obj = 0 as *mut pdf_obj;
    if !category.is_null() {
        ...
        __assert_fail(b"category\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdoc.c\x00" as *const u8 as *const libc::c_char,
                      2183i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 46],
                                                &[libc::c_char; 46]>(b"pdf_obj *pdf_doc_get_dictionary(const char *)\x00")).as_ptr());
    }
    if streq_ptr(category, b"Names\x00" as *const u8 as *const libc::c_char) {
        if (*p).root.names.is_null() { (*p).root.names = pdf_new_dict() }
        dict = (*p).root.names
    } else if streq_ptr(category,
                        b"Pages\x00" as *const u8 as *const libc::c_char) {
        if (*p).root.pages.is_null() { (*p).root.pages = pdf_new_dict() }
        dict = (*p).root.pages
    } else if streq_ptr(category,
                        b"Catalog\x00" as *const u8 as *const libc::c_char) {
        if (*p).root.dict.is_null() { (*p).root.dict = pdf_new_dict() }
        dict = (*p).root.dict
    } else if streq_ptr(category,
                        b"Info\x00" as *const u8 as *const libc::c_char) {
        if (*p).info.is_null() { (*p).info = pdf_new_dict() }
        dict = (*p).info
    } else if streq_ptr(category,
    ...
    if dict.is_null() {
        _tt_abort(b"Document dict. \"%s\" not exist. \x00" as *const u8 as
                      *const libc::c_char, category);
    }
    return dict;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_current_page_number() -> libc::c_int {
    let mut p: *mut pdf_doc = &mut pdoc;
    return (*p).pages.num_entries.wrapping_add(1i32 as libc::c_uint) as
               libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_ref_page(mut page_no: libc::c_uint)
 -> *mut pdf_obj {
    let mut p: *mut pdf_doc = &mut pdoc;
    let mut page: *mut pdf_page = 0 as *mut pdf_page;
    page = doc_get_page_entry(p, page_no);
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_get_reference(mut category:
                                                   *const libc::c_char)
 -> *mut pdf_obj {
    ...
    if !category.is_null() {
        ...
        __assert_fail(b"category\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 45],
                                                &[libc::c_char; 45]>(b"pdf_obj *pdf_doc_get_reference(const char *)\x00")).as_ptr());
    }
    page_no = pdf_doc_current_page_number();
    if streq_ptr(category,
                 b"@THISPAGE\x00" as *const u8 as *const libc::c_char) {
     ...
     {
        if page_no <= 1i32 {
            _tt_abort(b"Reference to previous page, but no pages have been completed yet.\x00"
                          as *const u8 as *const libc::c_char);
        }
    ...
    if ref_0.is_null() {
        _tt_abort(b"Reference to \"%s\" not exist. \x00" as *const u8 as
                      *const libc::c_char, category);
    }
    return ref_0;
}
unsafe extern "C" fn pdf_doc_new_page(mut p: *mut pdf_doc) {
    ...
    if (*p).pages.num_entries >= (*p).pages.max_entries {
        doc_resize_page_entries(p,
                                (*p).pages.max_entries.wrapping_add(128u32));
    }
    /*
   * This is confusing. pdf_doc_finish_page() have increased page count!
   */
    currentpage =
        &mut *(*p).pages.entries.offset((*p).pages.num_entries as isize) as
            *mut pdf_page;
...
unsafe extern "C" fn pdf_doc_finish_page(mut p: *mut pdf_doc) {
    let mut currentpage: *mut pdf_page = 0 as *mut pdf_page;
    if !(*p).pending_forms.is_null() {
        _tt_abort(b"A pending form XObject at the end of page.\x00" as
                      *const u8 as *const libc::c_char);
    }
    currentpage =
        &mut *(*p).pages.entries.offset((*p).pages.num_entries as isize) as
   ...
   */
    if !(*currentpage).background.is_null() {
        ...
        (*currentpage).background = 0 as *mut pdf_obj
    } else { (*currentpage).content_refs[1] = 0 as *mut pdf_obj }
   ...
   */
    ...
    } else { (*currentpage).content_refs[3] = 0 as *mut pdf_obj }
    /*
   * Page resources.
   */
    if !(*currentpage).resources.is_null() {
     ...
     */
        ...
        pdf_add_array(procset,
                      pdf_new_name(b"PDF\x00" as *const u8 as
                                       *const libc::c_char));
        pdf_add_array(procset,
                      pdf_new_name(b"Text\x00" as *const u8 as
                                       *const libc::c_char));
        pdf_add_array(procset,
                      pdf_new_name(b"ImageC\x00" as *const u8 as
                                       *const libc::c_char));
        pdf_add_array(procset,
                      pdf_new_name(b"ImageB\x00" as *const u8 as
                                       *const libc::c_char));
        pdf_add_array(procset,
                      pdf_new_name(b"ImageI\x00" as *const u8 as
                                       *const libc::c_char));
        pdf_add_dict((*currentpage).resources,
                     pdf_new_name(b"ProcSet\x00" as *const u8 as
                                      *const libc::c_char), procset);
        pdf_add_dict((*currentpage).page_obj,
                     pdf_new_name(b"Resources\x00" as *const u8 as
                                      *const libc::c_char),
    ...
    if manual_thumb_enabled != 0 {
        ...
        thumb_filename =
            new((strlen(thumb_basename).wrapping_add(7i32 as libc::c_ulong) as
                     uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                     as libc::c_ulong) as
                    uint32_t) as *mut libc::c_char;
        sprintf(thumb_filename,
                b"%s.%ld\x00" as *const u8 as *const libc::c_char,
                thumb_basename,
                (*p).pages.num_entries.wrapping_rem(99999i32 as libc::c_uint)
                    as libc::c_long + 1i64);
        thumb_ref = read_thumbnail(thumb_filename);
        free(thumb_filename as *mut libc::c_void);
        if !thumb_ref.is_null() {
            pdf_add_dict((*currentpage).page_obj,
                         pdf_new_name(b"Thumb\x00" as *const u8 as
                                          *const libc::c_char), thumb_ref);
        }
    }
...
unsafe extern "C" fn doc_fill_page_background(mut p: *mut pdf_doc) {
    ...
    if cm == 0 || pdf_color_is_white(&mut bgcolor) as libc::c_int != 0 {
        return
    }
    pdf_doc_get_mediabox(pdf_doc_current_page_number() as libc::c_uint,
                         &mut r);
    currentpage =
        &mut *(*p).pages.entries.offset((*p).pages.num_entries as isize) as
            *mut pdf_page;
    if !currentpage.is_null() {
        ...
        __assert_fail(b"currentpage\x00" as *const u8 as *const libc::c_char,
                      b"dpx-pdfdoc.c\x00" as *const u8 as *const libc::c_char,
                      2426i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 41],
                                                &[libc::c_char; 41]>(b"void doc_fill_page_background(pdf_doc *)\x00")).as_ptr());
    }
    if (*currentpage).background.is_null() {
    ...
    pdf_dev_gsave();
    pdf_dev_set_color(&mut bgcolor, 0x20i32 as libc::c_char, 0i32);
    pdf_dev_rectfill(r.llx, r.lly, r.urx - r.llx, r.ury - r.lly);
    pdf_dev_grestore();
    (*currentpage).contents = saved_content;
}
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_begin_page(mut scale: libc::c_double,
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_add_page_content(mut buffer:
                                                      *const libc::c_char,
                                                  mut length: libc::c_uint) {
    let mut p: *mut pdf_doc = &mut pdoc;
    let mut currentpage: *mut pdf_page = 0 as *mut pdf_page;
    if !(*p).pending_forms.is_null() {
        pdf_add_stream((*(*p).pending_forms).form.contents,
                       buffer as *const libc::c_void, length as libc::c_int);
    } else {
        currentpage =
            &mut *(*p).pages.entries.offset((*p).pages.num_entries as isize)
                as *mut pdf_page;
        pdf_add_stream((*currentpage).contents, buffer as *const libc::c_void,
                       length as libc::c_int);
    };
}
static mut doccreator: *mut libc::c_char =
    0 as *const libc::c_char as *mut libc::c_char;
/* Ugh */
#[no_mangle]
pub unsafe extern "C" fn pdf_open_document(mut filename: *const libc::c_char,
                                           mut enable_encrypt: bool,
                                           mut enable_object_stream: bool,
                                           mut media_width: libc::c_double,
                                           mut media_height: libc::c_double,
                                           mut annot_grow_amount:
                                               libc::c_double,
                                           mut bookmark_open_depth:
                                               libc::c_int,
                                           mut check_gotos: libc::c_int) {
    let mut p: *mut pdf_doc = &mut pdoc;
    ...
    if !doccreator.is_null() {
        pdf_add_dict((*p).info,
                     pdf_new_name(b"Creator\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_string(doccreator as *const libc::c_void,
                                    strlen(doccreator)));
        doccreator =
            mfree(doccreator as *mut libc::c_void) as *mut libc::c_char
    }
    ...
    if manual_thumb_enabled != 0 {
        ...
        if fn_len > 4i32 as libc::c_ulong &&
               strncmp(b".pdf\x00" as *const u8 as *const libc::c_char,
                       filename.offset(fn_len as isize).offset(-4),
                       4i32 as libc::c_ulong) == 0 {
            thumb_basename =
                new((fn_len.wrapping_sub(4i32 as
                                             libc::c_ulong).wrapping_add(1i32
                                                                             as
                                                                             libc::c_ulong)
                         as uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                         as libc::c_ulong) as
                        uint32_t) as *mut libc::c_char;
            strncpy(thumb_basename, filename,
                    fn_len.wrapping_sub(4i32 as libc::c_ulong));
            *thumb_basename.offset(fn_len.wrapping_sub(4i32 as libc::c_ulong)
                                       as isize) = 0i32 as libc::c_char
        } else {
            thumb_basename =
                new((fn_len.wrapping_add(1i32 as libc::c_ulong) as uint32_t as
                         libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                         as libc::c_ulong) as
                        uint32_t) as *mut libc::c_char;
...
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_set_creator(mut creator:
                                                 *const libc::c_char) {
    if creator.is_null() ||
           *creator.offset(0) as libc::c_int == '\u{0}' as i32 {
        return
    }
    doccreator =
        new((strlen(creator).wrapping_add(1i32 as libc::c_ulong) as uint32_t
                 as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
 ...
 */
unsafe extern "C" fn pdf_doc_make_xform(mut xform: *mut pdf_obj,
                                        mut bbox: *mut pdf_rect,
                                        mut matrix: *mut pdf_tmatrix,
    ...
    pdf_add_dict(xform_dict,
                 pdf_new_name(b"Subtype\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_name(b"Form\x00" as *const u8 as
                                  *const libc::c_char));
    pdf_add_dict(xform_dict,
                 pdf_new_name(b"FormType\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_number(1.0f64));
    if bbox.is_null() {
        _tt_abort(b"No BoundingBox supplied.\x00" as *const u8 as
                      *const libc::c_char);
    }
    tmp = pdf_new_array();
    pdf_add_array(tmp,
                  pdf_new_number(floor((*bbox).llx / 0.001f64 + 0.5f64) *
                                     0.001f64));
    pdf_add_array(tmp,
                  pdf_new_number(floor((*bbox).lly / 0.001f64 + 0.5f64) *
                                     0.001f64));
    pdf_add_array(tmp,
                  pdf_new_number(floor((*bbox).urx / 0.001f64 + 0.5f64) *
                                     0.001f64));
    pdf_add_array(tmp,
                  pdf_new_number(floor((*bbox).ury / 0.001f64 + 0.5f64) *
                                     0.001f64));
    pdf_add_dict(xform_dict,
                 pdf_new_name(b"BBox\x00" as *const u8 as
                                  *const libc::c_char), tmp);
    if !matrix.is_null() {
        tmp = pdf_new_array();
        pdf_add_array(tmp,
                      pdf_new_number(floor((*matrix).a / 0.00001f64 + 0.5f64)
                                         * 0.00001f64));
        pdf_add_array(tmp,
                      pdf_new_number(floor((*matrix).b / 0.00001f64 + 0.5f64)
                                         * 0.00001f64));
        pdf_add_array(tmp,
                      pdf_new_number(floor((*matrix).c / 0.00001f64 + 0.5f64)
                                         * 0.00001f64));
        pdf_add_array(tmp,
                      pdf_new_number(floor((*matrix).d / 0.00001f64 + 0.5f64)
                                         * 0.00001f64));
        pdf_add_array(tmp,
                      pdf_new_number(floor((*matrix).e / 0.001f64 + 0.5f64) *
                                         0.001f64));
        pdf_add_array(tmp,
                      pdf_new_number(floor((*matrix).f / 0.001f64 + 0.5f64) *
                                         0.001f64));
        pdf_add_dict(xform_dict,
                     pdf_new_name(b"Matrix\x00" as *const u8 as
                                      *const libc::c_char), tmp);
    }
    if !attrib.is_null() { pdf_merge_dict(xform_dict, attrib); }
    pdf_add_dict(xform_dict,
                 pdf_new_name(b"Resources\x00" as *const u8 as
                                  *const libc::c_char), resources);
}
/*
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn pdf_doc_begin_grabbing(mut ident:
                                                    *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    let mut info: xform_info =
        xform_info{flags: 0,
                   bbox: pdf_rect{llx: 0., lly: 0., urx: 0., ury: 0.,},
                   matrix:
                       pdf_tmatrix{a: 0.,
                                   b: 0.,
                                   c: 0.,
    ...
    fnode =
        new((1i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<form_list_node>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut form_list_node;
  ...
  */
    ...
    xobj_id =
        pdf_ximage_defineresource(ident, 0i32,
                                  &mut info as *mut xform_info as
                                      *mut libc::c_void,
...
pub unsafe extern "C" fn pdf_doc_end_grabbing(mut attrib: *mut pdf_obj) {
    ...
    let mut fnode: *mut form_list_node = 0 as *mut form_list_node;
    if (*p).pending_forms.is_null() {
        dpx_warning(b"Tried to close a nonexistent form XOject.\x00" as
                        *const u8 as *const libc::c_char);
        return
    }
   ...
   */
    ...
    pdf_add_array(procset,
                  pdf_new_name(b"ImageI\x00" as *const u8 as
                                   *const libc::c_char));
    pdf_add_dict((*form).resources,
                 pdf_new_name(b"ProcSet\x00" as *const u8 as
                                  *const libc::c_char), procset);
    pdf_doc_make_xform((*form).contents, &mut (*form).cropbox,
                       &mut (*form).matrix, pdf_ref_obj((*form).resources),
                       attrib);
...
pub unsafe extern "C" fn pdf_doc_break_annot() {
    if breaking_state.dirty != 0 {
        ...
        pdf_doc_add_annot(pdf_doc_current_page_number() as libc::c_uint,
                          &mut breaking_state.rect, annot_dict,
                          (breaking_state.broken == 0) as libc::c_int);
...
pub unsafe extern "C" fn pdf_doc_expand_box(mut rect: *const pdf_rect) {
    breaking_state.rect.llx =
        if breaking_state.rect.llx < (*rect).llx {
            breaking_state.rect.llx
        } else { (*rect).llx };
    breaking_state.rect.lly =
        if breaking_state.rect.lly < (*rect).lly {
            breaking_state.rect.lly
        } else { (*rect).lly };
    breaking_state.rect.urx =
        if breaking_state.rect.urx > (*rect).urx {
            breaking_state.rect.urx
        } else { (*rect).urx };
    breaking_state.rect.ury =
        if breaking_state.rect.ury > (*rect).ury {
            breaking_state.rect.ury
        } else { (*rect).ury };
