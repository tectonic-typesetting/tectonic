 ...
 */
    ...
    #[no_mangle]
    fn CMap_decode_char(cmap: *mut CMap, inbuf: *mut *const libc::c_uchar,
...
static mut required_table: [C2RustUnnamed_1; 12] =
    [{
     ...
     {
         let mut init =
             C2RustUnnamed_1{name: 0 as *const libc::c_char,
                             must_exist: 0i32,};
         init
     }];
unsafe extern "C" fn validate_name(mut fontname: *mut libc::c_char,
                                   mut len: libc::c_int) {
    ...
    while i < len {
        if *fontname.offset(i as isize) as libc::c_int == 0i32 {
            memmove(fontname.offset(i as isize) as *mut libc::c_void,
                    fontname.offset(i as isize).offset(1) as
                        *const libc::c_void, (len - i) as libc::c_ulong);
            count += 1;
            len -= 1
        }
        i += 1
    ...
    if count > 0i32 {
        dpx_warning(b"Removed %d null character(s) from fontname --> %s\x00"
                        as *const u8 as *const libc::c_char, count, fontname);
    }
    *fontname.offset(len as isize) = '\u{0}' as i32 as libc::c_char;
    ...
    while !badstrlist[i as usize].is_null() {
        ...
        if !p.is_null() && p > fontname {
            dpx_warning(b"Removed string \"%s\" from fontname \"%s\".\x00" as
                            *const u8 as *const libc::c_char,
                        badstrlist[i as usize], fontname);
            *p.offset(0) = '\u{0}' as i32 as libc::c_char;
            len =
                p.wrapping_offset_from(fontname) as libc::c_long as
                    libc::c_int;
            break ;
        } else { i += 1 }
    }
    if len < 1i32 {
        _tt_abort(b"No valid character found in fontname string.\x00" as
                      *const u8 as *const libc::c_char);
    };
}
static mut known_encodings: [C2RustUnnamed_3; 11] =
    [{
         let mut init =
             C2RustUnnamed_3{platform: 3u32 as libc::c_ushort,
                             encoding: 10u32 as libc::c_ushort,
                             pdfnames:
                                 [b"UCSms-UCS4\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"UCSms-UCS2\x00" as *const u8 as
                                      *const libc::c_char,
     ...
     },
     {
         let mut init =
             C2RustUnnamed_3{platform: 3u32 as libc::c_ushort,
                             ...
                             pdfnames:
                                 [b"90ms-RKSJ\x00" as *const u8 as
                                      *const libc::c_char,
                                  0 as *const libc::c_char,
                                  0 as *const libc::c_char,
                                  0 as *const libc::c_char,
     ...
     },
     {
         let mut init =
             C2RustUnnamed_3{platform: 3u32 as libc::c_ushort,
                             ...
                             pdfnames:
                                 [b"KSCms-UHC\x00" as *const u8 as
                                      *const libc::c_char,
                                  0 as *const libc::c_char,
                                  0 as *const libc::c_char,
                                  0 as *const libc::c_char,
     ...
     {
         let mut init =
             C2RustUnnamed_3{platform: 1u32 as libc::c_ushort,
                             encoding: 1u32 as libc::c_ushort,
                             pdfnames:
                                 [b"90pv-RKSJ\x00" as *const u8 as
                                      *const libc::c_char,
                                  0 as *const libc::c_char,
                                  0 as *const libc::c_char,
                                  0 as *const libc::c_char,
     ...
     },
     {
         let mut init =
             C2RustUnnamed_3{platform: 1u32 as libc::c_ushort,
                             encoding: 3u32 as libc::c_ushort,
                             pdfnames:
                                 [b"KSCpc-EUC\x00" as *const u8 as
                                      *const libc::c_char,
                                  0 as *const libc::c_char,
                                  0 as *const libc::c_char,
                                  0 as *const libc::c_char,
     ...
     {
         let mut init =
             C2RustUnnamed_3{platform: 0i32 as libc::c_ushort,
...
unsafe extern "C" fn find_tocode_cmap(mut reg: *const libc::c_char,
                                      mut ord: *const libc::c_char,
                                      mut select: libc::c_int) -> *mut CMap {
    ...
    if reg.is_null() || ord.is_null() || select < 0i32 || select > 9i32 {
        _tt_abort(b"Character set unknown.\x00" as *const u8 as
                      *const libc::c_char);
    }
    if streq_ptr(ord, b"UCS\x00" as *const u8 as *const libc::c_char) as
           libc::c_int != 0 && select <= 1i32 {
        return 0 as *mut CMap
    }
    i = 0i32;
    while cmap_id < 0i32 && i < 5i32 {
        append = known_encodings[select as usize].pdfnames[i as usize];
        if append.is_null() { break ; }
        cmap_name =
            new((strlen(reg).wrapping_add(strlen(ord)).wrapping_add(strlen(append)).wrapping_add(3i32
                                                                                                     as
                                                                                                     libc::c_ulong)
                     as uint32_t as
        ...
        sprintf(cmap_name,
                b"%s-%s-%s\x00" as *const u8 as *const libc::c_char, reg, ord,
                append);
    ...
    if cmap_id < 0i32 {
        dpx_warning(b"Could not find CID-to-Code mapping for \"%s-%s\".\x00"
                        as *const u8 as *const libc::c_char, reg, ord);
        dpx_warning(b"I tried to load (one of) the following file(s):\x00" as
                        *const u8 as *const libc::c_char);
        i = 0i32;
        while i < 5i32 {
            append = known_encodings[select as usize].pdfnames[i as usize];
            if append.is_null() { break ; }
            dpx_message(b" %s-%s-%s\x00" as *const u8 as *const libc::c_char,
                        reg, ord, append);
            i += 1
        }
        dpx_warning(b"Please check if this file exists.\x00" as *const u8 as
                        *const libc::c_char);
 ...
 */
unsafe extern "C" fn add_TTCIDHMetrics(mut fontdict: *mut pdf_obj,
                                       mut g: *mut tt_glyphs,
    ...
    if (*g).dw as libc::c_int != 0i32 &&
           (*g).dw as libc::c_int <= (*g).emsize as libc::c_int {
        dw =
            floor(1000.0f64 * (*g).dw as libc::c_int as libc::c_double /
        ...
        dw =
            floor(1000.0f64 *
                      (*(*g).gd.offset(0)).advw as libc::c_int as
                          libc::c_double /
                      (*g).emsize as libc::c_int as libc::c_double /
                      1i32 as libc::c_double + 0.5f64) *
                1i32 as libc::c_double
        ...
        if !(*used_chars.offset((cid / 8i32) as isize) as libc::c_int &
            ...
            gid =
                (if !cidtogidmap.is_null() {
                     (*cidtogidmap.offset((2i32 * cid) as isize) as
                          libc::c_int) << 8i32 |
            ...
            if !(cid != 0i32 && idx as libc::c_int == 0i32) {
                width =
                    floor(1000.0f64 *
                              (*(*g).gd.offset(idx as isize)).advw as
...
unsafe extern "C" fn add_TTCIDVMetrics(mut fontdict: *mut pdf_obj,
                                       mut g: *mut tt_glyphs,
                                       mut used_chars: *mut libc::c_char,
                                       mut last_cid: libc::c_ushort) {
    ...
    defaultVertOriginY =
        floor(1000.0f64 *
                  ((*g).default_advh as libc::c_int -
                       (*g).default_tsb as libc::c_int) as libc::c_double /
                  (*g).emsize as libc::c_int as libc::c_double /
                  1i32 as libc::c_double + 0.5f64) * 1i32 as libc::c_double;
    defaultAdvanceHeight =
        floor(1000.0f64 * (*g).default_advh as libc::c_int as libc::c_double /
                  (*g).emsize as libc::c_int as libc::c_double /
                  1i32 as libc::c_double + 0.5f64) * 1i32 as libc::c_double;
    ...
    while cid <= last_cid as libc::c_int {
        ...
        if !(*used_chars.offset((cid / 8i32) as isize) as libc::c_int &
            ...
            if !(cid != 0i32 && idx as libc::c_int == 0i32) {
                advanceHeight =
                    floor(1000.0f64 *
                              (*(*g).gd.offset(idx as isize)).advh as
                                  libc::c_int as libc::c_double /
                              (*g).emsize as libc::c_int as libc::c_double /
                              1i32 as libc::c_double + 0.5f64) *
                        1i32 as libc::c_double;
                ...
                vertOriginY =
                    floor(1000.0f64 *
                              ((*(*g).gd.offset(idx as isize)).tsb as
                                   libc::c_int +
                                   (*(*g).gd.offset(idx as isize)).ury as
                                       libc::c_int) as libc::c_double /
                              (*g).emsize as libc::c_int as libc::c_double /
                              1i32 as libc::c_double + 0.5f64) *
                        1i32 as libc::c_double;
 ...
 * Unicode mappings.
 */
unsafe extern "C" fn fix_CJK_symbols(mut code: libc::c_ushort)
 -> libc::c_ushort {
    let mut alt_code: libc::c_ushort = 0;
    static mut CJK_Uni_symbols: [C2RustUnnamed_2; 10] =
        [{
             let mut init =
                 C2RustUnnamed_2{alt1: 0x2014i32 as libc::c_ushort,
                                 alt2: 0x2015i32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0x2016i32 as libc::c_ushort,
                                 alt2: 0x2225i32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0x203ei32 as libc::c_ushort,
                                 alt2: 0xffe3i32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0x2026i32 as libc::c_ushort,
                                 alt2: 0x22efi32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0x2212i32 as libc::c_ushort,
                                 alt2: 0xff0di32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0x301ci32 as libc::c_ushort,
                                 alt2: 0xff5ei32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0xffe0i32 as libc::c_ushort,
                                 alt2: 0xa2i32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0xffe1i32 as libc::c_ushort,
                                 alt2: 0xa3i32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0xffe2i32 as libc::c_ushort,
                                 alt2: 0xaci32 as libc::c_ushort,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_2{alt1: 0xffffi32 as libc::c_ushort,
    ...
    while (i as libc::c_ulong) <
              (::std::mem::size_of::<[C2RustUnnamed_2; 10]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<C2RustUnnamed_2>()
                                                   as libc::c_ulong) {
        if CJK_Uni_symbols[i as usize].alt1 as libc::c_int ==
               code as libc::c_int {
            alt_code = CJK_Uni_symbols[i as usize].alt2;
            break ;
        } else if CJK_Uni_symbols[i as usize].alt2 as libc::c_int ==
                      code as libc::c_int {
...
unsafe extern "C" fn cid_to_code(mut cmap: *mut CMap, mut cid: CID)
 -> libc::c_int {
    ...
    if inbytesleft != 0i32 as libc::c_ulong {
        ...
        if outbytesleft == 31i32 as libc::c_ulong {
            ...
            if outbytesleft == 30i32 as libc::c_ulong {
                return (outbuf[0] as libc::c_int) << 8i32 |
                           outbuf[1] as libc::c_int
            } else {
                if outbytesleft == 28i32 as libc::c_ulong {
                    ...
                    let mut lo: CID = 0;
                    hi =
                        ((outbuf[0] as libc::c_int) << 8i32 |
                             outbuf[1] as libc::c_int) as CID;
                    lo =
                        ((outbuf[2] as libc::c_int) << 8i32 |
                             outbuf[3] as libc::c_int) as CID;
                    if hi as libc::c_int >= 0xd800i32 &&
                        ...
                        return (hi as libc::c_int - 0xd800i32) * 0x400i32 +
                                   0x10000i32 + lo as libc::c_int - 0xdc00i32
                    } else {
                        return (hi as libc::c_int) << 16i32 |
                                   lo as libc::c_int
                    }
                }
            }
...
pub unsafe extern "C" fn CIDFont_type2_dofont(mut font: *mut CIDFont) {
    ...
    if CIDFont_is_BaseFont(font) { return }
    /*
    ...
    pdf_add_dict(tmp,
                 pdf_new_name(b"Registry\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_string((*(*font).csi).registry as
                                    *const libc::c_void,
                                strlen((*(*font).csi).registry)));
    pdf_add_dict(tmp,
                 pdf_new_name(b"Ordering\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_string((*(*font).csi).ordering as
                                    *const libc::c_void,
    ...
    if handle.is_null() {
        ...
        if handle.is_null() {
            _tt_abort(b"Could not open TTF/dfont file: %s\x00" as *const u8 as
                          *const libc::c_char, (*font).ident);
        }
        sfont = dfont_open(handle, (*(*font).options).index)
    } else { sfont = sfnt_open(handle) }
    if sfont.is_null() {
        _tt_abort(b"Could not open TTF file: %s\x00" as *const u8 as
                      *const libc::c_char, (*font).ident);
    }
    match (*sfont).type_0 {
        16 => {
        ...
        1 => {
            if (*(*font).options).index > 0i32 {
                _tt_abort(b"Found TrueType font file while expecting TTC file (%s).\x00"
        ...
        _ => {
            _tt_abort(b"Not a TrueType/TTC font (%s)?\x00" as *const u8 as
                          *const libc::c_char, (*font).ident);
        }
    }
    if sfnt_read_table_directory(sfont, offset) < 0i32 {
        _tt_abort(b"Could not read TrueType table directory (%s).\x00" as
                      *const u8 as *const libc::c_char, (*font).ident);
    }
    /*
     * Adobe-Identity means font's internal glyph ordering here.
     */
    if streq_ptr((*(*font).csi).registry,
                 b"Adobe\x00" as *const u8 as *const libc::c_char) as
           libc::c_int != 0 &&
           streq_ptr((*(*font).csi).ordering,
                     b"Identity\x00" as *const u8 as *const libc::c_char) as
               libc::c_int != 0 {
        glyph_ordering = 1i32
    } else { glyph_ordering = 0i32 }
    /*
    ...
    if glyph_ordering != 0 {
        ...
        while i <= 9i32 {
            ttcmap =
                tt_cmap_read(sfont, known_encodings[i as usize].platform,
                             known_encodings[i as usize].encoding);
            if !ttcmap.is_null() { break ; }
            i += 1
        }
        if ttcmap.is_null() {
            dpx_warning(b"No usable TrueType cmap table found for font \"%s\".\x00"
                            as *const u8 as *const libc::c_char,
                        (*font).ident);
            dpx_warning(b"CID character collection for this font is set to \"%s-%s\"\x00"
                            as *const u8 as *const libc::c_char,
                        (*(*font).csi).registry, (*(*font).csi).ordering);
            _tt_abort(b"Cannot continue without this...\x00" as *const u8 as
                          *const libc::c_char);
        } else {
            if i <= 1i32 { unicode_cmap = 1i32 } else { unicode_cmap = 0i32 }
        }
        /*
         * NULL is returned if CMap is Identity CMap.
         */
        cmap =
            find_tocode_cmap((*(*font).csi).registry, (*(*font).csi).ordering,
                             i)
    } /* .notdef */
    ...
    while i >= 0i32 {
        if !h_used_chars.is_null() &&
               *h_used_chars.offset(i as isize) as libc::c_int != 0i32 {
    ...
    while i >= 0i32 {
        if !v_used_chars.is_null() &&
               *v_used_chars.offset(i as isize) as libc::c_int != 0i32 {
    ...
    if last_cid as libc::c_uint >= 0xffffu32 {
        _tt_abort(b"CID count > 65535\x00" as *const u8 as
                      *const libc::c_char);
    }
    ...
    if !h_used_chars.is_null() {
        ...
        while cid as libc::c_int <= last_cid as libc::c_int {
            ...
            if !(*h_used_chars.offset((cid as libc::c_int / 8i32) as isize) as
                     libc::c_int & 1i32 << 7i32 - cid as libc::c_int % 8i32 ==
                     0) {
                if glyph_ordering != 0 {
                    gid = cid;
                    ...
                    if gid as libc::c_int == 0i32 && unicode_cmap != 0 {
                        ...
                        alt_code =
                            fix_CJK_symbols(code as libc::c_ushort) as
                                libc::c_int;
                        if alt_code != code {
                            gid =
                                tt_cmap_lookup(ttcmap,
                                               alt_code as SFNT_ULONG);
                            if gid as libc::c_int != 0i32 {
                                dpx_warning(b"Unicode char U+%04x replaced with U+%04x.\x00"
                                                as *const u8 as
                ...
                if gid as libc::c_int == 0i32 {
                    dpx_warning(b"Glyph missing in font. (CID=%u, code=0x%04x)\x00"
                                    as *const u8 as *const libc::c_char,
                                cid as libc::c_int, code);
                }
    ...
    if !v_used_chars.is_null() {
        ...
        while cid as libc::c_int <= last_cid as libc::c_int {
            ...
            if !(*v_used_chars.offset((cid as libc::c_int / 8i32) as isize) as
                     libc::c_int & 1i32 << 7i32 - cid as libc::c_int % 8i32 ==
                     0) {
             ...
             */
                if !(!h_used_chars.is_null() &&
                         *h_used_chars.offset((cid as libc::c_int / 8i32) as
                                                  isize) as libc::c_int &
                    ...
                    if glyph_ordering != 0 {
                        ...
                        if gid_0 as libc::c_int == 0i32 && unicode_cmap != 0 {
                            ...
                            alt_code_0 =
                                fix_CJK_symbols(code_0 as libc::c_ushort) as
                                    libc::c_int;
                            if alt_code_0 != code_0 {
                                gid_0 =
                                    tt_cmap_lookup(ttcmap,
                                                   alt_code_0 as SFNT_ULONG);
                    ...
                    if !used_chars.is_null() {
                        ...
                        let ref mut fresh0 =
                            *used_chars.offset((cid as libc::c_int / 8i32) as
                                                   isize);
                        *fresh0 =
    ...
    if CIDFont_get_embedding(font) != 0 {
        if tt_build_tables(sfont, glyphs) < 0i32 {
            _tt_abort(b"Could not created FontFile stream.\x00" as *const u8
                          as *const libc::c_char);
        }
        if verbose > 1i32 {
            dpx_message(b"[%u glyphs (Max CID: %u)]\x00" as *const u8 as
                            *const libc::c_char,
                        (*glyphs).num_glyphs as libc::c_int,
                        last_cid as libc::c_int);
        }
    } else if tt_get_metrics(sfont, glyphs) < 0i32 {
        _tt_abort(b"Reading glyph metrics failed...\x00" as *const u8 as
                      *const libc::c_char);
    }
    /*
     * DW, W, DW2, and W2
    ...
    while !required_table[i as usize].name.is_null() {
        if sfnt_require_table(sfont, required_table[i as usize].name,
            ...
            _tt_abort(b"Some required TrueType table (%s) does not exist.\x00"
                          as *const u8 as *const libc::c_char,
    ...
    if cidtogidmap.is_null() {
        pdf_add_dict((*font).fontdict,
                     pdf_new_name(b"CIDToGIDMap\x00" as *const u8 as
                                      *const libc::c_char),
                     pdf_new_name(b"Identity\x00" as *const u8 as
                                      *const libc::c_char));
    } else {
        let mut c2gmstream: *mut pdf_obj = 0 as *mut pdf_obj;
        c2gmstream = pdf_new_stream(1i32 << 0i32);
        pdf_add_stream(c2gmstream, cidtogidmap as *const libc::c_void,
...
*/
#[no_mangle]
pub unsafe extern "C" fn CIDFont_type2_open(mut font: *mut CIDFont,
 ...
 -> libc::c_int {
    ...
    if !font.is_null() && !opt.is_null() {
        ...
        __assert_fail(b"font && opt\x00" as *const u8 as *const libc::c_char,
                      b"dpx-cidtype2.c\x00" as *const u8 as
                          *const libc::c_char, 901i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 73],
                                                &[libc::c_char; 73]>(b"int CIDFont_type2_open(CIDFont *, const char *, CIDSysInfo *, cid_opt *)\x00")).as_ptr());
    }
    ...
    if sfont.is_null() { ttstub_input_close(handle); return -1i32 }
    match (*sfont).type_0 {
        16 => { offset = ttc_read_offset(sfont, (*opt).index) }
        1 => {
            if (*opt).index > 0i32 {
                _tt_abort(b"Invalid TTC index (not TTC font): %s\x00" as
    ...
    if sfnt_read_table_directory(sfont, offset) < 0i32 {
        _tt_abort(b"Reading TrueType table directory failed.\x00" as *const u8
                      as *const libc::c_char);
    }
    ...
    shortname =
        new((127i32 as uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as
            *mut libc::c_char; /* for SJIS, UTF-16, ... string */
    namelen =
        tt_get_ps_fontname(sfont, shortname, 127i32 as USHORT) as libc::c_int;
    if namelen == 0i32 {
        memset(shortname as *mut libc::c_void, 0i32, 127i32 as libc::c_ulong);
    ...
    /*
         ...
         */
    fontname =
        new((strlen(shortname).wrapping_add(19i32 as libc::c_ulong) as
                 uint32_t as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                 as libc::c_ulong) as
                uint32_t) as *mut libc::c_char;
    ...
    if (*opt).embed != 0 && (*opt).style != 0i32 {
        dpx_warning(b"Embedding disabled due to style option for %s.\x00" as
                        *const u8 as *const libc::c_char, name);
        (*opt).embed = 0i32
    }
    match (*opt).style {
     ...
     */
    (*font).fontname =
        fontname; /* This means font's internal glyph ordering. */
    (*font).subtype = 2i32;
    (*font).csi =
    ...
    if !(*opt).csi.is_null() {
        if !cmap_csi.is_null() {
            if strcmp((*(*opt).csi).registry, (*cmap_csi).registry) != 0 ||
                ...
                dpx_warning(b"CID character collection mismatched:\n\x00" as
                                *const u8 as *const libc::c_char);
                dpx_message(b"\tFont: %s-%s-%d\n\x00" as *const u8 as
                                *const libc::c_char, (*(*opt).csi).registry,
                            (*(*opt).csi).ordering, (*(*opt).csi).supplement);
                dpx_message(b"\tCMap: %s-%s-%d\n\x00" as *const u8 as
                                *const libc::c_char, (*cmap_csi).registry,
                            (*cmap_csi).ordering, (*cmap_csi).supplement);
                _tt_abort(b"Incompatible CMap specified for this font.\x00" as
                              *const u8 as *const libc::c_char);
            }
            if (*(*opt).csi).supplement < (*cmap_csi).supplement {
                dpx_warning(b"Supplmement value in CIDSystemInfo increased.\x00"
                                as *const u8 as *const libc::c_char);
                dpx_warning(b"Some characters may not shown.\x00" as *const u8
                                as *const libc::c_char);
                (*(*opt).csi).supplement = (*cmap_csi).supplement
            }
        }
        (*(*font).csi).registry =
            new((strlen((*(*opt).csi).registry).wrapping_add(1i32 as
                                                                 libc::c_ulong)
                     as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                     as libc::c_ulong) as
        ...
        (*(*font).csi).ordering =
            new((strlen((*(*opt).csi).ordering).wrapping_add(1i32 as
                                                                 libc::c_ulong)
                     as uint32_t as
                     libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                                                     as libc::c_ulong) as
    ...
    pdf_add_dict((*font).fontdict,
                 pdf_new_name(b"Subtype\x00" as *const u8 as
                                  *const libc::c_char),
                 pdf_new_name(b"CIDFontType2\x00" as *const u8 as
                                  *const libc::c_char));
    (*font).descriptor =
